<?php
/* Smarty version 4.5.3, created on 2026-03-24 18:32:57
  from '/home/venom/wwwdir/whmcs/templates/six/includes/pwstrength.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_69c2d8d9182763_17060034',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f8ec7da699d0bd097d1b556d03ae2f2c960f3231' => 
    array (
      0 => '/home/venom/wwwdir/whmcs/templates/six/includes/pwstrength.tpl',
      1 => 1773235103,
      2 => 'file',
    ),
  ),
...
function content_69c2d8d9182763_17060034 (Smarty_Internal_Template $_smarty_tpl) {
?><br />
...
<?php if (file_exists("templates/".((string)$_smarty_tpl->tpl_vars['template']->value)."/includes/alert.tpl")) {?>
    <?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'passwordtips','maximum_length'=>$_smarty_tpl->tpl_vars['maximumPasswordLength']->value),$_smarty_tpl ) );
...
$_smarty_tpl->_subTemplateRender("file:six/includes/alert.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('type'=>"info",'msg'=>$_prefixVariable4), 0, false);
}?>
...
<?php }?>
    ...
    var maximumPasswordLength = <?php echo $_smarty_tpl->tpl_vars['maximumPasswordLength']->value;?>
;
    ...
    jQuery("#passwordStrengthBar .progress-bar .sr-only").html('<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'addslashes' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'pwstrengthrating'),$_smarty_tpl ) ) ));?>
: ' + pwstrength + '%');
...
;
    ...
    if (password2 && password1 !== password2) {
        ...
        jQuery("#inputNewPassword2Msg").html('<p class="help-block" id="nonMatchingPasswordResult"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['LANG']->value['pwdoesnotmatch'], ENT_QUOTES, 'UTF-8', true);?>
</p>');
