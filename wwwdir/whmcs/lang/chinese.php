...
$_LANG['addToCartButton'] = "加入購物車";
$_LANG['addToGetFreeDomain'] = "添加以獲得免費域名";
$_LANG['addfunds'] = "加值";
...
$_LANG['basicSsl'] = "基本 SSL";
$_LANG['billableitemseach'] = "每個";
$_LANG['billableitemshour'] = "小時";
$_LANG['billableitemshours'] = "營業時間";
$_LANG['billableitemsquantity'] = "數量";
$_LANG['billing']['creditnote'] = "信用單";
$_LANG['billing']['debitnote'] = "扣賬單";
$_LANG['billing']['issuedate'] = "發行日期";
$_LANG['billing']['issuedby'] = "發行者";
$_LANG['billing']['issuedto'] = "發行至";
$_LANG['billing']['ledger']['date'] = "日期";
$_LANG['billing']['ledger']['reference'] = "參考";
$_LANG['billing']['ledger']['title'] = "總帳";
$_LANG['billing']['ledger']['type'] = "類型";
$_LANG['billing']['type']['affiliatepayout'] = "聯盟支付";
$_LANG['billing']['type']['clientaccountcredit'] = "客戶帳戶信用";
$_LANG['billing']['type']['clientaccountdebit'] = "客戶帳戶扣賬";
$_LANG['billing']['type']['creditnoteadjustment'] = "信用票據調整";
$_LANG['billing']['type']['invoiceadjustment'] = "商業發票調整";
$_LANG['billing']['type']['payment'] = "付款";
$_LANG['billing']['type']['refund'] = "退款";
$_LANG['billing']['type']['refundtocredit'] = "退款至客戶帳戶";
$_LANG['billingAddress'] = "帳單地址";
$_LANG['billingOverview'] = "帳單概述";
$_LANG['billingdetails'] = "帳務詳情";
$_LANG['billingnotes']['creditnote']['items'] = "信用票據項目";
$_LANG['billingnotes']['debitnote']['items'] = "借記票據項目";
...
$_LANG['cartItemType']['addon'] = "附加套件";
$_LANG['cartItemType']['addons'] = "附加套件";
$_LANG['cartItemType']['bundle'] = "組合";
$_LANG['cartItemType']['bundles'] = "束";
$_LANG['cartItemType']['domain'] = "網域";
$_LANG['cartItemType']['domainRegistration'] = "網域註冊";
$_LANG['cartItemType']['domainRenewal'] = "續約網域";
$_LANG['cartItemType']['domainRenewals'] = "網域續約";
$_LANG['cartItemType']['domainTransfer'] = "網域轉移";
$_LANG['cartItemType']['domainTransfers'] = "域名轉移";
$_LANG['cartItemType']['domains'] = "網域名稱";
$_LANG['cartItemType']['product'] = "產品";
$_LANG['cartItemType']['products'] = "產品";
$_LANG['cartItemsSelected'] = "您已選擇 :count 並準備購買。";
...
$_LANG['choosePackages'] = "從各種套餐中進行選擇";
...
$_LANG['designedToFitAnyBudget'] = "專為滿足任何預算而設計";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "按關鍵字、描述或網域搜尋。&#10;例如： &quot;有趣的商業活動 &quot;, &quot;專業人士的綜合財務規劃服務&quot;，或 &quot;example.com&quot;。";
$_LANG['domainSearch']['domainOrAiPrompt'] = "輸入簡短描述或確切的網域。";
$_LANG['domainSearch']['errors']['noSuggestions'] = "系統找不到任何建議。";
$_LANG['domainSearch']['exactMatch'] = "完全匹配";
$_LANG['domainSearch']['maxLength'] = "最大長度";
$_LANG['domainSearch']['notAvailable'] = "無法取得";
$_LANG['domainSearch']['safeSearch'] = "安全搜尋";
$_LANG['domainSearch']['tlds'] = "包括 TLD";
$_LANG['domainSearch']['topAiSuggestion'] = "人工智能建議";
$_LANG['domainSearch']['topSuggestion'] = "主要建議";
...
$_LANG['due'] = "到期";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "您必須通過勾選 :attribute接受服務條款。";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute 必須是一個數組。";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute 必須是有效日期。";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute 必須是有效的電子郵件地址。";
$_LANG['dynamicServiceFields']['validation']['failed'] = "系統遇到內部錯誤。稍後再試一次。";
$_LANG['dynamicServiceFields']['validation']['in'] = "選取的 :attribute 選項無效。";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute 必須是整數。";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute 不得包含超過 :max 字元。";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute 必須使用下列其中一種檔案類型： :values。";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute 必須至少包含 :min 字元。";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute 必須是一個數字。";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute 必須是一個有效的正則表達式。";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute 是必要的。";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute 必須是包含通訊協定的有效網址 (「http://」或「https://」)。";
$_LANG['edit'] = "編輯";
$_LANG['email'] = "電子郵件";
...
$_LANG['enabled'] = "已啟用";
$_LANG['encryption_failed'] = "加密失敗： %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "稍後再試一次。";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "主頁";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "您發送過多的請求。";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "抱歉！";
...
$_LANG['estimateTaxes'] = "估算稅金";
$_LANG['every'] = "每";
$_LANG['exampledomain'] = "例如：example.com";
$_LANG['excludeTLDs'] = "不包括特定 TLD 和最近續訂的網域";
...
$_LANG['extendYourDomainBy1Year'] = "延長您的域名 1 年 *";
...
$_LANG['freeDomainHostingPromo'] = "購買主機時獲得免費域名。";
$_LANG['from'] = "從";
$_LANG['fromJust'] = "從只是";
...
$_LANG['hideMenu'] = "隱藏選單";
$_LANG['hideSearchControls'] = "隱藏搜尋控制項";
...
$_LANG['inStock'] = "現有庫存: :amount";
$_LANG['incApplicableTaxes'] = "包括適用稅";
$_LANG['includeTLDs'] = "包括 TLD";
$_LANG['included'] = "包括";
$_LANG['information'] = "資訊";
$_LANG['insufficientstockmessage'] = "我們目前某些商品的庫存不足。購物車數量已相應調整。";
$_LANG['invalidCode'] = "無效的促銷代碼";
$_LANG['invalid_input'] = "無效輸入： %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "無效的機票 ID 或回覆 ID。";
...
$_LANG['marketConnect']['dynamic']['manage'] = "登入";
...
$_LANG['navMarketConnectService']['dynamic'] = "動態服務";
...
$_LANG['orderForm']['additionalInformation'] = "其他資訊";
...
$_LANG['orderForm']['findNewDomainAi'] = "使用 AI 支援的建議搜尋網域。";
...
$_LANG['ordererrortldsnotconfigured'] = "目前沒有域名副檔名可供出售。如需幫助，請聯繫我們。";
...
$_LANG['orderpaymenttermadjectiveannually'] = "年度";
$_LANG['orderpaymenttermadjectivebiennially'] = "雙年展";
$_LANG['orderpaymenttermadjectivefree'] = "免費";
$_LANG['orderpaymenttermadjectivemonthly'] = "月繳";
$_LANG['orderpaymenttermadjectiveonetime'] = "一次性繳費帳戶";
$_LANG['orderpaymenttermadjectivequarterly'] = "季繳";
$_LANG['orderpaymenttermadjectivesemiannually'] = "半年";
$_LANG['orderpaymenttermadjectivetriennially'] = "三年";
...
$_LANG['page'] = "頁次";
$_LANG['pageof'] = "/";
$_LANG['passwordtips'] = "<strong>安全密碼的提示</strong><br />請同時使用大寫和小寫字元。<br />至少包含一個符號（例如 <code>#</code>， <code>$</code>， <code>！</code>， <code>%</code>，或 <code>&amp;</code>）。<br />不要使用字典單詞。<br />密碼最多可包含 :maximum_ 長度字元。";
...
$_LANG['price'] = "價格";
$_LANG['priceFor'] = ":term的價格";
$_LANG['priceForThisTerm'] = "本期的價格";
$_LANG['priceStandard'] = "每年以 :renewalPrice更新，加稅。";
$_LANG['priceWithDiscount'] = "第一年 :registrationPrice ，然後每年 :renewalPrice 。";
...
$_LANG['pwlengthmax'] = "密碼不能包含超過 :max 字元。";
$_LANG['pwreset'] = "密碼重設";
...
$_LANG['pwstrengthfail'] = "這個密碼不夠強。輸入更複雜的密碼。";
...
$_LANG['rssfeed'] = "飼料";
$_LANG['safeSearch'] = "安全搜尋";
$_LANG['sale'] = "銷售";
$_LANG['salePrice'] = "銷售價格";
$_LANG['salesTaxes'] = "銷售稅";
$_LANG['search'] = "搜尋";
$_LANG['searchOurKnowledgebase'] = "搜尋我們的知識庫";
$_LANG['searchResults'] = "搜索結果";
...
$_LANG['selectCountry'] = "選擇國家";
$_LANG['selectDomain'] = "選擇網域";
$_LANG['selectDomainForHosting'] = "您想將此共享託管套件附加到哪個域名？";
$_LANG['selectDomainsForSsl'] = "您希望將基本 SSL 套用至哪個網域？您可以選取多個。";
$_LANG['selectState'] = "選擇州";
...
$_LANG['service_unavailable'] = "無法使用服務: %s";
$_LANG['servicesRenew'] = "續約";
$_LANG['setupFee'] = ":amount 設置費";
$_LANG['setupMandate'] = "設定付款授權";
$_LANG['sharedHosting'] = "共享託管";
$_LANG['shopNow'] = "立即購買";
$_LANG['shortcuts'] = "捷徑";
$_LANG['show'] = "顯示";
$_LANG['showMenu'] = "顯示菜單";
$_LANG['showSearchControls'] = "顯示搜尋控制項";
...
$_LANG['store']['dynamic']['title'] = "動態服務";
...
$_LANG['store']['error']['serviceUnavailable'] = "目前無法處理您的請求。這可能是由於逾時或臨時服務問題所致。請再試一次。";
$_LANG['store']['error']['validationFailed'] = "請檢查並更正以下錯誤。";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo 為您提供經過驗證、引導的 SEO 流程，而不需要您成為專家。 <br> marketgoo 價格實惠，並在直觀的界面中提供全面的 SEO 報告，計劃和建議。";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "是什麼讓 marketgoo 與其他 SEO 產品不同？";
$_LANG['store']['marketgoo']['faqs']['title'] = "常見問題與支援";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "搜尋引擎提交";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "網站生成器兼容性";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "每月進度報告";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "流量分析";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "下載搜索引擎優化報告為 PDF 格式 <a href='https://mktgoo.co/seo-report-score2'>(請參閱範例)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "AI 驅動的功能：自動生成標題和元描述";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "已掃描的頁面";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "競爭對手追蹤";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "關鍵字追蹤與最佳化";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "更新的報告和計劃";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "自定義 SEO 計劃";
$_LANG['store']['marketgoo']['features']['1'] = "取得您的 SEO 計劃";
$_LANG['store']['marketgoo']['features']['2'] = "遵循分步說明";
$_LANG['store']['marketgoo']['features']['3'] = "使用每月報告監控進度";
$_LANG['store']['marketgoo']['features']['4'] = "追蹤和監控競爭對手";
$_LANG['store']['marketgoo']['features']['5'] = "個別頁面優化";
$_LANG['store']['marketgoo']['features']['6'] = "簡單的關鍵字研究和監控";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "註冊並獲取您的即時 SEO 報告和計劃。查看哪些地方可以改進，並獲得針對您的網站量身定制的建議。";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "指示是為非技術精通的用戶撰寫，並引導您完成每個建議，並附帶示例和說明。";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "每個月，收到一封包含您網站的 SEO 進度的電子郵件，並將其下載為 PDF。";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "關注競爭對手，了解他們在獲得流量的做法以及您的數字與他們的數字如何比較。他們永遠不會知道你在看！";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo 通過將其與您選擇的關鍵字匹配，並確保頻率和位置正確，來指導您優化網站上的每個個別頁面。";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "如果您不熟悉 SEO，關鍵字可能會令人難以置信。marketgoo 推薦關鍵字，還允許您搜索並輸入要優化的關鍵字。";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "可與所有網站建置器一起使用";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " 比較日期：20 年 6 月 19 日 25:tagBreak* 根據 AV-Test 的研究進行的整體網絡性能。您可以閱讀 :tagOpen完整報告:tagClose。";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "有關資料洩漏的警報";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "惡意軟體掃描下載";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn2'] = "7300 人以上";
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "未披露";
$_LANG['store']['nordvpn']['features']['comparison']['vpn4'] = "200 人以上";
$_LANG['store']['nordvpn']['features']['comparison']['vpn5'] = "超過 3000";
$_LANG['store']['nordvpn']['features']['comparison']['vpn6'] = "六百多個以上";
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "追踪器和廣告攔截器";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "諾德 VPN 不限制連接速度。享受我們的全速 VPN 連接，而無需任何節流。";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "諾德 VPN 與所有流行平台兼容，包括 Windows，macOS，Linux，安卓和 iOS。此外，您最多可以保護 10 台設備，包括路由器。";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "沒有 VPN 頻寬限制  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "在私密且安全的連線上瀏覽、播放和工作";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "即使在公共 Wi-Fi 上也能保持安全連線";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "透過保護您的 IP 位址，減少線上追蹤";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "出國旅行時觀看家庭內容";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "隨時隨地使用 NordVPN 加密您的線上活動，以獲得額外的保護層級。";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN 使用新一代加密保護您的連接，因此您可以毫無憂地登入帳戶、進行銀行轉帳和在線購物。即使在不受保護的網絡上。";
$_LANG['store']['nordvpn']['features']['security']['tagline4'] = "你在網上做什麼都沒有關係。這就是為什麼我們不跟踪、收集或共享您的私人數據的原因。我們也無法向第三方提供有關您的任何詳細信息，即使他們要求。";
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN 擁有多種功能，可以保護您免受網絡威脅的侵害。除了威脅防護 Pro™ 之外，還有一個自動斷開關，可在 VPN 連接中斷時阻止您的互聯網連接，確保您的數據保持安全。當由於政府審查和嚴格的互聯網法規，需要高等級的在線安全性時，模糊的服務器將為您提供幫助。";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "使用 VPN 提高您的在線安全性";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "進階安全性";
$_LANG['store']['nordvpn']['features']['security']['title3'] = "無記錄政策";
$_LANG['store']['nordvpn']['features']['security']['title4'] = "額外功能提供額外的安全性";
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "每當您下載文件時，威脅防護 Pro™ 都會檢查它是否有惡意軟件。";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "威脅防護 Pro™ 阻止侵入式廣告和網絡追踪器，並自動掃描 URL 並阻止惡意的廣告。";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "威脅防護專業版™ 可保護您的設備和隱私。通過阻止跟踪器，它可以幫助您避免在線偷窺。";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "NordVPN 的 :tagOpen威脅防護專業版™:tagClose 功能改變了遊戲，只需單擊一下即可提供更多安全優勢和更好的保護。";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "不僅僅是 VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "即使您沒什麼可隱藏，您也許不喜歡被監視和跟踪的想法。互聯網用戶選擇 VPN 服務的主要原因是在線隱私和一般安全性。:tagBreak這裡有具體原因為什麼？";
...
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "避免對 Facebook、X（推特）和 WhatsApp 等平台進行區域和政治限制。";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "在線廣告通常會令人煩惱和分心。它們會混亂大部分網站，連接速度降低，並且可能是惡意的。";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "智能家居技術，尤其是不安全的 IoT 設備，可能會在家庭網絡中創造漏洞。";
$_LANG['store']['nordvpn']['features']['use']['tagline7'] = "智慧家居技術，尤其是不安全的 IoT 裝置，可能會為家庭網路造成弱點。";
$_LANG['store']['nordvpn']['features']['use']['title1'] = "使用案例";
$_LANG['store']['nordvpn']['features']['use']['title2'] = "安全的公共 Wi-Fi 連線";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "更安全的瀏覽";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "無限制的社交媒體訪問";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "防止惡意廣告";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "智能家居安全";
...
$_LANG['store']['nordvpn']['features']['world']['count1'] = "7300 人以上";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• 保護您的 IP 地址:tagBreak• 阻止惡意軟件，跟踪器和廣告:tagBreak• 最多可連接 10 台設備";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "每日智能數據庫掃描";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "每日智能文件掃描";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "使用 SocialBee 設計新鮮的內容，提高參與度並跟踪您的結果。";
$_LANG['store']['socialbee']['cartTitle'] = "社交蜂社交媒體管理";
...
$_LANG['tax']['errorVatInvalidFormat'] = ":countryName的增值稅編號格式無效。";
...
$_LANG['upTo'] = "最高 :num";
$_LANG['update'] = "修改資料";
$_LANG['updateProductQuantity'] = "更新";
$_LANG['updateTotals'] = "更新總計";
