...
$_LANG['addToCartButton'] = "Kosárba";
$_LANG['addToGetFreeDomain'] = "Hozzáadás az ingyenes domain megszerzéséhez";
...
$_LANG['billing']['creditnote'] = "Hiteljegyzet";
$_LANG['billing']['debitnote'] = "Betéti jegyzet";
$_LANG['billing']['issuedate'] = "Kiadás dátuma";
$_LANG['billing']['issuedby'] = "Kiadó:";
$_LANG['billing']['issuedto'] = "Kiadták";
$_LANG['billing']['ledger']['date'] = "Dátum";
$_LANG['billing']['ledger']['reference'] = "Referencia";
$_LANG['billing']['ledger']['title'] = "Főkönyv";
$_LANG['billing']['ledger']['type'] = "Típus";
$_LANG['billing']['type']['affiliatepayout'] = "Affiliate kifizetés";
$_LANG['billing']['type']['clientaccountcredit'] = "Ügyfélszámla hitel";
$_LANG['billing']['type']['clientaccountdebit'] = "Ügyfélszámla terhelése";
$_LANG['billing']['type']['creditnoteadjustment'] = "Hiteljegy-kiigazítás";
$_LANG['billing']['type']['invoiceadjustment'] = "Számla kiigazítása";
$_LANG['billing']['type']['payment'] = "Fizetés";
$_LANG['billing']['type']['refund'] = "Visszatérítés";
$_LANG['billing']['type']['refundtocredit'] = "Visszatérítés az ügyfélszámlára";
$_LANG['billingAddress'] = "Számlázási cím";
$_LANG['billingOverview'] = "Számlázás áttekintése";
$_LANG['billingdetails'] = "Számlázási adatok";
$_LANG['billingnotes']['creditnote']['items'] = "Hiteljegyzetek";
$_LANG['billingnotes']['debitnote']['items'] = "Betéti jegyzetelemek";
...
$_LANG['cartItemType']['addon'] = "Kiegészítés";
$_LANG['cartItemType']['addons'] = "Kiegészítések";
$_LANG['cartItemType']['bundle'] = "Csomag";
$_LANG['cartItemType']['bundles'] = "Csomagok";
$_LANG['cartItemType']['domain'] = "Domain";
$_LANG['cartItemType']['domainRegistration'] = "Domain regisztráció";
$_LANG['cartItemType']['domainRenewal'] = "Domain megújítása";
$_LANG['cartItemType']['domainRenewals'] = "Domain megújítás";
$_LANG['cartItemType']['domainTransfer'] = "Domain átrgisztráció";
$_LANG['cartItemType']['domainTransfers'] = "Domaintranszfer";
$_LANG['cartItemType']['domains'] = "Domainek";
$_LANG['cartItemType']['product'] = "Termék";
$_LANG['cartItemType']['products'] = "Termékek";
$_LANG['cartItemsSelected'] = "Kiválasztotta a :count lehetőséget, és készen áll a vásárlásra.";
...
$_LANG['choosePackages'] = "Válasszon a csomagok széles választékából";
...
$_LANG['codeApplied'] = "Promóciós kód alkalmazott";
$_LANG['completeorder'] = "Megrendelés";
$_LANG['configModalTitle'] = "Konfiguráció";
...
$_LANG['confirmItemDeletion'] = "Törlés megerősítése";
...
$_LANG['cycleRenewal'] = ":cycle Megújítás";
$_LANG['daily'] = "Napi";
...
$_LANG['designedToFitAnyBudget'] = "Bármilyen költségvetésnek megfelelően tervezték";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Keresés kulcsszó, leírás vagy domain alapján.&#10;Például: &quot;Szórakoztató üzleti események &quot;, &quot;Átfogó pénzügyi tervezési szolgáltatás szakemberek számára&quot;, vagy &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Adjon meg egy rövid leírást vagy egy pontos domaint.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "A rendszer nem talált javaslatokat.";
$_LANG['domainSearch']['exactMatch'] = "Pontos mérkőzés";
$_LANG['domainSearch']['maxLength'] = "Maximális hosszúság";
$_LANG['domainSearch']['notAvailable'] = "Nem elérhető";
$_LANG['domainSearch']['safeSearch'] = "Biztonságos keresés";
$_LANG['domainSearch']['tlds'] = "Tartalmazza a TLD-ket";
$_LANG['domainSearch']['topAiSuggestion'] = "Legjobb AI javaslat";
$_LANG['domainSearch']['topSuggestion'] = "Legjobb javaslat";
...
$_LANG['due'] = "Esedékes";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "A szolgáltatási feltételeket el kell fogadnia a :attributejelölőnégyzettel.";
$_LANG['dynamicServiceFields']['validation']['array'] = "A :attribute tömbnek kell lennie.";
$_LANG['dynamicServiceFields']['validation']['date'] = "A :attribute érvényes dátumnak kell lennie.";
$_LANG['dynamicServiceFields']['validation']['email'] = "A :attribute érvényes e-mail címnek kell lennie.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "A rendszer belső hibát tapasztalt. Próbáld újra később.";
$_LANG['dynamicServiceFields']['validation']['in'] = "A :attribute kijelölt opció érvénytelen.";
$_LANG['dynamicServiceFields']['validation']['integer'] = "A :attribute egész számnak kell lennie.";
$_LANG['dynamicServiceFields']['validation']['max'] = "A :attribute nem tartalmazhat több mint :max karaktert.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = "A :attribute a következő fájltípusok egyikét kell használnia: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = "A :attribute -nak legalább :min karaktert kell tartalmaznia.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = "A :attribute számnak kell lennie.";
$_LANG['dynamicServiceFields']['validation']['regex'] = "A :attribute érvényes reguláris kifejezésnek kell lennie.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute szükséges.";
$_LANG['dynamicServiceFields']['validation']['url'] = "A :attribute egy érvényes URL-nek kell lennie, amely tartalmazza a protokollt („http://” vagy „https://”).";
...
$_LANG['encryption_failed'] = "Titkosítás sikertelen: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Próbáld újra később.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Kezdőlap";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Túl sok kérést küldtél.";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "Hoppá!";
...
$_LANG['estimateTaxes'] = "Becsült adók";
$_LANG['every'] = "Minden";
$_LANG['exampledomain'] = "pl. example.com";
$_LANG['excludeTLDs'] = "Nem tartalmazza az egyes TLD-k és a nemrégiben megújított domainek díját";
...
$_LANG['extendYourDomainBy1Year'] = "Bővítse domainjét 1 évvel *";
...
$_LANG['findDomains'] = "Domainek keresése";
...
$_LANG['forTheFirstYear'] = "az első évben";
...
$_LANG['freeDomainHostingPromo'] = "Szerezzen ingyenes domaint, amikor tárhelyet vásárol.";
$_LANG['from'] = "Tól";
...
$_LANG['hideSearchControls'] = "Keresési vezérlők elrejtése";
...
$_LANG['inStock'] = "Raktáron: :amount";
$_LANG['incApplicableTaxes'] = "beleértve az alkalmazandó adókat";
$_LANG['includeTLDs'] = "Tartalmazza a TLD-ket";
$_LANG['included'] = "Tartalmazza";
...
$_LANG['invalidCode'] = "Érvénytelen promóciós kód";
$_LANG['invalid_input'] = "Érvénytelen bevitel: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "Érvénytelen jegyazonosító vagy válaszazonosító.";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Bejelentkezés";
...
$_LANG['marketConnect']['socialbee']['manage'] = "Jelentkezzen be a SocialBee-be";
...
$_LANG['maxLength'] = "Maximális hosszúság";
...
$_LANG['navMarketConnectService']['dynamic'] = "Dinamikus szolgáltatások";
...
$_LANG['noDomainsFound'] = "Nem találtak domaineket";
...
$_LANG['orderForm']['additionalInformation'] = "Egyéb Információ";
...
$_LANG['orderForm']['findNewDomainAi'] = "Keressen egy tartományt AI-alapú javaslatokkal.";
...
$_LANG['ordererrortldsnotconfigured'] = "Jelenleg nincs eladó domain kiterjesztés. Segítségért vegye fel velünk a kapcsolatot.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "Éves";
$_LANG['orderpaymenttermadjectivebiennially'] = "kétévente";
$_LANG['orderpaymenttermadjectivefree'] = "Ingyenes";
$_LANG['orderpaymenttermadjectivemonthly'] = "havonta";
$_LANG['orderpaymenttermadjectiveonetime'] = "egyszeri";
$_LANG['orderpaymenttermadjectivequarterly'] = "negyedévente";
$_LANG['orderpaymenttermadjectivesemiannually'] = "féléves";
$_LANG['orderpaymenttermadjectivetriennially'] = "Hároméves";
...
$_LANG['orderselectterm'] = "Válassza ki a kifejezést";
...
$_LANG['page'] = "Oldal";
$_LANG['pageof'] = "a";
$_LANG['passwordtips'] = "<strong>Tippek a biztonságos jelszóhoz</strong><br />Használjon nagybetűket és kisbetűket egyaránt.<br />Adjon meg legalább egy szimbólumot (például <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>, vagy <code>&amp;</code>).<br />Ne használjon szótárszavakat.<br />A jelszavak legfeljebb :maximum_length karaktereket tartalmazhatnak.";
...
$_LANG['paypalCommerce']['error']['currency_not_supported'] = "A PayPal nem támogatja ezt a pénznemet.";
...
$_LANG['premium'] = "Prémium";
$_LANG['presalescontactdescription'] = "Kérjük itt tegye fel a kérdéseit";
$_LANG['previous'] = "Előző";
$_LANG['previouspage'] = "Előző oldal";
$_LANG['price'] = "ár";
$_LANG['priceFor'] = "Ár a :term";
$_LANG['priceForThisTerm'] = "Ennek a kifejezésnek az ára";
$_LANG['priceStandard'] = "Minden évben megújul a :renewalPrice-on, plusz adó.";
$_LANG['priceWithDiscount'] = "Az első évben :registrationPrice , majd évente :renewalPrice .";
...
$_LANG['pwlengthmax'] = "A jelszavak nem tartalmazhatnak több mint :max karaktert.";
...
$_LANG['pwstrengthfail'] = "Ez a jelszó nem elég erős. Adjon meg egy összetettebb jelszót.";
...
$_LANG['recommendedTLDs'] = "Ajánlott TLD-k";
...
$_LANG['renewPrice'] = "Ár megújítása";
...
$_LANG['requiredFields'] = "A kötelező mezők betűkkel vannak jelölve: *";
...
$_LANG['safeSearch'] = "Biztonságos keresés";
$_LANG['sale'] = "Akció";
$_LANG['salePrice'] = "eladási ár";
$_LANG['salesTaxes'] = "Értékesítési adók";
$_LANG['search'] = "Keresés";
$_LANG['searchOurKnowledgebase'] = "Keressen tudásbázisunkban";
$_LANG['searchResults'] = "Keresési eredmények";
...
$_LANG['selectCountry'] = "Válasszon országot";
$_LANG['selectDomain'] = "Domain kiválasztása";
$_LANG['selectDomainForHosting'] = "Melyik domainhez szeretné csatolni ezt a megosztott tárhelycsomagot?";
$_LANG['selectDomainsForSsl'] = "Melyik domain (ek) re szeretné alkalmazni az alapvető SSL-t? Kiválaszthat többszöröt.";
$_LANG['selectState'] = "Válassza ki az államot";
...
$_LANG['service_unavailable'] = "Szolgáltatás nem érhető el: %s";
$_LANG['servicesRenew'] = "Megújítás";
$_LANG['setupFee'] = ":amount Beállítási díj";
$_LANG['setupMandate'] = "Beállítás megbízása a fizetéshez";
$_LANG['sharedHosting'] = "Megosztott tárhely";
$_LANG['shopNow'] = "Vásároljon most";
$_LANG['shortcuts'] = "Gyorsmenü";
$_LANG['show'] = "Mutat";
$_LANG['showMenu'] = "Menü megjelenítése";
$_LANG['showSearchControls'] = "Keresési vezérlők megjelenítése";
...
$_LANG['store']['engage'] = "Vegyen részt";
$_LANG['store']['error']['serviceUnavailable'] = "Jelenleg nem sikerült feldolgozni a kérését. Ennek oka lehet időlejárás vagy ideiglenes szolgáltatási probléma. Kérjük, próbálkozzon újra.";
$_LANG['store']['error']['validationFailed'] = "Kérjük, ellenőrizze és javítsa ki az alábbi hibákat.";
$_LANG['store']['faq'] = "Gyakran Ismételt Kérdések";
$_LANG['store']['forJust'] = "részére csak";
$_LANG['store']['fromJust'] = "tól csak";
$_LANG['store']['getstarted'] = "Első lépések";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "A marketgoo bevált, irányított SEO folyamatot biztosít Önnek anélkül, hogy szakértőnek kellene lenned. A <br> marketgoo megfizethető, és átfogó SEO jelentéseket, terveket és ajánlásokat kínál, mindezt intuitív felületen.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Miben különbözik a marketgoo más SEO termékektől?";
$_LANG['store']['marketgoo']['faqs']['title'] = "GYIK és támogatás";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "Keresőmotor beküldése";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Webhely-készítő kompatibilitás";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Havi előrehaladási jelentés";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Forgalomelemzés";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Töltse le a SEO jelentést PDF formátumban <a href='https://mktgoo.co/seo-report-score2'>(lásd a példát)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "AI-alapú funkciók: A cím és a meta leírás automatikus generálása";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Szkennelt oldalak";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Versenytársak követése";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Kulcsszókövetés és optimalizálás";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Frissített jelentés és terv";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Egyedi SEO terv";
$_LANG['store']['marketgoo']['features']['1'] = "Szerezd meg SEO tervét";
$_LANG['store']['marketgoo']['features']['2'] = "Kövesse lépésenkénti utasításokat";
$_LANG['store']['marketgoo']['features']['3'] = "Az előrehaladás figyelemmel kísérése havi jelentéssel";
$_LANG['store']['marketgoo']['features']['4'] = "A versenytársak nyomon követése és";
$_LANG['store']['marketgoo']['features']['5'] = "Egyéni oldaloptimalizálás";
$_LANG['store']['marketgoo']['features']['6'] = "Könnyű kulcsszókutatás és monitorozás";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Iratkozzon fel, és kapja meg azonnali SEO jelentését és tervét. Nézze meg, hol van lehetőség a fejlesztésre, és kérjen ajánlásokat a webhelyéhez igazított.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Az utasításokat nem technikailag hozzáértő felhasználók számára írják, amelyek minden ajánláson keresztül vezetnek, példákkal és magyarázatokkal.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Minden hónapban kapjon e-mailt webhelye SEO előrehaladásáról, és töltse le PDF formátumban.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Tartsa figyelemmel a versenytársakat, hogy megnézze, mit tesznek a forgalom elérése érdekében, és hogy a számok hogyan állnak össze az övékkel. Soha nem fogják tudni, hogy nézel!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "a marketgoo útmutat a webhely egyes oldalainak optimalizálásán azáltal, hogy illeszti azt az egyik kiválasztott kulcsszóhoz, és megbizonyosodik arról, hogy a gyakoriság és az elhelyezés helyes.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "A kulcsszavak elsöprőek lehetnek, ha nem ismeri a SEO-t. A marketgoo kulcsszavakat ajánl, és lehetővé teszi az optimalizálni kívánt kulcsszavak keresését és megadását is.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Minden weboldal készítővel működik";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Az összehasonlítás dátuma: június 19, 20 25:tagBreak*Teljes hálózati teljesítmény az AV-Test kutatása szerint. Elolvashatja a :tagOpenteljes jelentést:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "A kiszivárgott hitelesítő adatokról";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "A rosszindulatú programok letöltése";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Nem nyilvánosságra hozott";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "Nyomkövető és hirdetésblokkoló";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "A Nord VPN nem korlátozza a kapcsolat sebességét. Élvezze teljes sebességű VPN-kapcsolatunkat fojtás nélkül.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "A Nord VPN kompatibilis az összes népszerű platformmal, beleértve a Windows, macOS, Linux, Android és iOS rendszert. Ráadásul akár 10 eszközt is biztosíthat, beleértve a routert is.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "Nincs VPN sávszélességkorlátozás  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Böngésszen, játsszon és dolgozzon privát és biztonságos kapcsolaton";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Nyilvános Wi-Fi-n is biztonságosan kapcsolódjon";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Csökkentse az online követést az IP-cím árnyékolásával";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Nézze meg az otthoni tartalmat külföldön utazva";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "A NordVPN segítségével titkosíthatja online tevékenységeit, hogy további védelmet nyújtson, bárhol és bárhol is csatlakozik.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "A NordVPN a következő generációs titkosítással védi kapcsolatát, így gond nélkül bejelentkezhet számláira, banki átutalásokat végezhet és online vásárolhat. Még nem védett hálózatokon is.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "A NordVPN számos funkcióval büszkélkedhet, amelyek megvédik Önt a számítógépes fenyegetésekkel szemben. A Threat Protection Pro™ mellett van egy automatikus Kill Switch, amely blokkolja az internetkapcsolatot, ha a VPN-kapcsolat megszűnik, biztosítva az adatok biztonságát. A homályos szerverek segítenek, ha a kormányzati cenzúra és a szigorú internetes előírások miatt magas szintű online biztonságra van szükség.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Növelje online biztonságát VPN segítségével";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Speciális biztonság";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Amikor letölt egy fájlt, a Threat Protection Pro™ megvizsgálja, hogy nincs-e rosszindulatú programok.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "A Threat Protection Pro™ blokkolja a tolakodó hirdetéseket és a webes nyomkövetőket, automatikusan átvizsgálja az URL-eket és blokkolja a rosszindulatú hirdetéseket.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "A Threat Protection Pro™ védi eszközeit és magánéletét. A nyomkövetők blokkolásával segít elkerülni az online szoppeket.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "A NordVPN :tagOpenThreat Protection Pro™:tagClose funkciója egy játékváltó, amely még több biztonsági előnnyel és jobb védelmet kínál egyetlen extra kattintással.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Több, mint egy VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Még ha nincs is rejtegetnivalója, valószínűleg nem tetszik az ötlet, hogy figyelnek és nyomon követik. A fő oka annak, hogy az internetfelhasználók a VPN-szolgáltatásokat választják, az online adatvédelem és az általános biztonság.:tagBreakItt vannak konkrét okok, MIÉRT?";
...
$_LANG['store']['nordvpn']['features']['use']['tagline3'] = "Megakadályozza, hogy harmadik felek, például internetszolgáltatók lássák és nyomon követhessék a mindennapi online tevékenységét.";
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Kerülje a regionális és politikai korlátozásokat olyan platformokon, mint a Facebook, az X (Twitter) és a WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Az online hirdetések általában bosszantóak és zavaróak. Megzavarják a webhelyek nagy részét, lassítják a kapcsolat sebességét, és rosszindulatúak lehetnek.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Az intelligens otthoni technológiák, különösen a nem biztonságos IoT eszközök, sebezhetőségeket okozhatnak az otthoni hálózatokban.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Biztonságos nyilvános Wi-Fi kapcsolat";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Biztonságosabb böngészés";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Korlátlan közösségi média hozzáférés";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Védelem a rosszindulatú hirdetések ellen";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Intelligens otthoni biztonság";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Védje IP-címét:tagBreak• Blokkolja a rosszindulatú programokat, nyomkövetőket és hirdetéseket:tagBreak• Akár 10 eszköz csatlakoztatása";
...
$_LANG['store']['ox']['faq8']['answer'] = "Az OX App Suite a következő nyelveket támogatja: angol, német, spanyol, francia, olasz, holland, lengyel, 中文, 日本語, 中文";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Napi SMART adatbázis-vizsgálatok";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Napi SMART fájl vizsgálatok";
...
$_LANG['store']['sitelock']['features']['trustSeal'] = "SiteLock&trade; Megbízhatósági pecsét";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Tervezzen friss tartalmat, javítsa az elkötelezettséget, és nyomon kövesse eredményeit a SocialBee segítségével.";
$_LANG['store']['socialbee']['cartTitle'] = "SocialBee közösségi média menedzsment";
$_LANG['store']['socialbee']['comparison']['2years'] = "Legfeljebb 2 év";
$_LANG['store']['socialbee']['comparison']['3months'] = "Legfeljebb 3 hónap";
$_LANG['store']['socialbee']['comparison']['AICreation'] = "AI tartalom létrehozása";
$_LANG['store']['socialbee']['comparison']['accounts'] = "Közösségi média fiókok";
$_LANG['store']['socialbee']['comparison']['addons'] = "Kiegészítők felhasználókhoz, munkaterületekhez és profilokhoz";
$_LANG['store']['socialbee']['comparison']['analytics'] = "Közösségi média elemzés";
$_LANG['store']['socialbee']['comparison']['approval'] = "Tartalom jóváhagyása";
$_LANG['store']['socialbee']['comparison']['automation'] = "Automatizálási eszközintegrációk";
$_LANG['store']['socialbee']['comparison']['browserExtension'] = "Böngésző kiterjesztés";
$_LANG['store']['socialbee']['comparison']['canva'] = "Canva integráció";
$_LANG['store']['socialbee']['comparison']['categories'] = "Tartalomkategóriák (mappák)";
$_LANG['store']['socialbee']['comparison']['collaboration'] = "Csapati együttműködés";
$_LANG['store']['socialbee']['comparison']['comparePlans'] = "Tervek összehasonlítása";
$_LANG['store']['socialbee']['comparison']['comparePrices'] = "Árak összehasonlítása";
$_LANG['store']['socialbee']['comparison']['contentSchedulingPublishing'] = "Tartalom ütemezése és közzététele";
$_LANG['store']['socialbee']['comparison']['curation'] = "Tartalomkuráció";
$_LANG['store']['socialbee']['comparison']['curator'] = "Tartalomkurátor integrációk";
$_LANG['store']['socialbee']['comparison']['dataAccess'] = "Korábbi adatokhoz való hozzáférés";
$_LANG['store']['socialbee']['comparison']['drafts'] = "Tervezetek közzététele";
$_LANG['store']['socialbee']['comparison']['exportBrandedReports'] = "Márkás jelentések exportálása";
$_LANG['store']['socialbee']['comparison']['giphy'] = "GIPHY integráció";
$_LANG['store']['socialbee']['comparison']['importFeeds'] = "RSS-hírcsatornák importálása";
$_LANG['store']['socialbee']['comparison']['mobileApp'] = "Mobil alkalmazás";
$_LANG['store']['socialbee']['comparison']['notes'] = "Belső megjegyzések (visszajelzés)";
$_LANG['store']['socialbee']['comparison']['postSuggestions'] = "A legjobb közzétételi időjavaslatok";
$_LANG['store']['socialbee']['comparison']['posts'] = "Hozzászólások kategóriánként";
$_LANG['store']['socialbee']['comparison']['resharing'] = "Tartalom újramegosztása";
$_LANG['store']['socialbee']['comparison']['sminbox'] = "Közösségi média beérkező levelek";
$_LANG['store']['socialbee']['comparison']['tagBootstrap'] = "sarkantyú";
$_LANG['store']['socialbee']['comparison']['tagLite'] = "Ingyenes 1 oldal";
...
$_LANG['store']['socialbee']['comparison']['uniposting'] = "Univerzális közzététel";
$_LANG['store']['socialbee']['comparison']['unlimited'] = "Korlátlan";
$_LANG['store']['socialbee']['comparison']['unsplash'] = "Unsplash integráció";
$_LANG['store']['socialbee']['comparison']['urlshorteners'] = "URL-rövidítő integrációk";
$_LANG['store']['socialbee']['comparison']['users'] = "Felhasználók";
$_LANG['store']['socialbee']['comparison']['workspaces'] = "Dedikált munkaterületek";
$_LANG['store']['socialbee']['content']['header'] = "Kezelje az összes közösségi média feladatát egy helyről.";
$_LANG['store']['socialbee']['content']['p1'] = "Ha manuálisan kezeli a közösségi média fiókjait, valószínűleg órákat tölt több platform és lap zsonglőrésével.";
$_LANG['store']['socialbee']['content']['p2'] = "A SocialBee megkönnyíti, mivel lehetővé teszi a hozzászólások előzetes létrehozását és ütemezését, így fiókjaid aktívak maradnak még akkor is, ha elfoglalt vagy szünetet tart. Kezeli a közzétételeket az Ön számára, megtakarítva a kézi közzététel stresszét, és mesterséges intelligencia eszközöket kínál, amelyek segítenek pillanatok alatt létrehozni a tartalmat.";
$_LANG['store']['socialbee']['content']['p3'] = "Megjegyzésekre, megemlítésekre és üzenetekre is válaszolhat, együttműködhet csapatával és nyomon követheti teljesítményét, mindezt anélkül, hogy második lap megnyitná.";
$_LANG['store']['socialbee']['faq']['a1'] = "Kezelheti és ütemezheti a tartalmat olyan népszerű platformokon, mint a Facebook, az Instagram, a Threads, X™ (korábban Twitter™), a LinkedIn, a Pinterest, a Google Business Profile™, a TikTok, a YouTube™ és a Bluesky.";
$_LANG['store']['socialbee']['faq']['a2']['i1'] = "Többfunkciós közösségi média kezelő eszköz, amely mindent kezel a tartalom létrehozásától, az ütemezéstől és a megosztástól az elemzésig, a közösségi postaládáig és a csapategyüttműködésig.";
$_LANG['store']['socialbee']['faq']['a2']['i2'] = "Támogatás <a href='href=https://socialbee.com/calendar/'>hívások</a>, csevegés vagy e-mail kommunikáció révén. Egyike vagyunk azon kevés közösségi média eszközöknek, amelyek még mindig ügyeleti támogatást kínálnak.";
$_LANG['store']['socialbee']['faq']['a2']['i3'] = "<a href='https://socialbee.com/webinars/'>Havi élő demók</a> a SocialBee használatáról, <a href='https://help.socialbee.com/'>részletes súgódokumentáció</a>, <a href='https://www.youtube.com/@SocialBeeHQ'>rövid oktatóanyagok</a>és sok <a href='https://socialbee.com/resources/'>más közösségi média forrás</a>.";
$_LANG['store']['socialbee']['faq']['a2']['i4'] = "A <a href='https://socialbee.com/roadmap/'>átlátható termékütemterv</a> arról, hogy mi lesz a SocialBee mellett.";
$_LANG['store']['socialbee']['faq']['a2']['i5'] = "<a href='https://changelog.socialbee.com/'>Havi termékkiadások</a>.";
$_LANG['store']['socialbee']['faq']['a2']['text'] = "A SocialBee-vel való együttműködés a következőket adja:";
...
$_LANG['store']['socialbee']['faq']['a4']['text'] = "Az ügynökségi tervek (Pro50, Pro100 és Pro150) ugyanazokkal a funkciókkal rendelkeznek, mint a Pro terv. A fő különbségek a csatlakoztatható közösségi média profilok száma, a munkaterületek száma és a munkaterülethez felvehető felhasználók száma:";
$_LANG['store']['socialbee']['faq']['a5'] = "A SocialBee szerverei Írországban, Európában találhatók.";
$_LANG['store']['socialbee']['faq']['q1'] = "Milyen közösségi média platformokat tudok kezelni a SocialBee segítségével?";
$_LANG['store']['socialbee']['faq']['q2'] = "Miért válasszam a SocialBee-t más eszközök helyett?";
$_LANG['store']['socialbee']['faq']['q3'] = "Milyen támogatási lehetőségek állnak rendelkezésre a SocialBee felhasználók számára?";
$_LANG['store']['socialbee']['faq']['q4'] = "A SocialBee ügynökségi tervei különböznek a szokásos Pro tervtől?";
$_LANG['store']['socialbee']['faq']['q5'] = "Hol találhatók a SocialBee szerverei? Hol tárolják a SocialBee adatait?";
$_LANG['store']['socialbee']['faq']['unanswered'] = "Van még több kérdésed?";
$_LANG['store']['socialbee']['features']['analyze']['i1'] = "Könnyen érthető mutatókkal, vizuális diagramokkal, térképekkel és egyebekkel egyértelmű képet kaphat közösségi média fejlődéséről.";
$_LANG['store']['socialbee']['features']['analyze']['i2'] = "Kövesse nyomon az elkötelezettséget, a megjelenítéseket, az átkattintási arányokat és a követők növekedését az idő múlásával az összes közösségi média fiókjában.";
$_LANG['store']['socialbee']['features']['analyze']['i3'] = "Figyelje az egyéni posztteljesítményt, hogy megnézze, mi rezonál a közönség körében.";
$_LANG['store']['socialbee']['features']['analyze']['i4'] = "Hasonlítsa össze a platform teljesítményét, hogy meghatározza, hogy erőfeszítései hol térülnek ki a legjobban.";
$_LANG['store']['socialbee']['features']['analyze']['i5'] = "Szűrje az elemzéseket platform és dátumtartomány szerint, hogy tisztább képet kapjon a teljesítményéről.";
$_LANG['store']['socialbee']['features']['analyze']['i6'] = "Töltsön le professzionális PDF-elemző jelentéseket, amelyeket megoszthat ügyfelekkel vagy csapattagokkal.";
$_LANG['store']['socialbee']['features']['collaborate']['i1'] = "Ossza meg visszajelzéseit, és jelölje meg kollégáit közvetlenül a tartalomvázlat";
$_LANG['store']['socialbee']['features']['collaborate']['i2'] = "Jóváhagyja a bejegyzéseket, mielőtt életbe lépnének, hogy észleljen bármilyen elírási hibát vagy hibát.";
$_LANG['store']['socialbee']['features']['collaborate']['i3'] = "Kövesse nyomon a csapat tevékenységét, hogy megtudja, ki miben és mikor dolgozott.";
$_LANG['store']['socialbee']['features']['collaborate']['i4'] = "Kerülje az együttműködéshez használt megosztott területtel történő ismétlődő munkát.";
$_LANG['store']['socialbee']['features']['collaborate']['i5'] = "Adjon konkrét engedélyeket a csapattagoknak szerepük alapján.";
$_LANG['store']['socialbee']['features']['collaborate']['i6'] = "Több márka vagy ügyfél kezelése külön, szervezett munkaterületekkel.";
$_LANG['store']['socialbee']['features']['create']['i1'] = "A SocialBee integrálódik a Canva, az Unsplash és a GIPHY programokkal, így könnyedén létrehozhat és kurálhat vizuális képeket bejegyzéseihez.";
$_LANG['store']['socialbee']['features']['create']['i2'] = "Az AI segítségével másodpercek alatt készítsen feliratokat és képeket, és időt takarítson meg több mint 1000 előre elkészített utasításhoz.";
$_LANG['store']['socialbee']['features']['create']['i3'] = "Testreszabhatja a hozzászólásokat automatikusan mesterséges intelligenciával vagy manuálisan minden platformhoz, hogy megbizonyosodjon arról, hogy a tartalom a legjobban működjön, bárhol is";
$_LANG['store']['socialbee']['features']['create']['i4'] = "Hagyja, hogy a Copilot, a SocialBee AI asszisztense percek alatt személyre szabott tartalomtervet készítsen Önnek. Nincs többé kitalálva, mit tegyen közzé és mikor.";
$_LANG['store']['socialbee']['features']['create']['i5'] = "Szervezze a bejegyzéseket mappákba témakonként, változatos és jól strukturált tartalomtervet tartva.";
$_LANG['store']['socialbee']['features']['create']['i6'] = "Kísérletezzen különböző típusú bejegyzésekkel, például képekkel, videókkal, körhintákkal, történetekkel és tárcsákkal, hogy megtalálja, mi kapcsolódik a legjobban a közönséghez.";
$_LANG['store']['socialbee']['features']['engage']['i1'] = "Válaszoljon minden megjegyzésére, megemlítésére és DM-re a közösségi média platformokon keresztül egyetlen, könnyen kezelhető postaládából.";
$_LANG['store']['socialbee']['features']['engage']['i2'] = "Takarítson meg időt, és maradjon naprakész a beszélgetésekkel anélkül, hogy váltania kellene a különböző közösségi média fiókok között.";
$_LANG['store']['socialbee']['features']['engage']['i3'] = "Értesítést kap, amikor valaki kapcsolatba lép a tartalmával, így soha nem hagyja ki a fontos üzeneteket vagy elkötelezettségi lehetőségeket.";
$_LANG['store']['socialbee']['features']['engage']['i4'] = "Valós időben lépjen kapcsolatba a követőkkel, hogy bővítse közösségét, és gyors válaszokkal válaszoljon az ügyfelek kérdéseire.";
$_LANG['store']['socialbee']['features']['engage']['i5'] = "Figyelje a márka említéseit, hogy megnézze, mit mondanak az emberek, nyomon követve a beszélgetéseket és a visszajelzéseket.";
$_LANG['store']['socialbee']['features']['engage']['i6'] = "Táblák és adatfolyamok segítségével könnyen kezelhető módon rendezheti megjegyzéseit, említéseit és üzeneteit.";
$_LANG['store']['socialbee']['features']['schedule']['i1'] = "Ütemezze a főbb platformokra, például a Facebook®, az Instagram, a LinkedIn®, a TikTok, a Pinterest és még sok más bejegyzéseket egy helyről.";
$_LANG['store']['socialbee']['features']['schedule']['i2'] = "Szervezze bejegyzéseit egy vizuális naptárral, amely egy pillantásra bemutatja a teljes közösségi média stratégiáját.";
$_LANG['store']['socialbee']['features']['schedule']['i3'] = "Tervezze meg és állítsa be a bejegyzéseket idő előtt, hogy a közösségi médiafiókok aktívak maradjanak anélkül, hogy manuálisan kellene közzétennie.";
$_LANG['store']['socialbee']['features']['schedule']['i4'] = "Ütemezze tartalmát olyan időpontokra, amikor a közönség aktív, és hagyja, hogy a SocialBee javasolja a legjobb időket a korábbi teljesítménye alapján.";
$_LANG['store']['socialbee']['features']['schedule']['i5'] = "Használja újra a sikeres örökzöld tartalmat a bejegyzések átütemezésével, hogy a hírcsatorna friss maradjon, anélkül, hogy folyamatosan új tartalmat kellene létrehoznia.";
$_LANG['store']['socialbee']['features']['schedule']['i6'] = "Szüneteltesse, szerkesztheti vagy ütemezheti át a bejegyzéseket, amikor a tervei változnak. A SocialBee rugalmasságot biztosít a tartalomnaptár igény szerinti módosításához.";
$_LANG['store']['socialbee']['header'] = "SocialBee, az összes közösségi média fiók kezelésének legegyszerűbb módja";
$_LANG['store']['socialbee']['hero'] = "Hozzon létre, ütemezze, tegye közzé, elemezze, vegyen részt és együttműködjön anélkül, hogy időt pazarolna egyetlen másodpercet sem.";
$_LANG['store']['socialbee']['packages'] = "Árak és csomagok megtekintése";
$_LANG['store']['socialbee']['plan']['accelerate'] = "Gyorsítsa";
$_LANG['store']['socialbee']['plan']['bootstrap'] = "sarkantyú";
...
$_LANG['store']['socialbee']['pricing']['header']['body'] = "Árak és csomagok megtekintése";
$_LANG['store']['socialbee']['pricing']['header']['title'] = "Próbálja ki a SocialBee-t, és kezdje el növekedni a közösségi médiában.";
$_LANG['store']['socialbee']['profiles'] = ":num közösségi profilok";
$_LANG['store']['socialbee']['promo']['sidebar']['body'] = "Kezelje az összes közösségi média profilját egy helyről.";
$_LANG['store']['socialbee']['promo']['sidebar']['title'] = "SocialBee";
$_LANG['store']['socialbee']['title'] = "SocialBee";
$_LANG['store']['socialbee']['websitePricing']['title'] = "Árképzés";
$_LANG['store']['socialbee']['workspaces'] = ":num munkaterületek";
$_LANG['store']['socialbee']['workspaceusers'] = ":num felhasználó munkaterületenként";
...
$_LANG['store']['ssl']['landingPage']['encrypts'] = "Titkosítja a kommunikációt, hogy megvédje az ügyfelek által biztosított érzékeny információkat.";
...
$_LANG['store']['xoviNow']['features']['benchmarking']['bullet5'] = "A Láthatósági pontszámok nyomon követése és";
...
$_LANG['suggestedTLDs'] = "Javasolt TLD-k";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Érvénytelen áfaszám-formátum a :countryNameesetében.";
...
$_LANG['updateProductQuantity'] = "Frissítés";
$_LANG['updateTotals'] = "Végösszeg frissítése";
