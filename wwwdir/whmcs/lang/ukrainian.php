...
$_LANG['addToCartButton'] = "Додати у кошик";
$_LANG['addToGetFreeDomain'] = "Додати, щоб отримати безкоштовний домен";
...
$_LANG['applyPromoCode'] = "Застосувати";
...
$_LANG['billing']['creditnote'] = "Кредитна нота";
$_LANG['billing']['debitnote'] = "Дебетова записка";
$_LANG['billing']['issuedate'] = "Дата випуску";
$_LANG['billing']['issuedby'] = "Видано";
$_LANG['billing']['issuedto'] = "Видається на";
$_LANG['billing']['ledger']['date'] = "Дата";
$_LANG['billing']['ledger']['reference'] = "Довідка";
$_LANG['billing']['ledger']['title'] = "Книга";
$_LANG['billing']['ledger']['type'] = "Тип";
$_LANG['billing']['type']['affiliatepayout'] = "Партнерська виплата";
$_LANG['billing']['type']['clientaccountcredit'] = "Кредит на рахунок клієнта";
$_LANG['billing']['type']['clientaccountdebit'] = "Дебет рахунку клієнта";
$_LANG['billing']['type']['creditnoteadjustment'] = "Коригування кредитної ноти";
$_LANG['billing']['type']['invoiceadjustment'] = "Коригування рахунків-фактур";
$_LANG['billing']['type']['payment'] = "Оплата";
$_LANG['billing']['type']['refund'] = "Повернення";
$_LANG['billing']['type']['refundtocredit'] = "Повернення коштів на рахунок клієнта";
$_LANG['billingAddress'] = "Платіжна адреса";
$_LANG['billingOverview'] = "Перегляд білінгу";
$_LANG['billingdetails'] = "Платіжні дані";
$_LANG['billingnotes']['creditnote']['items'] = "Елементи кредитної ноти";
$_LANG['billingnotes']['debitnote']['items'] = "Елементи дебетової ноти";
...
$_LANG['cartItemType']['addon'] = "Додаток";
$_LANG['cartItemType']['addons'] = "Додатки";
$_LANG['cartItemType']['bundle'] = "пучок";
$_LANG['cartItemType']['bundles'] = "Пучки";
$_LANG['cartItemType']['domain'] = "Домен";
$_LANG['cartItemType']['domainRegistration'] = "Реєстрація домену";
$_LANG['cartItemType']['domainRenewal'] = "Поновлення домену";
$_LANG['cartItemType']['domainRenewals'] = "Поновлення домену";
$_LANG['cartItemType']['domainTransfer'] = "Перенос домену";
$_LANG['cartItemType']['domainTransfers'] = "Передача доменів";
$_LANG['cartItemType']['domains'] = "Домени";
$_LANG['cartItemType']['product'] = "Продукт";
$_LANG['cartItemType']['products'] = "Продукти";
$_LANG['cartItemsSelected'] = "Ви вибрали :count і готові до покупки.";
...
$_LANG['choosePackages'] = "Вибирайте з асортименту пакетів";
...
$_LANG['codeApplied'] = "Застосовано промокод";
$_LANG['completeorder'] = "Завершити замовлення";
$_LANG['configModalTitle'] = "Конфігурація";
...
$_LANG['confirmItemDeletion'] = "Підтвердити видалення";
...
$_LANG['cycleRenewal'] = ":cycle Відновлення";
$_LANG['daily'] = "Денна";
$_LANG['dateTime']['AM'] = "Я";
...
$_LANG['designedToFitAnyBudget'] = "Розроблений для будь-якого бюджету";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Пошук за ключовим словом, описом або доменом.&#10;Наприклад: &quot;Веселі ділові заходи &quot;, &quot;Послуга комплексного фінансового планування для професіоналів&quot;, або &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Введіть короткий опис або точний домен.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "Система не змогла знайти жодних пропозицій.";
$_LANG['domainSearch']['exactMatch'] = "Точний збіг";
$_LANG['domainSearch']['maxLength'] = "Максимальна довжина";
$_LANG['domainSearch']['notAvailable'] = "Недоступний";
$_LANG['domainSearch']['safeSearch'] = "Безпечний пошук";
$_LANG['domainSearch']['tlds'] = "Включити TLD";
$_LANG['domainSearch']['topAiSuggestion'] = "Найпопулярніші пропозиції AI";
$_LANG['domainSearch']['topSuggestion'] = "Найкраща пропозиція";
...
$_LANG['due'] = "за";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "Ви повинні прийняти умови надання послуг, поставивши прапорець :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute має бути масивом.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute має бути дійсною датою.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute має бути дійсною адресою електронної пошти.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "Система зіткнулася з внутрішньою помилкою. Спробуйте ще раз пізніше.";
$_LANG['dynamicServiceFields']['validation']['in'] = "Вибраний параметр для :attribute недійсний.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute має бути цілим числом.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute не може містити більше символів :max .";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute повинен використовувати один з наступних типів файлів: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute має містити не менше :min символів.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute має бути цифрою.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute має бути дійсним регулярним виразом.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute є обов'язковим.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute має бути дійсною URL-адресою, яка містить протокол («http://» або «https://»).";
$_LANG['edit'] = "Змінити";
...
$_LANG['encryption_failed'] = "Не вдалося шифрувати: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Спробуйте ще раз пізніше.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Домашня сторінка";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Ви надсилали занадто багато запитів.";
...
$_LANG['estimateTaxes'] = "Податки";
$_LANG['every'] = "Кожен";
$_LANG['exampledomain'] = "наприклад, example.com";
$_LANG['excludeTLDs'] = "Виключає певні домени верхнього рівня і нещодавно оновлені домени";
...
$_LANG['extendYourDomainBy1Year'] = "Продовжити домен на 1 рік*";
...
$_LANG['findDomains'] = "Знайти домени";
...
$_LANG['forTheFirstYear'] = "за перший рік";
...
$_LANG['freeDomainHostingPromo'] = "Отримайте безкоштовний домен при покупці хостингу.";
$_LANG['from'] = "Від";
...
$_LANG['hideSearchControls'] = "Приховати елементи керування пошуком";
...
$_LANG['inStock'] = "В наявності: :amount";
$_LANG['incApplicableTaxes'] = "включаючи застосовні податки";
$_LANG['includeTLDs'] = "Включити TLD";
$_LANG['included'] = "В комплекті";
...
$_LANG['invalidCode'] = "Недійсний промокод";
$_LANG['invalid_input'] = "Неправильний вхід: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "Недійсний ідентифікатор квитка або ідентифікатор відповіді.";
...
$_LANG['language'] = "Мова";
$_LANG['lastChance'] = "Останній шанс";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Увійти";
...
$_LANG['maxLength'] = "Максимальна довжина";
...
$_LANG['navMarketConnectService']['dynamic'] = "Динамічні послуги";
...
$_LANG['noDomainsFound'] = "Не знайдено доменів";
...
$_LANG['orderForm']['additionalInformation'] = "Додаткова інформація";
...
$_LANG['orderForm']['findNewDomainAi'] = "Шукайте домен із пропозиціями на основі штучного інтелекту.";
...
$_LANG['ordererrortldsnotconfigured'] = "Наразі не доступні для продажу доменні розширення. За допомогою зв'яжіться з нами.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "Щорічний";
$_LANG['orderpaymenttermadjectivebiennially'] = "Двоєнале";
$_LANG['orderpaymenttermadjectivefree'] = "Безкоштовно";
$_LANG['orderpaymenttermadjectivemonthly'] = "Щомісячно";
$_LANG['orderpaymenttermadjectiveonetime'] = "Один раз";
$_LANG['orderpaymenttermadjectivequarterly'] = "Щоквартально";
$_LANG['orderpaymenttermadjectivesemiannually'] = "Піврічний";
$_LANG['orderpaymenttermadjectivetriennially'] = "Трирієнале";
...
$_LANG['orderselectterm'] = "Виберіть термін";
...
$_LANG['page'] = "Сторінка";
$_LANG['pageof'] = "з";
$_LANG['passwordtips'] = "<strong>Поради щодо безпечного пароля</strong><br />Використовуйте як великі, так і малі символи.<br />Включіть принаймні один символ (наприклад, <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>, або <code>&amp;</code>).<br />Не використовуйте словникові слова.<br />Паролі можуть містити до :maximumсимволів _довжини.";
...
$_LANG['price'] = "ціна";
$_LANG['priceFor'] = "Ціна за :term";
$_LANG['priceForThisTerm'] = "Ціна за цей термін";
$_LANG['priceStandard'] = "Поновлюється щороку за :renewalPrice, плюс податок.";
$_LANG['priceWithDiscount'] = ":registrationPrice перший рік, потім :renewalPrice щорічно.";
...
$_LANG['pwlengthmax'] = "Пароль не може містити більше символів :max .";
...
$_LANG['pwstrengthfail'] = "Цей пароль недостатньо надійний. Введіть більш складний пароль.";
...
$_LANG['recommendedTLDs'] = "Рекомендовані TLD";
...
$_LANG['renewPrice'] = "Вартість продовження";
...
$_LANG['requiredFields'] = "Обов'язкові поля позначені символом*";
...
$_LANG['rssfeed'] = "RSS";
$_LANG['safeSearch'] = "Безпечний пошук";
$_LANG['sale'] = "Розпродаж";
$_LANG['salePrice'] = "ціна продажу";
$_LANG['salesTaxes'] = "Податки з продажу";
$_LANG['search'] = "Пошук";
$_LANG['searchOurKnowledgebase'] = "Шукайте нашу базу знань";
$_LANG['searchResults'] = "Результати пошуку";
...
$_LANG['selectCountry'] = "Оберіть країну";
$_LANG['selectDomain'] = "Виберіть домен";
$_LANG['selectDomainForHosting'] = "До якого домену ви хотіли б приєднати цей пакет віртуального хостингу?";
$_LANG['selectDomainsForSsl'] = "До якого домену (ів) ви хотіли б застосувати базовий SSL? Можна вибрати кілька.";
$_LANG['selectState'] = "Виберіть штат";
...
$_LANG['service_unavailable'] = "Сервіс недоступний: %s";
$_LANG['servicesRenew'] = "Поновити";
$_LANG['setupFee'] = ":amount Вартість встановлення";
$_LANG['setupMandate'] = "Налаштування мандата для оплати";
$_LANG['sharedHosting'] = "Віртуальний хостинг";
$_LANG['shopNow'] = "Купуйте зараз";
$_LANG['shortcuts'] = "Ярлики";
$_LANG['show'] = "Показати";
$_LANG['showMenu'] = "Показати";
$_LANG['showSearchControls'] = "Показати елементи керування пошуком";
...
$_LANG['store']['dynamic']['title'] = "Динамічні послуги";
...
$_LANG['store']['error']['serviceUnavailable'] = "На даний момент не вдається обробити ваш запит. Це може бути пов'язано з тайм-аутом або тимчасовою проблемою обслуговування. Будь ласка, спробуйте ще раз.";
$_LANG['store']['error']['validationFailed'] = "Будь ласка, перевірте та виправте помилки нижче.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo надає вам перевірений, керований процес SEO, не вимагаючи від вас бути експертом. <br> marketgoo доступний і надає вичерпні звіти про SEO, плани та рекомендації, все в інтуїтивно зрозумілому інтерфейсі.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Чим marketgoo відрізняється від інших продуктів SEO?";
...
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Сумісність конструктора веб-сайтів";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Щомісячний звіт про прогрес";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Аналітика трафіку";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Завантажити звіт про SEO у форматі PDF <a href='https://mktgoo.co/seo-report-score2'>(Див. Приклад)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "Функції на основі штучного інтелекту: автоматичне генерування заголовків та мета-опису";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Відскановані сторінки";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Відстеження конкурентів";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Відстеження та оптимізація ключових слів";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Оновлений звіт і план";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Призначений для користувача план SEO";
$_LANG['store']['marketgoo']['features']['1'] = "Отримайте свій план SEO";
$_LANG['store']['marketgoo']['features']['2'] = "Дотримуйтесь покрокових інструкцій";
$_LANG['store']['marketgoo']['features']['3'] = "Моніторинг прогресу за допомогою щомісячного звіту";
$_LANG['store']['marketgoo']['features']['4'] = "Відстеження та моніторинг конкурентів";
$_LANG['store']['marketgoo']['features']['5'] = "Оптимізація індивідуальної сторінки";
$_LANG['store']['marketgoo']['features']['6'] = "Легке дослідження та моніторинг ключових слів";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Підпишіться та отримайте свій миттєвий звіт та план SEO. Подивіться, де є місце для вдосконалення, та отримайте рекомендації, розроблені відповідно до вашого сайту.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Інструкції написані для недосвідчених користувачів, які ведуть вас через кожну рекомендацію, з прикладами та поясненнями.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Щомісяця отримуйте електронний лист із прогресом SEO вашого сайту та завантажуйте його у форматі PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Слідкуйте за конкурентами, щоб побачити, що вони роблять, щоб отримати трафік і як ваші номери співпадають з їхніми. Вони ніколи не дізнаються, що ти дивишся!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo допоможе вам оптимізувати кожну окрему сторінку на вашому сайті, зіставляючи її з одним із вибраних вами ключових слів та переконавшись, що частота та розміщення правильні.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "Ключові слова можуть бути приголомшливими, якщо ви не знайомі з SEO. marketgoo рекомендує ключові слова, а також дозволяє шукати та вводити ті, для яких ви хочете оптимізувати.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Працює з усіма конструкторами веб-сайтів";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Дата порівняння: 19 червня 20 25:tagBreak*Загальна продуктивність мережі згідно з дослідженнями AV-Test. Ви можете прочитати :tagOpenповний звіт:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Сповіщення про просочені облікові дані";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Сканування шкідливих програм на наявність завантажень";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Не розкривається";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "Трекер і блокувальник реклами";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN не обмежує швидкість з'єднання. Насолоджуйтесь нашим повношвидкісним VPN-з'єднанням без будь-яких обмежень.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN сумісний з усіма популярними платформами, включаючи Windows, macOS, Linux, Android та iOS. Крім того, ви можете захистити до 10 пристроїв, включаючи ваш маршрутизатор.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "Немає обмежень пропускної здатності VPN  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Переглядайте, грайте та працюйте на приватному та безпечному з'єднанні";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Залишайтеся безпечно підключеними навіть через загальнодоступний Wi-Fi";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Зменшіть відстеження в Інтернеті, захищаючи свою IP-адресу";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Переглядайте домашній контент під час подорожі за кордон";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Використовуйте NordVPN для шифрування своєї активності в Інтернеті для додаткового рівня захисту, коли і де б ви не були підключені.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN захищає ваш зв'язок за допомогою шифрування нового покоління, тому ви можете входити до своїх облікових записів, здійснювати банківські перекази та робити покупки в Інтернеті без турбот. Навіть у незахищених мережах.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN може похвалитися широким спектром функцій, щоб захистити вас від кіберзагроз. На додаток до Threat Protection Pro™, є автоматичний Kill Switch, який блокує ваше підключення до Інтернету, якщо ваше з'єднання VPN припиняється, гарантуючи, що ваші дані залишаються в безпеці. Затуманені сервери допоможуть, коли потрібен високий рівень безпеки в Інтернеті через державну цензуру та суворі правила Інтернету.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Підвищуйте безпеку в Інтернеті за допомогою VPN";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Розширена безпека";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Щоразу, коли ви завантажуєте файл, Threat Protection Pro™ перевіряє його на наявність шкідливих програм.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ блокує нав'язливу рекламу та веб-трекери, а також автоматично сканує URL-адреси та блокує шкідливі.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Захист від загроз Pro™ захищає ваші пристрої та вашу конфіденційність. Блокуючи трекери, це допомагає уникнути онлайн-шуперів.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "Функція :tagOpenThreat Protection Pro™:tagClose від NordVPN змінить гру, яка пропонує ще більше переваг безпеки та кращий захист одним додатковим клацанням миші.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Більше, ніж просто VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Навіть якщо вам нема чого приховувати, вам, напевно, не подобається ідея спостерігати та відстежувати. Основна причина, чому користувачі Інтернету вибирають послуги VPN, - це конфіденційність в Інтернеті та загальна безпека.:tagBreakОсь конкретні причини ЧОМУ?";
...
$_LANG['store']['nordvpn']['features']['use']['tagline3'] = "Запобігайте третім сторонам, таким як постачальникам послуг Інтернету, бачити та відстежувати вашу повсякденну діяльність в Інтернеті.";
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Уникайте регіональних та політичних обмежень на таких платформах, як Facebook, X (Twitter) та WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Онлайн-реклама зазвичай дратує і відволікає увагу. Вони захаращують велику частину веб-сайтів, знижують швидкість з'єднання і можуть бути шкідливими.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Технології розумного будинку, особливо незахищені пристрої IoT, можуть створити вразливості в домашніх мережах.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Безпечне загальнодоступне Wi-Fi з'єднання";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Безпечний перегляд";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Необмежений доступ до соціальних медіа";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Захист від шкідливих оголошень";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Безпека розумного будинку";
...
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Отримайте угоду";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Захистіть свою IP-адресу:tagBreak• Блокування шкідливих програм, трекерів та реклами:tagBreak• Підключіть до 10 пристроїв";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Щоденне сканування бази даних SMART";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Щоденне сканування файлів SMART";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Створюйте свіжий вміст, покращуйте взаємодію та відстежуйте свої результати за допомогою SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "SocialBee Управління соціальними медіа";
...
$_LANG['success'] = "Успіх";
$_LANG['suggestedTLDs'] = "Рекомендовані TLD";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Неправильний формат номера ПДВ для :countryName.";
...
$_LANG['tld'] = "Домен верхнього рівня (TLD)";
$_LANG['tldpricing'] = "Вартість";
$_LANG['toggleNav'] = "Переключити навігацію";
$_LANG['top'] = "Догори";
$_LANG['total'] = "Всього до оплати";
...
$_LANG['updateProductQuantity'] = "Обновити";
$_LANG['updateTotals'] = "Оновити";
