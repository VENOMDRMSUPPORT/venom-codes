...
$_LANG['addToGetFreeDomain'] = "Add to get free domain";
...
$_LANG['basicSsl'] = "Basic SSL";
$_LANG['billableitemseach'] = "Each";
$_LANG['billableitemshour'] = "Hour";
$_LANG['billableitemshours'] = "Hours";
$_LANG['billableitemsquantity'] = "Qty";
$_LANG['billing']['creditnote'] = "Credit Note";
$_LANG['billing']['debitnote'] = "Debit Note";
$_LANG['billing']['issuedate'] = "Issue Date";
$_LANG['billing']['issuedby'] = "Issued By";
$_LANG['billing']['issuedto'] = "Issued To";
$_LANG['billing']['ledger']['date'] = "Date";
$_LANG['billing']['ledger']['reference'] = "Reference";
$_LANG['billing']['ledger']['title'] = "Ledger";
$_LANG['billing']['ledger']['type'] = "Type";
$_LANG['billing']['type']['affiliatepayout'] = "Affiliate Payout";
$_LANG['billing']['type']['clientaccountcredit'] = "Client Account Credit";
$_LANG['billing']['type']['clientaccountdebit'] = "Client Account Debit";
$_LANG['billing']['type']['creditnoteadjustment'] = "Credit Note Adjustment";
$_LANG['billing']['type']['invoiceadjustment'] = "Invoice Adjustment";
$_LANG['billing']['type']['payment'] = "Payment";
$_LANG['billing']['type']['refund'] = "Refund";
$_LANG['billing']['type']['refundtocredit'] = "Refund to Client Account";
$_LANG['billingAddress'] = "Billing Address";
$_LANG['billingOverview'] = "Billing Overview";
$_LANG['billingdetails'] = "Billing Details";
$_LANG['billingnotes']['creditnote']['items'] = "Credit Note Items";
$_LANG['billingnotes']['debitnote']['items'] = "Debit Note Items";
...
$_LANG['captcha']['hcaptcha']['tagLine'] = "Protected by hCaptcha®";
$_LANG['captcha']['verification']['failed'] = "Captcha verification failed. Contact support for more information.";
$_LANG['captchaIncorrect'] = "Complete the captcha and try again.";
...
$_LANG['captchaverifyincorrect'] = "The characters that you entered did not match the displayed image. Try again.";
...
$_LANG['cartItemType']['bundle'] = "Bundle";
$_LANG['cartItemType']['bundles'] = "Bundles";
...
$_LANG['cartItemType']['domainTransfers'] = "Domain Transfers";
$_LANG['cartItemType']['domains'] = "Domains";
$_LANG['cartItemType']['product'] = "Product";
$_LANG['cartItemType']['products'] = "Products";
$_LANG['cartItemsSelected'] = "You have :count selected and ready to purchase.";
...
$_LANG['choosePackages'] = "Choose from a range of packages";
...
$_LANG['codeApplied'] = "Promo code applied";
...
$_LANG['confirmItemDeletion'] = "Confirm Deletion";
...
$_LANG['cycleRenewal'] = ":cycle Renewal";
$_LANG['daily'] = "Daily";
...
$_LANG['designedToFitAnyBudget'] = "Designed to fit any budget";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Search by keyword, description, or domain.&#10;For example: &quot;Fun business events &quot;, &quot;A comprehensive financial planning service for professionals&quot;, or &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Enter a short description or an exact domain.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "The system could not find any suggestions.";
$_LANG['domainSearch']['exactMatch'] = "Exact Match";
$_LANG['domainSearch']['maxLength'] = "Maximum Length";
$_LANG['domainSearch']['notAvailable'] = "Not Available";
$_LANG['domainSearch']['safeSearch'] = "Safe Search";
$_LANG['domainSearch']['tlds'] = "Include TLDs";
$_LANG['domainSearch']['topAiSuggestion'] = "Top AI Suggestion";
...
$_LANG['due'] = "Due";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "You must accept the terms of service by checking :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute must be an array.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute must be a valid date.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute must be a valid email address.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "The system encountered an internal error. Try again later.";
$_LANG['dynamicServiceFields']['validation']['in'] = "The selected option for :attribute is invalid.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute must be an integer.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute may not contain more than :max characters.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute must use one of the following file types: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute must contain at least :min characters.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute must be a number.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute must be a valid regular expression.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute is required.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute must be a valid URL that includes the protocol ('http://' or 'https://').";
$_LANG['edit'] = "Edit";
$_LANG['email'] = "Email";
...
$_LANG['encryption_failed'] = "Encryption Failed: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Try again later.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Homepage";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "You have sent too many requests.";
...
$_LANG['extendYourDomainBy1Year'] = "Extend your domain by 1 year*";
...
$_LANG['findDomains'] = "Find Domains";
...
$_LANG['forTheFirstYear'] = "for the first year";
...
$_LANG['freeDomainHostingPromo'] = "Get a free domain when you purchase hosting.";
$_LANG['from'] = "From";
...
$_LANG['hideSearchControls'] = "Hide Search Controls";
...
$_LANG['inStock'] = "In Stock: :amount";
$_LANG['incApplicableTaxes'] = "inc applicable taxes";
$_LANG['includeTLDs'] = "Include TLDs";
...
$_LANG['invalidCode'] = "Invalid promo code";
$_LANG['invalid_input'] = "Invalid Input: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "Invalid ticket id or reply id.";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Log In";
...
$_LANG['marketConnect']['socialbee']['manage'] = "Log in to SocialBee";
...
$_LANG['navMarketConnectService']['dynamic'] = "Dynamic Services";
...
$_LANG['noDomainsFound'] = "No domains found";
...
$_LANG['orderForm']['findNewDomainAi'] = "Search for a domain with AI-powered suggestions.";
...
$_LANG['ordererrortldsnotconfigured'] = "No domain extensions are currently available for sale. For help, contact us.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "Annual";
$_LANG['orderpaymenttermadjectivebiennially'] = "Biennial";
...
$_LANG['orderpaymenttermadjectivesemiannually'] = "Semi-Annual";
$_LANG['orderpaymenttermadjectivetriennially'] = "Triennial";
...
$_LANG['orderselectterm'] = "Select Term";
...
$_LANG['page'] = "Page";
$_LANG['pageof'] = "of";
$_LANG['passwordtips'] = "<strong>Tips for a Secure Password</strong><br />Use both uppercase and lowercase characters.<br />Include at least one symbol (for example, <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>, or <code>&amp;</code>).<br />Do not use dictionary words.<br />Passwords can contain up to :maximum_length characters.";
...
$_LANG['paypalCommerce']['error']['currency_not_supported'] = "PayPal does not support this currency.";
...
$_LANG['price'] = "price";
$_LANG['priceFor'] = "Price for :term";
$_LANG['priceForThisTerm'] = "Price for this term";
$_LANG['priceStandard'] = "Renews each year at :renewalPrice, plus tax.";
$_LANG['priceWithDiscount'] = ":registrationPrice for the first year, then :renewalPrice annually.";
...
$_LANG['pwlengthmax'] = "Passwords cannot contain more than :max characters.";
...
$_LANG['pwstrengthfail'] = "This password is not strong enough. Enter a more complex password.";
...
$_LANG['recommendedTLDs'] = "Recommended TLDs";
...
$_LANG['requiredFields'] = "Required fields are marked with *";
...
$_LANG['rssfeed'] = "Feed";
$_LANG['safeSearch'] = "Safe Search";
$_LANG['sale'] = "Sale";
$_LANG['salePrice'] = "sale price";
$_LANG['salesTaxes'] = "Sales Taxes";
$_LANG['search'] = "Search";
...
$_LANG['selectDomain'] = "Select Domain";
$_LANG['selectDomainForHosting'] = "Which domain would you like to attach this shared hosting package to?";
$_LANG['selectDomainsForSsl'] = "Which domain(s) would you like to apply the basic SSL to? You can select multiple.";
$_LANG['selectState'] = "Select State";
...
$_LANG['service_unavailable'] = "Service Unavailable: %s";
$_LANG['servicesRenew'] = "Renew";
$_LANG['setupFee'] = ":amount Setup Fee";
$_LANG['setupMandate'] = "Setup Mandate for Payment";
$_LANG['sharedHosting'] = "Shared Hosting";
$_LANG['shopNow'] = "Shop Now";
$_LANG['shortcuts'] = "Shortcuts";
$_LANG['show'] = "Show";
$_LANG['showMenu'] = "Show Menu";
$_LANG['showSearchControls'] = "Show Search Controls";
...
$_LANG['store']['engage'] = "Engage";
$_LANG['store']['error']['serviceUnavailable'] = "Unable to process your request at the moment. This may be due to a timeout or temporary service issue. Please try again.";
$_LANG['store']['error']['validationFailed'] = "Please check and correct the errors below.";
$_LANG['store']['faq'] = "Frequently Asked Questions";
$_LANG['store']['forJust'] = "for just";
$_LANG['store']['fromJust'] = "from just";
$_LANG['store']['getstarted'] = "Get Started";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo provides you with a proven, guided SEO process without requiring you to be an expert. <br> marketgoo is affordable and provides comprehensive SEO reports, plans, and recommendations, all in an intuitive interface.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "What makes marketgoo different from other SEO products?";
$_LANG['store']['marketgoo']['faqs']['title'] = "FAQs and Support";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "Search Engine Submission";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Website Builder Compatibility";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Monthly Progress Report";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Traffic Analytics";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Download SEO Report as PDF <a href='https://mktgoo.co/seo-report-score2'>(See Example)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "AI-Powered Features: Auto-Generation of Title and Meta Description";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Pages Scanned";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Competitor Tracking";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Keyword Tracking and Optimization";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Updated Report and Plan";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Custom SEO Plan";
$_LANG['store']['marketgoo']['features']['1'] = "Get your SEO Plan";
$_LANG['store']['marketgoo']['features']['2'] = "Follow Step-by-Step Instructions";
$_LANG['store']['marketgoo']['features']['3'] = "Monitor Progress with a Monthly Report";
$_LANG['store']['marketgoo']['features']['4'] = "Track and Monitor Competitors";
$_LANG['store']['marketgoo']['features']['5'] = "Individual Page Optimization";
$_LANG['store']['marketgoo']['features']['6'] = "Easy Keyword Research and Monitoring";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Sign up and get your instant SEO report and plan. See where there's room for improvement and get recommendations tailored for your site.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Instructions are written for non-tech-savvy users, guiding you through each recommendation, with examples and explanations.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Every month, get an email with your site’s SEO progress and download it as a PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Keep tabs on competitors to see what they’re doing to get traffic and how your numbers stack up against theirs. They’ll never know you’re watching!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo guides you through optimizing each individual page on your site by matching it to one of your chosen keywords and making sure the frequency and placement are correct.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "Keywords can be overwhelming if you’re not familiar with SEO. marketgoo recommends keywords and also allows you to search for and enter the ones you want to optimize for.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Works with All Website Builders";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Date of comparison: June 19, 20 25:tagBreak*Overall network performance according to research by AV-Test. You can read :tagOpenthe full report:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Alerts about leaked credentials";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Malware scan for downloads";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Not disclosed";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "Tracker and ad blocker";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN doesn’t limit connection speeds. Enjoy our full-speed VPN connection without any throttling.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN is compatible with all popular platforms, including Windows, macOS, Linux, Android, and iOS. Plus, you can secure up to 10 devices, including your router.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "No VPN bandwidth limits  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Browse, play, and work on a private and secure connection";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Stay securely connected even on public Wi-Fi";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Reduce online tracking by shielding your IP address";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Watch home content while traveling abroad";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Use NordVPN to encrypt your online activity for an extra layer of protection whenever and wherever you're connected.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN safeguards your connection with next-generation encryption, so you can log into your accounts, make bank transfers, and shop online without worries. Even on unprotected networks.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN boasts a wide range of features to protect you from cyber threats. In addition to Threat Protection Pro ™, there is an automatic Kill Switch that blocks your internet connection if your VPN connection drops, ensuring that your data stays safe. Obfuscated servers will help when a high level of online security is required due to government censorship and strict internet regulations.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Increase your online security with a VPN";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Advanced Security";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Whenever you download a file, Threat Protection Pro ™ inspects it for malware.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro ™ blocks intrusive ads and web trackers, and automatically scans URLs and blocks malicious ones.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Threat Protection Pro ™ protects your devices and your privacy. By blocking trackers, it helps you avoid online snoopers.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "NordVPN's :tagOpenThreat Protection Pro ™:tagClose feature is a game changer that offers even more security benefits and better protection with a single extra click.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "More than just a VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Even if you have nothing to hide, you probably don't like the idea of being watched and tracked. The main reason why internet users choose VPN services is online privacy and general security.:tagBreakHere are specific reasons WHY?";
$_LANG['store']['nordvpn']['features']['use']['tagline2'] = "Public Wi-Fi networks in hotels, airports, and coffee shops are the perfect targets for hackers due to often low security measures.";
...
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Avoid regional and political restrictions on platforms like Facebook, X (Twitter), and WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Online ads are usually annoying and distracting.  They clutter large parts of websites, slow connection speed, and might be malicious.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Smart home technologies, particularly unsecure IoT devices, can create vulnerabilities in the home networks.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Secure public Wi-Fi connection";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Safer browsing";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Unrestricted social media access";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Protection from malicious ads";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Smart home security";
...
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Get the Deal";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Protect your IP address:tagBreak• Block malware, trackers, and ads:tagBreak• Connect up to 10 devices";
...
$_LANG['store']['ox']['faq8']['answer'] = "OX App Suite supports the following languages: English, German, Spanish, French, Italian, Dutch, Polish, 中文 简体, 中文 繁體, 日本語";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Daily SMART Database Scans";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Daily SMART File Scans";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Design fresh content, improve engagement, and track your results with SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "SocialBee Social Media Management";
$_LANG['store']['socialbee']['comparison']['2years'] = "Up to 2 Years";
$_LANG['store']['socialbee']['comparison']['3months'] = "Up to 3 Months";
$_LANG['store']['socialbee']['comparison']['AICreation'] = "AI Content Creation";
$_LANG['store']['socialbee']['comparison']['accounts'] = "Social Media Accounts";
$_LANG['store']['socialbee']['comparison']['addons'] = "Addons for Users, Workspaces, and Profiles";
$_LANG['store']['socialbee']['comparison']['analytics'] = "Social Media Analytics";
$_LANG['store']['socialbee']['comparison']['approval'] = "Content Approval";
$_LANG['store']['socialbee']['comparison']['automation'] = "Automation Tool Integrations";
$_LANG['store']['socialbee']['comparison']['browserExtension'] = "Browser Extension";
$_LANG['store']['socialbee']['comparison']['canva'] = "Canva Integration";
$_LANG['store']['socialbee']['comparison']['categories'] = "Content Categories (Folders)";
$_LANG['store']['socialbee']['comparison']['collaboration'] = "Team Collaboration";
$_LANG['store']['socialbee']['comparison']['comparePlans'] = "Compare Plans";
$_LANG['store']['socialbee']['comparison']['comparePrices'] = "Compare Prices";
$_LANG['store']['socialbee']['comparison']['contentSchedulingPublishing'] = "Content Scheduling and Publishing";
$_LANG['store']['socialbee']['comparison']['curation'] = "Content Curation";
$_LANG['store']['socialbee']['comparison']['curator'] = "Content Curator Integrations";
$_LANG['store']['socialbee']['comparison']['dataAccess'] = "Historical Data Access";
$_LANG['store']['socialbee']['comparison']['drafts'] = "Post Drafts";
$_LANG['store']['socialbee']['comparison']['exportBrandedReports'] = "Export Branded Reports";
$_LANG['store']['socialbee']['comparison']['giphy'] = "GIPHY Integration";
$_LANG['store']['socialbee']['comparison']['importFeeds'] = "Import RSS Feeds";
$_LANG['store']['socialbee']['comparison']['mobileApp'] = "Mobile App";
$_LANG['store']['socialbee']['comparison']['notes'] = "Internal Notes (Feedback)";
$_LANG['store']['socialbee']['comparison']['postSuggestions'] = "Best Posting Time Suggestions";
$_LANG['store']['socialbee']['comparison']['posts'] = "Posts per Category";
$_LANG['store']['socialbee']['comparison']['resharing'] = "Content Resharing";
$_LANG['store']['socialbee']['comparison']['sminbox'] = "Social Media Inbox";
$_LANG['store']['socialbee']['comparison']['tagBootstrap'] = "Bootstrap";
$_LANG['store']['socialbee']['comparison']['tagLite'] = "Free 1 Site";
...
$_LANG['store']['socialbee']['comparison']['uniposting'] = "Universal Posting";
$_LANG['store']['socialbee']['comparison']['unlimited'] = "Unlimited";
$_LANG['store']['socialbee']['comparison']['unsplash'] = "Unsplash Integration";
$_LANG['store']['socialbee']['comparison']['urlshorteners'] = "URL Shortener Integrations";
$_LANG['store']['socialbee']['comparison']['users'] = "Users";
$_LANG['store']['socialbee']['comparison']['workspaces'] = "Dedicated Workspaces";
$_LANG['store']['socialbee']['content']['header'] = "Handle all of your social media tasks from one place.";
$_LANG['store']['socialbee']['content']['p1'] = "If you’re manually managing your social media accounts, you’re probably spending hours juggling multiple platforms and tabs.";
$_LANG['store']['socialbee']['content']['p2'] = "SocialBee makes it easier by letting you create and schedule posts in advance, so your accounts stay active even when you’re busy or taking a break. It handles posting for you, saving you the stress of manual posting, and offers AI tools to help you create content in no time.";
$_LANG['store']['socialbee']['content']['p3'] = "You can also reply to comments, mentions, and messages, collaborate with your team, and track your performance, all without opening a second tab.";
$_LANG['store']['socialbee']['faq']['a1'] = "You can manage and schedule content for popular platforms like Facebook, Instagram, Threads, X™ (formerly Twitter™), LinkedIn, Pinterest, Google Business Profile™, TikTok, YouTube™, and Bluesky.";
$_LANG['store']['socialbee']['faq']['a2']['i1'] = "An all-in-one social media management tool that handles everything from content creation, scheduling, and sharing to analytics, social inbox, and team collaboration.";
...
$_LANG['store']['socialbee']['faq']['a2']['i5'] = "<a href='https://changelog.socialbee.com/'>Monthly product releases</a>.";
$_LANG['store']['socialbee']['faq']['a2']['text'] = "Working with SocialBee gives you:";
...
$_LANG['store']['socialbee']['faq']['a4']['text'] = "The agency plans (Pro50, Pro100, and Pro150) have the same features as the Pro plan. The main differences are the number of social media profiles that you can connect, the number of workspaces, and the users you can add to a workspace:";
$_LANG['store']['socialbee']['faq']['a5'] = "SocialBee’s servers are located in Ireland, Europe.";
$_LANG['store']['socialbee']['faq']['q1'] = "Which social media platforms can I manage with SocialBee?";
$_LANG['store']['socialbee']['faq']['q2'] = "Why should I choose SocialBee over other tools?";
$_LANG['store']['socialbee']['faq']['q3'] = "What support options are available for SocialBee users?";
$_LANG['store']['socialbee']['faq']['q4'] = "Are SocialBee’s agency plans different from the regular Pro plan?";
$_LANG['store']['socialbee']['faq']['q5'] = "Where are SocialBee’s servers located? Where is SocialBee’s data stored?";
$_LANG['store']['socialbee']['faq']['unanswered'] = "Do you have more questions?";
$_LANG['store']['socialbee']['features']['analyze']['i1'] = "Get a clear view of your social media progress with easy-to-understand metrics, visual charts, maps, and more.";
$_LANG['store']['socialbee']['features']['analyze']['i2'] = "Track engagement, impressions, clickthrough rates, and follower growth over time for all of your social media accounts.";
$_LANG['store']['socialbee']['features']['analyze']['i3'] = "Monitor individual post performance to see what resonates with your audience.";
$_LANG['store']['socialbee']['features']['analyze']['i4'] = "Compare platform performance to identify where your efforts pay off the most.";
$_LANG['store']['socialbee']['features']['analyze']['i5'] = "Filter your analytics by platform and date range to get a clearer view of your performance.";
$_LANG['store']['socialbee']['features']['analyze']['i6'] = "Download professional PDF analytics reports to share with clients or team members.";
$_LANG['store']['socialbee']['features']['collaborate']['i1'] = "Share feedback and tag your colleagues directly on content drafts.";
$_LANG['store']['socialbee']['features']['collaborate']['i2'] = "Approve posts before they go live to catch any typos or mistakes.";
$_LANG['store']['socialbee']['features']['collaborate']['i3'] = "Track team activity to know who worked on what and when.";
$_LANG['store']['socialbee']['features']['collaborate']['i4'] = "Avoid duplicate work with a shared space for collaboration.";
$_LANG['store']['socialbee']['features']['collaborate']['i5'] = "Give specific permissions to team members based on their roles.";
$_LANG['store']['socialbee']['features']['collaborate']['i6'] = "Manage multiple brands or clients with separate, organized workspaces.";
$_LANG['store']['socialbee']['features']['create']['i1'] = "SocialBee integrates with Canva, Unsplash, and GIPHY, so you can easily create and curate visuals for your posts.";
$_LANG['store']['socialbee']['features']['create']['i2'] = "Generate captions and images in seconds with AI, and get access to over 1,000 premade prompts to save time.";
$_LANG['store']['socialbee']['features']['create']['i3'] = "Tailor posts automatically with AI or manually for each platform to make sure your content works best wherever it's shared.";
$_LANG['store']['socialbee']['features']['create']['i4'] = "Let Copilot, SocialBee's AI assistant, create a personalized content plan for you in minutes. No more guessing what to post or when.";
$_LANG['store']['socialbee']['features']['create']['i5'] = "Organize posts in folders by topic, keeping your content plan diverse and wellstructured.";
$_LANG['store']['socialbee']['features']['create']['i6'] = "Experiment with different post types like images, videos, carousels, stories, and Reels to find what connects best with your audience.";
$_LANG['store']['socialbee']['features']['engage']['i1'] = "Respond to all your comments, mentions, and DMs across social media platforms from a single, easy-to-manage inbox.";
$_LANG['store']['socialbee']['features']['engage']['i2'] = "Save time and stay on top of conversations without having to switch between different social media accounts.";
$_LANG['store']['socialbee']['features']['engage']['i3'] = "Get notified whenever someone engages with your content, so you never miss important messages or engagement opportunities.";
$_LANG['store']['socialbee']['features']['engage']['i4'] = "Interact with followers in real time to grow your community and answer customer questions with quick replies.";
$_LANG['store']['socialbee']['features']['engage']['i5'] = "Monitor mentions of your brand to see what people are saying, keeping track of conversations and feedback.";
$_LANG['store']['socialbee']['features']['engage']['i6'] = "Use boards and streams to organize your comments, mentions, and messages in a way that's easy for you to manage.";
$_LANG['store']['socialbee']['features']['schedule']['i1'] = "Schedule posts for major platforms like Facebook®, Instagram, LinkedIn®, TikTok, Pinterest, and more, all from one place.";
$_LANG['store']['socialbee']['features']['schedule']['i2'] = "Organize your posts with a visual calendar that shows your entire social media strategy at a glance.";
$_LANG['store']['socialbee']['features']['schedule']['i3'] = "Plan and queue posts ahead of time to keep your social media accounts active without needing to post manually.";
$_LANG['store']['socialbee']['features']['schedule']['i4'] = "Schedule your content at specific times when your audience is active and let SocialBee suggest the best times based on your past performance.";
$_LANG['store']['socialbee']['features']['schedule']['i5'] = "Reuse successful evergreen content by rescheduling posts to keep your feed fresh, without having to create new content constantly.";
$_LANG['store']['socialbee']['features']['schedule']['i6'] = "Pause, edit, or reschedule posts anytime your plans change. SocialBee gives you the flexibility to adjust your content calendar as needed.";
$_LANG['store']['socialbee']['header'] = "SocialBee, the easiest way to manage all of your social media accounts";
$_LANG['store']['socialbee']['hero'] = "Create, schedule, publish, analyze, engage, and collaborate without wasting a second of your time.";
$_LANG['store']['socialbee']['packages'] = "View Pricing and Packages";
$_LANG['store']['socialbee']['plan']['accelerate'] = "Accelerate";
...
$_LANG['store']['socialbee']['pricing']['header']['body'] = "View Pricing and Packages";
$_LANG['store']['socialbee']['pricing']['header']['title'] = "Try SocialBee and start growing on social media.";
$_LANG['store']['socialbee']['profiles'] = ":num social profiles";
$_LANG['store']['socialbee']['promo']['sidebar']['body'] = "Manage all your social media profiles from one place.";
$_LANG['store']['socialbee']['promo']['sidebar']['title'] = "SocialBee";
$_LANG['store']['socialbee']['title'] = "SocialBee";
$_LANG['store']['socialbee']['websitePricing']['title'] = "Pricing";
$_LANG['store']['socialbee']['workspaces'] = ":num workspaces";
$_LANG['store']['socialbee']['workspaceusers'] = ":num users per workspace";
...
$_LANG['store']['ssl']['dv']['descriptionTitle'] = "What is Basic DV SSL?";
...
$_LANG['store']['ssl']['landingPage']['certificate']['description']['basic'] = "Enables basic protection for your main domain (for example, www.example.com and example.com).";
$_LANG['store']['ssl']['landingPage']['certificate']['description']['business'] = "Secures your entire website, including subdomains, with business-level protection.";
$_LANG['store']['ssl']['landingPage']['certificate']['description']['wildcard'] = "Secures your entire website, including subdomains. Most sites use subdomains to run important services like email.";
$_LANG['store']['ssl']['landingPage']['certificate']['feature']['https'] = "Enables HTTPS and displays a padlock icon.";
$_LANG['store']['ssl']['landingPage']['certificate']['feature']['issued'] = "Issued in minutes.";
$_LANG['store']['ssl']['landingPage']['certificate']['feature']['secure'] = "Secures your primary domain.";
$_LANG['store']['ssl']['landingPage']['certificate']['feature']['subdomain'] = "Secures unlimited subdomains.";
$_LANG['store']['ssl']['landingPage']['certificate']['feature']['trusted'] = "Globally trusted.";
$_LANG['store']['ssl']['landingPage']['certificate']['feature']['validation'] = "Full business validation (issued in  1-3 days).";
$_LANG['store']['ssl']['landingPage']['certificate']['feature']['warranty'] = "$:amount protection warranty.";
$_LANG['store']['ssl']['landingPage']['choose'] = "Help Me Choose";
$_LANG['store']['ssl']['landingPage']['chooseLevel'] = "Choose your level of security";
$_LANG['store']['ssl']['landingPage']['competitiveUpgrade'] = "Upgrade with us and get up to an additional 12 months free.";
$_LANG['store']['ssl']['landingPage']['digicert']['recommended'] = "Business and ecommerce websites.";
$_LANG['store']['ssl']['landingPage']['digicert']['title'] = "Business-Level Protection for Your Entire Website";
$_LANG['store']['ssl']['landingPage']['dv'] = "Domain Validation (DV)";
$_LANG['store']['ssl']['landingPage']['encrypts'] = "Encrypts communication to protect sensitive information your customers provide.";
$_LANG['store']['ssl']['landingPage']['ev'] = "Extended Validation (EV)";
$_LANG['store']['ssl']['landingPage']['evs']['compare'] = "Compare Wildcard SSL Certificates";
...
$_LANG['store']['ssl']['landingPage']['evs']['dontLeave'] = "Don’t leave your website’s back door open to hackers—protect your entire site with wildcard SSL!";
$_LANG['store']['ssl']['landingPage']['evs']['emailServer'] = "Email (mail.example.com)";
$_LANG['store']['ssl']['landingPage']['evs']['ftpAccess'] = "FTP or SFTP (ftp.example.com)";
$_LANG['store']['ssl']['landingPage']['evs']['googleQuote'] = "All communication should be secure by default.";
$_LANG['store']['ssl']['landingPage']['evs']['protectSubdomain'] = "Protect every subdomain, including critical website services.<br>Secure your subdomains to protect critical services like:";
$_LANG['store']['ssl']['landingPage']['evs']['secureTitle'] = "Secure Your Entire Site with Wildcard SSL";
$_LANG['store']['ssl']['landingPage']['evs']['webmailAccess'] = "Webmail (webmail.example.com)";
$_LANG['store']['ssl']['landingPage']['evs']['websiteControl'] = "Control Panel (mail.example.com)";
$_LANG['store']['ssl']['landingPage']['evs']['wildcardDescription'] = "A wildcard SSL certificate protects your main domain and an unlimited number of subdomains (for example, mail.example.com or ftp.example.com). Even if you haven’t created any subdomains yourself, you probably have several subdomains for features included in your hosting package.";
$_LANG['store']['ssl']['landingPage']['evs']['wildcardSubtitle'] = "A wildcard SSL certificate is the best way to secure your entire website and keep your users safe.";
...
$_LANG['store']['ssl']['landingPage']['geoTrust']['recommended'] = "Most personal and non-commercial websites.";
$_LANG['store']['ssl']['landingPage']['geoTrust']['title'] = "Protection for Your Entire Website";
...
$_LANG['store']['ssl']['landingPage']['rapidSSL']['recommended'] = "Personal websites without subdomains. (Most sites do have subdomains.)";
$_LANG['store']['ssl']['landingPage']['rapidSSL']['title'] = "Basic Protection for a Primary Domain";
$_LANG['store']['ssl']['landingPage']['recommendedFor'] = "Recommended for";
...
$_LANG['store']['ssl']['shared']['dvSsl'] = "Basic SSL (DV)";
...
$_LANG['store']['ssl']['shared']['wcSsl'] = "Wildcard SSL (Entire Website)";
...
$_LANG['suggestedTLDs'] = "Suggested TLDs";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Invalid VAT number format for :countryName.";
