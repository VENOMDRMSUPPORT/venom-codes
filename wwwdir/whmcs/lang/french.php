...
$_LANG['accountInvite']['emailAlreadyExists'] = "Il y a déjà un utilisateur avec cette adresse e-mail. Veuillez vous connecter ou utiliser une autre adresse e-mail.";
$_LANG['accountInvite']['givenAccess'] = ":ot:senderName:ct vous a accordé l'accès au compte :ot:clientName:ct .";
...
$_LANG['accountInvite']['notFound'] = "Oups  ! Nous n'avons pas trouvé d'invitation en attente correspondant à votre demande.";
...
$_LANG['actionRequiresAtLeastOneDomainSelected'] = "Veuillez sélectionner au moins un domaine pour appliquer les actions choisies.";
$_LANG['actions'] = "Actions";
$_LANG['activateNowFor'] = "Activez maintenant pour :price";
$_LANG['addToCartButton'] = "Ajouter au panier";
$_LANG['addToGetFreeDomain'] = "Ajouter pour obtenir un domaine gratuit";
...
$_LANG['admin']['returnToAdmin'] = "Revenir à l'espace administration";
...
$_LANG['affiliatesignuptitle'] = "Gagnez de l'argent en nous recommandant des clients !";
...
$_LANG['ajaxcartcheckout'] = "Procédez directement au paiement &raquo;";
...
$_LANG['announcementscontinue'] = "Poursuivre la lecture";
...
$_LANG['applyPromoCode'] = "Appliquer";
$_LANG['assignedIPs'] = "IP assignées";
...
$_LANG['basicSsl'] = "SSL de base";
$_LANG['billableitemseach'] = "par unité";
$_LANG['billableitemshour'] = "Heure";
$_LANG['billableitemshours'] = "Heures";
$_LANG['billableitemsquantity'] = "Qté";
$_LANG['billing']['creditnote'] = "Note de crédit";
$_LANG['billing']['debitnote'] = "Note de débit";
$_LANG['billing']['issuedate'] = "Date d'émission";
$_LANG['billing']['issuedby'] = "Publié par";
$_LANG['billing']['issuedto'] = "Délivré à";
$_LANG['billing']['ledger']['date'] = "Date";
$_LANG['billing']['ledger']['reference'] = "Référence";
$_LANG['billing']['ledger']['title'] = "Grand livre";
$_LANG['billing']['ledger']['type'] = "Type";
$_LANG['billing']['type']['affiliatepayout'] = "Paiement aux affiliés";
$_LANG['billing']['type']['clientaccountcredit'] = "Crédit sur compte client";
$_LANG['billing']['type']['clientaccountdebit'] = "Débit du compte client";
$_LANG['billing']['type']['creditnoteadjustment'] = "Ajustement de la note de crédit";
$_LANG['billing']['type']['invoiceadjustment'] = "Ajustement de la facture";
$_LANG['billing']['type']['payment'] = "Paiement";
$_LANG['billing']['type']['refund'] = "Remboursement";
$_LANG['billing']['type']['refundtocredit'] = "Remboursement sur le compte client";
...
$_LANG['billingnotes']['creditnote']['items'] = "Articles relatifs aux notes de crédit";
$_LANG['billingnotes']['debitnote']['items'] = "Éléments relatifs aux notes de débit";
$_LANG['blankCustomField'] = "(aucune valeur)";
...
$_LANG['bundlewarningdomainaddon'] = "Cet ensemble requiert l'option '%s' pour le nom de domaine %s afin d'être éligible.";
$_LANG['bundlewarningdomainregperiod'] = "Cet ensemble requiert la période d'enregistrement '%s' pour le nom de domaine %s afin d'être éligible.";
$_LANG['bundlewarningdomainreq'] = "Cet ensemble requiert l'enregistrement ou le transfert d'un nom de domaine avec le produit %s afin d'être éligible.";
$_LANG['bundlewarningdomaintld'] = "Cet ensemble requiert un nom de domaine avec l'extension '%s' pour le nom de domaine %s afin d'être éligible.";
...
$_LANG['cPanel']['autoresponders'] = "Répondeurs automatiques";
$_LANG['cPanel']['awstats'] = "AWStats";
$_LANG['cPanel']['backup'] = "Sauvegarde";
$_LANG['cPanel']['create'] = "Créer";
$_LANG['cPanel']['createEmailAccount'] = "Créer rapidement un compte courriel";
...
$_LANG['cPanel']['emailAccountCreateSuccess'] = "Le compte courriel a bien été créé !";
...
$_LANG['cPanel']['statusSuspendedNotice'] = "Vous ne pouvez plus utiliser ni gérer cet hébergement jusqu'à sa réactivation.";
...
$_LANG['cancelrequestdomainconfirm'] = "Je confirme ne pas vouloir renouveler ce domaine.";
...
$_LANG['captchaverify'] = "Veuillez saisir les caractères affichés dans l'image ci-dessous dans la zone de texte prévue à cet effet. Cette étape est obligatoire pour empêcher les soumissions automatisées.";
...
$_LANG['cart']['applyCreditAmount'] = "Appliquer <span>:amount</span> de mon solde créditeur à cette commande. Je paierai le montant restant via la méthode de paiement sélectionnée ci-dessous.";
...
$_LANG['cart']['applyCreditSkip'] = "N'appliquer aucun crédit de mon solde créditeur à cette commande. Je paierai en utilisant la méthode de paiement sélectionnée ci-dessous.";
...
$_LANG['cart']['idnLanguageDescription'] = "Nous avons détecté que le domaine que vous avez indiqué est un nom de domaine international. Afin de continuer, veuillez sélectionner la langue de votre domaine.";
...
$_LANG['cartItemType']['bundle'] = "Forfait";
$_LANG['cartItemType']['bundles'] = "Lots";
$_LANG['cartItemType']['domain'] = "Domaine";
$_LANG['cartItemType']['domainRegistration'] = "Enregistrement de domaine";
$_LANG['cartItemType']['domainRenewal'] = "Renouvellement de domaine";
$_LANG['cartItemType']['domainRenewals'] = "Renouveler un nom de domaine";
$_LANG['cartItemType']['domainTransfer'] = "Domain Transfer";
$_LANG['cartItemType']['domainTransfers'] = "Transferts de domaines";
$_LANG['cartItemType']['domains'] = "Nom de domaines";
$_LANG['cartItemType']['product'] = "Produit";
$_LANG['cartItemType']['products'] = "Produits";
$_LANG['cartItemsSelected'] = "Vous avez sélectionné :count et vous êtes prêt à acheter.";
...
$_LANG['cartbrowse'] = "Parcourir les produits et services";
...
$_LANG['cartcustomfieldsdesc'] = "Ce produit/service requiert des informations supplémentaires afin de nous permettre de traiter votre commande.";
...
$_LANG['cartdomainsconfiginfo'] = "Les options et les paramètres suivants sont disponibles pour les domaines que vous avez choisis. Les champs obligatoires sont indiqués par un astérisque (*).";
$_LANG['cartdomainshashosting'] = "Est hébergé";
$_LANG['cartdomainsnohosting'] = "Aucun hébergement  ! Cliquez pour en ajouter un.";
$_LANG['cartdomaintaken'] = "Malheureusement, %s n'est pas disponible.";
$_LANG['cartdomainunavailablemanual'] = "Ce domaine m'appartient déjà et je vais mettre les serveurs de noms (DNS) à jour";
$_LANG['cartdomainunavailableoptions'] = "Ce domaine n'est plus disponible. Si vous en êtes le propriétaire, choisissez une option ci-dessous...";
...
$_LANG['cartenterdomain'] = "Veuillez saisir ci-dessous le nom de domaine que vous souhaitez utiliser.";
$_LANG['cartenterpromo'] = "Entrez le code de la promotion";
$_LANG['carterrordomainconfigskipped'] = "Vous devez revenir en arrière. Complétez ci-dessus les champs obligatoires de configuration du nom de domaine.";
...
$_LANG['cartmakedomainselection'] = "Veuillez indiquer le nom de domaine que vous souhaitez utiliser avec votre service d'hébergement. Pour cela, sélectionnez une option ci-dessous.";
...
$_LANG['choosePackages'] = "Choisissez parmi une gamme de forfaits";
...
$_LANG['clientAlerts']['domainsExpiringSoon'] = ":numberOfDomains domaine(s) expire(nt) dans les :days jours à venir.";
...
$_LANG['clientHomePanels']['domainsExpiringSoonMsg'] = ":numberOfDomainsdomaine(s) expire(nt) dans les :days jours à venir. Vous pouvez les renouveler.";
...
$_LANG['clientareacontactsemailssupport'] = "Courriels des demandes d'assistance : recevez une copie de toutes les communications liées aux demandes d'assistance créés par le propriétaire du compte parent.";
...
$_LANG['clientareadisklimit'] = "Limite de l'espace disque";
$_LANG['clientareadiskusage'] = "Espace disque utilisé";
$_LANG['clientareadomainexpirydate'] = "Date d'expiration";
$_LANG['clientareadomainmanagedns'] = "Gérer les DNS";
$_LANG['clientareadomainmanageemailfwds'] = "Gérer la redirection d'e-mails";
...
$_LANG['clientareaerroremail'] = "Vous n'avez pas saisi votre adresse courriel.";
...
$_LANG['clientareaheader'] = "Bienvenue dans votre espace client ! Dans cette espace, vous pouvez gérer votre compte. Cette page est une vue d'ensemble de votre compte. Vous y trouverez également vos demandes ouvertes et vos factures non payées. Assurez-vous de toujours maintenir à jour vos coordonnées.";
...
$_LANG['clientareamodifydomaincontactinfo'] = "Modifier les informations de contact du domaine";
...
$_LANG['clientareanavdomains'] = "Mes domaines";
...
$_LANG['clientareaproductdetailsintro'] = "Voici un aperçu de tous vos produits/services.";
...
$_LANG['cloudSlider']['feature02Description'] = "Nos services reposent sur des centaines de serveurs et de centres de données répartis dans le monde entier. Vos clients peuvent accéder à votre site où qu’ils se trouvent — et vous, vous pouvez rester serein ! Nous proposons également des outils de surveillance qui vous fournissent des analyses expertes : suivre le trafic de votre site Web est essentiel pour améliorer son efficacité et sa popularité. Vous pouvez ainsi savoir d’où viennent les internautes, à quelle heure ils consultent votre site et connaitre la durée de leur visite. Enfin, notre engagement envers un marché mondial s’étend aussi à l’enregistrement de noms de domaine : nous proposons les TLD les plus populaires pour vos enregistrements.";
$_LANG['cloudSlider']['feature02DescriptionTwo'] = "Nous nous engageons à soutenir notre clientèle dans le monde entier ! C'est pourquoi nous vous proposons diverses manières de vous aider pour vos questions liées à l'hébergement : vous pouvez nous contacter par téléphone, par courriel ou depuis l'espace de discussion en direct.";
...
$_LANG['codeApplied'] = "Code promotionnel appliqué";
$_LANG['completeorder'] = "Régler la commande";
$_LANG['configModalTitle'] = "Configuration";
...
$_LANG['confirmItemDeletion'] = "Confirmer la suppression";
...
$_LANG['contacterrormessage'] = "Vous n'avez pas saisi de message.";
$_LANG['contacterrorname'] = "Vous n'avez pas saisi votre nom.";
$_LANG['contacterrorsubject'] = "Vous n'avez pas indiqué d'objet.";
...
$_LANG['creditcardccvinvalid'] = "Le code de sécurité de la carte (CVV) n'est pas valide.";
$_LANG['creditcardconfirmation'] = "Merci ! Les informations de votre carte bancaire ont été acceptées et le premier paiement a bien été effectué. Un courriel de confirmation vous a été envoyé.";
...
$_LANG['cycleRenewal'] = "Renouvellement :cycle";
...
$_LANG['designedToFitAnyBudget'] = "Conçu pour s'adapter à tous les budgets";
...
$_LANG['domainCannotBeManagedUnlessActive'] = "Ce domaine n'est pas actif, vous ne pouvez pas le gérer.";
...
$_LANG['domainDetails']['error']['releaseDomain'] = "Un problème est survenu lors de la libération du domaine. Veuillez vérifier la valeur saisie et essayer à nouveau.";
...
$_LANG['domainRenewal']['unavailable'] = "Renouvellement de domaine non disponible";
$_LANG['domainSearch']['domainOrAiInstruction'] = "Effectuez une recherche par mot clé, description ou domaine.&#10;Par exemple : &quot;Fun business events &quot;, &quot;Un service complet de planification financière pour les professionnels&quot;, ou &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Entrez une brève description ou un domaine exact.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "Le système n'a trouvé aucune suggestion.";
$_LANG['domainSearch']['exactMatch'] = "Correspondance exacte";
$_LANG['domainSearch']['maxLength'] = "Longueur maximale";
$_LANG['domainSearch']['notAvailable'] = "Not Available";
$_LANG['domainSearch']['safeSearch'] = "Recherche sécurisée";
$_LANG['domainSearch']['tlds'] = "Inclure les TLD";
$_LANG['domainSearch']['topAiSuggestion'] = "Meilleure suggestion d'IA";
$_LANG['domainSearch']['topSuggestion'] = "Meilleure suggestion";
$_LANG['domainaddons'] = "Ajouts";
$_LANG['domainaddonsbuynow'] = "Achetez maintenant pour";
$_LANG['domainaddonscancelareyousure'] = "Voulez-vous vraiment désactiver et annuler cette option de domaine ?";
$_LANG['domainaddonscancelfailed'] = "Échec lors de la désactivation de l'option de domaine. Veuillez contacter l'assistance technique.";
$_LANG['domainaddonscancelsuccess'] = "L'option a ben été désactivée.";
...
$_LANG['domainaddonsemailforwardinginfo'] = "Assurez le transfert de vos courriels vers une adresse de votre choix afin de pouvoir les gérer depuis un seul compte.";
$_LANG['domainaddonsidprotectioninfo'] = "Protégez vos informations personnelles et diminuez le volume de spam entrant en activant la protection d'identité.";
...
$_LANG['domainautorenewinfo'] = "Le renouvellement automatique vous aide à protéger votre domaine. Lorsqu'il est activé, vous recevez automatiquement une facture de renouvellement quelques semaines avant la date d'expiration de votre domaine et le paiement du renouvellement sera automatique.";
$_LANG['domainautorenewrecommend'] = "Nous vous recommandons de maintenir le renouvellement automatique activé pour éviter de perdre votre nom de domaine.";
$_LANG['domainautorenewstatus'] = "Statut de l'auto-renouvellement";
...
$_LANG['domainbulkmanagement'] = "Gestion en masse des actions";
$_LANG['domainbulkmanagementchangeaffect'] = "Cette modification s'appliquera aux domaines suivants :";
$_LANG['domainbulkmanagementchangesaffect'] = "Les modifications ci-dessous auront une incidence sur les domaines suivants :";
$_LANG['domainbulkmanagementnotpossible'] = "Malheureusement, ces réglages ne peuvent pas être modifiés à partir de notre espace client actuellement. Pour toute modification, merci de contacter l'assistance client.";
$_LANG['domainbulksearch'] = "Recherche de noms de domaines multiples";
$_LANG['domainbulksearchintro'] = "Recherchez jusqu'à 20 noms de domaines en même temps. Saisissez un nom de domaine par ligne, sans  http:// ou www.";
$_LANG['domainbulktransferdescription'] = "Vous pouvez transférer vos noms de domaine actuels chez nous aujourd'hui. Pour commencer, saisissez-les un par ligne ci-dessous sans www. ni http://.";
...
$_LANG['domainchecker']['suggestiontakenmsg'] = "Malheureusement le nom de domaine que vous avez choisi n'est pas disponible. Cela peut se produire lorsque le domaine vient juste d'être enregistré. Revenez à l'étape précédente et choisissez un autre nom de domaine.";
...
$_LANG['domaincheckerbulkplaceholder'] = "Saisissez jusqu'à 20 noms de domaine.\nUn seul nom de domaine par ligne.\n\nExemple :\nexample.com\nexample.net";
...
$_LANG['domaincheckerenterdomain'] = "Démarrez votre expérience d'hébergement Web chez nous ! Pour cela, saisissez le nom de domaine que vous souhaitez enregistrer, transférer ou achetez simplement un hébergement ci-dessous…";
$_LANG['domaincheckerhostingonly'] = "Commander uniquement un hébergement";
$_LANG['domaincheckernomoresuggestions'] = "C'est tout ce que nous avons trouvé ! Nous vous suggérons de saisir un autre mot-clé.";
$_LANG['domaincheckertaken'] = "Non disponible";
$_LANG['domaincheckertransferable'] = "Transférable";
$_LANG['domaincheckerunabletooffertld'] = "Malheureusement nous ne pouvons pas enregistrer ce domaine actuellement.";
...
$_LANG['domaincontactdetails']['Phone Country Code'] = "Indicatif téléphonique";
...
$_LANG['domainemailforwardingdesc'] = "Si le serveur de redirection des courriels détermine que la redirection n'est pas valide, nous désactiverons l'enregistrement de redirection automatiquement. Veuillez vérifier l'adresse de redirection avant de la réactiver. L'entrée en vigueur des modifications d'une redirection existante peut prendre jusqu'à une heure.";
...
$_LANG['domaingeteppcodeexplanation'] = "Le code EPP est en quelque sorte un mot de passe pour un nom de domaine. Il s'agit d'une mesure de sécurité garantissant que seul le propriétaire du nom de domaine peut le transférer. Vous en aurez besoin si vous souhaitez transférer votre domaine vers un autre registraire.";
...
$_LANG['domainregistrantchoose'] = "Choisissez le contact que vous voulez utiliser";
$_LANG['domainregistrantinfo'] = "Information sur le propriétaire du domaine";
$_LANG['domainregistrarlock'] = "Verrouillage du domaine";
$_LANG['domainregistrarlockdesc'] = "Activez le verrouillage du domaine (recommandé). Tout transfert non autorisé sera interdit si le verrouillage est actif.";
$_LANG['domainregistration'] = "Enregistrement de domaine";
$_LANG['domainregistryinfo'] = "Informations sur le registre de domaine";
...
$_LANG['domainreleasedescription'] = "Saisissez un nouveau TAG ici pour transférer votre domaine chez un nouveau registraire";
$_LANG['domainreleasetag'] = "Tag du nouveau registraire";
...
$_LANG['domainrenewalsnoneavailable'] = "Il n'y a aucun domaine éligible à un renouvellement.";
...
$_LANG['domainrenewexp'] = "Lorsque vous activez le renouvellement automatique nous pouvons vous envoyer automatiquement une facture de renouvellement, avant que votre nom de domaine n'arrive à expiration.";
...
$_LANG['domains']['irtpLockDescription'] = "Ce domaine est actuellement verrouillé : aucun un transfert n'est possible en raison d'un changement de contact ou d'une nouvelle inscription.";
...
$_LANG['due'] = "Dû";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "Vous devez accepter les conditions d'utilisation en cochant :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute doit être un tableau.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute doit être une date valide.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute doit être une adresse e-mail valide.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "Le système a rencontré une erreur interne. Réessayez plus tard.";
$_LANG['dynamicServiceFields']['validation']['in'] = "L'option sélectionnée pour :attribute n'est pas valide.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute doit être un entier.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute ne doit pas contenir plus de :max caractères.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute doit utiliser l'un des types de fichiers suivants : :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute doit contenir au moins :min caractères.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute doit être un chiffre.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute doit être une expression régulière valide.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute est obligatoire.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute doit être une URL valide qui inclut le protocole (« http ://» ou « https ://»).";
$_LANG['edit'] = "Éditer";
...
$_LANG['emailPreferences']['domainContactRequired'] = "Pour désactiver les notifications de domaine, veuillez activer les notifications de domaine pour le propriétaire principal du compte ou un autre contact.";
...
$_LANG['emailPreferences']['support'] = "Courriels pour les demandes d'assistance : recevez une copie de toutes vos communications avec le service.";
...
$_LANG['encryption_failed'] = "Échec du chiffrement : %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Réessayez plus tard.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Homepage";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Vous avez envoyé trop de demandes.";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "Oups !";
...
$_LANG['existingpasswordincorrect'] = "Votre mot de passe actuel n'est pas valide.";
$_LANG['expiresToday'] = "Expire aujourd'hui";
$_LANG['expiringsoon'] = "Expire bientôt";
$_LANG['expressCheckoutError'] = "Une erreur s'est produite lors du traitement de votre paiement. Veuillez contacter l'assistance.";
$_LANG['expressCheckoutInfo'] = "Votre paiement est en attente de confirmation. Cela ne dure que quelques minutes en général. Toutefois, si vous ne recevez pas de confirmation par courriel sous peu, veuillez contacter l'assistance.";
$_LANG['extendYourDomainBy1Year'] = "Prolongez votre domaine d'un an*";
...
$_LANG['features'] = "Fonctionnalités";
$_LANG['feedbackbest'] = "Meilleur";
$_LANG['feedbackclickreview'] = "Cliquez ici pour nous fournir vos commentaires";
$_LANG['feedbackclosed'] = "Vous ne pouvez pas saisir d'avis tant que les demandes d'assistance ne sont pas clôturées.";
$_LANG['feedbackdesc'] = "Pourriez-vous prendre un instant afin de remplir le formulaire ci-dessous et partager votre avis sur la qualité de votre expérience avec notre équipe d'assistance ?";
$_LANG['feedbackhandled'] = "a traité cette demande d'assistance";
...
$_LANG['feedbackprovided'] = "Vous avez déjà partagé votre avis pour cette demande d'assistance.";
...
$_LANG['findDomains'] = "Rechercher des domaines";
...
$_LANG['forTheFirstYear'] = "pour la première année";
...
$_LANG['fraud']['checkConfiguration'] = "Une erreur s'est produite lors de la vérification pour fraude. Veuillez contacter l'assistance.";
$_LANG['fraud']['countryMismatch'] = "Le pays de votre adresse IP et celui de votre adresse de facturation ne correspondent pas. Nous ne pouvons donc pas accepter votre commande.";
...
$_LANG['fraud']['highFraudRiskScore'] = "Votre commande a été signalée comme présentant un risque potentiellement élevé et a donc été retenue pour vérification manuelle.<br /><br />Si vous pensez avoir reçu ce message par erreur, veuillez accepter nos excuses et <a href=\"submitticket.php\">envoyer une demande d'assistance</a> à notre service. Merci !";
$_LANG['fraud']['highRiskCountry'] = "Malheureusement, nous ne sommes pas en mesure d'accepter votre commande car de nombreuses activités frauduleuses ont eu lieu dans votre pays. Si vous souhaitez utiliser un autre moyen de paiement, veuillez nous contacter.";
$_LANG['fraud']['manualReview'] = "Votre commande a été retenue pour vérification manuelle.<br /><br />Si vous pensez avoir reçu ce message par erreur, veuillez accepter nos excuses et <a href=\"submitticket.php\">envoyer une demande d'assistance</a> à notre service. Merci !";
$_LANG['fraud']['status']['failed'] = "Échec";
...
$_LANG['freeDomainHostingPromo'] = "Obtenez un domaine gratuit lorsque vous achetez un hébergement.";
...
$_LANG['genericPaymentDeclined'] = "Votre paiement a été refusé. Merci de réessayer ou de contacter notre assistance.";
$_LANG['genericerror']['msg'] = "Veuillez réessayer plus tard. Si le problème persiste, veuillez contacter notre assistance.";
...
$_LANG['hideSearchControls'] = "Masquer les commandes de recherche";
...
$_LANG['idnLanguage']['bal'] = "Baloutchi";
...
$_LANG['incApplicableTaxes'] = "taxes applicables incluses";
$_LANG['includeTLDs'] = "Inclure les TLD";
...
$_LANG['invalidCode'] = "Code promotionnel non valide";
$_LANG['invalid_input'] = "Entrée non valide : %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "ID de ticket ou identifiant de réponse non valide.";
...
$_LANG['invoicepaymentfailedconfirmation'] = "Malheureusement votre tentative de paiement a échouée.<br />Merci d'essayer à nouveau ou contactez le service d'assistance.";
...
$_LANG['invoicesadjustments'] = "Invoice Adjustments";
$_LANG['invoicesamount'] = "Montant";
$_LANG['invoicesattn'] = "À l'attention de";
$_LANG['invoicesbacktoclientarea'] = "&laquo; Revenir à l'espace client";
...
$_LANG['kbsuggestionsexplanation'] = "Les articles suivants proviennent de la base de connaissance et pourraient répondre à votre question. Veillez vérifier ces suggestions avant de nous faire parvenir votre question.";
...
$_LANG['logoutandreturntoadminarea'] = "Cliquez ici pour vous déconnecter et revenir à l'espace administration.";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Connectez-vous";
...
$_LANG['marketConnect']['nordvpn']['clientOutput']['2'] = "Vous avez des questions sur NordVPN ou vous avez besoin d'assistance technique ? Contactez :anchorOpenl'assistance NordVPN:anchorClose.";
$_LANG['marketConnect']['nordvpn']['clientOutput']['3'] = "Vous avez des questions concernant votre commande ou votre facturation ? Contactez notre équipe d'assistance via :anchorOpenSoumettre un ticket:anchorClose.";
$_LANG['marketConnect']['nordvpn']['clientOutput']['4'] = "Si vous avez déjà un compte et que vous souhaitez gérer les paramètres de votre compte Nord, :anchorOpenconnectez-vous ici:anchorClose.";
$_LANG['marketConnect']['ox']['manage'] = "Se connecter à OX App Suite";
$_LANG['marketConnect']['siteBuilder']['buildWebsite'] = "Créez votre site Web";
...
$_LANG['marketConnect']['sitelock']['updateFtp'] = "Mettre à jour les identifiants FTP";
...
$_LANG['marketConnect']['websiteBuilder']['updateFtp'] = "Mettre à jour les identifiants FTP";
...
$_LANG['maxLength'] = "Longueur maximale";
$_LANG['maxmind']['manualReview'] = "Votre commande a été retenue pour vérification manuelle.<br /><br />Si vous pensez avoir reçu ce message par erreur, veuillez accepter nos excuses et <a href=\"submitticket.php\">envoyer une demande d'assistance</a> à notre service. Merci !";
...
$_LANG['maxmind_checkconfiguration'] = "Une erreur s'est produite lors de la vérification pour fraude. Veuillez contacter l'assistance.";
...
$_LANG['maxmind_faileddescription'] = "Le code que vous avez saisi est incorrect. Si vous pensez qu'il s'agit d'une erreur, veuillez contacter notre service d'assistance dès que possible.";
$_LANG['maxmind_highfraudriskscore'] = "Votre commande a été signalée comme présentant un risque potentiellement élevé et a donc été retenue pour vérification manuelle.<br /><br />Si vous pensez avoir reçu ce message par erreur, veuillez accepter nos excuses et <a href=\"submitticket.php\">envoyer une demande d'assistance</a> à notre service. Merci !";
$_LANG['maxmind_highriskcountry'] = "Malheureusement, nous ne sommes pas en mesure d'accepter votre commande car de nombreuses activités frauduleuses ont eu lieu dans votre pays. Si vous souhaitez utiliser un autre moyen de paiement, veuillez nous contacter.";
$_LANG['maxmind_incorrectcode'] = "Code incorrect";
$_LANG['maxmind_invalidip'] = "Adresse IP non valide ou adresse locale détectée. Veuillez contacter l'assistance.";
...
$_LANG['metrics']['explanation'] = "En plus du prix de base, les frais de facturation de ce produit incluent l'utilisation. Les statistiques d'utilisation et leurs informations de tarification sont affichées ci-dessous.";
...
$_LANG['moduleactionfailed'] = "Échec de l'action";
...
$_LANG['navMarketConnectService']['dynamic'] = "Services dynamiques";
$_LANG['navMarketConnectService']['marketgoo'] = "Outils SEO";
$_LANG['navMarketConnectService']['nordvpn'] = "VPN";
$_LANG['navMarketConnectService']['ox'] = "Courriel professionnel";
...
$_LANG['networkIssuesScheduled'] = "Certains événements de maintenance planifiés pourraient avoir un impact sur nos services.";
...
$_LANG['networkstatusnone'] = "Il n'y a aucun problème de réseau %s actuellement.";
...
$_LANG['newsletterresubscribe'] = "Si vous souhaitez vous réabonner vous pouvez le faire à tout moment depuis la section %sMes informations%s de votre espace client.";
...
$_LANG['noDomainsFound'] = "Aucun domaine n'a été trouvé";
...
$_LANG['nosupportdepartments'] = "Aucun service d'assistance trouvé. Veuillez réessayer ultérieurement.";
$_LANG['notice'] = "Avis";
...
$_LANG['oauth']['currentlyLoggedInAs'] = "Vous utilisez actuellement le compte pour votre connexion :firstName :lastName";
...
$_LANG['orderForm']['additionalInformation'] = "Informations supplémentaires";
...
$_LANG['orderForm']['domainExtensionTransferNotSupported'] = "Nous ne prenons pas en charge ce domaine pour le transfert actuellement. Essayez un autre domaine.";
...
$_LANG['orderForm']['enterPersonalDetails'] = "Veuillez saisir vos informations personnelles et votre adresse de facturation.";
...
$_LANG['orderForm']['findNewDomainAi'] = "Recherchez un domaine à l'aide de suggestions basées sur l'IA.";
...
$_LANG['orderForm']['returnToClientArea'] = "Revenir à l'espace client";
...
$_LANG['orderForm']['transferUnlockBeforeContinuing'] = "Avant de continuer, vérifiez si vous avez déverrouillé votre domaine auprès de votre registraire actuel.";
...
$_LANG['orderForm']['upgradeQuantityMustChange'] = "Vous devez choisir une mise à niveau du forfait ou modifier la quantité.";
...
$_LANG['ordererrortldsnotconfigured'] = "Aucune extension de domaine n'est actuellement disponible à la vente. Pour obtenir de l'aide, contactez-nous.";
...
$_LANG['orderfailed'] = "Échec de la commande";
$_LANG['orderfinalinstructions'] = "Vous avez des questions concernant votre commande ? Veuillez nous envoyer une demande d'aide à partir de votre espace client et spécifiez votre numéro de commande.";
...
$_LANG['ordergotoclientarea'] = "Cliquez ici pour accéder à l'espace client";
...
$_LANG['orderlogininfopart2'] = "Espace client : le mot de passe et le nom d'utilisateur sont différents de ceux de votre panneau de contrôle de site Web.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "Annuel";
$_LANG['orderpaymenttermadjectivebiennially'] = "Biennal";
...
$_LANG['orderpaymenttermadjectivesemiannually'] = "Semestriel";
$_LANG['orderpaymenttermadjectivetriennially'] = "Triennal";
...
$_LANG['orderselectterm'] = "Sélectionnez un terme";
...
$_LANG['ordertransfersecretexplanation'] = "Veuillez saisir le secret de transfert de domaine. Vous pouvez 'obtenir auprès du registraire actuel du nom de domaine. ";
...
$_LANG['ox']['emailAccounts'] = "Comptes courriels";
...
$_LANG['ox']['mailboxSize'] = "Taille de la boîte de messagerie";
...
$_LANG['ox']['settings']['password'] = "Utilisez le mot de passe du compte courriel.";
...
$_LANG['ox']['settings']['retrievalIntro'] = "Pour configurer votre compte courriel dans une application de messagerie, utilisez les informations ci-dessous.";
...
$_LANG['paymentMethods']['intro'] = "Voici une vue d'ensemble de vos modes de paiement et des paramètres.";
...
$_LANG['paymentMethodsManage']['invalidCardDetails'] = "Le numéro de carte que vous avez saisi n'est pas valide. Veuillez réessayer.";
...
$_LANG['paymentMethodsManage']['unsupportedCardType'] = "Nous ne pouvons pas accepter le type de carte que vous avez indiqué. Veuillez utiliser une autre carte.";
...
$_LANG['price'] = "prix";
$_LANG['priceFor'] = "Prix pour :term";
$_LANG['priceForThisTerm'] = "Prix pour cette période";
$_LANG['priceStandard'] = "Renouvelable chaque année au :renewalPrice, plus taxes.";
$_LANG['priceWithDiscount'] = ":registrationPrice la première année, puis :renewalPrice chaque année.";
...
$_LANG['pwlengthmax'] = "Les mots de passe ne peuvent pas contenir plus de :max caractères.";
$_LANG['pwreset'] = "Réinitialiser le mot de passe";
$_LANG['pwresetcheckemail'] = "La réinitialisation de votre mot de passe a débuté. Merci de consulter vos courriels afin de poursuivre la procédure.";
...
$_LANG['pwresetkeyinvalid'] = "Le lien de réinitialisation que vous avez suivi n'est pas valide. Merci d'essayer à nouveau.";
...
$_LANG['pwstrengthfail'] = "Ce mot de passe n'est pas assez fort. Entrez un mot de passe plus complexe.";
...
$_LANG['recommendedTLDs'] = "TLDs recommandés";
...
$_LANG['remoteAuthn']['unavailable'] = "est inaccessible pour le moment. Merci de réessayer ultérieurement.";
...
$_LANG['renewPrice'] = "Prix de renouvellement";
...
$_LANG['requiredFields'] = "Les champs obligatoires sont marqués d'une *";
...
$_LANG['returnclient'] = "Revenir à l'espace client";
$_LANG['returnhome'] = "Revenir à l'accueil";
$_LANG['returntoadminarea'] = "Cliquez ici pour revenir à l'espace administration";
$_LANG['rssfeed'] = "Flux RSS";
$_LANG['safeSearch'] = "Recherche sécurisée";
$_LANG['sale'] = "Sale";
$_LANG['salePrice'] = "prix de vente";
$_LANG['salesTaxes'] = "Taxes de vente";
...
$_LANG['searchtickets'] = "Saisissez le numéro ou l'objet de la demande";
...
$_LANG['selectCountry'] = "Sélectionner le pays";
$_LANG['selectDomain'] = "Sélectionnez un domaine";
$_LANG['selectDomainForHosting'] = "À quel domaine souhaitez-vous associer ce pack d'hébergement partagé ?";
$_LANG['selectDomainsForSsl'] = "À quel (s) domaine (s) souhaitez-vous appliquer le SSL de base ? Vous pouvez en sélectionner plusieurs.";
$_LANG['selectState'] = "Sélectionnez un État";
...
$_LANG['serverchangepasswordintro'] = "D'ici vous pouvez modifier le mot de passe de vos produits et services (Remarque : ceci n'affecte ni le mot de passe de votre espace client ni celui de vos autres produits).";
...
$_LANG['serverstatusnoservers'] = "Aucun serveur surveillé actuellement";
...
$_LANG['service_unavailable'] = "Service non disponible : %s";
$_LANG['servicesRenew'] = "Renouvellement";
$_LANG['setupFee'] = ":amount Frais de configuration";
$_LANG['setupMandate'] = "Configurer le mandat de paiement";
$_LANG['sharedHosting'] = "Hébergement mutualisé";
$_LANG['shopNow'] = "Achetez maintenant";
$_LANG['shortcuts'] = "Raccourcis";
$_LANG['show'] = "Montrer";
$_LANG['showMenu'] = "Afficher le Menu";
$_LANG['showSearchControls'] = "Afficher les commandes de recherche";
...
$_LANG['sidebars']['viewAccount']['myDetails'] = "Mes informations";
...
$_LANG['ssl']['approverEmailUpdateInfo'] = "<p>Vous recevrez sous peu un message pour approuver le certificat. Le message sera envoyé à l'adresse suivante : <em>:newApproverEmail</em> .</p><p>Si vous ne le recevez pas, vérifiez les filtres anti-spam et les dossiers de protection antivirus au cas où le message serait placé en quarantaine. Si vous ne le trouvez toujours pas, veuillez <a href=\"submitticket.php\">contacter l'assistance</a>.</p>";
...
$_LANG['ssl']['installFurtherInfo'] = "Pour plus d'informations, consultez la page :anchorAssistance lors de l'installation RapidSSL:endAnchor.";
...
$_LANG['ssl']['reissueSuccessInfo'] = "<p>Votre demande de réémission de votre certificat a été soumise à l'autorité de certification.</p><p>Vous recevrez sous peu un message pour approuver le certificat. Le message sera envoyé à l'adresse suivante : <em>:approverEmail</em>.</p><p>Si vous ne le recevez pas, vérifiez les filtres anti-spam et les dossiers de protection antivirus au cas où le message serait placé en quarantaine. Si vous ne le trouvez toujours pas, veuillez <a href=\"submitticket.php\">contacter l'assistance</a>.</p>";
...
$_LANG['ssl']['status']['completed'] = "Terminé";
...
$_LANG['ssladmininfodetails'] = "Ces informations de contact n'apparaîtront pas sur le certificat. Elles seront utilisées uniquement pour l'émission du certificat et pour son renouvellement.";
$_LANG['sslawaitingconfig'] = "En attente de configuration";
$_LANG['sslcertinfo'] = "Informations du certificat SSL";
...
$_LANG['sslconfsslcertificate'] = "Configurez le certificat SSL.";
$_LANG['sslcsr'] = "Demande de signature de certificat (CSR)";
$_LANG['ssldomain'] = "Domaine";
$_LANG['sslerrorapproveremail'] = "Vous devez entrer l'adresse courriel du responsable de ce certificat";
$_LANG['sslerrorentercsr'] = "Vous devez saisir votre demande de signature de certificat (CSR)";
...
$_LANG['sslinvalidlink'] = "Lien non valide. Veuillez réessayer.";
$_LANG['sslnoconfigurationpossible'] = "La configuration a été effectuée. Si vous rencontrez des problèmes, veuillez contacter l'assistance.";
...
$_LANG['sslserverinfo'] = "Informations du serveur";
...
$_LANG['ssofatalerror'] = "Une erreur fatale s'est produite. Veuillez contacter l'assistance.";
$_LANG['ssounabletologin'] = "Impossible d'utiliser la connexion automatique. Veuillez contacter l'assistance.";
...
$_LANG['statsnumtickets'] = "Nombre de demandes d'assistance";
$_LANG['stepNumber'] = "Étape :number";
$_LANG['store']['addToExistingPackage'] = "pour l'ajouter à un forfait d'hébergement existant.";
$_LANG['store']['addon']['notFound']['contactSupport'] = "Contacter l'assistance";
...
$_LANG['store']['codeGuard']['adminPreview'] = "Les forfaits CodeGuard que vous activez seront affichés ici";
...
$_LANG['store']['codeGuard']['faq']['a2'] = "CodeGuard fournit une solution de sauvegarde externe indépendante pour votre site web, ainsi qu'une surveillance quotidienne afin de garantir que votre site web est en ligne et exempt de logiciels malveillants.";
...
$_LANG['store']['codeGuard']['faq']['a4'] = "Changez facilement de forfait ! Vous pouvez mettre à niveau votre capacité de stockage sur disque et l'augmenter en quelques clics seulement depuis notre espace client.";
...
$_LANG['store']['codeGuard']['faq']['a6'] = "Oui, les sauvegardes stockées sont chiffrées à l'aide de la norme de chiffrement AES-256.";
...
$_LANG['store']['codeGuard']['faq']['a8'] = "CodeGuard peut surveiller votre site et vous avertir par courriel en cas de nouvelles menaces et de nouveaux logiciels malveillants lorsque votre site Web est modifié.";
...
$_LANG['store']['codeGuard']['features']['malwareMonitoring'] = "Surveillance des logiciels malveillants";
$_LANG['store']['codeGuard']['features']['malwareMonitoringDescription'] = "Restez serein ! Confiez la surveillance à CodeGuard et laissez-le vérifier chaque jour votre site pour y détecter des modifications.";
...
$_LANG['store']['codeGuard']['leadText2'] = "Avec les sauvegardes de sites Web CodeGuard, votre site Web est sauvegardé tous les jours. En cas de sinistre, vous pouvez restaurer votre site à un point antérieur dans le temps en un clic.";
...
$_LANG['store']['codeGuard']['tab']['features'] = "Fonctionnalités";
$_LANG['store']['codeGuard']['tab']['overview'] = "Vue d'ensemble";
$_LANG['store']['codeGuard']['tab']['pricing'] = "Prix";
$_LANG['store']['codeGuard']['tagline'] = "Protégez-vous contre les virus, les pirates et même votre propre code qui pourrait accidentellement endommager votre site. Utilisez les sauvegardes de sites Web CodeGuard.";
...
$_LANG['store']['dynamic']['title'] = "Services dynamiques";
...
$_LANG['store']['emailServices']['benefits']['archiving']['5'] = "Gestion facile de la protection des données";
...
$_LANG['store']['emailServices']['benefits']['archiving']['a2a'] = "Vous cherchez désespérément un e-mail important de l'année dernière, mais vous ne le trouvez pas et vous vous exposez à une sanction ou vous risquez de perdre un contrat important ? Afin d'éviter cela, optez pour une solution professionnelle d'archivage des courriels. Cet outil est essentiel pour conserver une sauvegarde sécurisée de tous vos messages et respecter la législation.";
...
$_LANG['store']['emailServices']['benefits']['incoming']['a2'] = "Cessez de vous exposer aux menaces informatiques. Si votre boîte de réception est saturée de courriers indésirables, c'est le signe qu'il vous faut une solution professionnelle de filtrage des messages entrants. Bénéficiez d'une protection complète et dites adieu aux spams, virus et logiciels malveillants !";
...
$_LANG['store']['emailServices']['benefits']['outgoing']['a1'] = "Le filtrage des e-mails sortants est essentiel pour protéger la réputation de votre infrastructure informatique et garantir que tous vos messages sortants parviennent en toute sécurité chez leurs destinataires. Cette solution professionnelle empêchera le spam et les virus de quitter votre réseau et empêchera vos adresses IP de figurer à nouveau sur liste noire. De plus, le filtre sortant SpamExperts vous offre les rapports et les outils pour détecter les comptes compromis et verrouiller les utilisateurs diffusant du spam.";
$_LANG['store']['emailServices']['benefits']['outgoing']['a2'] = "Votre réseau a-t-il déjà envoyé des spams à votre insu ? En raison des faiblesses du réseau, presque tous les appareils peuvent être compromis pour transmettre des messages SMTP sortants, ce qui permet d'envoyer des spams ou des logiciels malveillants depuis votre réseau sans que vous ne le sachiez ! Par conséquent, il est essentiel que vous investissiez dans une solution professionnelle de filtrage sortant. Préservez la bonne réputation de votre entreprise, empêchez les spams de quitter votre réseau et évitez d'être mis sur liste noire afin que vos courriels parviennent toujours à leurs destinataires.";
...
$_LANG['store']['emailServices']['blockSpamHeadline'] = "Bloquez près de 100 % des virus, des logiciels malveillants et du spam avant qu'ils n'atteignent votre boîte de réception";
...
$_LANG['store']['emailServices']['overview']['archiving']['headline'] = "Ne perdez jamais vos courriels et garantissez l’intégrité des données pour rester conforme à la législation.";
...
$_LANG['store']['emailServices']['overview']['incoming']['headline'] = "Éliminez le spam et les virus des courriels avant qu'ils n'atteignent votre réseau";
...
$_LANG['store']['emailServices']['overview']['outgoing']['headline'] = "Empêchez le spam et les virus de quitter votre réseau à votre insu";
...
$_LANG['store']['emailServices']['tab']['overview'] = "Vue d'ensemble";
...
$_LANG['store']['error']['serviceUnavailable'] = "Impossible de traiter votre demande pour le moment. Cela peut être dû à un délai d'attente ou à un problème de service temporaire. Réessayez, s'il vous plaît.";
$_LANG['store']['error']['validationFailed'] = "Vérifiez et corrigez les erreurs ci-dessous.";
...
$_LANG['store']['marketgoo']['adminPreview'] = "Les forfaits Marketgoo que vous activez seront affichés ici";
...
$_LANG['store']['marketgoo']['faqs']['a1'] = "Voir une comparaison vidéo des forfaits";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo vous propose un processus de référencement guidé et éprouvé sans que vous ayez besoin d'être un expert. <br> marketgoo est abordable et fournit des rapports, des plans et des recommandations de référencement complets, le tout dans une interface intuitive.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Qu'est-ce qui différencie Marketgoo des autres produits de référencement ?";
$_LANG['store']['marketgoo']['faqs']['title'] = "FAQ et assistance";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "Soumission aux moteurs de recherche";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Compatibilité avec les créateurs de sites Web";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Rapport d'avancement mensuel";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Analyse du trafic";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Téléchargez le rapport SEO au format PDF <a href='https://mktgoo.co/seo-report-score2'>(voir exemple)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "Fonctionnalités alimentées par l'IA : génération automatique du titre et de la méta-description";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Pages numérisées";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Suivi des concurrents";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Suivi et optimisation des mots clés";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Rapport et plan mis à jour";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Plan de référencement personnalisé";
$_LANG['store']['marketgoo']['features']['1'] = "Obtenez votre plan de référencement";
$_LANG['store']['marketgoo']['features']['2'] = "Suivez les instructions étape par étape";
$_LANG['store']['marketgoo']['features']['3'] = "Suivez les progrès grâce à un rapport mensuel";
$_LANG['store']['marketgoo']['features']['4'] = "Suivez et surveillez les concurrents";
$_LANG['store']['marketgoo']['features']['5'] = "Optimisation des pages individuelles";
$_LANG['store']['marketgoo']['features']['6'] = "Recherche et surveillance faciles des mots clés";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Inscrivez-vous et obtenez votre rapport et votre plan de référencement instantanés. Identifiez les points à améliorer et obtenez des recommandations adaptées à votre site.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Des instructions sont rédigées pour les utilisateurs non férus de technologie et vous guident à travers chaque recommandation, avec des exemples et des explications.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Chaque mois, recevez un e-mail indiquant la progression du référencement de votre site et téléchargez-le au format PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Surveillez vos concurrents pour voir ce qu'ils font pour générer du trafic et comparer vos chiffres aux leurs. Ils ne sauront jamais que tu les regardes !";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo vous guide dans l'optimisation de chaque page individuelle de votre site en la faisant correspondre à l'un des mots clés que vous avez choisis et en vous assurant que la fréquence et le placement sont corrects.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "Les mots clés peuvent être accablants si vous n'êtes pas familier avec le référencement. marketgoo recommande des mots clés et vous permet également de rechercher et de saisir ceux pour lesquels vous souhaitez optimiser.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Fonctionne avec tous les constructeurs de sites Web";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Date de comparaison : 19, 20 et 25 juin:tagBreak*Performances globales du réseau selon une étude réalisée par AV-Test. Vous pouvez lire :tagOpenle rapport complet:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Alertes concernant la fuite d'informations d'";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Analyse des logiciels malveillants pour les téléchargements";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn2'] = "Plus de 7300";
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Non divulgué";
$_LANG['store']['nordvpn']['features']['comparison']['vpn4'] = "Plus de 200";
$_LANG['store']['nordvpn']['features']['comparison']['vpn5'] = "Plus de 3 000";
$_LANG['store']['nordvpn']['features']['comparison']['vpn6'] = "Plus de 6 500";
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "Traqueur et bloqueur de publicités";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN ne limite pas les vitesses de connexion. Profitez de notre connexion VPN à haut débit sans aucune limitation.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN est compatible avec toutes les plateformes populaires, notamment Windows, macOS, Linux, Android et iOS. De plus, vous pouvez sécuriser jusqu'à 10 appareils, y compris votre routeur.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "Aucune limite de bande passante VPN  ";
$_LANG['store']['nordvpn']['features']['device']['title2'] = "Compatible avec tous les appareils";
$_LANG['store']['nordvpn']['features']['faq']['answer1'] = ":tagOpenUn réseau privé virtuel:tagClose achemine votre trafic Internet via un tunnel sécurisé, en modifiant votre emplacement virtuel au passage. Mais NordVPN est bien plus qu'un simple VPN : nous proposons également de puissants outils anti-malware.";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Naviguez, jouez et travaillez sur une connexion privée et sécurisée";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Restez connecté en toute sécurité, même sur les réseaux Wi-Fi publics";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Réduisez le suivi en ligne en protégeant votre adresse IP";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Regardez du contenu personnel lorsque vous voyagez à l'étranger";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Utilisez NordVPN pour chiffrer votre activité en ligne et renforcer la protection de votre connexion à tout moment et partout.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN protège votre connexion grâce à un cryptage de nouvelle génération, afin que vous puissiez vous connecter à vos comptes, effectuer des virements bancaires et faire des achats en ligne sans soucis. Même sur des réseaux non protégés.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN propose un large éventail de fonctionnalités pour vous protéger des cybermenaces. Outre Threat Protection Pro™, il existe un Kill Switch automatique qui bloque votre connexion Internet en cas de panne de votre connexion VPN, garantissant ainsi la sécurité de vos données. Les serveurs obfusqués sont utiles lorsqu'un niveau élevé de sécurité en ligne est requis en raison de la censure gouvernementale et de réglementations strictes sur Internet.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Renforcez votre sécurité en ligne avec un VPN";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Sécurité avancée";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Chaque fois que vous téléchargez un fichier, Threat Protection Pro™ l'inspecte pour détecter la présence de logiciels malveillants.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ bloque les publicités intrusives et les outils de suivi Web, analyse automatiquement les URL et bloque les sites malveillants.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Threat Protection Pro™ protège vos appareils et votre confidentialité. En bloquant les traceurs, il vous permet d'éviter les espions en ligne.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "La fonctionnalité :tagOpenThreat Protection Pro™:tagClose de NordVPN change la donne en offrant encore plus d'avantages en matière de sécurité et une meilleure protection en un seul clic supplémentaire.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Plus qu'un simple VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Même si vous n'avez rien à cacher, vous n'aimez probablement pas l'idée d'être surveillé et suivi. La principale raison pour laquelle les internautes choisissent les services VPN est la confidentialité en ligne et la sécurité générale.:tagBreakVoici les raisons spécifiques pour lesquelles ?";
...
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Évitez les restrictions régionales et politiques sur les plateformes telles que Facebook, X (Twitter) et WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Les publicités en ligne sont généralement ennuyeuses et distrayantes. Ils encombrent de grandes parties des sites Web, ralentissent la vitesse de connexion et peuvent être malveillants.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Les technologies domestiques intelligentes, en particulier les appareils IoT non sécurisés, peuvent créer des vulnérabilités dans les réseaux domestiques.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Connexion Wi-Fi publique sécurisée";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Navigation plus sûre";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Accès illimité aux réseaux sociaux";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Protection contre les publicités malveillantes";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Sécurité domestique intelligente";
...
$_LANG['store']['nordvpn']['features']['world']['count1'] = "Plus de 7300";
$_LANG['store']['nordvpn']['features']['world']['count2'] = "118";
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Obtenez l'offre";
$_LANG['store']['nordvpn']['features']['world']['tagline'] = "Choisissez parmi des milliers de serveurs VPN ultrarapides dans le monde entier. :tagBreakProfitez d'une connexion stable où que vous soyez.";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Protégez votre adresse IP:tagBreak• Bloquez les malwares, les traqueurs et les publicités:tagBreak• Connectez jusqu'à 10 appareils";
$_LANG['store']['nordvpn']['hero']['title'] = "Cybersécurité.:tagBreak:tagOpenPour tous les jours:tagClose";
...
$_LANG['store']['ox']['cartShortDescription'] = "Bénéficiez d'une messagerie professionnelle de très haute qualité dotée d'outils de communication et de coopération complets pour travailler en toute sécurité et avec fiabilité.";
$_LANG['store']['ox']['cartTitle'] = "Courriel professionnel";
...
$_LANG['store']['ox']['faq2']['answer'] = "Oui, OX App Suite prend en charge la connexion de tous les comptes courriels IMAP externes, y compris les fournisseurs populaires tels que Gmail, Yahoo et Outlook.com. Ajoutez simplement votre adresse courriel et votre mot de passe dans App Suite et tout e-mail envoyé à ces comptes s'affichera dans votre interface App Suite.";
...
$_LANG['store']['ox']['faq4']['answer'] = "App Suite est compatible avec la plupart des clients de messagerie natifs sur ordinateurs et mobiles.";
$_LANG['store']['ox']['faq4']['devices'] = "Appareils mobiles : iPhone avec iOS 11 / iOS 12, téléphones mobiles avec Android 4.1 ou une version ultérieure<br>Navigateurs pris en charge : Safari, Chrome (version la plus récente et version précédente), Mozilla Firefox (version la plus récente et version précédente), Microsoft Internet Explorer 11 / Edge";
...
$_LANG['store']['ox']['faq9']['answer'] = "Oui, nous proposons en libre-service un outil de migration intuitif et facile à utiliser. Migrez depuis les fournisseurs de messagerie populaires y compris Apple iCloud, Gmail, Outlook.com/Windows Live/Hotmail, Yahoo Mail, GMX ou T-Online, ou saisissez les données d'accès de vous fournisseur avec les informations IMAP/POP3 ou tout autre protocole de votre choix.";
$_LANG['store']['ox']['faq9']['question'] = "Puis-je migrer mon compte courriel existant d'un autre fournisseur ?";
...
$_LANG['store']['ox']['manage'] = "Gérer les comptes courriels";
...
$_LANG['store']['ox']['standout']['feature1']['bullet1'] = "Courriel professionnel@votre-domaine.com";
...
$_LANG['store']['ox']['standout']['feature1']['bullet4'] = "Boîtes de messagerie volumineuses de 10 Go et 50 Go";
$_LANG['store']['ox']['standout']['feature1']['title'] = "Attendez plus des e-mails";
$_LANG['store']['ox']['standout']['feature2']['detail'] = "Grâce à l'IA et à un logiciel de défense prédictive des courriels, OX App Suite s'engage à protéger votre boîte de réception contre le spam, les virus, les logiciels malveillants et les attaques de phishing.";
$_LANG['store']['ox']['standout']['feature2']['title'] = "Dites adieu au spam";
$_LANG['store']['ox']['standout']['feature3']['detail'] = "OX App Suite se synchronise sur tous vos appareils. L'accès mobile et ordinateur ne pose aucun problème, car OX App Suite fonctionne parfaitement avec tous les clients natifs.";
$_LANG['store']['ox']['standout']['feature3']['title'] = "Travaillez n'importe où";
$_LANG['store']['ox']['title'] = "Courriel professionnel";
$_LANG['store']['ox']['viewPricing'] = "Voir les forfaits et la tarification";
...
$_LANG['store']['siteBuilder']['compareTitle'] = "Quelles sont les différences entre notre Site Builder et <br class=\"hidden-xs\"> les outils de création de sites Web de nos concurrents ?";
$_LANG['store']['siteBuilder']['features']['blog']['1'] = "Page de blog";
$_LANG['store']['siteBuilder']['features']['blog']['2'] = "Brouillon d'article";
$_LANG['store']['siteBuilder']['features']['blog']['3'] = "Éditeur d'article";
$_LANG['store']['siteBuilder']['features']['blog']['4'] = "Partage social";
...
$_LANG['store']['siteBuilder']['features']['blog']['tagline'] = "Partager votre histoire fait toute la différence. Connectez-vous aux internautes via les réseaux sociaux et votre blog.";
$_LANG['store']['siteBuilder']['features']['essentials']['1'] = "Éditeur en glisser/déposer";
$_LANG['store']['siteBuilder']['features']['essentials']['2'] = "Fonctionnalités de création";
...
$_LANG['store']['siteBuilder']['features']['essentials']['tagline'] = "Notre Site Builder inclut l'ensemble de ces fonctionnalités.";
...
$_LANG['store']['siteBuilder']['features']['store']['tagline'] = "Les ventes en ligne peuvent dynamiser vos affaires. Créez site Web comme un magasin, une boutique ou une enseigne.";
$_LANG['store']['siteBuilder']['featuresEssentials'] = "Fonctionnalités essentielles";
$_LANG['store']['siteBuilder']['featuresLabelTitle'] = "Fonctionnalités";
...
$_LANG['store']['siteBuilder']['featuresSocial'] = "Réseaux sociaux et blog";
$_LANG['store']['siteBuilder']['featuresStore'] = "Boutique en ligne";
$_LANG['store']['siteBuilder']['featuresTitle'] = "Fonctionnalités de Site Builder";
...
$_LANG['store']['siteBuilder']['featuresdescriptions']['essentials']['1'] = "L'éditeur en glisser/déposer permet aux clients d'ajouter et d'organiser les éléments du site Web directement sur la page, avec une mise en évidence prédictive des zones de placement.";
$_LANG['store']['siteBuilder']['featuresdescriptions']['essentials']['2'] = "Vous pouvez utiliser des éléments de mise en page prêts à l'emploi tels que du texte, des boutons, des photos ou des icônes afin de créer une mise en page de site Web personnalisée et professionnelle.";
...
$_LANG['store']['siteBuilder']['featuresdescriptions']['essentials']['4'] = "Les sites Web s'afficheront parfaitement sur tous les appareils. Les modèles sont 100 % compatibles avec tous les appareils, y compris les téléphones mobiles, les tablettes et les ordinateurs de bureau.";
$_LANG['store']['siteBuilder']['featuresdescriptions']['essentials']['5'] = "Dynamisez votre site Web grâce à une sélection de plus de 200 000 photos professionnelles de haute qualité et en haute résolution. Notre outil de création de sites comprend également l'optimisation des images et vidéos intégrées.";
$_LANG['store']['siteBuilder']['featuresdescriptions']['essentials']['6'] = "Grâce à la sauvegarde en temps réel, vous avez la certitude de ne perdre aucune donnée. L'éditeur enregistre automatiquement tout pendant que vous travaillez.";
...
$_LANG['store']['siteBuilder']['intro1'] = "La création d'une présence Web requiert la bonne plateforme. Démarquez-vous grâce à notre outil de création de sites Web DIY.";
$_LANG['store']['siteBuilder']['intro2'] = "Que vous souhaitiez faire votre promotion ou celle de votre entreprise, notre outil de création de sites est un modèle et un assistant qui vous guide pas à pas. Il est suffisamment simple pour les débutants et riche en fonctionnalités pour les professionnels. Il ressemble à PowerPoint, en plus performant, plus élégant et plus simple. Une solution que vous aurez plaisir à utiliser !";
$_LANG['store']['siteBuilder']['introHeadline'] = "Votre aventure en ligne <br class=\"hidden-xs\">commence ici.";
...
$_LANG['store']['siteBuilder']['templates']['blog-page'] = "Page de blog";
...
$_LANG['store']['siteBuilder']['upgrade']['loggedInAs'] = "Vous utilisez actuellement le compte pour votre connexion :email";
$_LANG['store']['siteBuilder']['upgrade']['login'] = "Merci de vous connecter pour voir les options disponibles.";
$_LANG['store']['siteBuilder']['upgrade']['no'] = "Aucune mise à niveau disponible";
$_LANG['store']['siteBuilder']['upgrade']['noPlans'] = "Aucun forfait Site Builder actif trouvé.";
$_LANG['store']['siteBuilder']['upgrade']['noUpgrade'] = "Il n'y a aucune mise à niveau disponible pour le moment.";
$_LANG['store']['siteBuilder']['upgrade']['recommended'] = "Le plan recommandé est affiché.";
$_LANG['store']['siteBuilder']['upgrade']['required'] = "Mise à niveau requise";
$_LANG['store']['siteBuilder']['upgrade']['requiredDescription'] = "Pour utiliser à la fonctionnalité souhaitée, vous devez mettre à jour votre forfait Site Builder.";
$_LANG['store']['siteBuilder']['upgrade']['submitTicket'] = "Contacter l'assistance";
$_LANG['store']['siteBuilder']['upgrade']['switchUser'] = "Se déconnecter/Changer d'utilisateur";
$_LANG['store']['siteBuilder']['upgrade']['title'] = "Mise à niveau Site Builder";
$_LANG['store']['siteBuilder']['upgrade']['to'] = "Mettre à niveau :product pour :amount";
...
$_LANG['store']['sitelock']['comparePlans'] = "Comparer les forfaits SiteLock";
...
$_LANG['store']['sitelock']['contentBodyParagraph2'] = "L'analyse quotidienne des logiciels malveillants de SiteLock identifie les vulnérabilités et les codes malveillants connus et les supprime automatiquement de votre site Web pour protéger votre site et les internautes qui le consultent contre les menaces.";
...
$_LANG['store']['sitelock']['contentHeadline'] = "Sécurité et protection contre les logiciels malveillants pour votre site Web";
...
$_LANG['store']['sitelock']['emergencyPlanBody'] = "Si votre site Web a été attaqué et compromis, obtenez une assistance d'urgence immédiate pour récupérer rapidement votre site. Voici comment l'intervention d'urgence de SiteLock vous aide :";
...
$_LANG['store']['sitelock']['emergencyPlanResponseContent'] = "Bénéficiez de notre temps de réponse le plus rapide avec une analyse et la récupération de votre site dans un délai de 30 minutes.";
...
$_LANG['store']['sitelock']['faqFourBodyParagraph2'] = "Un :malwareStrong ou encore logiciel malveillant, est utilisé pour collecter des données sensibles, obtenir un accès non autorisé aux sites Web et même pirater des ordinateurs.";
$_LANG['store']['sitelock']['faqFourTitle'] = "Que sont les vulnérabilités et les logiciels malveillants ?";
$_LANG['store']['sitelock']['faqOneBody'] = "SiteLock offre une sécurité de site Web simple, rapide et abordable aux sites Web de toutes tailles. Fondée en 2008, la société protège plus de 12 millions de sites Web dans le monde. La suite de produits basée sur le cloud SiteLock détecte automatiquement les vulnérabilités de sites Web, inclut la suppression des logiciels malveillants, une protection DDoS, une accélération de sites Web, des évaluations des risques de sites Web et la conformité PCI.";
...
$_LANG['store']['sitelock']['faqThreeBodyList1'] = "SiteLock analyse tous les jours les fichiers d'un site Web à la recherche de logiciels malveillants. Si un logiciel malveillant est détecté, le propriétaire du site Web est immédiatement alerté. SiteLock propose également des analyses complètes pour supprimer automatiquement le logiciel malveillant.";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Analyses quotidiennes de la base de données SMART";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Analyses quotidiennes de fichiers SMART";
$_LANG['store']['sitelock']['features']['globalCdn'] = "CDN mondial";
$_LANG['store']['sitelock']['features']['malwareScanning'] = "Analyse quotidienne des logiciels malveillants";
...
$_LANG['store']['sitelock']['featuresMalwareContent'] = "Bénéficiez d'une surveillance proactive et d'alertes pour tout logiciel malveillant détecté sur votre site Web.";
...
$_LANG['store']['sitelock']['featuresReputationContent'] = "Les analyses quotidiennes aident à détecter les logiciels malveillants avant que les moteurs de recherche ne les trouvent et placent votre site sur liste noire.";
...
$_LANG['store']['sitelock']['plansAndPricing'] = "Forfaits et tarification";
...
$_LANG['store']['sitelock']['promo']['sidebar']['title'] = "Protection contre les logiciels malveillants";
$_LANG['store']['sitelock']['tagline'] = "Analysez automatiquement votre site Web pour détecter les logiciels malveillants et protéger sa réputation en ligne";
...
$_LANG['store']['sitelockvpn']['adminPreview'] = "Les forfaits VPN SiteLock que vous activez seront affichés ici";
...
$_LANG['store']['sitelockvpn']['feature1']['highlights']['five'] = "Utilisez un chiffrement de niveau militaire";
...
$_LANG['store']['sitelockvpn']['plans']['features']['allInclude'] = "Tous les forfaits d'abonnement incluent";
$_LANG['store']['sitelockvpn']['plans']['features']['apps'] = "Applications pour Windows, Mac, iOS, <br> Android et Linux";
$_LANG['store']['sitelockvpn']['plans']['features']['countries'] = "Plus de 40 pays";
$_LANG['store']['sitelockvpn']['plans']['features']['encryption'] = "Chiffrement AES 256 bits";
$_LANG['store']['sitelockvpn']['plans']['features']['highSpeed'] = "Réseau à haut débit";
$_LANG['store']['sitelockvpn']['plans']['features']['noRestrictions'] = "Aucune restriction";
$_LANG['store']['sitelockvpn']['plans']['features']['protocol'] = "OpenVPN, L2TP-IPsec <br> et protocoles PPTP";
$_LANG['store']['sitelockvpn']['plans']['features']['servers'] = "Plus de 1000 serveurs";
...
$_LANG['store']['sitelockvpn']['pricing']['features']['encryption'] = "Chiffrement AES 256 bits";
$_LANG['store']['sitelockvpn']['pricing']['features']['highSpeed'] = "Réseau à haut débit";
$_LANG['store']['sitelockvpn']['pricing']['features']['noRestrictions'] = "Aucune restriction";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Concevez du nouveau contenu, améliorez l'engagement et suivez vos résultats avec SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "Gestion des réseaux sociaux SocialBee";
...
$_LANG['store']['socialbee']['faq']['a4']['text'] = "Les forfaits d'agence (Pro50, Pro100 et Pro150) ont les mêmes caractéristiques que le forfait Pro. Les principales différences concernent le nombre de profils de réseaux sociaux auxquels vous pouvez vous connecter, le nombre d'espaces de travail et les utilisateurs que vous pouvez ajouter à un espace de travail :";
...
$_LANG['store']['socialbee']['faq']['q4'] = "Quelles sont les différences entre les forfaits d'agence de SocialBee et le forfait Pro classique ?";
...
$_LANG['store']['socialbee']['features']['create']['i5'] = "Organisez les publications dans des dossiers par sujet, en veillant à ce que le plan de votre contenu soit diversifié et bien structuré.";
...
$_LANG['store']['socialbee']['features']['schedule']['i1'] = "Centralisez la planification des publications pour les principales plateformes telles que Facebook®, Instagram, LinkedIn®, TikTok, Pinterest, etc. Tout depuis un emplacement unique !";
...
$_LANG['store']['socialbee']['features']['schedule']['i6'] = "Suspendez, modifiez ou reprogrammez les publications chaque fois que vos forfaits changent. SocialBee vous donne la possibilité d'ajuster votre calendrier de contenu selon vos besoins.";
...
$_LANG['store']['spamexperts']['cartShortDescription'] = "Ajoutez une solution professionnelle de sécurité et d'archivage de messagerie à votre domaine pour protéger et sécuriser vos messages contre les attaques et les logiciels malveillants.";
...
$_LANG['store']['ssl']['competitiveUpgrades']['buyWithTime'] = "Achetez votre certificat SSL chez nous et bénéficiez de la durée restante de votre certificat actuel, jusqu’à 12 mois supplémentaires.";
$_LANG['store']['ssl']['competitiveUpgrades']['checkFailed'] = "Impossible de se connecter à l'API de validation. Veuillez réessayer plus tard ou contacter l'assistance.";
...
$_LANG['store']['ssl']['competitiveUpgrades']['continue'] = "Continuez pour choisir un certificat SSL";
...
$_LANG['store']['ssl']['competitiveUpgrades']['ineligible'] = "Malheureusement, le domaine que vous avez saisi n'est pas éligible à l'offre de mise à niveau compétitive DigiCert. Veuillez vérifier que le domaine est saisi correctement et possède un certificat SSL actif et actuel de l'un des fournisseurs pris en charge.";
...
$_LANG['store']['ssl']['dv']['descriptionContent'] = "<p>Les certificats à validation de domaine (DV) offrent un moyen rapide et économique d’installer un certificat SSL sur votre site. Ils vérifient que vous êtes bien propriétaire du domaine, sans contrôle supplémentaire au niveau de l’organisation.</p> <p>Idéaux pour les sites personnels, les blogues, les médias sociaux ou tout site ne traitant pas d’informations sensibles, ces certificats activent le cadenas dans le navigateur et permettent l’utilisation de HTTPS, assurant aux internautes et à la clientèle que leur confidentialité est protégée.</p>";
...
$_LANG['store']['ssl']['landingPage']['browser']['competitiveUpgrade'] = "Mettez à niveau et obtenez jusqu'à 12 mois supplémentaires gratuits.";
...
$_LANG['store']['ssl']['landingPage']['competitiveUpgrade'] = "Mettez à niveau et obtenez jusqu'à 12 mois supplémentaires gratuits.";
...
$_LANG['store']['ssl']['landingPage']['faq']['a1'] = "Les certificats SSL permettent le chiffrement des données sur Internet et la transmission sécurisée des données d'un serveur Web à un navigateur. Avec un certificat SSL, votre site Web peut utiliser le protocole HTTPS et affichera un cadenas dans les navigateurs Web des utilisateurs finaux pour indiquer que la connexion est sécurisée.";
...
$_LANG['store']['ssl']['landingPage']['faq']['a4'] = "Un certificat SSL générique offre les mêmes fonctionnalités de chiffrement et d'authentification que les autres certificats SSL, mais peut également être appliqué à un nombre illimité de sous-domaines d'un site Web. Un certificat SSL générique prend en charge le domaine racine (example.com) ainsi que ses sous-domaines.";
...
$_LANG['store']['ssl']['landingPage']['padlock'] = "Affiche un cadenas à côté de votre adresse Web dans le navigateur.";
...
$_LANG['store']['ssl']['shared']['browserSupport'] = "Compatibilité des navigateurs";
...
$_LANG['store']['ssl']['shared']['encryption256'] = "Chiffrement 256 bits";
...
$_LANG['store']['ssl']['wildcard']['descriptionContent'] = "<p>Le SSL certificat SSL générique permet de sécuriser un nombre illimité de sous-domaines avec un seul certificat. C'est une excellente solution pour quiconque héberge ou gère plusieurs sites ou pages qui existent sur le même domaine. Le coût ponctuel du certificat couvre les sous-domaines supplémentaires que vous pourriez éventuellement ajouter.</p><p>Contrairement à un certificat SSL standard délivré à un seul nom de domaine complet (FQDN), par exemple www.votredomaine.com qui peut être utilisé uniquement pour sécuriser le domaine exact auquel il a été délivré, un certificat SSL générique est délivré à *.votredomaine.com : l'astérisque représente tous les sous-domaines possibles.</p><p>Le certificat SSL générique est une option disponible pour les certificats de type DV et OV.</p>";
$_LANG['store']['ssl']['wildcard']['descriptionTitle'] = "Qu'est-ce qu'un certificat SSL Wildcard?";
$_LANG['store']['ssl']['wildcard']['tagline'] = "Sécurisez des sous-domaines illimités sur un certificat unique.";
$_LANG['store']['ssl']['wildcard']['title'] = "SSL WildCard";
$_LANG['store']['subOfExisting'] = "Sous-domaine d'un domaine existant";
$_LANG['store']['symantec']['cartShortDescription'] = "Ajoutez un certificat SSL à votre hébergement Web pour assurer aux internautes que votre site est sécurisé et sûr mais aussi renforcer leur confiance.";
$_LANG['store']['symantec']['cartTitle'] = "Protégez votre site avec un certificat SSL";
$_LANG['store']['symantec']['promo']['sidebar']['body'] = "Activez l'icône cadenas et protégez la vie privée de vos utilisateurs";
$_LANG['store']['symantec']['promo']['sidebar']['title'] = "Ajouter un certificat SSL à votre site Web";
...
$_LANG['store']['threesixtymonitoring']['comparison']['multiChannel'] = ":tagOpenMulticanaux:tagClose";
...
$_LANG['store']['threesixtymonitoring']['serverPricing']['cta'] = ":tagOpenVous cherchez des solutions pour la surveillance des sites web ?:tagClose Des mesures telles que la disponibilité, les performances et la santé.";
$_LANG['store']['threesixtymonitoring']['title'] = "360 Monitoring";
$_LANG['store']['threesixtymonitoring']['websiteDiscover']['i1'] = "Surveillez les temps de chargement et la réactivité avec des :tagOpenanalyses courantes:tagClose et des métriques que vous pouvez utiliser.";
$_LANG['store']['threesixtymonitoring']['websiteDiscover']['i2'] = "Optimisez la disponibilité en résolvant les problèmes de site web avant qu'ils ne surviennent grâce aux :tagOpenalertes instantanées.:tagClose";
...
$_LANG['store']['threesixtymonitoring']['websitePricing']['cta'] = ":tagOpenVous souhaitez surveiller vos serveurs ?:tagClose Des mesures telles que l'utilisation du processeur, du réseau, de la mémoire et du disque.";
$_LANG['store']['threesixtymonitoring']['websitePricing']['title'] = "Prix";
$_LANG['store']['websiteBuilder']['adminPreview'] = "Les forfaits Weebly que vous activez seront affichés ici";
$_LANG['store']['websiteBuilder']['ddEditor'] = "Constructeur glisser & déposer";
$_LANG['store']['websiteBuilder']['ddEditorDescription'] = "L'outil de création en glisser-déposer vous permet de créer un site Web professionnel sans aucune compétence technique. Choisissez différents éléments pour ajouter des photos, des cartes ou des vidéos en les faisant glisser et en les déposant simplement à l'endroit souhaité, directement depuis votre navigateurWweb.";
$_LANG['store']['websiteBuilder']['faq']['a1'] = "Oui, le constructeur de site Web vous permet d'inclure la fonctionnalité de blog.";
$_LANG['store']['websiteBuilder']['faq']['a2'] = "Oui, tous les sites Web créés avec l'outil de création de sites Weebly sont optimisés pour les mobiles.";
$_LANG['store']['websiteBuilder']['faq']['a3'] = "Oui, vous pouvez ajouter des photos à votre site, mais la vidéo HD et l'audio sont disponibles uniquement avec les forfaits Pro & Business.";
$_LANG['store']['websiteBuilder']['faq']['a4'] = "Oui, la fonctionnalité de commerce électronique est incluse dans tous les forfaits, mais le nombre de produits que vous pouvez proposer varie.";
$_LANG['store']['websiteBuilder']['faq']['a5'] = "Oui, l'outil de création de site Web Weebly facilite la création de formulaires de contact, de listes de réponse, de sondages, etc.";
...
$_LANG['store']['websiteBuilder']['faq']['a8'] = "Oui, vous pouvez mettre à niveau à tout moment. Connectez-vous simplement à votre compte et choisissez l'option de mise à niveau.";
...
$_LANG['store']['websiteBuilder']['faq']['q6'] = "Comment puis-je référencer mon site sur les moteurs de recherche ?";
$_LANG['store']['websiteBuilder']['faq']['q7'] = "Y a-t-il plusieurs styles à choisir ?";
$_LANG['store']['websiteBuilder']['faq']['q8'] = "Puis-je mettre à niveau ?";
$_LANG['store']['websiteBuilder']['faq']['title'] = "Questions fréquemment posées";
$_LANG['store']['websiteBuilder']['features']['blogging'] = "Blog";
$_LANG['store']['websiteBuilder']['features']['bloggingDescription'] = "Créez un blog incroyable en quelques minutes !";
$_LANG['store']['websiteBuilder']['features']['builder'] = "Constructeur";
$_LANG['store']['websiteBuilder']['features']['builderDescription'] = "Créez le site Web parfait avec de puissants outils de création de sites Web en glisser-déposer !";
...
$_LANG['store']['websiteBuilder']['headline'] = "Créer un site Web n'a jamais été aussi simple !";
$_LANG['store']['websiteBuilder']['introduction'] = "L'outil de création de sites Web en glisser-déposer de Weebly facilite la création d'un site Web puissant et professionnel sans compétence technique. Plus de 40 millions d'entrepreneurs et de petites entreprises ont déjà utilisé Weebly pour créer leur présence en ligne avec un site Web, un blog ou une boutique.";
...
$_LANG['store']['websiteBuilder']['pricing']['features']['abandonedCart'] = "Courriel suite à panier d'achat abandonné";
...
$_LANG['store']['websiteBuilder']['pricing']['features']['pages'] = "Nombre illimité de pages";
...
$_LANG['store']['websiteBuilder']['pricing']['features']['unlimitedProducts'] = "Nombre illimité de produits";
...
$_LANG['store']['websiteBuilder']['tab']['features'] = "Fonctionnalités";
...
$_LANG['store']['websiteBuilder']['upgrade']['loggedInAs'] = "Vous utilisez actuellement le compte pour votre connexion :email";
...
$_LANG['store']['websiteBuilder']['upgrade']['noPlans'] = "Aucun forfait Weebly actif trouvé";
$_LANG['store']['websiteBuilder']['upgrade']['noUpgrade'] = "Il n'y a aucune mise à niveau disponible pour le moment.";
...
$_LANG['store']['websiteBuilder']['upgrade']['requiredDescription'] = "Pour accéder aux fonctionnalités que vous avez demandées, vous devez mettre à niveau votre forfait Weebly Site Builder.";
$_LANG['store']['websiteBuilder']['upgrade']['submitTicket'] = "Contacter l'assistance";
...
$_LANG['store']['websiteBuilder']['upgrade']['to'] = "Mettre à niveau :product pour :amount";
$_LANG['store']['weebly']['cartShortDescription'] = "Ajoutez l'outil de création de sites Web en glisser-déposer de Weebly à votre hébergement pour vous permettre de créer un site Web, une boutique ou un blog impressionnant.";
...
$_LANG['subaccountactivatedesc'] = "Cocher pour configurer comme sous-compte avec accès à l'espace client";
...
$_LANG['subaccountpermstickets'] = "Voir et ouvrir des demandes d'assistance";
...
$_LANG['subscription']['failedpaymentscount'] = "Nombre d’échecs de paiement";
...
$_LANG['subscription']['status'] = "Statut de l'abonnement";
...
$_LANG['suggestedTLDs'] = "TLDs suggérés";
$_LANG['support']['addCcRecipients'] = "Saisir l'adresse courriel";
$_LANG['support']['addEmailExists'] = "Cette adresse :email est déjà en CC.";
...
$_LANG['support']['deleteEmailNotExisting'] = "Cette adresse :email n'est pas en CC.";
...
$_LANG['support']['successDelete'] = "Le destinataire CC :email a été supprimé.";
$_LANG['support']['ticketError'] = "Nous ne pouvons pas traiter votre ticket pour le moment. Veuillez réessayer ultérieurement.";
$_LANG['supportAndUpdatesClickHereToRenew'] = "Cliquez ici pour renouveler";
$_LANG['supportAndUpdatesExpired'] = "L'assistance et les mises à jour ont expiré.";
$_LANG['supportAndUpdatesExpiredLicense'] = "L'assistance et les mises à jour de cette licence ont expiré.";
$_LANG['supportAndUpdatesRenewalRequired'] = "L'assistance et les mises à jour doivent être renouvelées afin d'accéder à ce téléchargement.";
...
$_LANG['supportticketinvalid'] = "Une erreur s'est produite. Cette demande d'assistance n'a pu être trouvée.";
$_LANG['supportticketsallowedextensions'] = "Extensions autorisées";
$_LANG['supportticketschoosedepartment'] = "Sélectionnez le service";
$_LANG['supportticketsclient'] = "Cliente";
$_LANG['supportticketsclientemail'] = "Courriel";
$_LANG['supportticketsclientname'] = "Nom";
$_LANG['supportticketsclose'] = "Fermer";
...
$_LANG['supportticketserrornoemail'] = "Vous n'avez pas saisi votre adresse courriel.";
$_LANG['supportticketserrornomessage'] = "Vous n'avez pas saisi de message.";
$_LANG['supportticketserrornoname'] = "Vous n'avez pas saisi votre nom.";
$_LANG['supportticketserrornosubject'] = "Vous n'avez pas indiqué d'objet.";
$_LANG['supportticketsfilenotallowed'] = "Le type de fichier que vous essayez de téléverser est interdit.";
$_LANG['supportticketsheader'] = "Si vous ne trouvez pas la réponse dans la base de connaissances, n'hésitez pas à nous envoyer un message à l'aide du formulaire ci-dessous.";
$_LANG['supportticketsintro'] = "Sur cette page, vous pouvez envoyer vos demandes et faire leur suivi…";
$_LANG['supportticketsnoneopen'] = "Il n'y a actuellement aucune demande d'assistance ouverte.";
$_LANG['supportticketsnotfound'] = "Demande introuvable";
$_LANG['supportticketsopentickets'] = "Demandes d'assistance en attente";
$_LANG['supportticketspagetitle'] = "Demande d'assistance";
...
$_LANG['supportticketsstatus'] = "Statut";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Format de numéro de TVA non valide pour :countryName.";
...
$_LANG['telesigninvalidnumber'] = "Numéro de téléphone non valide";
...
$_LANG['twofabackupcodeexpl'] = "Écrivez-le sur un papier et conservez-le en sécurité. Nous vous recommandons de l'enregistrer à l'aide d'un gestionnaire de mots de passe.";
$_LANG['twofabackupcodeintro'] = "Votre code de code de récupération est requis pour accéder à votre compte si l'authentification à deux facteurs n'est pas possible.";
$_LANG['twofabackupcodeis'] = "Votre code de récupération est";
$_LANG['twofabackupcodelogin'] = "Saisissez votre code de récupération ci-dessous pour vous connecter";
$_LANG['twofabackupcodereset'] = "Connexion avec votre code de récupération réussie. <br />Le code de récupération est valide une seule fois : il sera maintenant réinitialisé.";
$_LANG['twofacantaccess2ndfactor'] = "Vous ne pouvez pas accéder à votre périphérique pour l'authentification avec deuxième facteur ?";
$_LANG['twofaconfirmpw'] = "Saisissez votre mot de passe";
...
$_LANG['twoipinstruct'] = "Scannez le code QR ci-dessous à l'aide d'une application d'authentification comme %s ou %s. Vous rencontrez des difficultés pour scanner le code ? Saisissez-le manuellement :";
...
$_LANG['unableToLoadShoppingCart'] = "Impossible de charger votre panier. Veuillez contacter l'assistance.";
$_LANG['unabletolookup'] = "Impossible de rechercher ce mot-clé";
$_LANG['unavailable'] = "Non disponible";
...
$_LANG['upgradeNotPossible'] = "La mise à niveau de ce produit est impossible. Si vous pensez avoir accédé à cette page par erreur, veuillez contacter notre service d'assistance. Sinon, retournez en arrière et vérifiez votre sélection.";
$_LANG['upgradeSameProductMustExtendCycle'] = "Pour modifier votre cycle de facturation, veuillez choisir un cycle supérieur à votre cycle de facturation actuel.";
$_LANG['upgradeService']['chooseNew'] = "Choisissez un nouveau produit / forfait";
...
$_LANG['upgradechoosepackage'] = "Choisissez le nouveau forfait ou le produit que vous voulez dans les options ci-dessous.";
...
$_LANG['upgradedowngradepackage'] = "Augmenter/Réduire votre forfait d'hébergement";
...
$_LANG['upgradeproductlogic'] = "Le coût de la mise à niveau est calculé à partir d'un crédit sur la portion inutilisée du forfait actuel et le coût du nouveau forfait pour la même période.";
...
$_LANG['usageStatsDiskLimitNear'] = "Vous atteindrez bientôt la limite de l'espace disque.";
...
$_LANG['userManagement']['alreadyInvited'] = "Il y a déjà une invitation active correspondant à cette adresse courriel.";
$_LANG['userManagement']['alreadyLinked'] = "L'adresse courriel saisie est déjà un utilisateur de ce compte.";
...
$_LANG['userManagement']['emailAddress'] = "Adresse courriel";
$_LANG['userManagement']['inviteCancelled'] = "L'invitation a bien été annulée !";
$_LANG['userManagement']['inviteEmail'] = "Courriel d'invitation";
$_LANG['userManagement']['inviteNewUser'] = "Inviter un nouvel utilisateur";
$_LANG['userManagement']['inviteNewUserDescription'] = "Cette option vous permet d'inviter un utilisateur à accéder à votre compte. Si l'invité dispose déjà d'un compte utilisateur, il pourra accéder à votre compte en utilisant ses identifiants de connexion existants. Si l'utilisateur n'a pas encore de compte utilisateur, il pourra en créer un.";
$_LANG['userManagement']['inviteResendSuccess'] = "L'invitation a bien été renvoyée !";
$_LANG['userManagement']['inviteSent'] = "Invitation envoyée";
$_LANG['userManagement']['inviteSentSuccess'] = "L'invitation a bien été envoyée !";
...
$_LANG['userManagement']['permissionsUpdateSuccess'] = "Les autorisations ont bien été mises à jour !";
...
$_LANG['userManagement']['userDescriptor'] = "Adresse courriel / Dernière connexion";
...
$_LANG['userProfile']['changeEmail'] = "Changer l'adresse courriel";
...
$_LANG['validation']['regex'] = "Le format :attribute n'est pas valide.";
...
$_LANG['validation']['url'] = "Le format :attribute n'est pas valide.";
$_LANG['varilogixfraudcall_callnow'] = "Appeler maintenant!";
$_LANG['varilogixfraudcall_description'] = "En guise de mesure de prévention des fraudes, nous allons maintenant appeler le numéro de téléphone que vous avez enregistré pour votre compte. Nous vous demanderons de saisir le code donné ci-dessus. Veuillez noter ce code. Lorsque vous êtes prêt·e pour recevoir l'appel, cliquez sur le bouton ci-dessous.";
$_LANG['varilogixfraudcall_error'] = "Une erreur est survenue. L'appel pour vérifier votre commande n'a pu être placé. Contactez notre service d'assistance afin de compléter votre commande.";
$_LANG['varilogixfraudcall_fail'] = "L'appel pour vérifier votre commande a échoué. Votre numéro de téléphone n'a peut-être été composé correctement ou est sur la liste noire. Contactez notre service d'assistance dès que possible pour compléter votre commande.";
...
$_LANG['wptk']['installationSuccess'] = "<strong>Bravo !</strong> <a href=\"\" target=\"_blank\" id=\"newWordPressLink\">Découvrez</a> votre nouvelle installation WordPress® ou ouvrez votre <a href=\"\" target=\"_blank\" id=\"newWordPressAdminLink\">Espace administration</a>.";
...
$_LANG['yourrecenttickets'] = "Vos derniers tickets";
