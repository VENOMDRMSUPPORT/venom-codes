...
$_LANG['addToCartButton'] = "Добавить в корзину";
$_LANG['addToGetFreeDomain'] = "Добавьте, чтобы получить бесплатный домен";
...
$_LANG['applyPromoCode'] = "Применить";
...
$_LANG['billing']['creditnote'] = "Кредитная нота";
$_LANG['billing']['debitnote'] = "Дебетовая нота";
$_LANG['billing']['issuedate'] = "Дата выпуска";
$_LANG['billing']['issuedby'] = "Выпущено";
$_LANG['billing']['issuedto'] = "Кому выдано";
$_LANG['billing']['ledger']['date'] = "Дата";
$_LANG['billing']['ledger']['reference'] = "Справочная информация";
$_LANG['billing']['ledger']['title'] = "бухгалтерская книга";
$_LANG['billing']['ledger']['type'] = "тип";
$_LANG['billing']['type']['affiliatepayout'] = "Выплата партнерской программе";
$_LANG['billing']['type']['clientaccountcredit'] = "Кредит на счет клиента";
$_LANG['billing']['type']['clientaccountdebit'] = "Дебет клиентского счета";
$_LANG['billing']['type']['creditnoteadjustment'] = "Корректировка кредитных нот";
$_LANG['billing']['type']['invoiceadjustment'] = "Корректировка счета";
$_LANG['billing']['type']['payment'] = "Платеж";
$_LANG['billing']['type']['refund'] = "Возврат";
$_LANG['billing']['type']['refundtocredit'] = "Возврат средств на счет клиента";
$_LANG['billingAddress'] = "Платежный адрес";
$_LANG['billingOverview'] = "Просмотр биллинга";
$_LANG['billingdetails'] = "Платежные данные";
$_LANG['billingnotes']['creditnote']['items'] = "Предметы кредитных нот";
$_LANG['billingnotes']['debitnote']['items'] = "Статьи дебетовых банкнот";
...
$_LANG['cartItemType']['addon'] = "Дополнения";
$_LANG['cartItemType']['addons'] = "Дополнения";
$_LANG['cartItemType']['bundle'] = "Пакет";
$_LANG['cartItemType']['bundles'] = "пакеты";
$_LANG['cartItemType']['domain'] = "Домен";
$_LANG['cartItemType']['domainRegistration'] = "Регистрация домена";
$_LANG['cartItemType']['domainRenewal'] = "Продление домена";
$_LANG['cartItemType']['domainRenewals'] = "Продление домена";
$_LANG['cartItemType']['domainTransfer'] = "Перенос домена";
$_LANG['cartItemType']['domainTransfers'] = "Перенос доменов";
$_LANG['cartItemType']['domains'] = "Домены";
$_LANG['cartItemType']['product'] = "Изделие";
$_LANG['cartItemType']['products'] = "продукты";
$_LANG['cartItemsSelected'] = "Вы выбрали :count и готовы к покупке.";
...
$_LANG['cartbrowse'] = "Обзор продуктов и услуг";
...
$_LANG['choosePackages'] = "Выберите из целого ряда пакетов";
...
$_LANG['codeApplied'] = "Применен промокод";
$_LANG['completeorder'] = "Завершить заказ";
$_LANG['configModalTitle'] = "Конфигурация";
...
$_LANG['confirmItemDeletion'] = "Подтвердить удаление";
...
$_LANG['cycleRenewal'] = ":cycle Продление";
$_LANG['daily'] = "Дневной";
$_LANG['dateTime']['AM'] = "Я";
...
$_LANG['designedToFitAnyBudget'] = "Разработан для любого бюджета";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Поиск по ключевому слову, описанию или домену.&#10;Например: &quot;Веселые деловые мероприятия &quot;, &quot;Комплексный сервис финансового планирования для профессионалов&quot;или &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Введите краткое описание или точный домен.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "Система не смогла найти никаких предложений.";
$_LANG['domainSearch']['exactMatch'] = "Точное совпадение";
$_LANG['domainSearch']['maxLength'] = "Максимальная длина";
$_LANG['domainSearch']['notAvailable'] = "Недоступен";
$_LANG['domainSearch']['safeSearch'] = "Безопасный поиск";
$_LANG['domainSearch']['tlds'] = "Включить TLD";
$_LANG['domainSearch']['topAiSuggestion'] = "Лучшее предложение по искусственному интеллекту";
$_LANG['domainSearch']['topSuggestion'] = "Лучшее предложение";
...
$_LANG['due'] = "за";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "Вы должны принять условия обслуживания, отметив :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute должен быть массивом.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute должна быть действительной датой.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute должен быть действительным адресом электронной почты.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "В системе произошла внутренняя ошибка. Повторите попытку позже.";
$_LANG['dynamicServiceFields']['validation']['in'] = "Выбранный вариант для :attribute недействителен.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute должно быть целым числом.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute не может содержать более :max символов.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute должен использовать один из следующих типов файлов: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute должен содержать не менее :min символов.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute должно быть числом.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute должно быть действительным регулярным выражением.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute обязателен.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute должен быть действительным URL-адресом, включающим протокол («http://» или «https://»).";
$_LANG['edit'] = "Изменить";
...
$_LANG['encryption_failed'] = "Ошибка шифрования: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Попробуйте позже.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "домашняя страница";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Вы отправили слишком много запросов.";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "Упс!";
...
$_LANG['estimateTaxes'] = "Налоги";
$_LANG['every'] = "Каждый";
$_LANG['exampledomain'] = "например, example.com";
$_LANG['excludeTLDs'] = "Не включает некоторые зоны и недавно продленые домены";
...
$_LANG['extendYourDomainBy1Year'] = "Продлите свой домен на 1 год*";
...
$_LANG['findDomains'] = "Найдите домены";
...
$_LANG['forTheFirstYear'] = "за первый год";
...
$_LANG['freeDomainHostingPromo'] = "Получите бесплатный домен при покупке хостинга.";
$_LANG['from'] = "От";
...
$_LANG['hideSearchControls'] = "Скрыть элементы управления поиском";
...
$_LANG['inStock'] = "В наличии: :amount";
$_LANG['incApplicableTaxes'] = "включая применимые налоги";
$_LANG['includeTLDs'] = "Включить TLD";
$_LANG['included'] = "Включено";
...
$_LANG['invalidCode'] = "Неверный промокод";
$_LANG['invalid_input'] = "Неверный ввод: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "Неверный идентификатор заявки или идентификатор ответа.";
...
$_LANG['item'] = "Характеристика";
$_LANG['items'] = "Элементы";
...
$_LANG['language'] = "Язык";
$_LANG['lastChance'] = "Последний шанс";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Войти";
...
$_LANG['maxLength'] = "Максимальная длина";
...
$_LANG['navMarketConnectService']['dynamic'] = "Динамические сервисы";
...
$_LANG['noDomainsFound'] = "Домены не найдены";
...
$_LANG['orderForm']['additionalInformation'] = "Дополнительная информация";
...
$_LANG['orderForm']['findNewDomainAi'] = "Найдите домен с помощью рекомендаций на основе искусственного интеллекта.";
...
$_LANG['ordererrortldsnotconfigured'] = "В настоящее время в продаже нет доменных расширений. Для получения помощи свяжитесь с нами.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "Ежегодный";
$_LANG['orderpaymenttermadjectivebiennially'] = "Двухгодичный";
$_LANG['orderpaymenttermadjectivefree'] = "Бесплатно";
$_LANG['orderpaymenttermadjectivemonthly'] = "ежемесячно";
$_LANG['orderpaymenttermadjectiveonetime'] = "однократно";
$_LANG['orderpaymenttermadjectivequarterly'] = "ежеквартально";
$_LANG['orderpaymenttermadjectivesemiannually'] = "Полугодовой";
$_LANG['orderpaymenttermadjectivetriennially'] = "Триеннале";
...
$_LANG['orderselectterm'] = "Выберите термин";
...
$_LANG['page'] = "Страница";
$_LANG['pageof'] = "из";
$_LANG['passwordtips'] = "<strong>Советы по безопасному паролю</strong><br />Используйте как прописные, так и строчные буквы.<br />Включите хотя бы один символ (например, <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>или <code>&amp;</code>).<br />Не используйте словарные слова.<br />Пароли могут содержать до :maximum_length символов.";
...
$_LANG['premium'] = "премия";
$_LANG['presalescontactdescription'] = "Вы можете указать здесь предпродажные вопросы и замечания";
$_LANG['previous'] = "Назад";
$_LANG['previouspage'] = "Назад";
$_LANG['price'] = "цена";
$_LANG['priceFor'] = "Цена за :term";
$_LANG['priceForThisTerm'] = "Цена за этот срок";
$_LANG['priceStandard'] = "Обновляется каждый год по цене :renewalPriceплюс налоги.";
$_LANG['priceWithDiscount'] = ":registrationPrice в течение первого года, затем :renewalPrice ежегодно.";
...
$_LANG['pwlengthmax'] = "Пароли не могут содержать более :max символов.";
...
$_LANG['pwstrengthfail'] = "Этот пароль недостаточно надежный. Введите более сложный пароль.";
...
$_LANG['recommendedTLDs'] = "Рекомендуемые TLD";
...
$_LANG['renewPrice'] = "Продлить цену";
...
$_LANG['requiredFields'] = "Обязательные поля отмечены звездочкой (*)";
...
$_LANG['safeSearch'] = "Безопасный поиск";
$_LANG['sale'] = "Продажа";
$_LANG['salePrice'] = "цена продажи";
$_LANG['salesTaxes'] = "Налоги с продаж";
$_LANG['search'] = "Поиск";
$_LANG['searchOurKnowledgebase'] = "Поищите в нашей базе знаний";
$_LANG['searchResults'] = "Результаты поиска";
...
$_LANG['selectCountry'] = "Выберите страну";
$_LANG['selectDomain'] = "Выберите домен";
$_LANG['selectDomainForHosting'] = "К какому домену вы хотите прикрепить этот пакет виртуального хостинга?";
$_LANG['selectDomainsForSsl'] = "К какому домену (доменам) вы хотите применить базовый протокол SSL? Можно выбрать несколько.";
$_LANG['selectState'] = "Выберите штат";
...
$_LANG['service_unavailable'] = "Услуга недоступна: %s";
$_LANG['servicesRenew'] = "Продлить";
$_LANG['setupFee'] = ":amount Стоимость установки";
$_LANG['setupMandate'] = "Настроить мандат на оплату";
$_LANG['sharedHosting'] = "Виртуальный хостинг";
$_LANG['shopNow'] = "Покупайте сейчас";
$_LANG['shortcuts'] = "Ярлыки";
$_LANG['show'] = "Показать";
$_LANG['showMenu'] = "Показать меню";
$_LANG['showSearchControls'] = "Показать элементы управления поиском";
...
$_LANG['store']['dynamic']['title'] = "Динамические сервисы";
...
$_LANG['store']['error']['serviceUnavailable'] = "В данный момент невозможно обработать ваш запрос. Это может быть связано с тайм-аутом или временной проблемой с обслуживанием. Пожалуйста, попробуйте еще раз.";
$_LANG['store']['error']['validationFailed'] = "Пожалуйста, проверьте и исправьте указанные ниже ошибки.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo предоставляет вам проверенный и управляемый процесс SEO без необходимости быть экспертом. <br> marketgoo доступен по цене и предоставляет исчерпывающие SEO-отчеты, планы и рекомендации в интуитивно понятном интерфейсе.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Чем Marketgoo отличается от других SEO-продуктов?";
$_LANG['store']['marketgoo']['faqs']['title'] = "Часто задаваемые вопросы и поддержка";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "Отправка в поисковую систему";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Совместимость с конструктором веб-сайтов";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Ежемесячный отчет о проделанной работе";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Аналитика трафика";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Загрузите отчет по SEO в формате PDF <a href='https://mktgoo.co/seo-report-score2'>(см. пример)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "Функции на базе искусственного интеллекта: автоматическая генерация заголовка и метаописания";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Сканированные страницы";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Отслеживание конкурентов";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Отслеживание и оптимизация ключевых слов";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Обновленный отчет и план";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Индивидуальный план SEO";
$_LANG['store']['marketgoo']['features']['1'] = "Получите свой план SEO";
$_LANG['store']['marketgoo']['features']['2'] = "Следуйте пошаговым инструкциям";
$_LANG['store']['marketgoo']['features']['3'] = "Отслеживайте прогресс с помощью ежемесячного отчета";
$_LANG['store']['marketgoo']['features']['4'] = "Отслеживайте и контролируйте конкурентов";
$_LANG['store']['marketgoo']['features']['5'] = "Индивидуальная оптимизация страницы";
$_LANG['store']['marketgoo']['features']['6'] = "Простое исследование и мониторинг ключевых слов";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Зарегистрируйтесь и получите мгновенный отчет и план SEO. Узнайте, что еще можно улучшить, и получите рекомендации, адаптированные к вашему сайту.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Инструкции написаны для пользователей, не разбирающихся в технологиях, и содержат примеры и пояснения к каждой рекомендации.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Каждый месяц получайте электронное письмо с информацией о ходе SEO вашего сайта и загружайте его в формате PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Следите за конкурентами, чтобы узнать, что они делают для привлечения трафика и насколько ваши показатели соотносятся с их показателями. Они никогда не заметят, что вы смотрите!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo поможет вам оптимизировать каждую отдельную страницу вашего сайта, сопоставив ее с одним из выбранных вами ключевых слов и убедившись в правильности частоты и местоположения.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "Ключевые слова могут оказаться непосильными, если вы не знакомы с SEO. Marketgoo рекомендует ключевые слова, а также позволяет искать и вводить те, которые вы хотите оптимизировать.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Работает со всеми конструкторами сайтов";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Дата сравнения: 19 июня 20 25:tagBreak*Общая производительность сети согласно исследованию AV-Test. Вы можете прочитать :tagOpenполный отчет:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Оповещения об утечке учетных данных";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Сканирование загрузок на наличие вредоносных программ";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Не раскрывается";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "Трекер и блокировщик рекламы";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN не ограничивает скорость соединения. Наслаждайтесь нашим полноскоростным VPN-соединением без ограничений.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN совместим со всеми популярными платформами, включая Windows, macOS, Linux, Android и iOS. Кроме того, вы можете защитить до 10 устройств, включая маршрутизатор.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "Нет ограничений по пропускной способности VPN  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Просматривайте веб-страницы, играйте и работайте в конфиденциальном и безопасном соединении";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Оставайтесь на связи даже в общественных местах Wi-Fi";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Уменьшите онлайн-отслеживание, защитив свой IP-адрес";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Смотрите домашний контент во время путешествий за границу";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Используйте NordVPN для шифрования ваших действий в Интернете, чтобы обеспечить дополнительный уровень защиты в любое время и в любом месте.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN защищает ваше соединение с помощью шифрования нового поколения, поэтому вы можете без проблем входить в свои счета, совершать банковские переводы и делать покупки в Интернете. Даже в незащищенных сетях.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN может похвастаться широким набором функций для защиты от киберугроз. В дополнение к Threat Protection Pro™ есть автоматическая функция Kill Switch, которая блокирует ваше подключение к Интернету в случае разрыва VPN-соединения, обеспечивая безопасность ваших данных. Затемненные серверы помогут вам в тех случаях, когда требуется высокий уровень онлайн-безопасности из-за государственной цензуры и строгих правил использования Интернета.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Повысьте свою онлайн-безопасность с помощью VPN";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Расширенная безопасность";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Каждый раз, когда вы загружаете файл, Threat Protection Pro™ проверяет его на наличие вредоносных программ.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ блокирует навязчивую рекламу и веб-трекеры, а также автоматически сканирует URL-адреса и блокирует вредоносные.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Threat Protection Pro™ защищает ваши устройства и вашу конфиденциальность. Блокируя трекеры, вы можете избежать слежки в Интернете.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "Функция NordVPN :tagOpenThreat Protection Pro™:tagClose кардинально меняет правила игры и обеспечивает еще больше преимуществ в сфере безопасности и лучшей защиты одним дополнительным щелчком мыши.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Больше, чем просто VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Даже если вам нечего скрывать, вам, вероятно, не нравится идея, что за вами наблюдают и отслеживают. Основная причина, по которой пользователи Интернета выбирают VPN-сервисы, — это конфиденциальность в Интернете и общая безопасность.:tagBreakВот конкретные причины ПОЧЕМУ?";
...
$_LANG['store']['nordvpn']['features']['use']['tagline3'] = "Не позволяйте третьим сторонам, например поставщикам интернет-услуг, видеть и отслеживать вашу повседневную онлайн-активность.";
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Избегайте региональных и политических ограничений на таких платформах, как Facebook, X (Twitter) и WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Онлайн-реклама обычно раздражает и отвлекает. Они загромождают большую часть веб-сайтов, снижают скорость соединения и могут быть вредоносными.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Технологии умного дома, в частности небезопасные устройства Интернета вещей, могут создавать уязвимости в домашних сетях.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Безопасное общедоступное подключение к Wi-Fi";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Более безопасный просмотр";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Неограниченный доступ к социальным сетям";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Защита от вредоносной рекламы";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Охрана умного дома";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Защитите свой IP-адрес:tagBreak• Блокируйте вредоносные программы, трекеры и рекламу:tagBreak• Подключите до 10 устройств";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Ежедневное сканирование баз данных SMART";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Ежедневное сканирование файлов SMART";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Создавайте свежий контент, повышайте вовлеченность и отслеживайте результаты с помощью SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "Управление социальными сетями SocialBee";
...
$_LANG['success'] = "Успех";
$_LANG['suggestedTLDs'] = "Предлагаемые TLD";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Неверный формат номера НДС для :countryName.";
...
$_LANG['updateProductQuantity'] = "Обновить";
$_LANG['updateTotals'] = "Обновить сумму";
