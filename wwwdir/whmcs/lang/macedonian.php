...
$_LANG['addToCartButton'] = "Додади во кошничка";
$_LANG['addToGetFreeDomain'] = "Додај за да добиете бесплатен домен";
...
$_LANG['applyPromoCode'] = "Аплицирај";
...
$_LANG['billing']['creditnote'] = "Кредитна белешка";
$_LANG['billing']['debitnote'] = "Дебитна белешка";
$_LANG['billing']['issuedate'] = "Датум на издавање";
$_LANG['billing']['issuedby'] = "Издадено од";
$_LANG['billing']['issuedto'] = "Издадено на";
$_LANG['billing']['ledger']['date'] = "Дата";
$_LANG['billing']['ledger']['reference'] = "Референца";
$_LANG['billing']['ledger']['title'] = "Леџер";
$_LANG['billing']['ledger']['type'] = "Тип";
$_LANG['billing']['type']['affiliatepayout'] = "Придружна исплата";
$_LANG['billing']['type']['clientaccountcredit'] = "Кредит на клиентска сметка";
$_LANG['billing']['type']['clientaccountdebit'] = "Дебитна сметка на клиентот";
$_LANG['billing']['type']['creditnoteadjustment'] = "Прилагодување на кредитната белешка";
$_LANG['billing']['type']['invoiceadjustment'] = "Прилагодување на фактурата";
$_LANG['billing']['type']['payment'] = "Плаќање";
$_LANG['billing']['type']['refund'] = "Враќање на парите";
$_LANG['billing']['type']['refundtocredit'] = "Враќање на сметката на клиентот";
$_LANG['billingAddress'] = "Платежна адреса";
$_LANG['billingOverview'] = "Финансиски преглед";
$_LANG['billingdetails'] = "Детали за сметки";
$_LANG['billingnotes']['creditnote']['items'] = "Предмети за кредитна белешка";
$_LANG['billingnotes']['debitnote']['items'] = "Предмети за дебитна белешка";
...
$_LANG['cartItemType']['addon'] = "Дополнителни опции";
$_LANG['cartItemType']['addons'] = "Дополнителни опции";
$_LANG['cartItemType']['bundle'] = "Пакет";
$_LANG['cartItemType']['bundles'] = "Снопови";
$_LANG['cartItemType']['domain'] = "Домен";
$_LANG['cartItemType']['domainRegistration'] = "Регистрација на домен";
$_LANG['cartItemType']['domainRenewal'] = "Обнова на домен";
$_LANG['cartItemType']['domainRenewals'] = "Обнова на домени";
$_LANG['cartItemType']['domainTransfer'] = "ТРАНСФЕР НА ДОМЕНИ";
$_LANG['cartItemType']['domainTransfers'] = "Трансфер на домени";
$_LANG['cartItemType']['domains'] = "Домени";
$_LANG['cartItemType']['product'] = "Производ";
$_LANG['cartItemType']['products'] = "Производи";
$_LANG['cartItemsSelected'] = "Имате избран :count и подготвен за купување.";
...
$_LANG['cartbrowse'] = "Прелистајте производи и услуги";
...
$_LANG['choosePackages'] = "Изберете од низа пакети";
...
$_LANG['codeApplied'] = "Применет промотивен код";
$_LANG['completeorder'] = "ПОТВРДЕТЕ ЈА НАРАЧКАТА";
$_LANG['configModalTitle'] = "Конфигурација";
...
$_LANG['confirmItemDeletion'] = "Потврдете го бришењето";
...
$_LANG['cycleRenewal'] = ":cycle Обнова";
$_LANG['daily'] = "Дневен";
...
$_LANG['designedToFitAnyBudget'] = "Дизајниран да одговара на секој буџет";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Пребарувајте по клучен збор, опис или домен.&#10;На пример: &quot;Забавни деловни настани &quot;, &quot;Сеопфатна услуга за финансиско планирање за професионалци&quot;, или &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Внесете краток опис или точен домен.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "Системот не можеше да најде никакви предлози.";
$_LANG['domainSearch']['exactMatch'] = "Точен натпревар";
$_LANG['domainSearch']['maxLength'] = "Максимална должина";
$_LANG['domainSearch']['notAvailable'] = "Недостапен";
$_LANG['domainSearch']['safeSearch'] = "Безбедно пребарување";
$_LANG['domainSearch']['tlds'] = "Вклучете TLD";
$_LANG['domainSearch']['topAiSuggestion'] = "Врвен предлог за АИ";
$_LANG['domainSearch']['topSuggestion'] = "Топ предлог";
...
$_LANG['due'] = "Доспевање";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "Мора да ги прифатите условите за користење со проверка на :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute мора да биде низа.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute мора да биде валиден датум.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute мора да биде валидна адреса за е-пошта.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "Системот наиде на внатрешна грешка. Обидете се повторно подоцна.";
$_LANG['dynamicServiceFields']['validation']['in'] = "Избраната опција за :attribute е неважечка.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute мора да биде цел број.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute не смее да содржи повеќе од :max знаци.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute мора да користи еден од следниве типови на датотеки: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute мора да содржи најмалку :min знаци.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute мора да биде број.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute мора да биде валиден регуларен израз.";
$_LANG['dynamicServiceFields']['validation']['required'] = "Потребно е :attribute .";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute мора да биде валидна URL која го вклучува протоколот ('http: //' или 'https: //').";
$_LANG['edit'] = "Промени";
$_LANG['email'] = "E-пошта";
...
$_LANG['encryption_failed'] = "Шифрирањето не успеа: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Обидете се повторно подоцна.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Почетната страница";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Испративте премногу барања.";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "Грешка!";
...
$_LANG['estimateTaxes'] = "Одданочување";
$_LANG['every'] = "за";
$_LANG['exampledomain'] = "пример: vasiotdomen.mk";
$_LANG['excludeTLDs'] = "Исклучува одредени TLD и неодамна обновени домени";
...
$_LANG['extendYourDomainBy1Year'] = "Проширете го вашиот домен за 1 година*";
...
$_LANG['findDomains'] = "Најди домени";
...
$_LANG['forTheFirstYear'] = "за првата година";
...
$_LANG['freeDomainHostingPromo'] = "Добијте бесплатен домен кога купувате хостинг.";
$_LANG['from'] = "Од";
...
$_LANG['hideSearchControls'] = "Сокриј контроли за пребарување";
...
$_LANG['inStock'] = "На залиха: :amount";
$_LANG['incApplicableTaxes'] = "вклучително применливи даноци";
$_LANG['includeTLDs'] = "Вклучете TLD";
$_LANG['included'] = "Вклучено";
...
$_LANG['invalidCode'] = "Невалиден промотивен код";
$_LANG['invalid_input'] = "Невалиден влез: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "Невалиден идентификатор на билет или идентификатор на одговор.";
...
$_LANG['lastChance'] = "Последна шанса";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Пријавете се";
...
$_LANG['maxLength'] = "Максимална должина";
...
$_LANG['navMarketConnectService']['dynamic'] = "Динамички услуги";
...
$_LANG['noDomainsFound'] = "Не се пронајдени домени";
...
$_LANG['orderForm']['additionalInformation'] = "Останати информации";
...
$_LANG['orderForm']['findNewDomainAi'] = "Пребарајте домен со предлози што се напојуваат со вештачка интелигенција.";
...
$_LANG['ordererrortldsnotconfigured'] = "Во моментов не се достапни за продажба екстензии на домен. За помош, контактирајте не.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "Годишен";
$_LANG['orderpaymenttermadjectivebiennially'] = "Биенале";
$_LANG['orderpaymenttermadjectivefree'] = "Бесплатно";
$_LANG['orderpaymenttermadjectivemonthly'] = "Месечно";
$_LANG['orderpaymenttermadjectiveonetime'] = "Еднократно";
$_LANG['orderpaymenttermadjectivequarterly'] = "Квартално";
$_LANG['orderpaymenttermadjectivesemiannually'] = "Полугодишно";
$_LANG['orderpaymenttermadjectivetriennially'] = "Триенале";
...
$_LANG['orderselectterm'] = "Изберете термин";
...
$_LANG['page'] = "Страна";
$_LANG['pageof'] = "од";
$_LANG['passwordtips'] = "<strong>Совети за безбедна лозинка</strong><br />Користете и големи и мали знаци.<br />Вклучете барем еден симбол (на пример, <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>, или <code>&amp;</code>).<br />Не користете зборови од речникот.<br />Лозинките можат да содржат до :maximum_length знаци.";
...
$_LANG['premium'] = "Премиум";
$_LANG['presalescontactdescription'] = "Поставете прашања пред да извршите закуп на услугите.";
$_LANG['previous'] = "Претходна";
$_LANG['previouspage'] = "Претходна страна";
$_LANG['price'] = "цена";
$_LANG['priceFor'] = "Цена за :term";
$_LANG['priceForThisTerm'] = "Цена за овој термин";
$_LANG['priceStandard'] = "Се обновува секоја година на :renewalPrice, плус данок.";
$_LANG['priceWithDiscount'] = ":registrationPrice за првата година, потоа :renewalPrice годишно.";
...
$_LANG['pwlengthmax'] = "Лозинките не можат да содржат повеќе од :max знаци.";
...
$_LANG['pwstrengthfail'] = "Оваа лозинка не е доволно силна. Внесете посложена лозинка.";
...
$_LANG['recommendedTLDs'] = "Препорачани TLD";
...
$_LANG['renewPrice'] = "Обновете ја цената";
...
$_LANG['requiredFields'] = "Задолжителните полиња се означени со *";
...
$_LANG['safeSearch'] = "Безбедно пребарување";
$_LANG['sale'] = "Продажба";
$_LANG['salePrice'] = "продажна цена";
$_LANG['salesTaxes'] = "Даноци на продажба";
$_LANG['search'] = "Барај";
$_LANG['searchOurKnowledgebase'] = "Пребарајте ја нашата база на знаење";
$_LANG['searchResults'] = "Резултати од пребарувањето";
...
$_LANG['selectCountry'] = "Избери држава";
$_LANG['selectDomain'] = "Изберете домен";
$_LANG['selectDomainForHosting'] = "На кој домен би сакале да го прикачите овој споделен хостинг пакет?";
$_LANG['selectDomainsForSsl'] = "На кој домен (и) би сакале да го примените основниот SSL? Можете да изберете повеќе.";
$_LANG['selectState'] = "Изберете држава";
...
$_LANG['store']['dynamic']['title'] = "Динамички услуги";
...
$_LANG['store']['error']['serviceUnavailable'] = "Во моментов не можам да го обработиме вашето барање. Ова може да се должи на временски прекин или проблем со привремена услуга. Ве молиме обидете се повторно.";
$_LANG['store']['error']['validationFailed'] = "Ве молиме проверете и поправете ги грешките подолу.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo ви обезбедува докажан, воден процес на оптимизација без да бара од вас да бидете експерт. <br> marketgoo е прифатлива и обезбедува сеопфатни извештаи за оптимизација, планови и препораки, сите во интуитивен интерфејс.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Што го прави Marketgoo различен од другите производи за оптимизација?";
...
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Компатибилност со градител на";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Месечен извештај за напредокот";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Сообраќајна аналитика";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Преземете го извештајот за оптимизација како PDF <a href='https://mktgoo.co/seo-report-score2'>(види пример)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "Карактеристики напојувани со вештачка интелигенција: Автоматско генерирање на наслов и";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Скенирани страници";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Следење на конкурентите";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Следење и оптимизација на клучни зборови";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Ажуриран извештај и план";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Прилагоден план за оптимизација";
$_LANG['store']['marketgoo']['features']['1'] = "Добијте го вашиот план за оптимизација";
$_LANG['store']['marketgoo']['features']['2'] = "Следете чекор-по-чекор инструкции";
$_LANG['store']['marketgoo']['features']['3'] = "Следете го напредокот со месечен извештај";
$_LANG['store']['marketgoo']['features']['4'] = "Следете ги и следете ги натпреварувачите";
$_LANG['store']['marketgoo']['features']['5'] = "Индивидуална оптимизација на страницата";
$_LANG['store']['marketgoo']['features']['6'] = "Лесно истражување и следење на клучни зборови";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Пријавете се и добијте го вашиот инстант извештај и план за оптимизација. Погледнете каде има простор за подобрување и добијте препораки прилагодени за вашата страница.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Инструкциите се напишани за корисници кои не се технолошки, водејќи ве низ секоја препорака, со примери и објаснувања.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Секој месец, добијте е-пошта со напредокот на оптимизација на вашиот сајт и преземете го како PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Чувајте ги контролите за конкурентите за да видите што прават за да добијат сообраќај и како вашите броеви се редат против нивните. Никогаш нема да знаат дека гледате!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo ве води преку оптимизирање на секоја поединечна страница на вашата страница со тоа што ќе ја усогласите со еден од вашите избрани клучни зборови и осигурувајќи се дека фреквенцијата и поставеноста се точни.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "Клучните зборови можат да бидат огромни ако не сте запознаени со SEO. marketgoo препорачува клучни зборови и исто така ви овозможува да ги пребарувате и внесете оние за кои сакате да ги оптимизирате.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Работи со сите градители на веб-страници";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Датум на споредба: 19 јуни, 20 25:tagBreak*Вкупни перформанси на мрежата според истражувањето на AV-Test. Можете да го прочитате :tagOpenцелосниот извештај:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Предупредувања за протечени акредити";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Малициозен софтвер за преземања";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Не е откриено";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "Тракер и блокатор на реклами";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN не ги ограничува брзините на поврзување. Уживајте во нашата VPN конекција со целосна брзина без никакво придушување.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN е компатибилен со сите популарни платформи, вклучувајќи Windows, macOS, Linux, Android и iOS. Плус, можете да обезбедите до 10 уреди, вклучувајќи го и вашиот рутер.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "Нема ограничувања на опсегот на VPN  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Прелистувајте, играјте и работете на приватна и безбедна врска";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Останете безбедно поврзани дури и на јавен Wi-Fi";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Намалете го следењето преку Интернет со заштита на вашата IP адреса";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Гледајте домашни содржини додека патувате во странство";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Користете NordVPN за да ја шифрирате вашата онлајн активност за дополнителен слој на заштита секогаш кога и каде и да сте поврзани.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN ја штити вашата врска со енкрипција од следната генерација, за да можете да се најавите на вашите сметки, да правите банкарски трансфери и да купувате онлајн без грижи. Дури и на незаштитени мрежи.";
$_LANG['store']['nordvpn']['features']['security']['tagline4'] = "Ничија работа не е она што го правите онлајн. Затоа не ги следиме, собираме или споделуваме вашите приватни податоци. Не можевме да дадеме никакви детали за вас на трети страни, дури и ако тие побараат.";
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN може да се пофали со широк спектар на функции за да ве заштити од сајбер закани. Во прилог на Threat Protection Pro™, постои автоматски Kill Switch кој ја блокира вашата интернет конекција ако вашата VPN конекција падне, осигурувајќи дека вашите податоци остануваат безбедни. Затворените сервери ќе помогнат кога е потребно високо ниво на онлајн безбедност поради владината цензура и строгите интернет прописи.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Зголемете ја вашата онлајн безбедност со VPN";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Напредна безбедност";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Секогаш кога ќе преземете датотека, Threat Protection Pro™ ја проверува за малициозен софтвер.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Заштита на закана Pro™ блокира наметливи реклами и веб-тракери и автоматски ги скенира URL-адресите и ги блокира малициозните.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Заштита на закана Pro™ ги штити вашите уреди и вашата приватност. Со блокирање на тракерите, тоа ви помага да избегнете онлајн snoopers.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "Функцијата :tagOpenЗаштита на закана Pro™:tagClose на NordVPN е менувач на игри кој нуди уште повеќе безбедносни придобивки и подобра заштита со еден дополнителен клик.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Повеќе од само VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Дури и ако немате што да криете, веројатно не ви се допаѓа идејата да бидете гледани и следени. Главната причина зошто корисниците на интернет избираат VPN услуги е приватноста на интернет и општата безбедност.:tagBreakЕве конкретни причини ЗОШТО?";
$_LANG['store']['nordvpn']['features']['use']['tagline2'] = "Јавните Wi-Fi мрежи во хотелите, аеродромите и кафулињата се совршена мета за хакерите поради честопати ниските безбедносни мерки.";
$_LANG['store']['nordvpn']['features']['use']['tagline3'] = "Спречете трети страни, како што се провајдерите на интернет услуги, да ја гледаат и следат вашата секојдневна онлајн активност.";
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Избегнувајте регионални и политички ограничувања на платформи како Фејсбук, Х (Твитер) и WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Онлајн рекламите обично се досадни и го одвлекуваат вниманието. Тие затрупуваат големи делови од веб-страниците, ја забавуваат брзината на врската и може да бидат злонамерни.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Технологиите за паметни домови, особено небезбедните IoT уреди, можат да создадат слабости во домашните мрежи.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Безбедна јавна Wi-Fi конекција";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Пбезбедно прелистување";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Неограничен пристап до социјалните медиуми";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Заштита од злонамерни реклами";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Безбедност на паметниот дом";
...
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Добијте го договорот";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Заштитете ја вашата IP адреса:tagBreak• Блокирајте малициозен софтвер, тракери и реклами:tagBreak• Поврзете до 10 уреди";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Дневно скенирање на база на податоци SMART";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Дневно скенирање на датотеки SMART";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Дизајнирајте свежа содржина, подобрете го ангажманот и следете ги вашите резултати со SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "Управување со социјални медиуми на SocialBee";
...
$_LANG['suggestedTLDs'] = "Предложени TLD";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Невалиден формат на ДДВ број за :countryName.";
...
$_LANG['updateProductQuantity'] = "ДОПОЛНИ КОШНИЧКА";
$_LANG['updateTotals'] = "Рекалкулирај износ";
