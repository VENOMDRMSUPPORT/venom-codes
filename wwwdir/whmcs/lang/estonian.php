...
$_LANG['addToCartButton'] = "Lisa ostukorvi";
$_LANG['addToGetFreeDomain'] = "Lisage tasuta domeeni saamiseks";
...
$_LANG['applyPromoCode'] = "Kandideeri";
...
$_LANG['basicSsl'] = "Põhiline SSL";
$_LANG['billableitemseach'] = "Iga";
$_LANG['billableitemshour'] = "Tund";
$_LANG['billableitemshours'] = "Tunnid";
$_LANG['billableitemsquantity'] = "Kogus";
$_LANG['billing']['creditnote'] = "Krediidimärkus";
$_LANG['billing']['debitnote'] = "Deebetmärkus";
$_LANG['billing']['issuedate'] = "Väljaandmise kuupäev";
$_LANG['billing']['issuedby'] = "Välja andnud";
$_LANG['billing']['issuedto'] = "Välja antud aadressile";
$_LANG['billing']['ledger']['date'] = "Kuupäev";
$_LANG['billing']['ledger']['reference'] = "Viide";
$_LANG['billing']['ledger']['title'] = "Peaamat";
$_LANG['billing']['ledger']['type'] = "Tüüp";
$_LANG['billing']['type']['affiliatepayout'] = "Sidusettevõtte väljamakse";
$_LANG['billing']['type']['clientaccountcredit'] = "Kliendikonto krediit";
$_LANG['billing']['type']['clientaccountdebit'] = "Kliendikonto deebet";
$_LANG['billing']['type']['creditnoteadjustment'] = "Krediidimärkide korrigeerimine";
$_LANG['billing']['type']['invoiceadjustment'] = "Arve korrigeerimine";
$_LANG['billing']['type']['payment'] = "Maksmine";
$_LANG['billing']['type']['refund'] = "Tagasimakse";
$_LANG['billing']['type']['refundtocredit'] = "Tagasimakse kliendikontole";
$_LANG['billingAddress'] = "Arveldusaadress";
$_LANG['billingOverview'] = "Arvelduse ülevaade";
$_LANG['billingdetails'] = "Arvelduse üksikasjad";
$_LANG['billingnotes']['creditnote']['items'] = "Krediitmärkide üksused";
$_LANG['billingnotes']['debitnote']['items'] = "Deebetmärkmete üksused";
...
$_LANG['cartItemType']['addon'] = "Lisad";
$_LANG['cartItemType']['addons'] = "Lisateenused";
$_LANG['cartItemType']['bundle'] = "komplekt";
$_LANG['cartItemType']['bundles'] = "Kimbud";
$_LANG['cartItemType']['domain'] = "Domeen";
$_LANG['cartItemType']['domainRegistration'] = "Domeeni registreerimine";
$_LANG['cartItemType']['domainRenewal'] = "Domeeni pikendamine";
$_LANG['cartItemType']['domainRenewals'] = "Domeeni pikendamine";
$_LANG['cartItemType']['domainTransfer'] = "Domain ülekanne";
$_LANG['cartItemType']['domainTransfers'] = "Domeeniülekanne";
$_LANG['cartItemType']['domains'] = "Domeenid";
$_LANG['cartItemType']['product'] = "Toode";
$_LANG['cartItemType']['products'] = "Tooted";
$_LANG['cartItemsSelected'] = "Teil on :count valitud ja ostmiseks valmis.";
...
$_LANG['cartbrowse'] = "Sirvige tooteid ja teenuseid";
...
$_LANG['choosePackages'] = "Valige paketide hulgast";
...
$_LANG['codeApplied'] = "Rakendatud sooduskood";
$_LANG['completeorder'] = "Lõpeta tellimus";
$_LANG['configModalTitle'] = "Konfiguratsioon";
...
$_LANG['confirmItemDeletion'] = "Kustutamise kinnitamine";
...
$_LANG['cycleRenewal'] = ":cycle Uuendamine";
$_LANG['daily'] = "Päevas";
...
$_LANG['designedToFitAnyBudget'] = "Mõeldud vastavalt igale eelarvele";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Otsige märksõna, kirjelduse või domeeni järgi.&#10;Näiteks: &quot;Lõbusad äriüritused &quot;, &quot;Põhjalik finantsplaneerimisteenus professionaalidele&quot;või &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Sisestage lühikirjeldus või täpne domeen.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "Süsteem ei leidnud ettepanekuid.";
$_LANG['domainSearch']['exactMatch'] = "Täpne vaste";
$_LANG['domainSearch']['maxLength'] = "Maksimaalne pikkus";
$_LANG['domainSearch']['notAvailable'] = "Pole saadaval";
$_LANG['domainSearch']['safeSearch'] = "Turvaline otsing";
$_LANG['domainSearch']['tlds'] = "Lisage TLD-d";
$_LANG['domainSearch']['topAiSuggestion'] = "Parim tehisintellekti soovitus";
$_LANG['domainSearch']['topSuggestion'] = "Parim soovitus";
...
$_LANG['due'] = "Tähtis";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "Peate nõustuma teenusetingimustega, märkides :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute peab olema massiiv.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute peab olema kehtiv kuupäev.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute peab olema kehtiv e-posti aadress.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "Süsteemil tekkis sisemine viga. Proovige hiljem uuesti.";
$_LANG['dynamicServiceFields']['validation']['in'] = ":attribute valitud valik on vale.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute peab olema täisarv.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute ei tohi sisaldada rohkem kui :max tähemärki.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute peab kasutama ühte järgmistest failitüüpidest: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute peab sisaldama vähemalt :min tähemärki.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute peab olema number.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute peab olema kehtiv regulaaravaldis.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute on nõutav.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute peab olema kehtiv URL, mis sisaldab protokolli („http://” või „https://”).";
...
$_LANG['encryption_failed'] = "Krüptimine ebaõnnestus: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Proovige hiljem uuesti.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Koduleht";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Olete saatnud liiga palju taotlusi.";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "Vabandust!";
...
$_LANG['estimateTaxes'] = "Hinnake makse";
$_LANG['every'] = "Iga";
$_LANG['exampledomain'] = "ntks. example.com";
$_LANG['excludeTLDs'] = "Välja arvatud teatud TLD-d ja hiljuti uuendatud domeenid";
...
$_LANG['extendYourDomainBy1Year'] = "Laiendage oma domeeni 1 aasta võrra*";
...
$_LANG['findDomains'] = "Leidke domeenid";
...
$_LANG['forTheFirstYear'] = "esimeseks aastaks";
...
$_LANG['freeDomainHostingPromo'] = "Hostingu ostmisel saate tasuta domeeni.";
$_LANG['from'] = "Alates";
...
$_LANG['hideSearchControls'] = "Peida otsingu juhtelemendid";
...
$_LANG['inStock'] = "Laos: :amount";
$_LANG['incApplicableTaxes'] = "sisaldab kohaldatavaid makse";
$_LANG['includeTLDs'] = "Lisage TLD-d";
$_LANG['included'] = "Sisaldab";
...
$_LANG['invalidCode'] = "Kehtetu sooduskood";
$_LANG['invalid_input'] = "Vale sisend: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "Kehtetu pileti ID või vastuse ID.";
...
$_LANG['language'] = "Keel";
$_LANG['lastChance'] = "Viimane võimalus";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Logi sisse";
...
$_LANG['maxLength'] = "Maksimaalne pikkus";
...
$_LANG['navMarketConnectService']['dynamic'] = "Dünaamilised teenused";
...
$_LANG['noDomainsFound'] = "Domeene ei leitud";
...
$_LANG['orderForm']['additionalInformation'] = "Täiendav informatsioon";
...
$_LANG['orderForm']['findNewDomainAi'] = "Otsige tehisintellekti toetavate soovitustega domeeni.";
...
$_LANG['ordererrortldsnotconfigured'] = "Praegu pole ühtegi domeenilaiendust müügil. Abi saamiseks võtke meiega ühendust.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "Iga-aastane";
$_LANG['orderpaymenttermadjectivebiennially'] = "Kaheaastane";
$_LANG['orderpaymenttermadjectivefree'] = "Tasuta";
$_LANG['orderpaymenttermadjectivemonthly'] = "Kord kuus";
$_LANG['orderpaymenttermadjectiveonetime'] = "Üks kord";
$_LANG['orderpaymenttermadjectivequarterly'] = "Kord kvartalis";
$_LANG['orderpaymenttermadjectivesemiannually'] = "Poolaastane";
$_LANG['orderpaymenttermadjectivetriennially'] = "Triennaal";
...
$_LANG['orderselectterm'] = "Valige Termin";
...
$_LANG['page'] = "Lehekülg";
$_LANG['pageof'] = "kohta";
$_LANG['passwordtips'] = "<strong>Näpunäited turvalise parooli jaoks</strong><br />Kasutage nii suurtähti kui ka väiketähti.<br />Lisage vähemalt üks sümbol (näiteks <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>või <code>&amp;</code>).<br />Ärge kasutage sõnastikusõnu.<br />Paroolid võivad sisaldada kuni :maximum_length tähemärke.";
...
$_LANG['price'] = "hind";
$_LANG['priceFor'] = "Hind eest :term";
$_LANG['priceForThisTerm'] = "Selle tähtaja hind";
$_LANG['priceStandard'] = "Uuendatakse igal aastal :renewalPrice, millele lisandub maks.";
$_LANG['priceWithDiscount'] = ":registrationPrice esimest aastat, seejärel :renewalPrice igal aastal.";
...
$_LANG['pwlengthmax'] = "Paroolid ei tohi sisaldada rohkem kui :max tähemärki.";
...
$_LANG['pwstrengthfail'] = "See parool ei ole piisavalt tugev. Sisestage keerulisem parool.";
...
$_LANG['recommendedTLDs'] = "Soovitatavad TLD-d";
...
$_LANG['requiredFields'] = "Kohustuslikud väljad on tähistatud tähega*";
...
$_LANG['rssfeed'] = "Toide";
$_LANG['safeSearch'] = "Turvaline otsing";
$_LANG['sale'] = "Müük";
$_LANG['salePrice'] = "müügihind";
$_LANG['salesTaxes'] = "Müügimaksud";
$_LANG['search'] = "Otsi";
$_LANG['searchOurKnowledgebase'] = "Otsige meie teadmistebaasist";
$_LANG['searchResults'] = "Otsingu tulemused";
...
$_LANG['selectCountry'] = "Vali riik";
$_LANG['selectDomain'] = "Valige domeen";
$_LANG['selectDomainForHosting'] = "Millisele domeenile soovite selle jagatud hostimispaketi lisada?";
$_LANG['selectDomainsForSsl'] = "Millisele domeenile soovite SSL-i põhilist rakendada? Saate valida mitu.";
$_LANG['selectState'] = "Valige riik";
...
$_LANG['service_unavailable'] = "Teenus pole saadaval: %s";
$_LANG['servicesRenew'] = "Pikenda";
$_LANG['setupFee'] = ":amount Seadistamistasu";
$_LANG['setupMandate'] = "Maksemise seadistamise mandaat";
$_LANG['sharedHosting'] = "Jagatud hostimine";
$_LANG['shopNow'] = "Ostke kohe";
$_LANG['shortcuts'] = "Otseteed";
$_LANG['show'] = "Näita";
$_LANG['showMenu'] = "Näita menüü";
$_LANG['showSearchControls'] = "Otsingu juhtelementide kuvamine";
...
$_LANG['store']['dynamic']['title'] = "Dünaamilised teenused";
...
$_LANG['store']['error']['serviceUnavailable'] = "Teie taotlust ei saa praegu töödelda. Selle põhjuseks võib olla ajutise teeninduse või ajutise teeninduse probleem. Palun proovige uuesti.";
$_LANG['store']['error']['validationFailed'] = "Palun kontrollige ja parandage allpool toodud vead.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo pakub teile tõestatud, juhendatud SEO protsessi, ilma et peaksite olema ekspert. <br> marketgoo on taskukohane ja pakub põhjalikke SEO aruandeid, plaane ja soovitusi, kõik intuitiivses liideses.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Mis eristab marketgoo teistest SEO toodetest?";
$_LANG['store']['marketgoo']['faqs']['title'] = "KKK ja tugi";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "Otsingumootori esitamine";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Veebisaidi ehitaja ühildu";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Igakuine eduaruanne";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Liiklusanalüüs";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Laadige SEO aruanne alla PDF-vormingus <a href='https://mktgoo.co/seo-report-score2'>(vt näidet)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "Tehisintellekti funktsioonid: pealkirja ja metakirjelduse automaatne genereerimine";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Skanitud leheküljed";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Konkurentside jälgimine";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Märksõnade jälgimine ja optimeerimine";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Ajakohastatud aruanne ja plaan";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Kohandatud SEO plaan";
$_LANG['store']['marketgoo']['features']['1'] = "Hankige oma SEO plaan";
$_LANG['store']['marketgoo']['features']['2'] = "Järgige üksikasjalikke juhiseid";
$_LANG['store']['marketgoo']['features']['3'] = "Jälgige edusamme igakuise aruande abil";
$_LANG['store']['marketgoo']['features']['4'] = "Võistlejate jälgimine ja jälgimine";
$_LANG['store']['marketgoo']['features']['5'] = "Individuaalne lehe optimeerimine";
$_LANG['store']['marketgoo']['features']['6'] = "Lihtne märksõnade uurimine ja jälgimine";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Registreeruge ja hankige oma kohene SEO aruanne ja plaan. Vaadake, kus on arenguruumi, ja hankige oma saidile kohandatud soovitusi.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Juhised on kirjutatud mittetehnoloogilistele kasutajatele, juhendades teid läbi iga soovituse, näidete ja selgitustega.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Iga kuu saate oma saidi SEO edusammudega e-kiri ja laadige see alla PDF-failina.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Jälgige konkurentidel, et näha, mida nad liikluse saamiseks teevad ja kuidas teie numbrid nende omaga kokku puutuvad. Nad ei saa kunagi teada, et vaatate!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo juhendab teid oma saidi iga üksiku lehe optimeerimisel, sobitades selle ühe teie valitud märksõnaga ja veendudes, et sagedus ja paigutus oleksid õiged.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "Märksõnad võivad olla ülekaalulikud, kui te pole SEO-ga tutt. marketgoo soovitab märksõnu ning võimaldab teil otsida ja sisestada ka neid, mille jaoks soovite optimeerida.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Töötab kõigi veebisaitide ehitajatega";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Võrdluse kuupäev: Juuni 19, 20 25:tagBreak*Üldine võrgu jõudlus vastavalt AV-Testi uuringutele. Saate lugeda :tagOpentäielikku aruannet:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Hoiatused lekkinud mandaatide kohta";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Pahavara skaneerib allalaadimisi";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Ei avalikustata";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "Jälgija ja reklaamiblokeerija";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN ei piira ühenduse kiirust. Nautige meie täiskiirust VPN-ühendust ilma igasuguse piiramiseta.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN ühildub kõigi populaarsete platvormidega, sealhulgas Windows, MacOS, Linux, Android ja iOS. Lisaks saate turvata kuni 10 seadet, sealhulgas ruuterit.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "VPN-i ribalaiuse piiranguid pole  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Sirvige, mängige ja töötage privaatse ja turvalise ühenduse kallal";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Püsige turvaliselt ühenduses isegi avalikus WiFi-ühenduses";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Vähendage veebipõhist jälgimist, varjestades oma IP-aadressi";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Vaadake kodusisu välismaale reisides";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Kasutage NordVPN-i krüpteerimiseks oma veebitegevust, et saada täiendavat kaitsekihti igal ajal ja kus iganes olete ühendatud.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN kaitseb teie ühenduse järgmise põlvkonna krüptimisega, et saaksite muretult sisse logida oma kontodesse, teha pangaülekandeid ja veebist sisseoste teha. Isegi kaitsmata võrkudes.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN-il on lai valik funktsioone, mis kaitsevad teid küberohtude eest. Lisaks Threat Protection Pro™ on olemas automaatne Kill Switch, mis blokeerib teie Interneti-ühenduse, kui teie VPN-ühendus kaob, tagades teie andmete turvalisuse. Varjatud serverid aitavad, kui valitsuse tsensuuri ja rangete Interneti-eeskirjade tõttu on vaja kõrget veebiturbe taset.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Suurendage oma veebiturvalisust VPN-iga";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Täiustatud turvalisus";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Kui laadite faili alla, kontrollib Threat Protection Pro™ selle pahavara suhtes.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ blokeerib pealetükkivad reklaamid ja veebijälgijad ning skaneerib automaatselt URL-id ja blokeerib pahatahtlikud.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Threat Protection Pro™ kaitseb teie seadmeid ja teie privaatsust. Jälgijate blokeerimisega aitab see vältida veebipõhiseid nuuskeid.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "NordVPN-i funktsioon :tagOpenThreat Protection Pro™:tagClose on mängumuutaja, mis pakub veelgi rohkem turbeeeliseid ja paremat kaitset ühe lisaklõpsuga.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Rohkem kui lihtsalt VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Isegi kui teil pole midagi varjata, ilmselt ei meeldi teile mõte, et teid jälgivad ja jälgitakse. Peamine põhjus, miks Interneti-kasutajad valivad VPN-teenuseid, on veebipõhine privaatsus ja üldine turvalisus.:tagBreakSiin on konkreetsed põhjused, MIKS?";
...
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Vältige piirkondlikke ja poliitilisi piiranguid sellistel platvormidel nagu Facebook, X (Twitter) ja WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Veebireklaamid on tavaliselt tüütud ja häirivad. Need segavad suurt osa veebisaitidest, aeglustavad ühenduse kiirust ja võivad olla pahatahtlikud.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Nutika kodu tehnoloogiad, eriti ebaturvalised IoT-seadmed, võivad koduvõrkudes tekitada haavatavusi.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Turvaline avalik WiFi-ühendus";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Turvalisem sirvimine";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Piiramatu juurdepääs sotsiaalmeediale";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Kaitse pahatahtlike reklaamide eest";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Nutika kodu turvalisus";
...
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Hankige pakkumine";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Kaitske oma IP-aadressi:tagBreak• Blokeerige pahavara, jälgijad ja reklaamid:tagBreak• Ühendage kuni 10 seadet";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Igapäevane SMART andmebaasi skaneerim";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Igapäevane SMART-failide skaneerimine";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Kujundage värsket sisu, parandage kaasatust ja jälgige oma tulemusi SocialBee abil.";
$_LANG['store']['socialbee']['cartTitle'] = "SocialBee sotsiaalmeedia haldamine";
...
$_LANG['success'] = "Edu";
$_LANG['suggestedTLDs'] = "Soovitatavad TLD-d";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Kehtetu käibemaksukohustuslase vorming :countryNamejaoks.";
...
$_LANG['upTo'] = "Kuni :num";
$_LANG['update'] = "Uuenda";
$_LANG['updateProductQuantity'] = "Uuenda";
$_LANG['updateTotals'] = "Uuenda kogusummasid";
