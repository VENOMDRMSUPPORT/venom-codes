...
$_LANG['addToGetFreeDomain'] = "Adicionar para obter domínio gratuito";
...
$_LANG['billing']['type']['affiliatepayout'] = "Pagamento de Afiliados";
$_LANG['billing']['type']['clientaccountcredit'] = "Crédito na Conta do Cliente";
$_LANG['billing']['type']['clientaccountdebit'] = "Débito na Conta do Cliente";
$_LANG['billing']['type']['creditnoteadjustment'] = "Ajustamento da Nota de Crédito";
$_LANG['billing']['type']['invoiceadjustment'] = "Ajuste de faturas";
$_LANG['billing']['type']['payment'] = "Pagamento";
$_LANG['billing']['type']['refund'] = "Reembolso";
$_LANG['billing']['type']['refundtocredit'] = "Reembolso para Conta de Cliente";
...
$_LANG['billingnotes']['creditnote']['items'] = "Itens de Nota de Crédito";
...
$_LANG['cartItemType']['addon'] = "Extra";
$_LANG['cartItemType']['addons'] = "Extras";
$_LANG['cartItemType']['bundle'] = "Pacote";
$_LANG['cartItemType']['bundles'] = "Pacotes";
$_LANG['cartItemType']['domain'] = "Domínio";
$_LANG['cartItemType']['domainRegistration'] = "Registo de Dominio";
$_LANG['cartItemType']['domainRenewal'] = "Renovação de Domínio";
$_LANG['cartItemType']['domainRenewals'] = "Renovações de domínio";
$_LANG['cartItemType']['domainTransfer'] = "Transferência de Dominio";
$_LANG['cartItemType']['domainTransfers'] = "Transferências de Domínios";
$_LANG['cartItemType']['domains'] = "Dominios";
$_LANG['cartItemType']['product'] = "Produto";
$_LANG['cartItemType']['products'] = "Produtos";
$_LANG['cartItemsSelected'] = "Tem :count seleccionado e pronto a comprar.";
...
$_LANG['confirmItemDeletion'] = "Confirmar Eliminação";
...
$_LANG['designedToFitAnyBudget'] = "Concebido para caber em qualquer orçamento";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Pesquise por palavra-chave, descrição ou domínio.&#10;Por exemplo: &quot;Eventos empresariais divertidos &quot;, &quot;Um serviço abrangente de planeamento financeiro para profissionais&quot;, ou &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Introduza uma breve descrição ou um domínio exato.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "O sistema não encontrou nenhuma sugestão.";
$_LANG['domainSearch']['exactMatch'] = "Correspondência Exacta";
...
$_LANG['domainSearch']['topAiSuggestion'] = "Top Sugestão de IA";
$_LANG['domainSearch']['topSuggestion'] = "Sugestão de topo";
...
$_LANG['due'] = "em falta";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "Deve aceitar os termos de serviço verificando :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute deve ser uma matriz.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute tem de ser uma data válida.";
...
$_LANG['dynamicServiceFields']['validation']['in'] = "A opção seleccionada para :attribute é inválida.";
...
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute deve utilizar um dos seguintes tipos de ficheiro: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute deve conter pelo menos :min caracteres.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute tem de ser um número.";
...
$_LANG['enabled'] = "Ativo";
$_LANG['encryption_failed'] = "Falha na encriptação: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Enviou demasiados pedidos.";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "Opa!";
...
$_LANG['estimateTaxes'] = "Impostos Estimados";
$_LANG['every'] = "a cada";
$_LANG['exampledomain'] = "ex. example.com";
$_LANG['excludeTLDs'] = "Exclui determinados TLDs e domínios renovados recentemente";
...
$_LANG['extendYourDomainBy1Year'] = "Prolongue o seu domínio por 1 ano*";
...
$_LANG['findDomains'] = "Localizar Domínios";
...
$_LANG['freeDomainHostingPromo'] = "Obtenha um domínio gratuito ao comprar alojamento.";
$_LANG['from'] = "De";
...
$_LANG['hideSearchControls'] = "Ocultar Controlos de Pesquisa";
...
$_LANG['inStock'] = "Em Stock: :amount";
$_LANG['incApplicableTaxes'] = "Inc. Impostos Aplicáveis";
...
$_LANG['invalid_ticket_id_or_reply_id'] = "ID de ticket inválido ou ID de resposta.";
...
$_LANG['lastChance'] = "Última Oportunidade";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Login";
...
$_LANG['orderForm']['additionalInformation'] = "informação Adicional";
...
$_LANG['orderForm']['findNewDomainAi'] = "Pesquise um domínio com sugestões com tecnologia de IA.";
...
$_LANG['ordererrortldsnotconfigured'] = "Não existem extensões de domínio disponíveis para venda no momento. Para obter ajuda, contacte-nos.";
...
$_LANG['orderpaymenttermadjectivefree'] = "Grátis";
$_LANG['orderpaymenttermadjectivemonthly'] = "Mensalmente";
$_LANG['orderpaymenttermadjectiveonetime'] = "Uma vez";
$_LANG['orderpaymenttermadjectivequarterly'] = "Trimestralmente";
$_LANG['orderpaymenttermadjectivesemiannually'] = "Semestralmente";
...
$_LANG['orderselectterm'] = "Selecionar Período";
...
$_LANG['page'] = "Página";
$_LANG['pageof'] = "de";
$_LANG['passwordtips'] = "<strong>Dicas para uma Senha Segura</strong><br />Use caracteres maiúsculos e minúsculos.<br />Incluir pelo menos um símbolo (por exemplo, <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>ou <code>&amp;</code>).<br />Não use palavras do dicionário.<br />As palavras-passe podem conter até :maximum_length caracteres.";
...
$_LANG['priceStandard'] = "Renova-se todos os anos em :renewalPrice, mais impostos.";
$_LANG['priceWithDiscount'] = ":registrationPrice para o primeiro ano, depois :renewalPrice anualmente.";
...
$_LANG['pwlengthmax'] = "As palavras-passe não podem conter mais do que :max caracteres.";
...
$_LANG['pwstrengthfail'] = "Esta palavra-passe não é suficientemente forte. Introduza uma palavra-passe mais complexa.";
...
$_LANG['requiredFields'] = "Os campos obrigatórios estão assinalados com*";
...
$_LANG['selectDomain'] = "Seleccionar Domínio";
$_LANG['selectDomainForHosting'] = "A que domínio gostaria de anexar este pacote de alojamento partilhado?";
$_LANG['selectDomainsForSsl'] = "A que domínio gostaria de aplicar o SSL básico? Pode seleccionar vários.";
$_LANG['selectState'] = "Selecionar Estado";
...
$_LANG['setupFee'] = ":amount Taxa de Instalação";
$_LANG['setupMandate'] = "Configurar mandato para pagamento";
$_LANG['sharedHosting'] = "Alojamento Partilhado";
$_LANG['shopNow'] = "Compre agora";
$_LANG['shortcuts'] = "Atalhos";
$_LANG['show'] = "Mostrar";
$_LANG['showMenu'] = "Mostrar Menu";
$_LANG['showSearchControls'] = "Mostrar controlos de pesquisa";
...
$_LANG['store']['error']['serviceUnavailable'] = "Não é possível processar o seu pedido de momento. Isto pode ser devido a um tempo limite ou a um problema de serviço temporário. Por favor, tente novamente.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "O marketgoo fornece-lhe um processo de SEO comprovado e guiado sem exigir que seja um especialista. <br> marketgoo é acessível e fornece relatórios, planos e recomendações de SEO abrangentes, tudo numa interface intuitiva.";
...
$_LANG['store']['marketgoo']['featurematrix']['1'] = "Submissão do motor de pesquisa";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Compatibilidade com o Construtor de Sites";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Relatório de Progresso Mensal";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Análise de Tráfego";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Descarregar Relatório de SEO em PDF <a href='https://mktgoo.co/seo-report-score2'>(Ver Exemplo)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "Funcionalidades alimentadas por IA: Geração Automática de Título e Meta Descrição";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Páginas digitalizadas";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Rastreamento de Concorrência";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Rastreamento e Optimização de Palavras-chave";
...
$_LANG['store']['marketgoo']['features']['1'] = "Obtenha o seu Plano de SEO";
$_LANG['store']['marketgoo']['features']['2'] = "Siga as instruções passo a passo";
$_LANG['store']['marketgoo']['features']['3'] = "Monitorizar o Progresso com um Relatório Mensal";
$_LANG['store']['marketgoo']['features']['4'] = "Acompanhar e monitorizar concorrentes";
$_LANG['store']['marketgoo']['features']['5'] = "Optimização de Página Individual";
$_LANG['store']['marketgoo']['features']['6'] = "Pesquisa e monitorização fáceis de palavras-chave";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Registe-se e receba o seu relatório e plano de SEO instantâneos. Veja onde há espaço para melhorias e obtenha recomendações personalizadas para o seu site.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "As instruções são escritas para utilizadores não experientes em tecnologia, orientando-o através de cada recomendação, com exemplos e explicações.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Todos os meses, receba um e-mail com o progresso de SEO do seu site e descarregue-o em PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Acompanhe os concorrentes para ver o que eles estão a fazer para obter tráfego e como os seus números se comparam aos deles. Nunca saberão que estás a ver!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "O marketgoo orienta-o através da otimização de cada página individual no seu site, combinando-a com uma das palavras-chave escolhidas e certificando-se de que a frequência e o posicionamento estão corretos.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "As palavras-chave podem ser esmagadoras se não estiver familiarizado com o SEO. o marketgoo recomenda palavras-chave e também permite pesquisar e inserir aquelas para as quais deseja otimizar.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Funciona com Todos os Construtores de Sites";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Data de comparação: 19 de junho 20 25:tagBreak*Desempenho geral da rede de acordo com pesquisa realizada pela AV-Test. Pode ler :tagOpeno relatório completo:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Alertas sobre credenciais vazadas";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Análise de malware para transferências";
...
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "O Nord VPN não limita as velocidades de ligação. Desfrute da nossa ligação VPN a toda velocidade sem qualquer limitação.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "O Nord VPN é compatível com todas as plataformas populares, incluindo Windows, macOS, Linux, Android e iOS. Além disso, pode proteger até 10 dispositivos, incluindo o seu router.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "Sem limites de largura de banda VPN  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Navegue, jogue e trabalhe numa ligação privada e segura";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Mantenha-se ligado de forma segura mesmo numa rede Wi-Fi pública";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Reduza o seguimento online protegendo o seu endereço IP";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Ver conteúdos da casa enquanto viaja para o estrangeiro";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Utilize a NordVPN para encriptar a sua atividade online para obter uma camada extra de proteção quando e onde estiver ligado.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "A NordVPN protege a sua ligação com encriptação de última geração, para que possa iniciar sessão nas suas contas, fazer transferências bancárias e fazer compras online sem preocupações. Mesmo em redes desprotegidas.";
$_LANG['store']['nordvpn']['features']['security']['tagline4'] = "Não é da conta de ninguém o que fazemos online. É por isso que não rastreamos, recolhemos ou partilhamos os seus dados privados. Não poderíamos fornecer quaisquer detalhes sobre si a terceiros, mesmo que eles peçam.";
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "A NordVPN possui uma vasta gama de funcionalidades para o proteger contra ameaças cibernéticas. Além do Threat Protection Pro™, existe um Kill Switch automático que bloqueia a sua ligação à Internet se a sua ligação VPN cair, garantindo que os seus dados permanecem seguros. Servidores ofuscados ajudarão quando um alto nível de segurança online for necessário devido à censura governamental e regulamentos rígidos da Internet.";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Sempre que transfere um ficheiro, o Threat Protection Pro™ inspeciona a existência de malware.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "O Threat Protection Pro™ bloqueia anúncios intrusivos e rastreadores da Web e analisa automaticamente URLs e bloqueia os maliciosos.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "O Threat Protection Pro™ protege os seus dispositivos e a sua privacidade. Ao bloquear rastreadores, ajuda-o a evitar os esnoopers online.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "A funcionalidade :tagOpenThreat Protection Pro™:tagClose da NordVPN é uma virada de jogo que oferece ainda mais benefícios de segurança e melhor proteção com um único clique extra.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Mais do que apenas uma VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Mesmo que não tenha nada a esconder, provavelmente não gosta da ideia de ser vigiado e rastreado. A principal razão pela qual os internautas escolhem os serviços VPN é a privacidade online e a segurança geral.:tagBreakAqui estão razões específicas PORQUÊ?";
$_LANG['store']['nordvpn']['features']['use']['tagline2'] = "As redes Wi-Fi públicas em hotéis, aeroportos e cafés são os alvos perfeitos para os hackers devido às medidas de segurança muitas vezes baixas.";
$_LANG['store']['nordvpn']['features']['use']['tagline3'] = "Impedir que terceiros, como fornecedores de serviços de internet, vejam e rastreiem a sua atividade online do dia-a-dia.";
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Evite restrições regionais e políticas em plataformas como o Facebook, X (Twitter), e WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Os anúncios online são normalmente irritantes e perturbadores. Eles ocupam grande parte dos websites, lentas a velocidade de ligação e podem ser maliciosos.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "As tecnologias de casa inteligente, particularmente dispositivos IoT não seguros, podem criar vulnerabilidades nas redes domésticas.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Ligação Wi-Fi pública segura";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Navegação mais segura";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Acesso irrestrito às redes sociais";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Protecção contra anúncios maliciosos";
...
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Obtenha o negócio";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Proteja o seu endereço IP:tagBreak• Bloqueie malware, rastreadores e anúncios:tagBreak• Ligue até 10 dispositivos";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Análises diárias de bases de dados SMART";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Análises Diárias de Ficheiros SMART";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Projete novos conteúdos, melhore o envolvimento e acompanhe os seus resultados com o SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "SocialBee Gestão de Redes Sociais";
