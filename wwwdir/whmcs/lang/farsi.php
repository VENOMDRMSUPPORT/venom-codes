...
$_LANG['addToCartButton'] = "افزودن به کارت";
$_LANG['addToGetFreeDomain'] = "برای دریافت دامنه رایگان اضافه کنید";
...
$_LANG['applyPromoCode'] = "درخواست دادن";
...
$_LANG['billing']['creditnote'] = "یادداشت اعتباری";
$_LANG['billing']['debitnote'] = "یادداشت نقدی";
$_LANG['billing']['issuedate'] = "تاریخ انتشار";
$_LANG['billing']['issuedby'] = "صادر شده توسط";
$_LANG['billing']['issuedto'] = "صادر شده به";
$_LANG['billing']['ledger']['date'] = "تاریخ";
$_LANG['billing']['ledger']['reference'] = "مرجع";
$_LANG['billing']['ledger']['title'] = "دفتر";
$_LANG['billing']['ledger']['type'] = "نوع";
$_LANG['billing']['type']['affiliatepayout'] = "پرداخت وابسته";
$_LANG['billing']['type']['clientaccountcredit'] = "اعتبار حساب مشتری";
$_LANG['billing']['type']['clientaccountdebit'] = "بدهی حساب مشتری";
$_LANG['billing']['type']['creditnoteadjustment'] = "تنظیم یادداشت اعتباری";
$_LANG['billing']['type']['invoiceadjustment'] = "تنظیم فاکتور";
$_LANG['billing']['type']['payment'] = "پرداخت";
$_LANG['billing']['type']['refund'] = "بازپرداخت";
$_LANG['billing']['type']['refundtocredit'] = "بازپرداخت به حساب مشتری";
$_LANG['billingAddress'] = "آدرس مالی";
$_LANG['billingOverview'] = "خلاصه وضعیت مالی";
$_LANG['billingdetails'] = "جزئیات مالی";
$_LANG['billingnotes']['creditnote']['items'] = "موارد یادداشت اعتباری";
$_LANG['billingnotes']['debitnote']['items'] = "موارد یادداشت نقدی";
...
$_LANG['cartItemType']['addon'] = " افزودنی ها";
$_LANG['cartItemType']['addons'] = "افزودنی ها";
$_LANG['cartItemType']['bundle'] = "بسته بندی";
$_LANG['cartItemType']['bundles'] = "بسته ها";
$_LANG['cartItemType']['domain'] = "دامنه";
$_LANG['cartItemType']['domainRegistration'] = "ثبت نام دامنه";
$_LANG['cartItemType']['domainRenewal'] = "تمدید دامنه";
$_LANG['cartItemType']['domainRenewals'] = " تمدید دامنه ";
$_LANG['cartItemType']['domainTransfer'] = "انتقال دامنه";
$_LANG['cartItemType']['domainTransfers'] = "انتقال دامنه";
$_LANG['cartItemType']['domains'] = "دامنه ها";
$_LANG['cartItemType']['product'] = "محصول";
$_LANG['cartItemType']['products'] = "محصولات";
$_LANG['cartItemsSelected'] = "شما :count را انتخاب کرده و آماده خرید هستید.";
...
$_LANG['choosePackages'] = "از بین طیف وسیعی از بسته ها انتخاب کنید";
...
$_LANG['cycleRenewal'] = ":cycle تمدید";
$_LANG['daily'] = "روزانه";
...
$_LANG['designedToFitAnyBudget'] = "طراحی شده برای متناسب با هر بودجه";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "جستجو بر اساس کلمه کلیدی، توضیحات یا دامنه.&#10;به عنوان مثال: &quot;رویدادهای تجاری سرگرم کننده &quot;، &quot;یک سرویس جامع برنامه ریزی مالی برای متخصصان&quot;، یا &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "یک توضیحات کوتاه یا یک دامنه دقیق وارد کنید.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "سیستم نتوانست هیچ پیشنهادی پیدا کند.";
$_LANG['domainSearch']['exactMatch'] = "تطابق دقیق";
$_LANG['domainSearch']['maxLength'] = "حداکثر طول";
$_LANG['domainSearch']['notAvailable'] = "در دسترس نیست ";
$_LANG['domainSearch']['safeSearch'] = "جستجوی امن";
$_LANG['domainSearch']['tlds'] = "شامل TLD ها";
$_LANG['domainSearch']['topAiSuggestion'] = "پیشنهادات برتر هوش مصنوعی";
$_LANG['domainSearch']['topSuggestion'] = "پیشنهاد برتر";
...
$_LANG['due'] = "سررسید";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "شما باید شرایط خدمات را با چک کردن :attributeبپذیرید.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute باید یک آرایه باشد.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute باید تاریخ معتبر باشد.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute باید یک آدرس ایمیل معتبر باشد.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "سیستم با خطای داخلی مواجه شد. بعدا دوباره امتحان کن";
$_LANG['dynamicServiceFields']['validation']['in'] = "گزینه انتخاب شده برای :attribute نامعتبر است.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute باید یک عدد صحیح باشد.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute ممکن است بیش از :max حاوی کاراکتر نباشد.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute باید از یکی از انواع فایل زیر استفاده کند: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute باید حداقل حاوی :min کاراکتر باشد.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute باید یک عدد باشد.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute باید یک عبارت منظم معتبر باشد.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute لازم است";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute باید یک URL معتبر باشد که شامل پروتکل ('http: //' یا 'https: //') باشد.";
$_LANG['edit'] = "ویرایش";
$_LANG['email'] = "ایمیل";
...
$_LANG['enabled'] = "فعال";
$_LANG['encryption_failed'] = "رمزگذاری شکست خورد: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "بعدا دوباره امتحان کن";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "صفحه اصلی";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "شما درخواست های زیادی ارسال کرده اید.";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "!اوه";
...
$_LANG['estimateTaxes'] = "برآورد مالیات";
$_LANG['every'] = "هر";
$_LANG['exampledomain'] = "برای مثال example.com";
$_LANG['excludeTLDs'] = "شامل برخی از تی ال دی ها و دامنه های اخیراً تمدید شده نمی شود";
...
$_LANG['extendYourDomainBy1Year'] = "دامنه خود را تا 1 سال تمدید کنید*";
...
$_LANG['findDomains'] = "یافتن دامنه ها";
...
$_LANG['forTheFirstYear'] = "برای سال اول";
...
$_LANG['freeDomainHostingPromo'] = "هنگام خرید میزبانی یک دامنه رایگان دریافت کنید.";
$_LANG['from'] = "از";
...
$_LANG['hideSearchControls'] = "پنهان کردن کنترل های جستجو";
...
$_LANG['inStock'] = "در انبار: :amount";
$_LANG['incApplicableTaxes'] = "شامل مالیات های قابل اجرا";
$_LANG['includeTLDs'] = "شامل TLD ها";
...
$_LANG['invalidCode'] = "کد تبلیغاتی نامعتبر";
$_LANG['invalid_input'] = "ورودی نامعتبر: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "شناسه بلیط یا شناسه پاسخ نامعتبر.";
...
$_LANG['marketConnect']['dynamic']['manage'] = "ورود به سیستم";
...
$_LANG['navMarketConnectService']['dynamic'] = "خدمات پویا";
...
$_LANG['noDomainsFound'] = "هیچ دامنه ای یافت نشد";
...
$_LANG['orderForm']['additionalInformation'] = "اطلاعات دیگر";
...
$_LANG['orderForm']['findNewDomainAi'] = "یک دامنه را با پیشنهادات مبتنی بر هوش مصنوعی جستجو کنید.";
...
$_LANG['ordererrortldsnotconfigured'] = "در حال حاضر هیچ پسوند دامنه برای فروش در دسترس نیست. برای کمک، با ما تماس بگیرید.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "سالانه";
$_LANG['orderpaymenttermadjectivebiennially'] = "دوسالانه";
$_LANG['orderpaymenttermadjectivefree'] = "رایگان";
$_LANG['orderpaymenttermadjectivemonthly'] = "ماهانه";
$_LANG['orderpaymenttermadjectiveonetime'] = "به صورت یک بار";
$_LANG['orderpaymenttermadjectivequarterly'] = "سه ماهه";
$_LANG['orderpaymenttermadjectivesemiannually'] = "نیمه سالانه";
$_LANG['orderpaymenttermadjectivetriennially'] = "سه سالانه";
...
$_LANG['orderselectterm'] = "اصطلاح را انتخاب کنید";
...
$_LANG['page'] = "صفحه";
$_LANG['pageof'] = "از";
$_LANG['passwordtips'] = "<strong>نکات برای یک رمز عبور امن</strong><br />از هر دو حرف بزرگ و کوچک استفاده کنید.<br />حداقل یک نماد را شامل کنید (به عنوان مثال، <code>#</code>، <code>$</code>, <code>!</code>، <code>%</code>، یا <code>&amp;</code>).<br />از کلمات فرهنگ لغت استفاده نکنید. رمزهای عبور<br />می توانند حاوی حداکثر :maximumکاراکترهای _length باشند.";
...
$_LANG['premium'] = "حق بیمه";
$_LANG['presalescontactdescription'] = "سوالات پیش از خرید";
$_LANG['previous'] = "قبلی";
$_LANG['previouspage'] = "صفحه قبل";
$_LANG['price'] = "قیمت";
$_LANG['priceFor'] = "قیمت برای :term";
$_LANG['priceForThisTerm'] = "قیمت برای این اصطلاح";
$_LANG['priceStandard'] = "هر ساله با قیمت :renewalPriceبه علاوه مالیات تمدید می شود.";
$_LANG['priceWithDiscount'] = ":registrationPrice برای سال اول، سپس :renewalPrice سالانه.";
...
$_LANG['processing'] = "در حال پردازش ...";
...
$_LANG['pwlengthmax'] = "رمزهای عبور نمی توانند بیش از :max حاوی کاراکتر باشند.";
...
$_LANG['pwstrengthfail'] = "این رمز عبور به اندازه کافی قوی نیست. یک رمز عبور پیچیده تر را وارد کنید.";
...
$_LANG['recommendedTLDs'] = "TLD های توصیه شده";
...
$_LANG['requiredFields'] = "فیلدهای مورد نیاز با * مشخص شده اند";
...
$_LANG['rssfeed'] = "فید";
$_LANG['safeSearch'] = "جستجوی امن";
$_LANG['sale'] = "فروش";
$_LANG['salePrice'] = "قیمت فروش";
$_LANG['salesTaxes'] = "مالیات فروش";
$_LANG['search'] = "جستجو";
$_LANG['searchOurKnowledgebase'] = "جستجو پایگاه دانش";
$_LANG['searchResults'] = "نتایج جستجو";
...
$_LANG['selectCountry'] = "انتخاب کشور";
$_LANG['selectDomain'] = "انتخاب دامنه";
$_LANG['selectDomainForHosting'] = "دوست دارید این بسته میزبانی مشترک را به کدام دامنه ضمیمه کنید؟";
$_LANG['selectDomainsForSsl'] = "دوست دارید SSL پایه را برای کدام دامنه اعمال کنید؟ شما می توانید چندین را انتخاب کنید.";
$_LANG['selectState'] = "ایالت را انتخاب کنید";
...
$_LANG['service_unavailable'] = "سرویس در دسترس نیست: %s";
$_LANG['servicesRenew'] = "تمدید";
$_LANG['setupFee'] = ":amount هزینه راه اندازی";
$_LANG['setupMandate'] = "دستور راه اندازی برای پرداخت";
$_LANG['sharedHosting'] = "میزبانی مشترک";
$_LANG['shopNow'] = "همین حالا بخرید";
$_LANG['shortcuts'] = "میانبر";
$_LANG['show'] = "نمایش";
$_LANG['showMenu'] = "نمایش منو";
$_LANG['showSearchControls'] = "نمایش کنترل های جستجو";
...
$_LANG['store']['dynamic']['title'] = "خدمات پویا";
...
$_LANG['store']['error']['serviceUnavailable'] = "در حال حاضر نمی توان درخواست شما را پردازش کرد. این ممکن است به دلیل تعطیلی یا مشکل خدمات موقت باشد. لطفا دوباره امتحان کنید";
$_LANG['store']['error']['validationFailed'] = "لطفا خطاهای زیر را بررسی و اصلاح کنید.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo بدون نیاز به متخصص بودن، فرآیند سئو اثبات شده و هدایت شده را در اختیار شما قرار می دهد. <br> marketgoo مقرون به صرفه است و گزارش ها، برنامه ها و توصیه های جامع سئو را در یک رابط بصری ارائه می دهد.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "چه چیزی marketgoo را با سایر محصولات سئو متفاوت می کند؟";
$_LANG['store']['marketgoo']['faqs']['title'] = "سوالات متداول و پشتیبانی";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "ارسال موتور جستجو";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "سازگاری سازنده وب سایت";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "گزارش پیشرفت ماهانه";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "تجزیه و تحلیل ترافیک";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "دانلود گزارش سئو به صورت PDF <a href='https://mktgoo.co/seo-report-score2'>(مثال را ببینید)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "ویژگی های مبتنی بر هوش مصنوعی: تولید خودکار عنوان و توضیحات متا";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "صفحات اسکن شده";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "ردیابی رقیب";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "ردیابی کلمات کلیدی و بهینه سازی";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "گزارش و برنامه به روز شده";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "طرح سئو سفارشی";
$_LANG['store']['marketgoo']['features']['1'] = "برنامه سئو خود را دریافت کنید";
$_LANG['store']['marketgoo']['features']['2'] = "دستورالعمل گام به گام";
$_LANG['store']['marketgoo']['features']['3'] = "نظارت بر پیشرفت با یک گزارش ماهانه";
$_LANG['store']['marketgoo']['features']['4'] = "ردیابی و نظارت بر رقبا";
$_LANG['store']['marketgoo']['features']['5'] = "بهینه سازی صفحه فردی";
$_LANG['store']['marketgoo']['features']['6'] = "تحقیق و نظارت بر کلمات کلیدی آسان";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "ثبت نام کنید و گزارش و برنامه فوری سئو خود را دریافت کنید. ببینید جایی برای بهبود وجود دارد و توصیه هایی را برای سایت خود دریافت کنید.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "دستورالعمل ها برای کاربران غیر متخصص فناوری نوشته شده اند و شما را در هر توصیه، با مثال ها و توضیحات راهنمایی می کنند.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "هر ماه، یک ایمیل با پیشرفت سئو سایت خود دریافت کنید و آن را به صورت PDF دانلود کنید.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "رقبا را تحت نظر داشته باشید تا ببینید آنها برای به دست آوردن ترافیک چه کاری انجام می دهند و چگونه شمارههای شما در مقایسه با شمارههای آنها مقایسه می شوند. اونا هيچوقت نميفهمن که داري نگاه ميکني";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo با تطبیق آن با یکی از کلمات کلیدی انتخابی شما و اطمینان از صحت فرکانس و قرار دادن صحیح بودن فرکانس، شما را در بهینه سازی هر صفحه در سایت شما راهنمایی می کند.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "اگر با SEO آشنا نیستید، کلمات کلیدی می توانند بسیار سخت باشند. marketgoo کلمات کلیدی را توصیه می کند و همچنین به شما امکان می دهد کلمات کلیدی را جستجو و وارد کنید که می خواهید برای آنها بهینه سازی کنید.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "با تمام سازندگان وب سایت کار می کند";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " تاریخ مقایسه: 19 ژوئن 20 25:tagBreak*عملکرد کلی شبکه بر اساس تحقیقات AV-Test. شما می توانید :tagOpenگزارش کامل:tagCloseرا بخوانید.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "هشدارها در مورد اطلاعات فاش شده";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "اسکن بدافزار برای دانلود";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn2'] = "۷۳۰۰ +";
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "فاش نشده";
$_LANG['store']['nordvpn']['features']['comparison']['vpn4'] = "200+";
$_LANG['store']['nordvpn']['features']['comparison']['vpn5'] = "۳۰۰۰+";
$_LANG['store']['nordvpn']['features']['comparison']['vpn6'] = "۶۵۰۰ +";
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "ردیاب و مسدود کننده تبلیغات";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN سرعت اتصال را محدود نمی کند. از اتصال VPN تمام سرعت ما بدون هیچ گونه محدودیت لذت ببرید.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN با تمام سیستم عامل های محبوب از جمله ویندوز، macOS، لینوکس، اندروید و iOS سازگار است. به علاوه، شما می توانید حداکثر 10 دستگاه از جمله روتر خود را امن کنید.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "بدون محدودیت پهنای باند VPN  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "مرور، بازی و کار بر روی یک اتصال خصوصی و امن";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "حتی در وای فای عمومی به طور ایمن متصل باشید";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "ردیابی آنلاین را با محافظت از آدرس IP خود کاهش دهید";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "تماشای محتوای خانه هنگام سفر به خارج از کشور";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "از NordVPN برای رمزگذاری فعالیت آنلاین خود برای یک لایه محافظت اضافی در هر زمان و هر کجا که متصل هستید استفاده کنید.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN از اتصال شما با رمزگذاری نسل بعدی محافظت می کند، بنابراین می توانید بدون نگرانی به حساب های خود وارد شوید، انتقال بانکی انجام دهید و آنلاین خرید کنید. حتی در شبکه های محافظت نشده.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN دارای طیف گسترده ای از ویژگی ها برای محافظت از شما در برابر تهدیدات سایبری است. علاوه بر Threat Protection Pro™، یک Kill Switch خودکار وجود دارد که در صورت قطع اتصال VPN شما اتصال به اینترنت شما را مسدود می کند و اطمینان حاصل می کند که داده های شما ایمن می مانند. سرورهای مبهم زمانی که به دلیل سانسور دولتی و مقررات دقیق اینترنت نیاز به سطح بالایی از امنیت آنلاین باشد، کمک خواهند کرد.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "امنیت آنلاین خود را با VPN افزایش دهید";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "امنیت پیشرفته";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "هر زمان که فایلی را بارگیری می کنید، Threat Protection Pro™ آن را از نظر بدافزار بررسی می کند.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ تبلیغات مزاحم و ردیاب های وب را مسدود می کند و به طور خودکار URL ها را اسکن می کند و موارد مخرب را مسدود می کند.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Threat Protection Pro™ از دستگاه ها و حریم خصوصی شما محافظت می کند. با مسدود کردن ردیاب ها، به شما کمک می کند از جاسوسی آنلاین اجتناب کنید.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "ویژگی :tagOpenThreat Protection Pro™:tagClose NordVPN یک تغییر دهنده بازی است که مزایای امنیتی بیشتری و حفاظت بهتری را با یک کلیک اضافی ارائه می دهد.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "چیزی فراتر از یک VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "حتی اگر چیزی برای پنهان کردن ندارید، احتمالاً ایده تماشا و ردیابی شدن را دوست ندارید. دلیل اصلی اینکه کاربران اینترنت خدمات VPN را انتخاب می کنند، حریم خصوصی آنلاین و امنیت عمومی است.:tagBreakدر اینجا دلایل خاصی وجود دارد که چرا؟";
...
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "از محدودیت های منطقه ای و سیاسی در سیستم عامل هایی مانند فیس بوک، X (توییتر) و واتساپ اجتناب کنید.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "تبلیغات آنلاین معمولا آزار دهنده و پرت کننده هستند. آنها بخش بزرگی از وب سایت ها را به هم ریخته می کنند، سرعت اتصال را کاهش می دهند و ممکن است مخرب باشند.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "فن آوری های خانه هوشمند، به ویژه دستگاه های غیر امن اینترنت اشیا، می توانند آسیب پذیری ها را در شبکه های خانگی ایجاد کنند.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "اتصال Wi-Fi عمومی امن";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "مرور ایمن تر";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "دسترسی نامحدود به رسانه های اجتماعی";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "حفاظت از تبلیغات مخرب";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "امنیت خانه هوشمند";
...
$_LANG['store']['nordvpn']['features']['world']['count1'] = "۷۳۰۰ +";
$_LANG['store']['nordvpn']['features']['world']['count2'] = "۱۱۸";
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "معامله را دریافت کنید";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• از آدرس IP خود محافظت کنید:tagBreak• مسدود کردن بدافزارها، ردیاب ها و تبلیغات:tagBreak• اتصال حداکثر 10 دستگاه";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "اسکن پایگاه داده هوشمند روزانه";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "اسکن روزانه فایل هوشمند";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "محتوای تازه طراحی کنید، تعامل را بهبود ببخشید و نتایج خود را با SocialBee پیگیری کنید.";
$_LANG['store']['socialbee']['cartTitle'] = "مدیریت رسانه های اجتماعی SocialBee";
...
$_LANG['suggestedTLDs'] = "TLD های پیشنهادی";
...
$_LANG['tax']['errorVatInvalidFormat'] = "فرمت شماره مالیات بر ارزش افزوده نامعتبر برای :countryName";
...
$_LANG['updateProductQuantity'] = "به روز رسانی";
$_LANG['updateTotals'] = "بروز رسانی محموع";
