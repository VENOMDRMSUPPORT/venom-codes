...
$_LANG['addToCartButton'] = "Lägg till i kundvagnen";
$_LANG['addToGetFreeDomain'] = "Lägg till för att få gratis domän";
...
$_LANG['basicSsl'] = "Grundläggande SSL";
$_LANG['billableitemseach'] = "Ea";
$_LANG['billableitemshour'] = "Timme";
$_LANG['billableitemshours'] = "Timmar";
$_LANG['billableitemsquantity'] = "Antal";
$_LANG['billing']['creditnote'] = "Kreditnota";
$_LANG['billing']['debitnote'] = "Debitnota";
$_LANG['billing']['issuedate'] = "Utgivningsdatum";
$_LANG['billing']['issuedby'] = "Utfärdad av";
$_LANG['billing']['issuedto'] = "Utfärdad till";
$_LANG['billing']['ledger']['date'] = "Datum";
$_LANG['billing']['ledger']['reference'] = "Referens";
$_LANG['billing']['ledger']['title'] = "Redovisning";
$_LANG['billing']['ledger']['type'] = "Typ";
$_LANG['billing']['type']['affiliatepayout'] = "Affiliate-utbetalning";
$_LANG['billing']['type']['clientaccountcredit'] = "Kredit för kundkonto";
$_LANG['billing']['type']['clientaccountdebit'] = "Debitering av klientkonto";
$_LANG['billing']['type']['creditnoteadjustment'] = "Justering av kreditnota";
$_LANG['billing']['type']['invoiceadjustment'] = "Fakturajering";
$_LANG['billing']['type']['payment'] = "Betalning";
$_LANG['billing']['type']['refund'] = "Återbetalning";
$_LANG['billing']['type']['refundtocredit'] = "Återbetalning till kundkonto";
$_LANG['billingAddress'] = "Fakturaadress";
$_LANG['billingOverview'] = "Faktureringsöversikt";
$_LANG['billingdetails'] = "Fakturadetaljer";
$_LANG['billingnotes']['creditnote']['items'] = "Kreditnoposter";
$_LANG['billingnotes']['debitnote']['items'] = "Debetnoteringsobjekt";
...
$_LANG['cartItemType']['addon'] = "Tilläggsdomän";
$_LANG['cartItemType']['addons'] = "Tilläggs";
$_LANG['cartItemType']['bundle'] = "Bunt";
$_LANG['cartItemType']['bundles'] = "Buntar";
$_LANG['cartItemType']['domain'] = "Domän";
$_LANG['cartItemType']['domainRegistration'] = "Domänregistrering";
$_LANG['cartItemType']['domainRenewal'] = "Domänförnyelse";
$_LANG['cartItemType']['domainRenewals'] = "Domänförnyelse";
$_LANG['cartItemType']['domainTransfer'] = "Domänflytt";
$_LANG['cartItemType']['domainTransfers'] = "Domänöverföringar";
$_LANG['cartItemType']['domains'] = "Domäner";
$_LANG['cartItemType']['product'] = "Produkt";
$_LANG['cartItemType']['products'] = "Produkter";
$_LANG['cartItemsSelected'] = "Du har :count valt och redo att köpa.";
...
$_LANG['cartbrowse'] = "Bläddra bland produkter och tjänster";
...
$_LANG['choosePackages'] = "Välj bland ett urval av paket";
...
$_LANG['codeApplied'] = "Kampanjkod tillämpad";
...
$_LANG['confirmItemDeletion'] = "Bekräfta borttagning";
...
$_LANG['cycleRenewal'] = ":cycle Förnyelse";
...
$_LANG['designedToFitAnyBudget'] = "Designad för att passa alla budgetar";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Sök efter nyckelord, beskrivning eller domän.&#10;Till exempel: &quot;Roliga affärsevenemang &quot;, &quot;En omfattande finansiell planeringstjänst för proffs&quot;, eller &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Ange en kort beskrivning eller en exakt domän.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "Systemet kunde inte hitta några förslag.";
$_LANG['domainSearch']['exactMatch'] = "Exakt matchning";
$_LANG['domainSearch']['maxLength'] = "Maximal längd";
$_LANG['domainSearch']['notAvailable'] = "Inte tillgänglig";
$_LANG['domainSearch']['safeSearch'] = "Säker sökning";
$_LANG['domainSearch']['tlds'] = "Inkludera toppdomäner";
$_LANG['domainSearch']['topAiSuggestion'] = "Bästa AI-förslag";
$_LANG['domainSearch']['topSuggestion'] = "Toppförslag";
...
$_LANG['due'] = "Förfaller";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "Du måste acceptera användarvillkoren genom att markera :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute måste vara en matris.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute måste vara ett giltigt datum.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute måste vara en giltig e-postadress.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "Systemet stötte på ett internt fel. Försök igen senare.";
$_LANG['dynamicServiceFields']['validation']['in'] = "Det valda alternativet för :attribute är ogiltigt.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute måste vara ett heltal.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute får inte innehålla fler än :max tecken.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute måste använda någon av följande filtyper: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute måste innehålla minst :min tecken.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute måste vara ett nummer.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute måste vara ett giltigt reguljärt uttryck.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute krävs.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute måste vara en giltig URL som innehåller protokollet ('http: //' eller 'https: //').";
$_LANG['edit'] = "Redigera";
$_LANG['email'] = "E-post";
...
$_LANG['encryption_failed'] = "Kryptering misslyckades: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Försök igen senare.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Hemsida";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Du har skickat för många förfrågningar.";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "Hoppsan!";
...
$_LANG['estimateTaxes'] = "Uppskatta skatter";
$_LANG['every'] = "per";
$_LANG['exampledomain'] = "ex. example.com";
$_LANG['excludeTLDs'] = "Gäller endast vissa TLDs och inte nyligen förlängda domäner";
...
$_LANG['extendYourDomainBy1Year'] = "Förläng din domän med 1 år*";
...
$_LANG['findDomains'] = "Hitta domäner";
...
$_LANG['forTheFirstYear'] = "för det första året";
...
$_LANG['freeDomainHostingPromo'] = "Få en gratis domän när du köper hosting.";
$_LANG['from'] = "Från";
...
$_LANG['hideSearchControls'] = "Dölj sökkontroller";
...
$_LANG['inStock'] = "I lager: :amount";
$_LANG['incApplicableTaxes'] = "inkl. tillämpliga skatter";
$_LANG['includeTLDs'] = "Inkludera toppdomäner";
$_LANG['included'] = "Ingår";
...
$_LANG['invalidCode'] = "Ogiltig kampanjkod";
$_LANG['invalid_input'] = "Ogiltig indata: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "Ogiltigt biljett-id eller svar-id.";
...
$_LANG['lastChance'] = "Sista chansen";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Logga in";
...
$_LANG['navMarketConnectService']['dynamic'] = "Dynamiska tjänster";
...
$_LANG['noDomainsFound'] = "Inga domäner hittades";
...
$_LANG['orderForm']['additionalInformation'] = "Ytterligare information";
...
$_LANG['orderForm']['findNewDomainAi'] = "Sök efter en domän med AI-drivna förslag.";
...
$_LANG['ordererrortldsnotconfigured'] = "Inga domäntillägg är för närvarande tillgängliga för försäljning. För hjälp, kontakta oss.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "Årlig";
$_LANG['orderpaymenttermadjectivebiennially'] = "Tvåårsjubileum";
$_LANG['orderpaymenttermadjectivefree'] = "Gratis";
$_LANG['orderpaymenttermadjectivemonthly'] = "Månadsvis";
$_LANG['orderpaymenttermadjectiveonetime'] = "Engångs";
$_LANG['orderpaymenttermadjectivequarterly'] = "Kvartalsvis";
$_LANG['orderpaymenttermadjectivesemiannually'] = "Halvårsvis";
$_LANG['orderpaymenttermadjectivetriennially'] = "Treennal";
...
$_LANG['orderselectterm'] = "Välj Term";
...
$_LANG['page'] = "Sida";
$_LANG['pageof'] = "av";
$_LANG['passwordtips'] = "<strong>Tips för ett säkert lösenord</strong><br />Använd både versaler och gemener.<br />Inkludera minst en symbol (till exempel <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>, eller <code>&amp;</code>).<br />Använd inte ordboksord.<br />Lösenord kan innehålla upp till :maximum_längdtecken.";
...
$_LANG['price'] = "pris";
$_LANG['priceFor'] = "Pris för :term";
$_LANG['priceForThisTerm'] = "Pris för denna termin";
$_LANG['priceStandard'] = "Förnyas varje år med :renewalPrice, plus skatt.";
$_LANG['priceWithDiscount'] = ":registrationPrice för det första året, sedan :renewalPrice årligen.";
...
$_LANG['pwlengthmax'] = "Lösenord får inte innehålla fler än :max tecken.";
...
$_LANG['pwstrengthfail'] = "Lösenordet är inte tillräckligt starkt. Ange ett mer komplext lösenord.";
...
$_LANG['recommendedTLDs'] = "Rekommenderade toppdomäner";
...
$_LANG['renewPrice'] = "Förnya priset";
...
$_LANG['requiredFields'] = "Obligatoriska fält är markerade med*";
...
$_LANG['rssfeed'] = "Flöde";
$_LANG['safeSearch'] = "Säker sökning";
$_LANG['sale'] = "Rea";
$_LANG['salePrice'] = "försäljningspris";
$_LANG['salesTaxes'] = "Försäljningsskatter";
$_LANG['search'] = "Sök";
$_LANG['searchOurKnowledgebase'] = "Sök i vår kunskapsbas";
$_LANG['searchResults'] = "Sökrresultat";
...
$_LANG['selectCountry'] = "Välj land";
$_LANG['selectDomain'] = "Välj domän";
$_LANG['selectDomainForHosting'] = "Vilken domän vill du bifoga detta delade värdpaket till?";
$_LANG['selectDomainsForSsl'] = "Vilken (n) domän (er) vill du tillämpa grundläggande SSL på? Du kan välja flera.";
$_LANG['selectState'] = "Välj stat";
...
$_LANG['service_unavailable'] = "Tjänsten är inte tillgänglig: %s";
$_LANG['servicesRenew'] = "Förnya";
$_LANG['setupFee'] = ":amount Startavgift";
$_LANG['setupMandate'] = "Ställ in betalningsuppdrag";
$_LANG['sharedHosting'] = "Delad webbhotell";
$_LANG['shopNow'] = "Handla nu";
$_LANG['shortcuts'] = "Genvägar";
$_LANG['show'] = "Visa";
$_LANG['showMenu'] = "Visa meny";
$_LANG['showSearchControls'] = "Visa sökkontroller";
...
$_LANG['store']['dynamic']['title'] = "Dynamiska tjänster";
...
$_LANG['store']['error']['serviceUnavailable'] = "Det går inte att behandla din begäran just nu. Detta kan bero på en timeout eller ett tillfälligt serviceproblem. Vänligen försök igen.";
$_LANG['store']['error']['validationFailed'] = "Kontrollera och korrigera felen nedan.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo ger dig en beprövad, guidad SEO-process utan att du behöver vara expert. <br> marketgoo är prisvärd och ger omfattande SEO-rapporter, planer och rekommendationer, allt i ett intuitivt gränssnitt.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Vad skiljer marketgoo från andra SEO-produkter?";
$_LANG['store']['marketgoo']['faqs']['title'] = "Vanliga frågor och support";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "Sökmotorinlämning";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Webbplatsbyggarkompatibilitet";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Månatlig lägesrapport";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Trafikanalys";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Ladda ner SEO-rapport som PDF <a href='https://mktgoo.co/seo-report-score2'>(Se exempel)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "AI-drivna funktioner: Automatisk generering av titel och metabeskrivning";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Skannade sidor";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Konkurrentspårning";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Sökordsspårning och optimering";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Uppdaterad rapport och plan";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Anpassad SEO-plan";
$_LANG['store']['marketgoo']['features']['1'] = "Skaffa din SEO-plan";
$_LANG['store']['marketgoo']['features']['2'] = "Följ steg-för-steg-instruktioner";
$_LANG['store']['marketgoo']['features']['3'] = "Övervaka framstegen med en månadsrapport";
$_LANG['store']['marketgoo']['features']['4'] = "Spåra och övervaka konkurrenter";
$_LANG['store']['marketgoo']['features']['5'] = "Individuell sidoptimering";
$_LANG['store']['marketgoo']['features']['6'] = "Enkel sökordsforskning och övervakning";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Registrera dig och få din omedelbara SEO-rapport och plan. Se var det finns utrymme för förbättringar och få rekommendationer skräddarsydda för din webbplats.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Instruktioner är skrivna för icke-tekniskt kunniga användare, guidar dig genom varje rekommendation, med exempel och förklaringar.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Varje månad får du ett e-postmeddelande med webbplatsens SEO-framsteg och ladda ner den som en PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Håll koll på konkurrenter för att se vad de gör för att få trafik och hur dina nummer står sig mot deras. De kommer aldrig att veta att du tittar!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo guidar dig genom att optimera varje enskild sida på din webbplats genom att matcha den till ett av dina valda sökord och se till att frekvensen och placeringen är korrekt.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "Nyckelord kan vara överväldigande om du inte är bekant med SEO. marketgoo rekommenderar nyckelord och låter dig också söka efter och ange de du vill optimera för.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Fungerar med alla webbplatsbyggare";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Datum för jämförelse: Juni 19, 20 25:tagBreak*Övergripande nätverksprestanda enligt forskning från AV-Test. Du kan läsa :tagOpenhela rapporten:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Varningar om läckta referenser";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Sök efter nedladdningar av skadlig programvara";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Inte avslöjad";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "Tracker och annonsblockerare";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN begränsar inte anslutningshastigheter. Njut av vår VPN-anslutning med full hastighet utan strypning.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN är kompatibel med alla populära plattformar, inklusive Windows, macOS, Linux, Android och iOS. Dessutom kan du säkra upp till 10 enheter, inklusive din router.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "Inga VPN-bandbreddsgränser  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Bläddra, spela och arbeta på en privat och säker anslutning";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Håll dig säkert uppkopplad även på offentlig Wi-Fi";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Minska spårning online genom att skydda din IP-adress";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Titta på heminnehåll när du reser utomlands";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Använd NordVPN för att kryptera din onlineaktivitet för ett extra lager av skydd när och var du än är ansluten.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN skyddar din anslutning med nästa generations kryptering, så att du kan logga in på dina konton, göra banköverföringar och handla online utan bekymmer. Även på oskyddade nätverk.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN har ett brett utbud av funktioner för att skydda dig från cyberhot. Förutom Threat Protection Pro™ finns det en automatisk Kill Switch som blockerar din internetanslutning om din VPN-anslutning bryts, vilket säkerställer att dina data förblir säkra. Fördunklade servrar hjälper till när en hög nivå av onlinesäkerhet krävs på grund av statlig censur och strikta internetregler.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Öka din onlinesäkerhet med ett VPN";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Avancerad säkerhet";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "När du laddar ner en fil inspekterar Threat Protection Pro™ den för skadlig kod.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ blockerar påträngande annonser och webbspårare och skannar automatiskt webbadresser och blockerar skadliga.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Threat Protection Pro™ skyddar dina enheter och din integritet. Genom att blockera spårare hjälper det dig att undvika online-snoopers.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "NordVPN:s :tagOpenThreat Protection Pro™:tagClose funktion är en spelväxlare som erbjuder ännu fler säkerhetsfördelar och bättre skydd med ett enda extra klick.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Mer än bara ett VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Även om du inte har något att dölja, gillar du förmodligen inte tanken på att bli bevakad och spårad. Den främsta anledningen till att internetanvändare väljer VPN-tjänster är integritet online och allmän säkerhet.:tagBreakHär är specifika skäl VARFÖR?";
...
$_LANG['store']['nordvpn']['features']['use']['tagline3'] = "Förhindra tredje part, till exempel internetleverantörer, från att se och spåra din dagliga onlineaktivitet.";
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Undvik regionala och politiska begränsningar på plattformar som Facebook, X (Twitter) och WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Onlineannonser är vanligtvis irriterande och distraherande. De stör stora delar av webbplatser, långsam anslutningshastighet och kan vara skadliga.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Smarta hemteknologier, särskilt osäkra IoT-enheter, kan skapa sårbarheter i hemnätverk.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Säker offentlig Wi-Fi-anslutning";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Säkrare surfning";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Obegränsad tillgång till sociala medier";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Skydd mot skadliga annonser";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Smart hemsäkerhet";
...
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Skaffa affären";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Skydda din IP-adress:tagBreak• Blockera skadlig kod, spårare och annonser:tagBreak• Anslut upp till 10 enheter";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Dagliga SMART-databasskanningar";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Dagliga SMART-filskanningar";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Designa nytt innehåll, förbättra engagemanget, och spåra dina resultat med SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "SocialBee Hantering av sociala medier";
...
$_LANG['success'] = "Klart";
$_LANG['suggestedTLDs'] = "Föreslagna toppdomäner";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Ogiltigt momsnummerformat för :countryName.";
...
$_LANG['updateProductQuantity'] = "Uppdatera";
$_LANG['updateTotals'] = "Uppdatera totaler";
