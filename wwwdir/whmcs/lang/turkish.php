...
$_LANG['addToCartButton'] = "Sepete Ekle";
$_LANG['addToGetFreeDomain'] = "Ücretsiz alan adı almak için ekle";
...
$_LANG['billing']['creditnote'] = "Kredi notu";
$_LANG['billing']['debitnote'] = "Borç Notu";
$_LANG['billing']['issuedate'] = "Veriliş Tarihi";
$_LANG['billing']['issuedby'] = "Tarafından Verildi";
$_LANG['billing']['issuedto'] = "Şuraya Verildi";
$_LANG['billing']['ledger']['date'] = "Tarih";
$_LANG['billing']['ledger']['reference'] = "Referans";
$_LANG['billing']['ledger']['title'] = "Defter";
$_LANG['billing']['ledger']['type'] = "Tür";
$_LANG['billing']['type']['affiliatepayout'] = "Ortaklık Ödemesi";
$_LANG['billing']['type']['clientaccountcredit'] = "Müşteri Hesabı Kredisi";
$_LANG['billing']['type']['clientaccountdebit'] = "Müşteri Hesabı Borç";
$_LANG['billing']['type']['creditnoteadjustment'] = "Kredi Notu Ayarlaması";
$_LANG['billing']['type']['invoiceadjustment'] = "Fatura Ayarlama";
$_LANG['billing']['type']['payment'] = "Ödeme";
$_LANG['billing']['type']['refund'] = "Para iadesi";
$_LANG['billing']['type']['refundtocredit'] = "Müşteri Hesabına Geri Ödeme";
$_LANG['billingAddress'] = "Fatura Adresi";
$_LANG['billingOverview'] = "Faturalandırma Detayları";
$_LANG['billingdetails'] = "Ödeme Detayları";
$_LANG['billingnotes']['creditnote']['items'] = "Kredi Notu Öğeleri";
$_LANG['billingnotes']['debitnote']['items'] = "Borç Notu Öğeleri";
...
$_LANG['cartItemType']['addon'] = "Eklenti";
$_LANG['cartItemType']['addons'] = "Eklentiler";
$_LANG['cartItemType']['bundle'] = "Paket";
$_LANG['cartItemType']['bundles'] = "Paketler";
$_LANG['cartItemType']['domain'] = "Alan Adı";
$_LANG['cartItemType']['domainRegistration'] = "Alan Adı Kaydı";
$_LANG['cartItemType']['domainRenewal'] = "Alan Adı Yenileme";
$_LANG['cartItemType']['domainRenewals'] = "Alan Adı Yenileme";
$_LANG['cartItemType']['domainTransfer'] = "Alan Adı Kaydı";
$_LANG['cartItemType']['domainTransfers'] = "Alan Adı Transferleri";
$_LANG['cartItemType']['domains'] = "Alan Adları";
$_LANG['cartItemType']['product'] = "Ürün";
$_LANG['cartItemType']['products'] = "Ürünler";
$_LANG['cartItemsSelected'] = ":count seçtiniz ve satın almaya hazırsınız.";
...
$_LANG['cartbrowse'] = "Ürün ve Hizmetlere Göz Atın";
...
$_LANG['choosePackages'] = "Çeşitli paketler arasından seçim yapın";
...
$_LANG['codeApplied'] = "Promosyon kodu uygulandı";
$_LANG['completeorder'] = "Siparişi Tamamla";
$_LANG['configModalTitle'] = "Yapılandırma";
...
$_LANG['confirmItemDeletion'] = "Silmeyi Onayla";
...
$_LANG['cycleRenewal'] = ":cycle Yenileme";
$_LANG['daily'] = "Günlük";
...
$_LANG['designedToFitAnyBudget'] = "Her bütçeye uyacak şekilde tasarlanmıştır";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Anahtar kelime, açıklama veya alan adına göre arama yapın.&#10;Örneğin: &quot;Eğlenceli iş etkinlikleri &quot;, &quot;Profesyoneller için kapsamlı bir finansal planlama hizmeti&quot;veya &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Kısa bir açıklama veya tam bir alan adı girin.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "Sistem herhangi bir öneri bulamadı.";
$_LANG['domainSearch']['exactMatch'] = "Tam Eşleşme";
$_LANG['domainSearch']['maxLength'] = "Maksimum Uzunluk";
$_LANG['domainSearch']['notAvailable'] = "Durum Bilgisi Alınamadı";
$_LANG['domainSearch']['safeSearch'] = "Güvenli Arama";
$_LANG['domainSearch']['tlds'] = "TLD'leri dahil et";
$_LANG['domainSearch']['topAiSuggestion'] = "En İyi Yapay Zeka Önerisi";
$_LANG['domainSearch']['topSuggestion'] = "En İyi Öneri";
...
$_LANG['due'] = "Hakediş";
$_LANG['dynamicServiceFields']['validation']['accepted'] = ":attributeseçeneğini işaretleyerek hizmet şartlarını kabul etmelisiniz.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute bir dizi olmalıdır.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute geçerli bir tarih olmalıdır.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute geçerli bir e-posta adresi olmalıdır.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "Sistem dahili bir hatayla karşılaştı. Daha sonra tekrar deneyin.";
$_LANG['dynamicServiceFields']['validation']['in'] = ":attribute için seçilen seçenek geçersiz.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute bir tamsayı olmalıdır.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute , :max karakterden fazla içeremez.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute aşağıdaki dosya türlerinden birini kullanmalıdır: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute en az :min karakter içermelidir.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute bir sayı olmalı.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute geçerli bir normal ifade olmalıdır.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute gereklidir.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute protokolü içeren geçerli bir URL olmalıdır ('http: //' veya 'https: //').";
$_LANG['edit'] = "Düzenle";
$_LANG['email'] = "E-posta";
...
$_LANG['enabled'] = "Etkin";
$_LANG['encryption_failed'] = "Şifreleme Başarısız: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Daha sonra tekrar deneyin.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Ana Sayfa";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Çok fazla istek gönderdiniz.";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "Hata !!!";
...
$_LANG['estimateTaxes'] = "Tahmini Vergiler";
$_LANG['every'] = "Her";
$_LANG['exampledomain'] = "örn. example.com";
$_LANG['excludeTLDs'] = "Son yenilenen alan adlarını ve bazı uzantıları dahil etme";
...
$_LANG['extendYourDomainBy1Year'] = "Alan adınızı 1 yıl uzatın*";
...
$_LANG['findDomains'] = "Etki Alanları Bul";
...
$_LANG['forTheFirstYear'] = "ilk yıl için";
...
$_LANG['freeDomainHostingPromo'] = "Hosting satın aldığınızda ücretsiz bir alan adı edinin.";
...
$_LANG['hideSearchControls'] = "Arama Kontrollerini Gizle";
...
$_LANG['inStock'] = "Stokta var: :amount";
$_LANG['incApplicableTaxes'] = "geçerli vergiler dahil";
$_LANG['includeTLDs'] = "TLD'leri dahil et";
$_LANG['included'] = "Dahil";
...
$_LANG['invalidCode'] = "Geçersiz promosyon kodu";
$_LANG['invalid_input'] = "Geçersiz Giriş: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "Geçersiz bilet kimliği veya yanıt kimliği.";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Oturum aç";
...
$_LANG['maxLength'] = "Maksimum uzunluk";
...
$_LANG['navMarketConnectService']['dynamic'] = "Dinamik Hizmetler";
...
$_LANG['noDomainsFound'] = "Alan adı bulunamadı";
...
$_LANG['orderForm']['additionalInformation'] = "Ek Bilgiler";
...
$_LANG['orderForm']['findNewDomainAi'] = "Yapay zeka destekli önerilerle bir alan adı arayın.";
...
$_LANG['ordererrortldsnotconfigured'] = "Şu anda satılık alan adı uzantısı yok. Yardım için bizimle iletişime geçin.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "Yıllık";
$_LANG['orderpaymenttermadjectivebiennially'] = "Bienal";
$_LANG['orderpaymenttermadjectivefree'] = "Ücretsiz";
$_LANG['orderpaymenttermadjectivemonthly'] = "Aylık";
$_LANG['orderpaymenttermadjectiveonetime'] = "Tek seferlik";
$_LANG['orderpaymenttermadjectivequarterly'] = "3 Aylık";
$_LANG['orderpaymenttermadjectivesemiannually'] = "Yarı Yıllık";
...
$_LANG['orderselectterm'] = "Terim Seçin";
...
$_LANG['passwordtips'] = "<strong>Güvenli Şifre İçin İpuçları</strong><br />Hem büyük hem de küçük harf karakterleri kullanın.<br />En az bir sembol ekleyin (örneğin, <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>, veya <code>&amp;</code>).<br />Sözlük kelimelerini kullanmayın.<br />Parolalar en fazla :maximum_length karakteri içerebilir.";
...
$_LANG['price'] = "fiyat";
$_LANG['priceFor'] = ":termiçin fiyat";
$_LANG['priceForThisTerm'] = "Bu dönem için fiyat";
$_LANG['priceStandard'] = "Her yıl :renewalPriceartı vergi ile yenilenir.";
$_LANG['priceWithDiscount'] = "İlk yıl için :registrationPrice , sonra her yıl :renewalPrice .";
...
$_LANG['pwlengthmax'] = "Parolalar :max karakterden fazla içeremez.";
...
$_LANG['pwstrengthfail'] = "Bu şifre yeterince güçlü değil. Daha karmaşık bir şifre girin.";
...
$_LANG['recommendedTLDs'] = "Önerilen TLD'ler";
...
$_LANG['renewPrice'] = "Fiyatını yenileyin";
...
$_LANG['requiredFields'] = "Zorunlu alanlar * ile işaretlenmiştir";
...
$_LANG['safeSearch'] = "Güvenli Arama";
$_LANG['sale'] = "Satışta";
$_LANG['salePrice'] = "satış fiyatı";
$_LANG['salesTaxes'] = "Satış Vergileri";
$_LANG['search'] = "Ara";
$_LANG['searchOurKnowledgebase'] = "Bilgi tabanımızda arama yapın";
$_LANG['searchResults'] = "Sorgulama Sonuçları";
...
$_LANG['selectCountry'] = "Ülke Seçin";
$_LANG['selectDomain'] = "Alan Adı Seçin";
$_LANG['selectDomainForHosting'] = "Bu paylaşılan barındırma paketini hangi alana eklemek istersiniz?";
$_LANG['selectDomainsForSsl'] = "Temel SSL'yi hangi alan adlarına uygulamak istersiniz? Birden fazla seçebilirsiniz.";
$_LANG['selectState'] = "Eyalet Seçiniz";
...
$_LANG['service_unavailable'] = "Hizmet Kullanılamıyor: %s";
$_LANG['servicesRenew'] = "Yenile/Süre Uzat";
$_LANG['setupFee'] = ":amount Kurulum Ücreti";
$_LANG['setupMandate'] = "Ödeme Yetki Kurulumu";
$_LANG['sharedHosting'] = "Paylaşımlı Barındırma";
$_LANG['shopNow'] = "Şimdi Satın Alın";
$_LANG['shortcuts'] = "Hızlı Erişim";
$_LANG['show'] = "Göster";
$_LANG['showMenu'] = "Menüyü Göster";
$_LANG['showSearchControls'] = "Arama Kontrollerini Göster";
...
$_LANG['store']['dynamic']['title'] = "Dinamik hizmetler";
...
$_LANG['store']['error']['serviceUnavailable'] = "Şu anda talebiniz işleme alınamıyor. Bunun nedeni bir zaman aşımı veya geçici servis sorunu olabilir. Lütfen tekrar deneyin.";
$_LANG['store']['error']['validationFailed'] = "Lütfen aşağıdaki hataları kontrol edin ve düzeltin.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo, uzman olmanızı gerektirmeden size kanıtlanmış, rehberli bir SEO süreci sunar. <br> marketgoo ekonomiktir ve tümü sezgisel bir arayüzde kapsamlı SEO raporları, planları ve önerileri sunar.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Marketgoo'yu diğer SEO ürünlerinden farklı kılan nedir?";
$_LANG['store']['marketgoo']['faqs']['title'] = "SSS ve Destek";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "Arama Motoru Gönderimi";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Web Sitesi Oluşturucu Uyumluluğu";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Aylık İlerleme Raporu";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Trafik Analizi";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "SEO Raporunu PDF Olarak İndirin <a href='https://mktgoo.co/seo-report-score2'>(Örneğe Bakın)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "Yapay Zeka Destekli Özellikler: Başlık ve Meta Açıklamanın Otomatik Oluşturulması";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Taranan Sayfalar";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Rakip Takibi";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Anahtar Kelime İzleme ve Optimizasyon";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Güncellenmiş Rapor ve Plan";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Özel SEO Planı";
$_LANG['store']['marketgoo']['features']['1'] = "SEO Planınızı Alın";
$_LANG['store']['marketgoo']['features']['2'] = "Adım Adım Talimatları İzleyin";
$_LANG['store']['marketgoo']['features']['3'] = "Aylık Raporla İlerlemeyi İzleyin";
$_LANG['store']['marketgoo']['features']['4'] = "Rakipleri Takip Edin ve İzleyin";
$_LANG['store']['marketgoo']['features']['5'] = "Bireysel Sayfa Optimizasyonu";
$_LANG['store']['marketgoo']['features']['6'] = "Kolay Anahtar Kelime Araştırma ve İzleme";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Kaydolun ve anında SEO raporunuzu ve planınızı alın. Nerede iyileştirme alanı olduğunu görün ve siteniz için uyarlanmış öneriler alın.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Talimatlar, teknoloji meraklısı olmayan kullanıcılar için yazılmıştır ve örnekler ve açıklamalarla her öneri boyunca size rehberlik eder.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Her ay, sitenizin SEO ilerlemesini içeren bir e-posta alın ve PDF olarak indirin.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Trafik almak için ne yaptıklarını ve sayılarınızın onlarınkilerle nasıl yükseldiğini görmek için rakipleri takip edin. İzlediğini asla bilemezler!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo, sitenizdeki her bir sayfayı seçtiğiniz anahtar kelimelerden biriyle eşleştirerek ve sıklığın ve yerleşimin doğru olduğundan emin olarak optimize etme konusunda size rehberlik eder.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "SEO'ya aşina değilseniz anahtar kelimeler bunaltıcı olabilir. marketgoo anahtar kelimeleri önerir ve ayrıca optimize etmek istediğiniz kelimeleri aramanıza ve girmenize olanak tanır.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Tüm Web Sitesi Oluşturucularla Çalışır";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Karşılaştırma tarihi: Haziran 19, 20 25:tagBreak*AV-Test tarafından yapılan araştırmaya göre genel ağ performansı. :tagOpenraporunun tamamını okuyabilirsiniz:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Sızan kimlik bilgileri hakkında uyarılar";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "İndirmeler için kötü amaçlı yazılım taraması";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Açıklanmadı";
$_LANG['store']['nordvpn']['features']['comparison']['vpn4'] = "200+";
$_LANG['store']['nordvpn']['features']['comparison']['vpn5'] = "3000'den fazla";
$_LANG['store']['nordvpn']['features']['comparison']['vpn6'] = "6500+";
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "İzleyici ve reklam engelleyici";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN bağlantı hızlarını sınırlamaz. Herhangi bir kısıtlama olmadan tam hızlı VPN bağlantımızın keyfini çıkarın.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN, Windows, macOS, Linux, Android ve iOS dahil olmak üzere tüm popüler platformlarla uyumludur. Ayrıca, yönlendiriciniz de dahil olmak üzere 10 cihaza kadar güvence altına alabilirsiniz.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "VPN bant genişliği sınırı yok  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Gizli ve güvenli bir bağlantıya göz atın, oynayın ve çalışın";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Herkese açık Wi-Fi'de bile güvenli bir şekilde bağlı kalın";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "IP adresinizi koruyarak çevrimiçi izlemeyi azaltın";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Yurtdışına seyahat ederken ev içeriğini izleyin";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Çevrimiçi etkinliğinizi şifrelemek için NordVPN'i kullanın ve her yerde bağlandığınız her yerde ekstra koruma katmanı sağlar.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN, bağlantınızı yeni nesil şifreleme ile korur, böylece hesaplarınıza giriş yapabilir, banka havaleleri yapabilir ve endişelenmeden çevrimiçi alışveriş yapabilirsiniz. Korunmasız ağlarda bile.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN sizi siber tehditlerden korumak için çok çeşitli özelliklere sahiptir. Threat Protection Pro™ 'e ek olarak, VPN bağlantınız kesildiğinde internet bağlantınızı engelleyen ve verilerinizin güvende kalmasını sağlayan otomatik bir Kill Switch vardır. Gizli sunucular, hükümet sansürü ve katı internet düzenlemeleri nedeniyle yüksek düzeyde çevrimiçi güvenlik gerektiğinde yardımcı olacaktır.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "VPN ile çevrimiçi güvenliğinizi artırın";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Gelişmiş Güvenlik";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Bir dosyayı her indirdiğinizde, Threat Protection Pro™ onu kötü amaçlı yazılım açısından denetler.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ müdahaleci reklamları ve web izleyicilerini engeller ve URL'leri otomatik olarak tarar ve kötü amaçlı olanları engeller.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Threat Protection Pro™ cihazlarınızı ve gizliliğinizi korur. İzleyicileri engelleyerek, çevrimiçi meraklılardan kaçınmanıza yardımcı olur.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "NordVPN'in :tagOpenThreat Protection Pro™:tagClose özelliği, tek bir ekstra tıklama ile daha fazla güvenlik avantajı ve daha iyi koruma sunan oyunun kurallarını değiştiricidir.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Bir VPN'den Daha Fazlası";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Saklayacak hiçbir şeyiniz olmasa bile, muhtemelen izlenme ve takip edilme fikrinden hoşlanmıyorsunuz. İnternet kullanıcılarının VPN hizmetlerini seçmelerinin ana nedeni çevrimiçi gizlilik ve genel güvenliktir.:tagBreakİşte neden belirli nedenler?";
$_LANG['store']['nordvpn']['features']['use']['tagline2'] = "Otellerdeki, havaalanlarındaki ve kafelerdeki genel Wi-Fi ağları, genellikle düşük güvenlik önlemleri nedeniyle bilgisayar korsanları için mükemmel hedeflerdir.";
...
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Facebook, X (Twitter) ve WhatsApp gibi platformlarda bölgesel ve siyasi kısıtlamalardan kaçının.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Çevrimiçi reklamlar genellikle can sıkıcı ve dikkat dağıtıcıdır. Web sitelerinin büyük bölümlerini karıştırırlar, bağlantı hızını yavaşlatırlar ve kötü niyetli olabilirler.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Akıllı ev teknolojileri, özellikle güvenli olmayan IoT cihazları, ev ağlarında güvenlik açıkları yaratabilir.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Güvenli halka açık Wi-Fi bağlantısı";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Daha güvenli gezinme";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Sınırsız sosyal medya erişimi";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Kötü amaçlı reklamlara karşı koruma";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Akıllı ev güvenliği";
...
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Anlaşmayı Alın";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• IP adresinizi koruyun:tagBreak• Kötü amaçlı yazılımları, izleyicileri ve reklamları engelleyin:tagBreak• 10 cihaza kadar bağlayın";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Günlük SMART Veritabanı Taramaları";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Günlük SMART Dosya Taramaları";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Yeni içerik tasarlayın, etkileşimi geliştirin, ve sonuçlarınızı SocialBee ile takip edin.";
$_LANG['store']['socialbee']['cartTitle'] = "SocialBee Sosyal Medya Yönetimi";
...
$_LANG['suggestedTLDs'] = "Önerilen TLD'ler";
...
$_LANG['tax']['errorVatInvalidFormat'] = ":countryNameiçin geçersiz KDV numarası biçimi.";
...
$_LANG['updateProductQuantity'] = "Güncelle";
$_LANG['updateTotals'] = "Fiyatı Güncelle";
