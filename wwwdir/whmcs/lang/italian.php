...
$_LANG['addToCartButton'] = "Aggiungi al carrello";
$_LANG['addToGetFreeDomain'] = "Aggiungi per ottenere un dominio gratuito";
...
$_LANG['basicSsl'] = "SSL di base";
$_LANG['billableitemseach'] = "Ciascuno";
$_LANG['billableitemshour'] = "Ora";
$_LANG['billableitemshours'] = "Ore";
$_LANG['billableitemsquantity'] = "Qtà";
$_LANG['billing']['creditnote'] = "Nota di credito";
$_LANG['billing']['debitnote'] = "Nota di addebito";
$_LANG['billing']['issuedate'] = "Data di emissione";
$_LANG['billing']['issuedby'] = "Emesso da";
$_LANG['billing']['issuedto'] = "Rilasciato a";
$_LANG['billing']['ledger']['date'] = "Data";
$_LANG['billing']['ledger']['reference'] = "Riferimento";
$_LANG['billing']['ledger']['title'] = "Libro mastro";
$_LANG['billing']['ledger']['type'] = "Tipo";
$_LANG['billing']['type']['affiliatepayout'] = "Pagamento degli affiliati";
$_LANG['billing']['type']['clientaccountcredit'] = "Credito sul conto del cliente";
$_LANG['billing']['type']['clientaccountdebit'] = "Addebito sul conto del cliente";
$_LANG['billing']['type']['creditnoteadjustment'] = "Adeguamento della nota di credito";
$_LANG['billing']['type']['invoiceadjustment'] = "Adeguamento della fattura";
$_LANG['billing']['type']['payment'] = "Pagamento";
$_LANG['billing']['type']['refund'] = "Rimborso";
$_LANG['billing']['type']['refundtocredit'] = "Rimborso sul conto del cliente";
...
$_LANG['billingnotes']['creditnote']['items'] = "Elementi della nota di credito";
$_LANG['billingnotes']['debitnote']['items'] = "Elementi della nota di debito";
...
$_LANG['cartItemType']['addon'] = "Opzioni extra";
$_LANG['cartItemType']['addons'] = "Opzioni extra";
$_LANG['cartItemType']['bundle'] = "Pacchetto";
$_LANG['cartItemType']['bundles'] = "gruppi";
$_LANG['cartItemType']['domain'] = "Dominio";
$_LANG['cartItemType']['domainRegistration'] = "Registrazione Dominio";
$_LANG['cartItemType']['domainRenewal'] = "Rinnovo Dominio";
$_LANG['cartItemType']['domainRenewals'] = "Rinnovi Dominio";
$_LANG['cartItemType']['domainTransfer'] = "Trasferimento Dominio";
$_LANG['cartItemType']['domainTransfers'] = "Trasferimenti di domini";
$_LANG['cartItemType']['domains'] = "Domini";
$_LANG['cartItemType']['product'] = "Prodotto";
$_LANG['cartItemType']['products'] = "Prodotti";
$_LANG['cartItemsSelected'] = "Hai selezionato :count e pronto per l'acquisto.";
...
$_LANG['choosePackages'] = "Scegli tra una vasta gamma di pacchetti";
...
$_LANG['codeApplied'] = "Codice promozionale applicato";
$_LANG['completeorder'] = "Completa Ordine";
$_LANG['configModalTitle'] = "Configurazione";
...
$_LANG['confirmItemDeletion'] = "Conferma l'eliminazione";
...
$_LANG['cycleRenewal'] = ":cycle Rinnovo";
...
$_LANG['designedToFitAnyBudget'] = "Progettato per adattarsi a qualsiasi budget";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Cerca per parola chiave, descrizione o dominio.&#10;Ad esempio: &quot;Fun business events &quot;, &quot;Un servizio completo di pianificazione finanziaria per professionisti&quot;, o &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Inserisci una breve descrizione o un dominio esatto.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "Il sistema non è riuscito a trovare alcun suggerimento.";
$_LANG['domainSearch']['exactMatch'] = "Corrispondenza esatta";
$_LANG['domainSearch']['maxLength'] = "Lunghezza massima";
$_LANG['domainSearch']['notAvailable'] = "Non disponibile";
$_LANG['domainSearch']['safeSearch'] = "Ricerca sicura";
$_LANG['domainSearch']['tlds'] = "Includi TLD";
$_LANG['domainSearch']['topAiSuggestion'] = "I migliori suggerimenti per l'intelligenza artificiale";
$_LANG['domainSearch']['topSuggestion'] = "Suggerimento migliore";
...
$_LANG['due'] = "Insolute";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "Devi accettare i termini di servizio selezionando :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute deve essere un array.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute deve essere una data valida.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute deve essere un indirizzo email valido.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "Il sistema ha riscontrato un errore interno. Riprova più tardi.";
$_LANG['dynamicServiceFields']['validation']['in'] = "L'opzione selezionata per :attribute non è valida.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute deve essere un numero intero.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute non può contenere più di :max caratteri.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute deve utilizzare uno dei seguenti tipi di file: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute deve contenere almeno :min caratteri.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute deve essere un numero.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute deve essere un'espressione regolare valida.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute è obbligatorio.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute deve essere un URL valido che include il protocollo ('http: //' o 'https: //').";
$_LANG['edit'] = "Modifica";
$_LANG['email'] = "E-mail";
...
$_LANG['encryption_failed'] = "Crittografia non riuscita: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Riprova più tardi.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Pagina Iniziale";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Hai inviato troppe richieste.";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "Ops!";
...
$_LANG['estimateTaxes'] = "IVA stimata";
$_LANG['every'] = "ogni";
$_LANG['exampledomain'] = "es. example.com";
$_LANG['excludeTLDs'] = "Escluse alcune estensioni e domini recentemente rinnovati";
...
$_LANG['extendYourDomainBy1Year'] = "Estendi il tuo dominio di 1 anno*";
...
$_LANG['findDomains'] = "Trova domini";
...
$_LANG['forTheFirstYear'] = "per il primo anno";
...
$_LANG['freeDomainHostingPromo'] = "Ottieni un dominio gratuito quando acquisti un servizio di hosting.";
$_LANG['from'] = "Da";
...
$_LANG['hideSearchControls'] = "Nascondi i controlli di ricerca";
...
$_LANG['inStock'] = "In magazzino: :amount";
$_LANG['incApplicableTaxes'] = "tasse applicabili incluse";
$_LANG['includeTLDs'] = "Includi TLD";
$_LANG['included'] = "Incluso";
...
$_LANG['invalidCode'] = "Codice promozionale non valido";
$_LANG['invalid_input'] = "Input non valido: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "ID del ticket o ID di risposta non valido.";
...
$_LANG['lastChance'] = "Ultima possibilità";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Accesso";
...
$_LANG['maxLength'] = "Lunghezza massima";
...
$_LANG['navMarketConnectService']['dynamic'] = "Servizi dinamici";
...
$_LANG['noDomainsFound'] = "Nessun dominio trovato";
...
$_LANG['orderForm']['additionalInformation'] = "Informazioni Aggiuntive";
...
$_LANG['orderForm']['findNewDomainAi'] = "Cerca un dominio con suggerimenti basati sull'intelligenza artificiale.";
...
$_LANG['ordererrortldsnotconfigured'] = "Nessuna estensione di dominio è attualmente disponibile per la vendita. Per assistenza, contattaci.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "Annuale";
$_LANG['orderpaymenttermadjectivebiennially'] = "Biennale";
$_LANG['orderpaymenttermadjectivefree'] = "Gratuito";
$_LANG['orderpaymenttermadjectivemonthly'] = "Mensile";
$_LANG['orderpaymenttermadjectiveonetime'] = "Una tantum";
$_LANG['orderpaymenttermadjectivequarterly'] = "Trimestrale";
$_LANG['orderpaymenttermadjectivesemiannually'] = "Semestrale";
$_LANG['orderpaymenttermadjectivetriennially'] = "Triennale";
...
$_LANG['orderselectterm'] = "Seleziona termine";
...
$_LANG['page'] = "Pagina";
$_LANG['pageof'] = "di";
$_LANG['passwordtips'] = "<strong>Suggerimenti per una password sicura</strong><br />Usa sia caratteri maiuscoli che minuscoli.<br />Includi almeno un simbolo (ad esempio <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>o <code>&amp;</code>).<br />Non usare parole del dizionario.<br />Le password possono contenere fino a :maximum_length caratteri.";
...
$_LANG['price'] = "prezzo";
$_LANG['priceFor'] = "Prezzo per :term";
$_LANG['priceForThisTerm'] = "Prezzo per questo periodo";
$_LANG['priceStandard'] = "Si rinnova ogni anno al :renewalPrice, tasse escluse.";
$_LANG['priceWithDiscount'] = ":registrationPrice per il primo anno, poi :renewalPrice ogni anno.";
...
$_LANG['pwlengthmax'] = "Le password non possono contenere più di :max caratteri.";
...
$_LANG['pwstrengthfail'] = "Questa password non è sufficientemente sicura. Inserisci una password più complessa.";
...
$_LANG['recommendedTLDs'] = "TLD consigliati";
...
$_LANG['renewPrice'] = "Rinnova il prezzo";
...
$_LANG['requiredFields'] = "I campi obbligatori sono contrassegnati con *";
...
$_LANG['safeSearch'] = "Ricerca sicura";
$_LANG['sale'] = "Saldo";
$_LANG['salePrice'] = "prezzo di vendita";
$_LANG['salesTaxes'] = "Imposte sulle vendite";
$_LANG['search'] = "Ricerca";
$_LANG['searchOurKnowledgebase'] = "Cerca nella nostra knowledge base";
$_LANG['searchResults'] = "Risultati della ricerca";
...
$_LANG['selectCountry'] = "Seleziona Nazione";
$_LANG['selectDomain'] = "Seleziona dominio";
$_LANG['selectDomainForHosting'] = "A quale dominio desideri collegare questo pacchetto di hosting condiviso?";
$_LANG['selectDomainsForSsl'] = "A quali domini desideri applicare l'SSL di base? Puoi selezionarne più di uno.";
$_LANG['selectState'] = "Seleziona stato";
...
$_LANG['service_unavailable'] = "Servizio non disponibile: %s";
$_LANG['servicesRenew'] = "Rinnova";
$_LANG['setupFee'] = ":amount Costo di installazione";
$_LANG['setupMandate'] = "Impostazione del mandato per il pagamento";
$_LANG['sharedHosting'] = "Hosting condiviso";
$_LANG['shopNow'] = "Acquista ora";
$_LANG['shortcuts'] = "Collegamenti veloci";
$_LANG['show'] = "Mostra";
$_LANG['showMenu'] = "Mostra Menu";
$_LANG['showSearchControls'] = "Mostra controlli di ricerca";
...
$_LANG['store']['dynamic']['title'] = "Servizi dinamici";
...
$_LANG['store']['error']['serviceUnavailable'] = "Al momento non è possibile elaborare la tua richiesta. Ciò può essere dovuto a un timeout o a un problema temporaneo del servizio. Per favore riprova.";
$_LANG['store']['error']['validationFailed'] = "Controlla e correggi gli errori riportati di seguito.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo ti offre un processo SEO collaudato e guidato senza che tu sia un esperto. <br> marketgoo è conveniente e fornisce report, piani e consigli SEO completi, il tutto in un'interfaccia intuitiva.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Cosa rende marketgoo diverso dagli altri prodotti SEO?";
...
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Compatibilità con Website Builder";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Rapporto mensile sullo stato di avanzamento";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Analisi del traffico";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Scarica il rapporto SEO in formato PDF <a href='https://mktgoo.co/seo-report-score2'>(vedi esempio)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "Funzionalità basate sull'intelligenza artificiale: generazione automatica di titoli e meta descrizioni";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Pagine scansionate";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Monitoraggio della concorrenza";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Monitoraggio e ottimizzazione delle parole chiave";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Rapporto e piano aggiornati";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Piano SEO personalizzato";
$_LANG['store']['marketgoo']['features']['1'] = "Ottieni il tuo piano SEO";
$_LANG['store']['marketgoo']['features']['2'] = "Segui le istruzioni dettagliate";
$_LANG['store']['marketgoo']['features']['3'] = "Monitora i progressi con un rapporto mensile";
$_LANG['store']['marketgoo']['features']['4'] = "Monitora e monitora i concorrenti";
$_LANG['store']['marketgoo']['features']['5'] = "Ottimizzazione delle singole pagine";
$_LANG['store']['marketgoo']['features']['6'] = "Semplice ricerca e monitoraggio delle parole chiave";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Registrati e ottieni il tuo rapporto e piano SEO istantanei. Scopri dove c'è margine di miglioramento e ottieni consigli su misura per il tuo sito.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Le istruzioni sono scritte per utenti non esperti di tecnologia e guidano l'utente attraverso ogni raccomandazione, con esempi e spiegazioni.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Ogni mese, ricevi un'email con i progressi SEO del tuo sito e scaricala in formato PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Tieni d'occhio i concorrenti per vedere cosa stanno facendo per ottenere traffico e come i tuoi numeri si confrontano con i loro. Non sapranno mai che stai guardando!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo ti guida nell'ottimizzazione di ogni singola pagina del tuo sito abbinandola a una delle parole chiave scelte e assicurandosi che la frequenza e il posizionamento siano corretti.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "Le parole chiave possono essere complicate se non hai familiarità con la SEO. marketgoo consiglia le parole chiave e ti consente anche di cercare e inserire quelle per le quali desideri ottimizzare.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Funziona con tutti i costruttori di siti web";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Data di confronto: 19, 20 giugno 25:tagBreak*Prestazioni complessive della rete secondo una ricerca di AV-Test. Puoi leggere :tagOpenil rapporto completo:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Avvisi sulle credenziali trapelate";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Scansione malware per i download";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn2'] = "Oltre 7300";
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Non divulgato";
$_LANG['store']['nordvpn']['features']['comparison']['vpn4'] = "Più di 200";
$_LANG['store']['nordvpn']['features']['comparison']['vpn5'] = "Più di 3000";
$_LANG['store']['nordvpn']['features']['comparison']['vpn6'] = "6500+";
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "Tracker e ad blocker";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN non limita la velocità di connessione. Goditi la nostra connessione VPN a piena velocità senza limitazioni.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN è compatibile con tutte le piattaforme più diffuse, tra cui Windows, macOS, Linux, Android e iOS. Inoltre, puoi proteggere fino a 10 dispositivi, incluso il router.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "Nessun limite di larghezza di banda VPN  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Naviga, gioca e lavora su una connessione privata e sicura";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Resta connesso in modo sicuro anche su reti Wi-Fi pubbliche";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Riduci il tracciamento online proteggendo il tuo indirizzo IP";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Guarda i contenuti della tua home page mentre viaggi all'estero";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Usa NordVPN per crittografare la tua attività online per un ulteriore livello di protezione quando e dove sei connesso.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN protegge la tua connessione con una crittografia di nuova generazione, così puoi accedere ai tuoi account, effettuare bonifici bancari e fare acquisti online senza preoccupazioni. Anche su reti non protette.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN vanta un'ampia gamma di funzionalità per proteggerti dalle minacce informatiche. Oltre a Threat Protection Pro™, è disponibile un Kill Switch automatico che blocca la connessione Internet in caso di interruzione della connessione VPN, garantendo la sicurezza dei dati. I server offuscati sono utili quando è richiesto un elevato livello di sicurezza online a causa della censura governativa e delle rigide normative su Internet.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Aumenta la tua sicurezza online con una VPN";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Sicurezza avanzata";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Ogni volta che scarichi un file, Threat Protection Pro™ lo ispeziona per individuare eventuali malware.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ blocca gli annunci intrusivi e i web tracker, scansiona automaticamente gli URL e blocca quelli dannosi.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Threat Protection Pro™ protegge i tuoi dispositivi e la tua privacy. Bloccando i tracker, ti aiuta a evitare i ficcanaso online.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "La funzionalità :tagOpenThreat Protection Pro™:tagClose di NordVPN è un punto di svolta che offre ancora più vantaggi in termini di sicurezza e una migliore protezione con un solo clic in più.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Molto più di una semplice VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Anche se non hai nulla da nascondere, probabilmente non ti piace l'idea di essere osservato e rintracciato. Il motivo principale per cui gli utenti di Internet scelgono i servizi VPN è la privacy online e la sicurezza generale.:tagBreakEcco i motivi specifici PERCHÉ?";
...
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Evita le restrizioni regionali e politiche su piattaforme come Facebook, X (Twitter) e WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Gli annunci online sono generalmente fastidiosi e distraggono. Ingombrano gran parte dei siti Web, rallentano la velocità di connessione e potrebbero essere dannosi.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Le tecnologie per la casa intelligente, in particolare i dispositivi IoT non sicuri, possono creare vulnerabilità nelle reti domestiche.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Connessione Wi-Fi pubblica sicura";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Navigazione più sicura";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Accesso illimitato ai social media";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Protezione da annunci dannosi";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Sicurezza domestica intelligente";
...
$_LANG['store']['nordvpn']['features']['world']['count1'] = "Oltre 7300";
$_LANG['store']['nordvpn']['features']['world']['count2'] = "118";
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Ottieni l'offerta";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Proteggi il tuo indirizzo IP:tagBreak• Blocca malware, tracker e annunci:tagBreak• Collega fino a 10 dispositivi";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Scansioni giornaliere del database SMART";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Scansioni giornaliere dei file SMART";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Progetta nuovi contenuti, migliora il coinvolgimento e monitora i tuoi risultati con SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "Gestione dei social media con SocialBee";
...
$_LANG['suggestedTLDs'] = "TLD consigliati";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Formato del numero di partita IVA non valido per :countryName.";
...
$_LANG['updateProductQuantity'] = "Aggiorna";
$_LANG['updateTotals'] = "Aggiorna totale";
