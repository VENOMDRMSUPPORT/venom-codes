...
$_LANG['addToCartButton'] = "הוספה לעגלת הקניות";
$_LANG['addToGetFreeDomain'] = "הוסף כדי לקבל דומיין בחינם";
...
$_LANG['basicSsl'] = "SSL בסיסי";
$_LANG['billableitemseach'] = "כל אחד";
$_LANG['billableitemshour'] = "שעה";
$_LANG['billableitemshours'] = "שעות";
$_LANG['billableitemsquantity'] = "כמות";
$_LANG['billing']['creditnote'] = "שטר אשראי";
$_LANG['billing']['debitnote'] = "שטר חיוב";
$_LANG['billing']['issuedate'] = "תאריך הנפקה";
$_LANG['billing']['issuedby'] = "הונפק על ידי";
$_LANG['billing']['issuedto'] = "הונפק ל";
$_LANG['billing']['ledger']['date'] = "תאריך";
$_LANG['billing']['ledger']['reference'] = "הפניה";
$_LANG['billing']['ledger']['title'] = "ספר חשבונות";
$_LANG['billing']['ledger']['type'] = "סוג";
$_LANG['billing']['type']['affiliatepayout'] = "תשלום שותפים";
$_LANG['billing']['type']['clientaccountcredit'] = "אשראי חשבון לקוח";
$_LANG['billing']['type']['clientaccountdebit'] = "חיוב חשבון לקוח";
$_LANG['billing']['type']['creditnoteadjustment'] = "התאמת שטר אשראי";
$_LANG['billing']['type']['invoiceadjustment'] = "התאמת חשבונית";
$_LANG['billing']['type']['payment'] = "תשלום";
$_LANG['billing']['type']['refund'] = "החזר כספי";
$_LANG['billing']['type']['refundtocredit'] = "החזר כספי לחשבון הלקוח";
$_LANG['billingAddress'] = "כתובת החיוב";
$_LANG['billingOverview'] = "סקירת חיובים ותשלומים";
$_LANG['billingdetails'] = "חיובים";
$_LANG['billingnotes']['creditnote']['items'] = "פריטי שטר אשראי";
$_LANG['billingnotes']['debitnote']['items'] = "פריטי שטר חיוב";
...
$_LANG['cartItemType']['addon'] = "תוסף";
$_LANG['cartItemType']['addons'] = "תוספות";
$_LANG['cartItemType']['bundle'] = "צרור";
$_LANG['cartItemType']['bundles'] = "חבילות";
$_LANG['cartItemType']['domain'] = "דומיין";
$_LANG['cartItemType']['domainRegistration'] = "רישום דומיין";
$_LANG['cartItemType']['domainRenewal'] = "חידוש דומיין";
$_LANG['cartItemType']['domainRenewals'] = "חידושי דומיינים";
$_LANG['cartItemType']['domainTransfer'] = "העברת דומיין";
$_LANG['cartItemType']['domainTransfers'] = "העברות דומיין";
$_LANG['cartItemType']['domains'] = "דומיינים";
$_LANG['cartItemType']['product'] = "מכפלה";
$_LANG['cartItemType']['products'] = "מוצרים";
$_LANG['cartItemsSelected'] = "בחרת :count ומוכנה לרכישה.";
...
$_LANG['cartbrowse'] = "עיין במוצרים ושירותים";
...
$_LANG['choosePackages'] = "בחר מתוך מגוון חבילות";
...
$_LANG['cycleRenewal'] = ":cycle חידוש";
$_LANG['daily'] = "יומי";
...
$_LANG['designedToFitAnyBudget'] = "מעוצב כדי להתאים לכל תקציב";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "חפש לפי מילת מפתח, תיאור או תחום.&#10;לדוגמא: &quot;אירועים עסקיים מהנים &quot;, &quot;שירות תכנון פיננסי מקיף לאנשי מקצוע&quot;, או &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "הזן תיאור קצר או תחום מדויק.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "המערכת לא מצאה הצעות.";
$_LANG['domainSearch']['exactMatch'] = "התאמה מדויקת";
$_LANG['domainSearch']['maxLength'] = "אורך מרבי";
$_LANG['domainSearch']['notAvailable'] = "לא זמין";
$_LANG['domainSearch']['safeSearch'] = "חיפוש בטוח";
$_LANG['domainSearch']['tlds'] = "כלול TLDs";
$_LANG['domainSearch']['topAiSuggestion'] = "הצעת AI מובילה";
$_LANG['domainSearch']['topSuggestion'] = "הצעה עליונה";
...
$_LANG['due'] = "לתשלום";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "עליך לקבל את תנאי השירות על ידי סימון :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute חייב להיות מערך.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute חייב להיות תאריך תקף.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute חייבת להיות כתובת דוא\"ל חוקית.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "המערכת נתקלה בשגיאה פנימית. נסה שוב מאוחר יותר.";
$_LANG['dynamicServiceFields']['validation']['in'] = "האפשרות שנבחרה עבור :attribute אינה חוקית.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute חייב להיות מספר שלם.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute לא יכול להכיל יותר מ- :max תווים.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute חייב להשתמש באחד מסוגי הקבצים הבאים: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute חייב להכיל לפחות תווים :min .";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute חייב להיות מספר.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute חייב להיות ביטוי רגולרי תקף.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute נדרש.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute חייבת להיות כתובת אתר חוקית הכוללת את הפרוטוקול ('http: //' או 'https: //').";
$_LANG['edit'] = "עריכה";
...
$_LANG['enabled'] = "מופעל";
$_LANG['encryption_failed'] = "ההצפנה נכשלה: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "נסה שוב מאוחר יותר.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "דף הבית";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "שלחת יותר מדי בקשות.";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "אופס!";
...
$_LANG['estimateTaxes'] = "מיסים צפויים";
$_LANG['every'] = "מידי";
$_LANG['exampledomain'] = "למשל example.com";
$_LANG['excludeTLDs'] = "לא כולל סיומות דומיין מסוימות ודומיינים שחודשו לאחרונה";
...
$_LANG['extendYourDomainBy1Year'] = "הארך את הדומיין שלך לשנה אחת*";
...
$_LANG['findDomains'] = "מצא דומיינים";
...
$_LANG['forTheFirstYear'] = "לשנה הראשונה";
...
$_LANG['freeDomainHostingPromo'] = "קבל דומיין בחינם בעת רכישת אירוח.";
$_LANG['from'] = "מאתר";
...
$_LANG['hideSearchControls'] = "הסתר פקדי חיפוש";
...
$_LANG['inStock'] = "במלאי: :amount";
$_LANG['incApplicableTaxes'] = "כולל מסים חלים";
$_LANG['includeTLDs'] = "כלול TLDs";
$_LANG['included'] = "כלול";
...
$_LANG['invalidCode'] = "קוד פרומו לא חוקי";
$_LANG['invalid_input'] = "קלט לא חוקי: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "מזהה כרטיס או מזהה תגובה לא חוקיים.";
...
$_LANG['language'] = "שפה";
$_LANG['lastChance'] = "הזדמנות אחרונה";
...
$_LANG['marketConnect']['dynamic']['manage'] = "כניסה";
...
$_LANG['navMarketConnectService']['dynamic'] = "שירותים דינמיים";
...
$_LANG['noDomainsFound'] = "לא נמצאו דומיינים";
...
$_LANG['orderForm']['additionalInformation'] = "מידע נוסף";
...
$_LANG['orderForm']['findNewDomainAi'] = "חפש דומיין עם הצעות המופעלות על ידי AI.";
...
$_LANG['ordererrortldsnotconfigured'] = "אין סיומות דומיין זמינות כרגע למכירה. לקבלת עזרה, צור איתנו קשר.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "שנתי";
$_LANG['orderpaymenttermadjectivebiennially'] = "דו-שנתי";
$_LANG['orderpaymenttermadjectivefree'] = "חינם";
$_LANG['orderpaymenttermadjectivemonthly'] = "חודשי";
$_LANG['orderpaymenttermadjectiveonetime'] = "חד פעמי";
$_LANG['orderpaymenttermadjectivequarterly'] = "רבעוני";
$_LANG['orderpaymenttermadjectivesemiannually'] = "חצי שנתי";
$_LANG['orderpaymenttermadjectivetriennially'] = "תלת-שנתי";
...
$_LANG['orderselectterm'] = "בחר מונח";
...
$_LANG['page'] = "עמוד";
$_LANG['pageof'] = "מתוך";
$_LANG['passwordtips'] = "<strong>טיפים לסיסמה מאובטחת</strong><br />השתמש הן באותיות גדולות והן באותיות קטנות.<br />כלול לפחות סמל אחד (לדוגמה, <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>, או <code>&amp;</code>).<br />אל תשתמש במילות מילון.<br />סיסמאות יכולות להכיל עד :maximumתווים _length.";
...
$_LANG['premium'] = "פרימיום";
$_LANG['presalescontactdescription'] = "הזינו כל שאלה בטרם היותכם לקוחות כאן";
$_LANG['previous'] = "הקודם";
$_LANG['previouspage'] = "דף קודם";
$_LANG['price'] = "המחיר";
$_LANG['priceFor'] = "מחיר עבור :term";
$_LANG['priceForThisTerm'] = "מחיר לתקופה זו";
$_LANG['priceStandard'] = "מתחדש בכל שנה ב :renewalPrice, בתוספת מס.";
$_LANG['priceWithDiscount'] = ":registrationPrice בשנה הראשונה, ואז :renewalPrice מדי שנה.";
...
$_LANG['pwlengthmax'] = "סיסמאות לא יכולות להכיל יותר מ- :max תווים.";
...
$_LANG['pwstrengthfail'] = "סיסמה זו אינה חזקה מספיק. הזן סיסמה מורכבת יותר.";
...
$_LANG['recommendedTLDs'] = "TLDs מומלצים";
...
$_LANG['requestor'] = "מאת";
$_LANG['requiredFields'] = "שדות חובה מסומנים ב*";
...
$_LANG['rssfeed'] = "הזנה";
$_LANG['safeSearch'] = "חיפוש בטוח";
$_LANG['sale'] = "מבצע";
$_LANG['salePrice'] = "מחיר מכירה";
$_LANG['salesTaxes'] = "מיסי מכירות";
$_LANG['search'] = "חיפוש";
$_LANG['searchOurKnowledgebase'] = "חיפוש במאגר המידע";
$_LANG['searchResults'] = "תוצאות החיפוש";
...
$_LANG['selectCountry'] = "בחרו מדינה";
$_LANG['selectDomain'] = "בחר דומיין";
$_LANG['selectDomainForHosting'] = "לאיזה דומיין תרצה לצרף חבילת אירוח משותפת זו?";
$_LANG['selectDomainsForSsl'] = "על איזה דומיין תרצה להחיל את ה- SSL הבסיסי? אתה יכול לבחור מספר.";
$_LANG['selectState'] = "בחר מדינה";
...
$_LANG['service_unavailable'] = "השירות אינו זמין: %s";
$_LANG['servicesRenew'] = "חידוש";
$_LANG['setupFee'] = ":amount דמי התקנה";
$_LANG['setupMandate'] = "הרשאות אמצעי תשלום";
$_LANG['sharedHosting'] = "אירוח משותף";
$_LANG['shopNow'] = "רכשו עכשיו";
$_LANG['shortcuts'] = "קיצורי דרך";
$_LANG['show'] = "הראה";
$_LANG['showMenu'] = "הצג תפריט";
$_LANG['showSearchControls'] = "הצג פקדי חיפוש";
...
$_LANG['store']['dynamic']['title'] = "שירותים דינמיים";
...
$_LANG['store']['error']['serviceUnavailable'] = "לא ניתן לעבד את בקשתך כרגע. ייתכן שהדבר נובע מפסק זמן או בעיה זמנית בשירות. אנא נסה שוב.";
$_LANG['store']['error']['validationFailed'] = "אנא בדוק ותקן את השגיאות שלהלן.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo מספק לך תהליך SEO מוכח ומודרך מבלי לדרוש ממך להיות מומחה. <br> marketgoo הוא זול ומספק דוחות SEO מקיפים, תוכניות והמלצות, והכל בממשק אינטואיטיבי.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "מה מייחד את marketgoo ממוצרי SEO אחרים?";
$_LANG['store']['marketgoo']['faqs']['title'] = "שאלות נפוצות ותמיכה";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "הגשת מנועי חיפוש";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "תאימות לבניית אתרים";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "דוח התקדמות חודשי";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "ניתוח תנועה";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "הורד דוח SEO כ- PDF <a href='https://mktgoo.co/seo-report-score2'>(ראה דוגמה)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "תכונות המופעלות על ידי AI: ייצור אוטומטי של כותרת ותיאור מטא";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "דפים שנסרקו";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "מעקב אחר מתחרים";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "מעקב מילות מפתח ואופטימיזציה";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "דוח ותוכנית מעודכנים";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "תוכנית SEO מותאמת אישית";
$_LANG['store']['marketgoo']['features']['1'] = "קבל את תוכנית ה- SEO שלך";
$_LANG['store']['marketgoo']['features']['2'] = "עקוב אחר ההוראות שלב אחר שלב";
$_LANG['store']['marketgoo']['features']['3'] = "מעקב אחר ההתקדמות באמצעות דוח חודשי";
$_LANG['store']['marketgoo']['features']['4'] = "עקוב ופיקוח על מתחרים";
$_LANG['store']['marketgoo']['features']['5'] = "אופטימיזציה לדפים פרטניים";
$_LANG['store']['marketgoo']['features']['6'] = "מחקר וניטור מילות מפתח קלים";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "הירשם וקבל את דוח ה- SEO והתוכנית המיידית שלך. ראה היכן יש מקום לשיפור וקבל המלצות המותאמות לאתר שלך.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "הוראות נכתבות למשתמשים שאינם בעלי ידע טכנולוגי, ומנחות אותך בכל המלצה, עם דוגמאות והסברים.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "כל חודש, קבל דוא\"ל עם התקדמות ה- SEO של האתר שלך והורד אותו כקובץ PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "עקוב אחר המתחרים כדי לראות מה הם עושים כדי להשיג תנועה וכיצד המספרים שלך מסתדרים מול שלהם. הם לעולם לא ידעו שאתה צופה!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo מנחה אותך באופטימיזציה של כל דף בודד באתר שלך על ידי התאמת אותו לאחת ממילות המפתח שבחרת ולוודא שהתדירות והמיקום נכונים.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "מילות מפתח יכולות להיות מכריעות אם אינך מכיר את ה- SEO. marketgoo ממליץ על מילות מפתח וגם מאפשר לך לחפש ולהזן את אלה שאתה רוצה לייעל.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "עובד עם כל בוני האתרים";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " תאריך השוואה: 19 ביוני, 20 25:tagBreak*ביצועי הרשת הכוללים על פי מחקר של AV-Test. אתה יכול לקרוא :tagOpenאת הדו\"ח המלא:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "התראות על אישורים שהודלפו";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "סריקת תוכנות זדוניות להורדות";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "לא נחשף";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "מעקב וחוסם מודעות";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN אינו מגביל את מהירויות החיבור. תיהנו מחיבור ה-VPN המלא שלנו ללא כל צמצום.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN תואם לכל הפלטפורמות הפופולריות, כולל חלונות, macOS, לינוקס, אנדרואיד ו- iOS. בנוסף, אתה יכול לאבטח עד 10 מכשירים, כולל הנתב שלך.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "אין מגבלות רוחב פס של VPN  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "דפדף, שחק ועבוד על חיבור פרטי ומאובטח";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "הישאר מחובר בצורה מאובטחת גם באמצעות Wi-Fi ציבורי";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "צמצם את המעקב המקוון על ידי הגנה על כתובת ה- IP שלך";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "צפה בתוכן ביתי בזמן נסיעה לחו\"ל";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "השתמש ב- NordVPN כדי להצפין את הפעילות המקוונת שלך לשכבת הגנה נוספת בכל מקום ובכל מקום שבו אתה מחובר.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN מגן על החיבור שלך באמצעות הצפנה מהדור הבא, כך שתוכל להיכנס לחשבונות שלך, לבצע העברות בנקאיות ולקנות באינטרנט ללא דאגות. אפילו ברשתות לא מוגנות.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN מתגאה במגוון רחב של תכונות כדי להגן עליך מפני איומי סייבר. בנוסף ל- Threat Protection Pro™, יש מתג השבתה אוטומטי החוסם את חיבור האינטרנט שלך אם חיבור ה-VPN שלך נופל, ומבטיח שהנתונים שלך נשארים בטוחים. שרתים מעורפלים יעזרו כאשר נדרשת רמה גבוהה של אבטחה מקוונת עקב צנזורה ממשלתית ותקנות אינטרנט קפדניות.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "הגדל את האבטחה המקוונת שלך עם VPN";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "אבטחה מתקדמת";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "בכל פעם שאתה מוריד קובץ, Threat Protection Pro™ בודק אותו לאיתור תוכנות זדוניות.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ חוסם מודעות פולשניות ועוקבי אינטרנט, וסורק באופן אוטומטי כתובות אתרים וחוסם כתובות זדוניות.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "הגנה מפני איומים Pro™ מגנה על המכשירים שלך ועל הפרטיות שלך. על ידי חסימת עוקבים, זה עוזר לך להימנע מסטופרים מקוונים.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "התכונה :tagOpenThreat Protection Pro™:tagClose של NordVPN משנה את המשחק שמציעה יתרונות אבטחה רבים יותר והגנה טובה יותר בלחיצה אחת נוספת.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "יותר מסתם VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "גם אם אין לך מה להסתיר, אתה כנראה לא אוהב את הרעיון של צפייה ומעקב. הסיבה העיקרית לכך שמשתמשי האינטרנט בוחרים בשירותי VPN היא פרטיות מקוונת ואבטחה כללית.:tagBreakלהלן סיבות ספציפיות מדוע?";
$_LANG['store']['nordvpn']['features']['use']['tagline2'] = "רשתות Wi-Fi ציבוריות בבתי מלון, שדות תעופה ובתי קפה הן היעדים המושלמים עבור האקרים בגלל אמצעי אבטחה נמוכים לעתים קרובות.";
...
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "הימנע ממגבלות אזוריות ופוליטיות בפלטפורמות כמו פייסבוק, X (טוויטר) ו- WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "מודעות מקוונות בדרך כלל מעצבנות ומסיחות את הדעת. הם מעמיסים חלקים גדולים מאתרי אינטרנט, מהירות חיבור איטית ועלולים להיות זדוניים.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "טכנולוגיות בית חכם, במיוחד מכשירי IoT לא מאובטחים, יכולות ליצור פגיעויות ברשתות הביתיות.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "חיבור Wi-Fi ציבורי מאובטח";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "גלישה בטוחה יותר";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "גישה בלתי מוגבלת למדיה חברתית";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "הגנה מפני מודעות זדוניות";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "אבטחת בית חכם";
...
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "קבל את העסקה";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• הגן על כתובת ה- IP שלך:tagBreak• חסום תוכנות זדוניות, עוקבים ומודעות:tagBreak• חבר עד 10 מכשירים";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "סריקות מסדי נתונים SMART יומיות";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "סריקות קבצים יומיות של SMART";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "עצב תוכן טרי, שפר את המעורבות ועקוב אחר התוצאות שלך באמצעות SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "ניהול מדיה חברתית SocialBee";
...
$_LANG['success'] = "הצלחה";
$_LANG['suggestedTLDs'] = "TLDs מוצעים";
...
$_LANG['tax']['errorVatInvalidFormat'] = "תבנית מספר מע\"מ לא חוקית עבור :countryName.";
...
$_LANG['upTo'] = "עד ל :num";
$_LANG['update'] = "עדכון";
$_LANG['updateProductQuantity'] = "עדכון";
$_LANG['updateTotals'] = "עדכון הסכום";
