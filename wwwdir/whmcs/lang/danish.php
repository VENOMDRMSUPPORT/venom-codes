...
$_LANG['addToCartButton'] = "Tilføj til bestillingskurv";
$_LANG['addToGetFreeDomain'] = "Tilføj for at få gratis domæne";
...
$_LANG['basicSsl'] = "Grundlæggende SSL";
...
$_LANG['billing']['debitnote'] = "Debitnote";
$_LANG['billing']['issuedate'] = "Udstedelsesdato";
$_LANG['billing']['issuedby'] = "Udstedt af";
$_LANG['billing']['issuedto'] = "Udstedt til";
$_LANG['billing']['ledger']['date'] = "Dato";
$_LANG['billing']['ledger']['reference'] = "Reference";
$_LANG['billing']['ledger']['title'] = "Finans";
$_LANG['billing']['ledger']['type'] = "Type";
$_LANG['billing']['type']['affiliatepayout'] = "Affiliate udbetaling";
$_LANG['billing']['type']['clientaccountcredit'] = "Kundekontokredit";
$_LANG['billing']['type']['clientaccountdebit'] = "Debitering af klientkonto";
$_LANG['billing']['type']['creditnoteadjustment'] = "Justering af kreditnota";
$_LANG['billing']['type']['invoiceadjustment'] = "Fakturajustering";
$_LANG['billing']['type']['payment'] = "Betaling";
$_LANG['billing']['type']['refund'] = "Tilbagebetaling";
$_LANG['billing']['type']['refundtocredit'] = "Tilbagebetaling til klientkonto";
...
$_LANG['billingnotes']['creditnote']['items'] = "Kreditnotaelementer";
$_LANG['billingnotes']['debitnote']['items'] = "Debetnotaelementer";
...
$_LANG['cartItemType']['addon'] = "Tilføjelse";
$_LANG['cartItemType']['addons'] = "Tilføjelser";
$_LANG['cartItemType']['bundle'] = "Bundt";
$_LANG['cartItemType']['bundles'] = "bundter";
$_LANG['cartItemType']['domain'] = "Domæne";
$_LANG['cartItemType']['domainRegistration'] = "Domæne registrering";
$_LANG['cartItemType']['domainRenewal'] = "Domæne fornyelse";
$_LANG['cartItemType']['domainRenewals'] = "Domæne fornyelser";
$_LANG['cartItemType']['domainTransfer'] = "Domæne flytning";
$_LANG['cartItemType']['domainTransfers'] = "Domæneoverførsler";
$_LANG['cartItemType']['domains'] = "Domæner";
$_LANG['cartItemType']['product'] = "Produkt";
$_LANG['cartItemType']['products'] = "Produkter";
$_LANG['cartItemsSelected'] = "Du har :count valgt og klar til køb.";
...
$_LANG['cartbrowse'] = "Gennemse produkter og tjenester";
...
$_LANG['choosePackages'] = "Vælg mellem en række pakker";
...
$_LANG['codeApplied'] = "Kampagnekode anvendt";
...
$_LANG['confirmItemDeletion'] = "Bekræft sletning";
...
$_LANG['cycleRenewal'] = ":cycle Fornyelse";
$_LANG['daily'] = "Dagligt";
...
$_LANG['designedToFitAnyBudget'] = "Designet til at passe til ethvert budget";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Søg efter nøgleord, beskrivelse, eller domæne.&#10;For eksempel: &quot;Sjove forretningsbegivenheder &quot;, &quot;En omfattende finansiel planlægningstjeneste for fagfolk&quot;, eller &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Indtast en kort beskrivelse eller et nøjagtigt domæne.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "Systemet kunne ikke finde nogen forslag.";
$_LANG['domainSearch']['exactMatch'] = "Præcis match";
$_LANG['domainSearch']['maxLength'] = "Maksimal længde";
$_LANG['domainSearch']['notAvailable'] = "Ikke tilgængelig";
$_LANG['domainSearch']['safeSearch'] = "Sikker søgning";
$_LANG['domainSearch']['tlds'] = "Inkluder TLD'er";
$_LANG['domainSearch']['topAiSuggestion'] = "Top AI-forslag";
$_LANG['domainSearch']['topSuggestion'] = "Top forslag";
...
$_LANG['due'] = "Forfalden";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "Du skal acceptere servicevilkårene ved at tjekke :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute skal være en matrix.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute skal være en gyldig dato.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute skal være en gyldig e-mail-adresse.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "Systemet stødte på en intern fejl. Prøv igen senere.";
$_LANG['dynamicServiceFields']['validation']['in'] = "Den valgte indstilling for :attribute er ugyldig.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute skal være et heltal.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute må ikke indeholde mere end :max tegn.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute skal bruge en af følgende filtyper: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute skal indeholde mindst :min tegn.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute skal være et tal.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute skal være et gyldigt regulært udtryk.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute er påkrævet.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute skal være en gyldig URL, der indeholder protokollen ('http: //' eller 'https: //').";
$_LANG['edit'] = "Ændre";
$_LANG['email'] = "E-mail";
...
$_LANG['encryption_failed'] = "Kryptering mislykkedes: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Prøv igen senere.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Hjemmeside";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Du har sendt for mange anmodninger.";
...
$_LANG['estimateTaxes'] = "Beregn moms";
$_LANG['every'] = "Hver";
$_LANG['exampledomain'] = "fx. example.com";
$_LANG['excludeTLDs'] = "Udelukker visse TLD'er og for nylig fornyede domæner";
...
$_LANG['extendYourDomainBy1Year'] = "Forlæng dit domæne med 1 år*";
...
$_LANG['findDomains'] = "Find domæner";
...
$_LANG['forTheFirstYear'] = "for det første år";
...
$_LANG['freeDomainHostingPromo'] = "Få et gratis domæne, når du køber hosting.";
$_LANG['from'] = "Fra";
...
$_LANG['hideSearchControls'] = "Skjul søgekontrolelementer";
...
$_LANG['inStock'] = "På lager: :amount";
$_LANG['incApplicableTaxes'] = "inkl. gældende skatter";
$_LANG['includeTLDs'] = "Inkluder TLD'er";
$_LANG['included'] = "Inkluderet";
...
$_LANG['invalidCode'] = "Ugyldig kampagnekode";
$_LANG['invalid_input'] = "Ugyldig input: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "Ugyldigt billet-id eller svar-id.";
...
$_LANG['lastChance'] = "Sidste chance";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Log ind";
...
$_LANG['navMarketConnectService']['dynamic'] = "Dynamiske tjenester";
...
$_LANG['noDomainsFound'] = "Ingen domæner fundet";
...
$_LANG['orderForm']['additionalInformation'] = "Yderligere information";
...
$_LANG['orderForm']['findNewDomainAi'] = "Søg efter et domæne med AI-drevne forslag.";
...
$_LANG['ordererrortldsnotconfigured'] = "Ingen domæneudvidelser er i øjeblikket tilgængelige til salg. For hjælp, kontakt os.";
...
$_LANG['orderpaymenttermadjectivemonthly'] = "Månedlig";
$_LANG['orderpaymenttermadjectiveonetime'] = "En gang";
$_LANG['orderpaymenttermadjectivequarterly'] = "Kvartalsvis";
$_LANG['orderpaymenttermadjectivesemiannually'] = "Halvårlig";
...
$_LANG['orderselectterm'] = "Vælg Term";
...
$_LANG['page'] = "Side";
$_LANG['pageof'] = "af";
$_LANG['passwordtips'] = "<strong>Tips til en sikker adgangskode</strong><br />Brug både store og små bogstaver.<br />Inkluder mindst et symbol (for eksempel <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>, eller <code>&amp;</code>).<br />Brug ikke ordbogsord.<br />Adgangskoder kan indeholde op til :maximumtegn med _længde.";
...
$_LANG['price'] = "pris";
$_LANG['priceFor'] = "Pris for :term";
$_LANG['priceForThisTerm'] = "Pris for denne periode";
$_LANG['priceStandard'] = "Fornyes hvert år med :renewalPriceplus skat.";
$_LANG['priceWithDiscount'] = ":registrationPrice for det første år, derefter :renewalPrice årligt.";
...
$_LANG['pwlengthmax'] = "Adgangskoder må ikke indeholde mere end :max tegn.";
...
$_LANG['pwstrengthfail'] = "Denne adgangskode er ikke stærk nok. Indtast en mere kompleks adgangskode.";
...
$_LANG['recommendedTLDs'] = "Anbefalede TLD'er";
...
$_LANG['requiredFields'] = "Obligatoriske felter er markeret med*";
...
$_LANG['rssfeed'] = "Foder";
$_LANG['safeSearch'] = "Sikker søgning";
$_LANG['sale'] = "Salg";
$_LANG['salePrice'] = "salgspris";
$_LANG['salesTaxes'] = "Salgsafgifter";
$_LANG['search'] = "Søg";
$_LANG['searchOurKnowledgebase'] = "Søg i vores vidensbase";
$_LANG['searchResults'] = "Søge resultater";
...
$_LANG['selectCountry'] = "Vælg land";
$_LANG['selectDomain'] = "Vælg domæne";
$_LANG['selectDomainForHosting'] = "Hvilket domæne vil du vedhæfte denne delte hostingpakke til?";
$_LANG['selectDomainsForSsl'] = "Hvilket (t) domæne (er) vil du anvende den grundlæggende SSL på? Du kan vælge flere.";
$_LANG['selectState'] = "Vælg stat";
...
$_LANG['service_unavailable'] = "Service ikke tilgængelig: %s";
$_LANG['servicesRenew'] = "Forny";
$_LANG['setupFee'] = ":amount Opsætningsgebyr";
$_LANG['setupMandate'] = "Opsætning af mandat til betaling";
$_LANG['sharedHosting'] = "Delt hosting";
$_LANG['shopNow'] = "Køb nu";
$_LANG['shortcuts'] = "Genveje";
$_LANG['show'] = "Vis";
$_LANG['showMenu'] = "Vis Menu";
$_LANG['showSearchControls'] = "Vis søgekontrolelementer";
...
$_LANG['store']['dynamic']['title'] = "Dynamiske tjenester";
...
$_LANG['store']['error']['serviceUnavailable'] = "Kan ikke behandle din anmodning i øjeblikket. Dette kan skyldes en timeout eller et midlertidigt serviceproblem. Prøv venligst igen.";
$_LANG['store']['error']['validationFailed'] = "Kontroller og ret fejlene nedenfor.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo giver dig en gennemprøvet, guidet SEO-proces uden at kræve, at du er ekspert. <br> marketgoo er overkommelig og giver omfattende SEO-rapporter, planer og anbefalinger, alt sammen i en intuitiv grænseflade.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Hvad adskiller marketgoo fra andre SEO-produkter?";
$_LANG['store']['marketgoo']['faqs']['title'] = "Ofte stillede spørgsmål og support";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "Søgemaskineindsendelse";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Webstedsbyggerkompatibilitet";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Månedlig statusrapport";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Trafikanalyse";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Download SEO-rapport som PDF <a href='https://mktgoo.co/seo-report-score2'>(Se eksempel)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "AI-drevne funktioner: Automatisk generering af titel og metabeskrivelse";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Sider scannet";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Sporing af konkurrenter";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Søgeordsporing og optimering";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Opdateret rapport og plan";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Brugerdefineret SEO-plan";
$_LANG['store']['marketgoo']['features']['1'] = "Få din SEO-plan";
$_LANG['store']['marketgoo']['features']['2'] = "Følg trinvise instruktioner";
$_LANG['store']['marketgoo']['features']['3'] = "Overvåg fremskridt med en månedlig rapport";
$_LANG['store']['marketgoo']['features']['4'] = "Spor og overvåg konkurrenter";
$_LANG['store']['marketgoo']['features']['5'] = "Individuel sideoptimering";
$_LANG['store']['marketgoo']['features']['6'] = "Nem søgeordsforskning og overvågning";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Tilmeld dig og få din øjeblikkelige SEO-rapport og plan. Se, hvor der er plads til forbedringer, og få anbefalinger, der er skræddersyet til dit websted.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Instruktioner er skrevet til ikke-teknisk kyndige brugere, der guider dig gennem hver anbefaling, med eksempler og forklaringer.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Hver måned skal du få en e-mail med dit websteds SEO-fremskridt og downloade den som en PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Hold øje med konkurrenterne for at se, hvad de gør for at få trafik, og hvordan dine numre står i forhold til deres. De vil aldrig vide, at du ser på!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo guider dig gennem optimering af hver enkelt side på dit websted ved at matche den til et af dine valgte søgeord og sørge for, at hyppigheden og placeringen er korrekt.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "Nøgleord kan være overvældende, hvis du ikke er bekendt med SEO. marketgoo anbefaler nøgleord og giver dig også mulighed for at søge efter og indtaste dem, du vil optimere til.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Fungerer med alle webstedsbyggere";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Sammenligningsdato: juni 19, 20 25:tagBreak*Samlet netværksydelse ifølge forskning fra AV-Test. Du kan læse :tagOpenhele rapporten:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Advarsler om lækkede legitimationsoplysninger";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Malware scanning efter downloads";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Ikke afsløret";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "Tracker og annonceblokering";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN begrænser ikke forbindelseshastigheder. Nyd vores fuldhastigheds VPN-forbindelse uden nogen begrænsning.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN er kompatibel med alle populære platforme, herunder Windows, macOS, Linux, Android og iOS. Derudover kan du sikre op til 10 enheder, inklusive din router.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "Ingen VPN-båndbreddegrænser  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Gennemse, spil og arbejd på en privat og sikker forbindelse";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Forbliv sikker forbindelse, selv på offentlig Wi-Fi";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Reducer online tracking ved at afskærme din IP-adresse";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Se hjemmeindhold, mens du rejser til udlandet";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Brug NordVPN til at kryptere din onlineaktivitet for et ekstra lag af beskyttelse, når og hvor du er tilsluttet.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN beskytter din forbindelse med næste generations kryptering, så du kan logge ind på dine konti, foretage bankoverførsler og shoppe online uden bekymringer. Selv på ubeskyttede netværk.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN kan prale af en bred vifte af funktioner, der beskytter dig mod cybertrusler. Ud over Threat Protection Pro™ er der en automatisk Kill Switch, der blokerer din internetforbindelse, hvis din VPN-forbindelse falder, hvilket sikrer, at dine data forbliver sikre. Tilslørte servere hjælper, når der kræves et højt niveau af onlinesikkerhed på grund af regeringens censur og strenge internetregler.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Forøg din online sikkerhed med en VPN";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Avanceret sikkerhed";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Hver gang du downloader en fil, inspicerer Threat Protection Pro™ den for malware.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ blokerer påtrængende annoncer og webtrackere og scanner automatisk webadresser og blokerer ondsindede.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Threat Protection Pro™ beskytter dine enheder og dit privatliv. Ved at blokere trackere hjælper det dig med at undgå online-snoopers.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "NordVPNs :tagOpenThreat Protection Pro™:tagClose funktion er en game changer, der giver endnu flere sikkerhedsfordele og bedre beskyttelse med et enkelt ekstra klik.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Mere end bare en VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Selvom du ikke har noget at skjule, kan du sandsynligvis ikke lide ideen om at blive overvåget og sporet. Hovedårsagen til, at internetbrugere vælger VPN-tjenester, er online privatliv og generel sikkerhed.:tagBreakHer er specifikke grunde til HVORFOR?";
$_LANG['store']['nordvpn']['features']['use']['tagline2'] = "Offentlige Wi-Fi-netværk på hoteller, lufthavne og kaffebarer er de perfekte mål for hackere på grund af ofte lave sikkerhedsforanstaltninger.";
...
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Undgå regionale og politiske begrænsninger på platforme som Facebook, X (Twitter) og WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Online-annoncer er normalt irriterende og distraherende. De roder store dele af websteder, langsom forbindelseshastighed og kan være ondsindede.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Smarte hjemmeteknologier, især usikre IoT-enheder, kan skabe sårbarheder i hjemmenetværkene.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Sikker offentlig Wi-Fi-forbindelse";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Sikrere browsing";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Ubegrænset adgang til sociale medier";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Beskyttelse mod ondsindede annoncer";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Smart hjemmesikkerhed";
...
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Få aftalen";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Beskyt din IP-adresse:tagBreak• Bloker malware, trackere og annoncer:tagBreak• Tilslut op til 10 enheder";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Daglige SMART-databasescanninger";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Daglige SMART-filscanninger";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Design nyt indhold, forbedre engagementet, og spor dine resultater med SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "SocialBee Administration af sociale medier";
...
$_LANG['suggestedTLDs'] = "Foreslåede TLD'er";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Ugyldigt momsnummerformat for :countryName.";
...
$_LANG['updateProductQuantity'] = "Opdater";
$_LANG['updateTotals'] = "Opdater total";
