...
$_LANG['addToCartButton'] = "Vložit do košíku";
$_LANG['addToGetFreeDomain'] = "Přidat a získat bezplatnou doménu";
...
$_LANG['applyPromoCode'] = "Aplikujte";
...
$_LANG['billing']['creditnote'] = "Úvěrová poznámka";
$_LANG['billing']['debitnote'] = "Debetní poznámka";
$_LANG['billing']['issuedate'] = "Datum vydání";
$_LANG['billing']['issuedby'] = "Vydáno uživatelem";
$_LANG['billing']['issuedto'] = "Vydáno do";
$_LANG['billing']['ledger']['date'] = "Datum";
$_LANG['billing']['ledger']['reference'] = "Odkaz";
$_LANG['billing']['ledger']['title'] = "Zápisník";
$_LANG['billing']['ledger']['type'] = "Typ";
$_LANG['billing']['type']['affiliatepayout'] = "Affiliate výplata";
$_LANG['billing']['type']['clientaccountcredit'] = "Kredit na klientský účet";
$_LANG['billing']['type']['clientaccountdebit'] = "Debit klientského účtu";
$_LANG['billing']['type']['creditnoteadjustment'] = "Úprava dobropisu";
$_LANG['billing']['type']['invoiceadjustment'] = "Úprava faktury";
$_LANG['billing']['type']['payment'] = "Platba";
$_LANG['billing']['type']['refund'] = "Vrácení peněz";
$_LANG['billing']['type']['refundtocredit'] = "Vrácení peněz na klientský účet";
$_LANG['billingAddress'] = "Fakturační adresa";
$_LANG['billingOverview'] = "Přehled fakturace";
$_LANG['billingdetails'] = "Fakturační údaje";
$_LANG['billingnotes']['creditnote']['items'] = "Položky dobropisu";
$_LANG['billingnotes']['debitnote']['items'] = "Položky debetních poznámek";
...
$_LANG['cartItemType']['addon'] = "Doplňek";
$_LANG['cartItemType']['addons'] = "Doplňky";
$_LANG['cartItemType']['bundle'] = "Balíček";
$_LANG['cartItemType']['bundles'] = "Svazky";
$_LANG['cartItemType']['domain'] = "Doména";
$_LANG['cartItemType']['domainRegistration'] = "Registrace domény";
$_LANG['cartItemType']['domainRenewal'] = "Prodloužení domén";
$_LANG['cartItemType']['domainRenewals'] = "Prodloužení domén";
$_LANG['cartItemType']['domainTransfer'] = "Transfer domény";
$_LANG['cartItemType']['domainTransfers'] = "Převody domén";
$_LANG['cartItemType']['domains'] = "Domény";
$_LANG['cartItemType']['product'] = "Produkt";
$_LANG['cartItemType']['products'] = "Výrobky";
$_LANG['cartItemsSelected'] = "Máte :count vybranou a připravenou k nákupu.";
...
$_LANG['cartbrowse'] = "Procházet produkty a služby";
...
$_LANG['choosePackages'] = "Vyberte si z řady balíčků";
...
$_LANG['codeApplied'] = "Použitý propagační kód";
$_LANG['completeorder'] = "Dokončit objednávku";
$_LANG['configModalTitle'] = "Konfigurace";
...
$_LANG['confirmItemDeletion'] = "Potvrdit smazání";
...
$_LANG['cycleRenewal'] = ":cycle Obnovení";
$_LANG['daily'] = "Denně";
...
$_LANG['designedToFitAnyBudget'] = "Navrženo tak, aby vyhovovalo jakémukoli rozpočtu";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Vyhledávání podle klíčového slova, popisu nebo domény.&#10;Například: &quot;Zábavné obchodní akce &quot;, &quot;Komplexní služba finančního plánování pro profesionály&quot;nebo &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Zadejte krátký popis nebo přesnou doménu.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "Systém nemohl najít žádné návrhy.";
$_LANG['domainSearch']['exactMatch'] = "Přesná shoda";
$_LANG['domainSearch']['maxLength'] = "Maximální délka";
$_LANG['domainSearch']['notAvailable'] = "Není dostupné";
$_LANG['domainSearch']['safeSearch'] = "Bezpečné vyhledávání";
$_LANG['domainSearch']['tlds'] = "Zahrnout TLD";
$_LANG['domainSearch']['topAiSuggestion'] = "Nejlepší návrh AI";
$_LANG['domainSearch']['topSuggestion'] = "Nejlepší návrh";
...
$_LANG['due'] = "Splatno";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "Podmínky služby musíte přijmout zaškrtnutím :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute musí být pole.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute musí být platné datum.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute musí být platná e-mailová adresa.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "Systém narazil na interní chybu. Zkuste to znovu později.";
$_LANG['dynamicServiceFields']['validation']['in'] = "Vybraná volba pro :attribute je neplatná.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute musí být celé číslo.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute nesmí obsahovat více než :max znaků.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute musí používat jeden z následujících typů souborů: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute musí obsahovat alespoň :min znaků.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute musí být číslo.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute musí být platný regulární výraz.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute je nutný.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute musí být platná adresa URL, která obsahuje protokol ('http: //' nebo 'https: //').";
$_LANG['edit'] = "Upravit";
$_LANG['email'] = "E-mail";
...
$_LANG['encryption_failed'] = "Šifrování se nezdařilo: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Zkuste to znovu později.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Domovská stránka";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Poslali jste příliš mnoho žádostí.";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "Jejda!";
...
$_LANG['estimateTaxes'] = "Odhad daní";
$_LANG['every'] = "Každý";
$_LANG['exampledomain'] = "např. example.com";
$_LANG['excludeTLDs'] = "Nezahrnuje některé TLD a nedávno obnovené domény";
...
$_LANG['extendYourDomainBy1Year'] = "Prodlužte svou doménu o 1 rok*";
...
$_LANG['findDomains'] = "Najít domény";
...
$_LANG['forTheFirstYear'] = "za první rok";
...
$_LANG['freeDomainHostingPromo'] = "Získejte zdarma doménu při nákupu hostingu.";
$_LANG['from'] = "Od";
...
$_LANG['hideSearchControls'] = "Skrýt ovládací prvky vyhledávání";
...
$_LANG['inStock'] = "Na skladě: :amount";
$_LANG['incApplicableTaxes'] = "včetně příslušných daní";
$_LANG['includeTLDs'] = "Zahrnout TLD";
$_LANG['included'] = "Zahrnuto";
...
$_LANG['invalidCode'] = "Neplatný promo kód";
$_LANG['invalid_input'] = "Neplatný vstup: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "Neplatné ID tiketu nebo ID odpovědi.";
...
$_LANG['lastChance'] = "Poslední šance";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Přihlásit se";
...
$_LANG['maxLength'] = "Maximální délka";
...
$_LANG['navMarketConnectService']['dynamic'] = "Dynamické služby";
...
$_LANG['noDomainsFound'] = "Nebyly nalezeny žádné domény";
...
$_LANG['orderForm']['additionalInformation'] = "Doplňující informace";
...
$_LANG['orderForm']['findNewDomainAi'] = "Vyhledejte doménu s návrhy založenými na umělé inteligenci.";
...
$_LANG['ordererrortldsnotconfigured'] = "V současné době nejsou k dispozici žádné přípony domény k prodeji. Pro pomoc nás kontaktujte.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "Roční";
$_LANG['orderpaymenttermadjectivebiennially'] = "Bienále";
$_LANG['orderpaymenttermadjectivefree'] = "Zdarma";
$_LANG['orderpaymenttermadjectivemonthly'] = "Měsíčně";
$_LANG['orderpaymenttermadjectiveonetime'] = "Jednorázově";
$_LANG['orderpaymenttermadjectivequarterly'] = "Čtvrtletně";
$_LANG['orderpaymenttermadjectivesemiannually'] = "Pololetní";
$_LANG['orderpaymenttermadjectivetriennially'] = "Trienále";
...
$_LANG['orderselectterm'] = "Vybrat termín";
...
$_LANG['page'] = "Strana";
$_LANG['pageof'] = "z";
$_LANG['passwordtips'] = "<strong>Tipy pro bezpečné heslo</strong><br />Používejte velká i malá písmena.<br />Uveďte alespoň jeden symbol (například <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>, nebo <code>&amp;</code>).<br />Nepoužívejte slovníková slova.<br />Hesla mohou obsahovat až :maximumznaků _length.";
...
$_LANG['premium'] = "Prémiové";
$_LANG['presalescontactdescription'] = "Kontakt v případě otázek před koupí našich služeb";
$_LANG['previous'] = "Předchozí";
$_LANG['previouspage'] = "Předchozí strana";
$_LANG['price'] = "cena";
$_LANG['priceFor'] = "Cena za :term";
$_LANG['priceForThisTerm'] = "Cena za tento termín";
$_LANG['priceStandard'] = "Obnovuje se každý rok na :renewalPriceplus daň.";
$_LANG['priceWithDiscount'] = ":registrationPrice za první rok, poté :renewalPrice ročně.";
...
$_LANG['pwlengthmax'] = "Hesla nesmí obsahovat více než :max znaků.";
...
$_LANG['pwstrengthfail'] = "Toto heslo není dostatečně silné. Zadejte složitější heslo.";
...
$_LANG['recommendedTLDs'] = "Doporučené TLD";
...
$_LANG['requiredFields'] = "Povinná pole jsou označena znakem*";
...
$_LANG['safeSearch'] = "Bezpečné vyhledávání";
$_LANG['sale'] = "Prodej";
$_LANG['salePrice'] = "prodejní cena";
$_LANG['salesTaxes'] = "Daně z prodeje";
$_LANG['search'] = "Hledání";
$_LANG['searchOurKnowledgebase'] = "Prohledejte naši znalostní databázi";
$_LANG['searchResults'] = "Výsledky vyhledávání";
...
$_LANG['selectCountry'] = "Vyberte zemi";
$_LANG['selectDomain'] = "Vybrat doménu";
$_LANG['selectDomainForHosting'] = "Ke které doméně byste chtěli připojit tento sdílený hostingový balíček?";
$_LANG['selectDomainsForSsl'] = "Na jakou doménu (domény) byste chtěli použít základní SSL? Můžete vybrat více.";
$_LANG['selectState'] = "Vybrat stát";
...
$_LANG['service_unavailable'] = "Služba není k dispozici: %s";
$_LANG['servicesRenew'] = "Prodloužení";
$_LANG['setupFee'] = ":amount Instalační poplatek";
$_LANG['setupMandate'] = "Nastavení pověření k platbě";
$_LANG['sharedHosting'] = "Sdílený hosting";
$_LANG['shopNow'] = "Nakupujte nyní";
$_LANG['shortcuts'] = "Zkratky";
$_LANG['show'] = "Zobrazit";
$_LANG['showMenu'] = "Zobrazit nabídku";
$_LANG['showSearchControls'] = "Zobrazit ovládací prvky vyhledávání";
...
$_LANG['store']['dynamic']['title'] = "Dynamické služby";
...
$_LANG['store']['error']['serviceUnavailable'] = "V tuto chvíli nelze zpracovat vaši žádost. Může to být způsobeno časovým limitem nebo dočasným problémem se službou. Zkuste to prosím znovu.";
$_LANG['store']['error']['validationFailed'] = "Zkontrolujte a opravte níže uvedené chyby.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo vám poskytuje osvědčený, řízený proces SEO, aniž byste museli být odborníkem. <br> marketgoo je cenově dostupný a poskytuje komplexní SEO zprávy, plány a doporučení, vše v intuitivním rozhraní.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Čím se marketgoo liší od ostatních SEO produktů?";
$_LANG['store']['marketgoo']['faqs']['title'] = "Časté dotazy a podpora";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "Odeslání vyhledávačů";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Kompatibilita Tvůrce webových stránek";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Měsíční zpráva o pokroku";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Analýzy provozu";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Stáhněte si SEO zprávu jako PDF <a href='https://mktgoo.co/seo-report-score2'>(viz příklad)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "Funkce založené na umělé inteligenci: Automatické generování titulu a meta popisu";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Naskenované stránky";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Sledování konkurence";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Sledování klíčových slov a optimalizace";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Aktualizovaná zpráva a plán";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Vlastní plán SEO";
$_LANG['store']['marketgoo']['features']['1'] = "Získejte svůj SEO plán";
$_LANG['store']['marketgoo']['features']['2'] = "Postupujte podle pokynů krok za krokem";
$_LANG['store']['marketgoo']['features']['3'] = "Monitorujte pokrok pomocí měsíční zprávy";
$_LANG['store']['marketgoo']['features']['4'] = "Sledujte a sledujte soutěžící";
$_LANG['store']['marketgoo']['features']['5'] = "Individuální optimalizace stránky";
$_LANG['store']['marketgoo']['features']['6'] = "Snadný výzkum a monitorování klíčových slov";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Zaregistrujte se a získejte okamžitou zprávu a plán SEO. Podívejte se, kde je prostor pro zlepšení, a získejte doporučení šitá na míru vašemu webu.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Pokyny jsou napsány pro uživatele, kteří nejsou technicky zdatní, provedou vás každým doporučením, s příklady a vysvětlením.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Každý měsíc obdržíte e-mail s pokrokem SEO vašeho webu a stáhněte si jej jako PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Sledujte konkurenty, abyste zjistili, co dělají, aby získali provoz a jak se vaše čísla vyrovnávají s jejich. Nikdy se nedozví, že se díváš!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo vás provede optimalizací každé jednotlivé stránky na vašem webu tím, že ji přiřadí k jednomu z vámi vybraných klíčových slov a ujistí se, že frekvence a umístění jsou správné.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "Klíčová slova mohou být ohromující, pokud nejste obeznámeni se SEO. marketgoo doporučuje klíčová slova a také vám umožňuje vyhledávat a zadávat ta, pro která chcete optimalizovat.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Spolupracuje se všemi tvůrci webových stránek";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Datum srovnání: červen 19,20 25:tagBreak*Celkový výkon sítě podle výzkumu AV-Test. Můžete si přečíst :tagOpencelou zprávu:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Upozornění na uniklé přihlašovací údaje";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Skenování škodlivého softwaru pro stahování";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Nezveřejněno";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "Sledovač a blokování reklam";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN neomezuje rychlost připojení. Užijte si naše vysokorychlostní připojení VPN bez omezení.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN je kompatibilní se všemi populárními platformami, včetně Windows, macOS, Linux, Android a iOS. Navíc můžete zabezpečit až 10 zařízení, včetně routeru.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "Žádné limity šířky pásma VPN  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Procházejte, hrajte a pracujte na soukromém a zabezpečeném připojení";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Zůstaňte bezpečně připojeni i na veřejné Wi-Fi";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Omezte sledování online chráněním vaší IP adresy";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Sledujte domácí obsah při cestování do zahraničí";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Použijte NordVPN k šifrování vaší online aktivity pro další vrstvu ochrany, kdykoli a kdekoli jste připojeni.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN chrání vaše připojení šifrováním nové generace, takže se můžete bez obav přihlásit ke svým účtům, provádět bankovní převody a nakupovat online. Dokonce i na nechráněných sítích.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN se může pochlubit širokou škálou funkcí, které vás ochrání před kybernetickými hrozbami. Kromě Threat Protection Pro™ je k dispozici automatický Kill Switch, který zablokuje vaše připojení k internetu v případě přerušení připojení k síti VPN a zajišťuje, že vaše data zůstanou v bezpečí. Zmatené servery pomohou, když je vyžadována vysoká úroveň zabezpečení online kvůli vládní cenzuře a přísným internetovým předpisům.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Zvyšte svou online bezpečnost pomocí VPN";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Pokročilé zabezpečení";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Kdykoli stáhnete soubor, Threat Protection Pro™ jej zkontroluje, zda neobsahuje malware.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ blokuje rušivé reklamy a webové sledovače a automaticky skenuje adresy URL a blokuje škodlivé.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Threat Protection Pro™ chrání vaše zařízení a vaše soukromí. Blokováním sledovačů vám pomůže vyhnout se online špehovačům.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "Funkce :tagOpenThreat Protection Pro™:tagClose společnosti NordVPN mění hru, která nabízí ještě více bezpečnostních výhod a lepší ochranu jediným kliknutím navíc.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Více než jen VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "I když nemáte co skrývat, pravděpodobně se vám nelíbí myšlenka být sledováni a sledováni. Hlavním důvodem, proč uživatelé internetu volí služby VPN, je online soukromí a obecná bezpečnost.:tagBreakZde jsou konkrétní důvody PROČ?";
...
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Vyhněte se regionálním a politickým omezením na platformách jako Facebook, X (Twitter) a WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Online reklamy jsou obvykle nepříjemné a rušivé. Zablokují velké části webových stránek, zpomalují rychlost připojení a mohou být škodlivé.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Inteligentní domácí technologie, zejména nezabezpečená zařízení IoT, mohou vytvářet zranitelnosti v domácích sítích.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Zabezpečené veřejné Wi-Fi připojení";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Bezpečnější prohlížení";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Neomezený přístup k sociálním médiím";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Ochrana před škodlivými reklamami";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Zabezpečení inteligentního domova";
...
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Získejte dohodu";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Chraňte svou IP adresu:tagBreak• Blokovat malware, sledovače a reklamy:tagBreak• Připojte až 10 zařízení";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Denní skenování SMART databáze";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Denní skenování souborů SMART";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Navrhněte nový obsah, zlepšete zapojení, a sledujte své výsledky pomocí SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "SocialBee Správa sociálních médií";
...
$_LANG['suggestedTLDs'] = "Doporučené TLD";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Neplatný formát čísla DPH pro :countryName.";
...
$_LANG['updateProductQuantity'] = "Aktualizace";
$_LANG['updateTotals'] = "Aktualizovat součty";
