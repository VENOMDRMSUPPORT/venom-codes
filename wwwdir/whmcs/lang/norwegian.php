...
$_LANG['addToCartButton'] = "Legg til handlevogn";
$_LANG['addToGetFreeDomain'] = "Legg til for å få gratis domene";
...
$_LANG['basicSsl'] = "Grunnleggende SSL";
$_LANG['billableitemseach'] = "Stk";
$_LANG['billableitemshour'] = "Time";
$_LANG['billableitemshours'] = "Timer";
$_LANG['billableitemsquantity'] = "Antall";
$_LANG['billing']['creditnote'] = "Kredittnotat";
$_LANG['billing']['debitnote'] = "Debetnotat";
$_LANG['billing']['issuedate'] = "Utstedelsesdato";
$_LANG['billing']['issuedby'] = "Utstedt av";
$_LANG['billing']['issuedto'] = "Utstedt til";
$_LANG['billing']['ledger']['date'] = "Dato";
$_LANG['billing']['ledger']['reference'] = "Referanse";
$_LANG['billing']['ledger']['title'] = "Hovedbok";
$_LANG['billing']['ledger']['type'] = "Type";
$_LANG['billing']['type']['affiliatepayout'] = "Affiliate utbetaling";
$_LANG['billing']['type']['clientaccountcredit'] = "Klientkontokreditt";
$_LANG['billing']['type']['clientaccountdebit'] = "Klientkontodebet";
...
$_LANG['billing']['type']['refund'] = "Tilbakebetaling";
$_LANG['billing']['type']['refundtocredit'] = "Tilbakebetaling til klientkonto";
$_LANG['billingAddress'] = "Fakturaadresse";
$_LANG['billingOverview'] = "Faktureringsoversikt";
$_LANG['billingdetails'] = "Fakturadetaljer";
$_LANG['billingnotes']['creditnote']['items'] = "Kredittnotatelementer";
$_LANG['billingnotes']['debitnote']['items'] = "Debetnotatelementer";
...
$_LANG['cartItemType']['addon'] = "Tillegg";
$_LANG['cartItemType']['addons'] = "Tillegg";
$_LANG['cartItemType']['bundle'] = "Bunt";
$_LANG['cartItemType']['bundles'] = "pakker";
$_LANG['cartItemType']['domain'] = "Domene";
$_LANG['cartItemType']['domainRegistration'] = "Domenenavn registrering";
$_LANG['cartItemType']['domainRenewal'] = "Domenenavn fornyelse";
$_LANG['cartItemType']['domainRenewals'] = "Fornying av domenenavn";
$_LANG['cartItemType']['domainTransfer'] = "Domenenavn overføring";
$_LANG['cartItemType']['domainTransfers'] = "Domeneoverføringer";
$_LANG['cartItemType']['domains'] = "Domenenavn";
$_LANG['cartItemType']['product'] = "Produkt";
$_LANG['cartItemType']['products'] = "Produkter";
$_LANG['cartItemsSelected'] = "Du har :count valgt og klar til kjøp.";
...
$_LANG['cartbrowse'] = "Bla gjennom produkter og tjenester";
...
$_LANG['choosePackages'] = "Velg fra en rekke pakker";
...
$_LANG['designedToFitAnyBudget'] = "Designet for å passe ethvert budsjett";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Søk etter nøkkelord, beskrivelse, eller domene.&#10;For eksempel: &quot;Morsomme forretningsarrangementer &quot;, &quot;En omfattende økonomisk planleggingstjeneste for fagfolk&quot;, eller &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Skriv inn en kort beskrivelse eller et nøyaktig domene.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "Systemet kunne ikke finne noen forslag.";
$_LANG['domainSearch']['exactMatch'] = "Eksakt samsvar";
$_LANG['domainSearch']['maxLength'] = "Maksimal lengde";
$_LANG['domainSearch']['notAvailable'] = "Ikke tilgjengelig";
$_LANG['domainSearch']['safeSearch'] = "Trygt søk";
$_LANG['domainSearch']['tlds'] = "Inkluder TLD-er";
$_LANG['domainSearch']['topAiSuggestion'] = "Topp AI-forslag";
$_LANG['domainSearch']['topSuggestion'] = "Topp forslag";
...
$_LANG['due'] = "Forfall";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "Du må godta vilkårene for bruk ved å sjekke :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute må være en matrise.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute må være en gyldig dato.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute må være en gyldig e-postadresse.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "Systemet opplevde en intern feil. Prøv igjen senere.";
$_LANG['dynamicServiceFields']['validation']['in'] = "Det valgte alternativet for :attribute er ugyldig.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute må være et heltall.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute kan ikke inneholde mer enn :max tegn.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute må bruke en av følgende filtyper: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute må inneholde minst :min tegn.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute må være et tall.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute må være et gyldig regulært uttrykk.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute er påkrevd.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute må være en gyldig URL som inneholder protokollen ('http: //' eller 'https: //').";
$_LANG['edit'] = "Rediger";
$_LANG['email'] = "E-post";
...
$_LANG['encryption_failed'] = "Kryptering mislyktes: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Prøv igjen senere.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Hovedsiden";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Du har sendt for mange forespørsler.";
$_LANG['errorPage']['rateLimitExceeded']['title'] = "Beklager!";
...
$_LANG['estimateTaxes'] = "Estimerte avgifter";
$_LANG['every'] = "Hver";
$_LANG['exampledomain'] = "feks. example.com";
$_LANG['excludeTLDs'] = "Utelukker noen TLDer og nylige fornyede domener";
...
$_LANG['extendYourDomainBy1Year'] = "Utvid domenet ditt med 1 år*";
...
$_LANG['findDomains'] = "Finn domener";
...
$_LANG['forTheFirstYear'] = "for det første året";
...
$_LANG['freeDomainHostingPromo'] = "Få et gratis domene når du kjøper hosting.";
$_LANG['from'] = "Fra";
...
$_LANG['hideSearchControls'] = "Skjul søkekontroller";
...
$_LANG['incApplicableTaxes'] = "inkl. gjeldende skatter";
$_LANG['includeTLDs'] = "Inkluder TLD-er";
$_LANG['included'] = "Inkludert";
...
$_LANG['invalidCode'] = "Ugyldig kampanjekode";
$_LANG['invalid_input'] = "Ugyldig inngang: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "Ugyldig billett-id eller svar-ID.";
...
$_LANG['lastChance'] = "Siste endring";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Logg inn";
...
$_LANG['noDomainsFound'] = "Ingen domener funnet";
...
$_LANG['orderForm']['additionalInformation'] = "Tilleggsinformation";
...
$_LANG['orderForm']['findNewDomainAi'] = "Søk etter et domene med AI-drevne forslag.";
...
$_LANG['ordererrortldsnotconfigured'] = "Ingen domeneutvidelser er for øyeblikket tilgjengelig for salg. For hjelp, kontakt oss.";
...
$_LANG['orderselectterm'] = "Velg begrep";
...
$_LANG['passwordtips'] = "<strong>Tips for et sikkert passord</strong><br />Bruk både store og små bokstaver.<br />Inkluder minst ett symbol (for eksempel <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>, eller <code>&amp;</code>).<br />Ikke bruk ordbokord.<br />Passord kan inneholde opptil :maximum_lengde-tegn.";
...
$_LANG['priceForThisTerm'] = "Pris for denne perioden";
$_LANG['priceStandard'] = "Fornyes hvert år på :renewalPrice, pluss skatt.";
$_LANG['priceWithDiscount'] = ":registrationPrice for det første året, deretter :renewalPrice årlig.";
...
$_LANG['pwlengthmax'] = "Passord kan ikke inneholde mer enn :max tegn.";
...
$_LANG['pwstrengthfail'] = "Dette passordet er ikke sterkt nok. Skriv inn et mer komplekst passord.";
...
$_LANG['recommendedTLDs'] = "Anbefalte toppdomener";
...
$_LANG['requiredFields'] = "Obligatoriske felt er merket med*";
...
$_LANG['safeSearch'] = "Trygt søk";
$_LANG['sale'] = "Salg";
$_LANG['salePrice'] = "salgspris";
$_LANG['salesTaxes'] = "Salgsavgifter";
$_LANG['search'] = "Søk";
$_LANG['searchOurKnowledgebase'] = "Søk i vår kunnskapsbase";
$_LANG['searchResults'] = "Søkeresultater";
...
$_LANG['selectCountry'] = "Velg land";
$_LANG['selectDomain'] = "Velg domene";
$_LANG['selectDomainForHosting'] = "Hvilket domene vil du knytte denne delte hostingpakken til?";
$_LANG['selectDomainsForSsl'] = "Hvilket domene vil du bruke grunnleggende SSL på? Du kan velge flere.";
$_LANG['selectState'] = "Velg stat";
...
$_LANG['service_unavailable'] = "Tjenesten ikke tilgjengelig: %s";
$_LANG['servicesRenew'] = "Fornye";
$_LANG['setupFee'] = ":amount Klargjøringsavgift";
...
$_LANG['showSearchControls'] = "Vis søkekontroller";
...
$_LANG['store']['error']['serviceUnavailable'] = "Kan ikke behandle forespørselen din for øyeblikket. Dette kan skyldes en tidsavbrudd eller et midlertidig serviceproblem. Vennligst prøv igjen.";
$_LANG['store']['error']['validationFailed'] = "Vennligst sjekk og korriger feilene nedenfor.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo gir deg en velprøvd, guidet SEO-prosess uten å kreve at du er ekspert. <br> marketgoo er rimelig og gir omfattende SEO-rapporter, planer og anbefalinger, alt i et intuitivt grensesnitt.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Hva gjør marketgoo forskjellig fra andre SEO-produkter?";
$_LANG['store']['marketgoo']['faqs']['title'] = "FAQs og support";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "Søkemotorinnsending";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Nettstedbyggerkompatibilitet";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Månedlig fremdriftsrapport";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Trafikkanalyse";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Last ned SEO-rapport som PDF <a href='https://mktgoo.co/seo-report-score2'>(Se eksempel)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "AI-drevne funksjoner: Automatisk generering av tittel og metabeskrivelse";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Skannede sider";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Konkurrentsporing";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Søkeordsporing og optimalisering";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Oppdatert rapport og plan";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Tilpasset SEO-plan";
$_LANG['store']['marketgoo']['features']['1'] = "Få din SEO-plan";
$_LANG['store']['marketgoo']['features']['2'] = "Følg trinnvise instruksjoner";
$_LANG['store']['marketgoo']['features']['3'] = "Overvåk fremdriften med en månedlig rapport";
$_LANG['store']['marketgoo']['features']['4'] = "Spor og overvåk konkurrenter";
$_LANG['store']['marketgoo']['features']['5'] = "Individuell sideoptimalisering";
$_LANG['store']['marketgoo']['features']['6'] = "Enkel søkeordforskning og overvåking";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Registrer deg og få din umiddelbare SEO-rapport og plan. Se hvor det er rom for forbedringer, og få anbefalinger skreddersydd for nettstedet ditt.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Instruksjoner er skrevet for ikke-teknisk kunnskapsrike brukere, og veileder deg gjennom hver anbefaling, med eksempler og forklaringer.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Hver måned får du en e-post med nettstedets SEO-fremgang og laster den ned som en PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Hold øye med konkurrentene for å se hva de gjør for å få trafikk og hvordan tallene dine står opp mot deres. De vil aldri vite at du ser på!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo guider deg gjennom å optimalisere hver enkelt side på nettstedet ditt ved å matche den til et av dine valgte søkeord og sørge for at frekvensen og plasseringen er riktig.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "Søkeord kan være overveldende hvis du ikke er kjent med SEO. marketgoo anbefaler nøkkelord og lar deg også søke etter og legge inn de du vil optimalisere for.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Fungerer med alle nettstedbyggere";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Sammenligningsdato: juni 19, 20 25:tagBreak*Samlet nettverksytelse i henhold til forskning fra AV-Test. Du kan lese :tagOpenhele rapporten:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Varsler om lekket legitimasjon";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Malware søk etter nedlastinger";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Ikke avslørt";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "Tracker og annonseblokkering";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN begrenser ikke tilkoblingshastigheter. Nyt vår fullhastighets VPN-tilkobling uten begrensning.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN er kompatibel med alle populære plattformer, inkludert Windows, macOS, Linux, Android og iOS. I tillegg kan du sikre opptil 10 enheter, inkludert ruteren din.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "Ingen VPN-båndbreddegrenser  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Bla gjennom, spill og arbeid på en privat og sikker tilkobling";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Hold deg trygt tilkoblet selv på offentlig Wi-Fi";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Reduser online sporing ved å skjerme IP-adressen din";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Se hjemmeinnhold mens du reiser utenlands";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Bruk NordVPN til å kryptere din online aktivitet for et ekstra lag med beskyttelse når og hvor du er tilkoblet.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN beskytter forbindelsen din med neste generasjons kryptering, slik at du kan logge på kontoene dine, foreta bankoverføringer og handle på nettet uten bekymringer. Selv på ubeskyttede nettverk.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN har et bredt spekter av funksjoner for å beskytte deg mot cybertrusler. I tillegg til Threat Protection Pro™ er det en automatisk Kill Switch som blokkerer internettforbindelsen din hvis VPN-tilkoblingen faller, og sikrer at dataene dine forblir trygge. Tilslørte servere vil hjelpe når et høyt nivå av online sikkerhet er nødvendig på grunn av statlig sensur og strenge internettforskrifter.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Øk sikkerheten på nettet med et VPN";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Avansert sikkerhet";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Hver gang du laster ned en fil, inspiserer Threat Protection Pro™ den for skadelig programvare.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ blokkerer påtrengende annonser og nettsporere, og skanner automatisk nettadresser og blokkerer ondsinnede.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Threat Protection Pro™ beskytter enhetene dine og personvernet ditt. Ved å blokkere sporere hjelper det deg å unngå online snoopers.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "NordVPNs :tagOpenThreat Protection Pro™:tagClose funksjon er en game changer som gir enda flere sikkerhetsfordeler og bedre beskyttelse med et enkelt ekstra klikk.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Mer enn bare et VPN";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Selv om du ikke har noe å skjule, liker du sannsynligvis ikke ideen om å bli overvåket og sporet. Hovedårsaken til at internettbrukere velger VPN-tjenester er personvern på nettet og generell sikkerhet.:tagBreakHer er spesifikke grunner HVORFOR?";
...
$_LANG['store']['nordvpn']['features']['use']['tagline3'] = "Forhindre tredjeparter, for eksempel internettleverandører, fra å se og spore din daglige aktivitet på nettet.";
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Unngå regionale og politiske begrensninger på plattformer som Facebook, X (Twitter) og WhatsApp.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Nettannonser er vanligvis irriterende og distraherende. De roter store deler av nettsteder, reduserer tilkoblingshastigheten, og kan være ondsinnede.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Smarte hjemmeteknologier, spesielt usikre IoT-enheter, kan skape sårbarheter i hjemmenettverkene.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Sikker offentlig Wi-Fi-tilkobling";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Tryggere surfing";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Ubegrenset tilgang til sosiale medier";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Beskyttelse mot ondsinnede annonser";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Smart hjemmesikkerhet";
...
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Få avtalen";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Beskytt IP-adressen din:tagBreak• Blokker skadelig programvare, sporere og annonser:tagBreak• Koble til opptil 10 enheter";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Daglige SMART-databaseskanninger";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Daglige SMART-filskanninger";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Design ferskt innhold, forbedre engasjementet, og spor resultatene dine med SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "SocialBee Administrasjon av sosiale medier";
...
$_LANG['suggestedTLDs'] = "Foreslåtte TLD-er";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Ugyldig MVA-nummerformat for :countryName.";
...
$_LANG['updateProductQuantity'] = "Oppdater";
$_LANG['updateTotals'] = "Oppdater totalsum";
