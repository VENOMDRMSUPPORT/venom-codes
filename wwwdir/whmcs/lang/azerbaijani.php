...
$_LANG['addToCartButton'] = "Əlavə et";
$_LANG['addToGetFreeDomain'] = "Pulsuz domen əldə etmək üçün əlavə edin";
...
$_LANG['applyPromoCode'] = "Müraciət edin";
...
$_LANG['basicSsl'] = "Əsas SSL";
$_LANG['billableitemseach'] = "Ea";
$_LANG['billableitemshour'] = "Saat";
$_LANG['billableitemshours'] = "Saat";
$_LANG['billableitemsquantity'] = "Ədəd";
$_LANG['billing']['creditnote'] = "Kredit qeydi";
$_LANG['billing']['debitnote'] = "Debit qeydi";
$_LANG['billing']['issuedate'] = "Buraxılış tarixi";
$_LANG['billing']['issuedby'] = "Buraxılıb";
$_LANG['billing']['issuedto'] = "Verildi";
$_LANG['billing']['ledger']['date'] = "Tarix";
$_LANG['billing']['ledger']['reference'] = "İstinad";
$_LANG['billing']['ledger']['title'] = "Kitab";
$_LANG['billing']['ledger']['type'] = "Tip";
$_LANG['billing']['type']['affiliatepayout'] = "Tərəfdaşlıq ödənişi";
$_LANG['billing']['type']['clientaccountcredit'] = "Müştəri hesabı krediti";
$_LANG['billing']['type']['clientaccountdebit'] = "Müştəri hesabı debitləri";
$_LANG['billing']['type']['creditnoteadjustment'] = "Kredit qeydlərinin tənzimlənməsi";
$_LANG['billing']['type']['invoiceadjustment'] = "Faktura tənzimlənməsi";
$_LANG['billing']['type']['payment'] = "Ödəniş";
$_LANG['billing']['type']['refund'] = "Geri qaytarma";
$_LANG['billing']['type']['refundtocredit'] = "Müştəri hesabına geri qaytarın";
...
$_LANG['billingnotes']['creditnote']['items'] = "Kredit Qeyd Məhsulları";
$_LANG['billingnotes']['debitnote']['items'] = "Debit Qeyd Məhsulları";
...
$_LANG['cartItemType']['addon'] = "Əlavələr";
$_LANG['cartItemType']['addons'] = "Əlavələr";
$_LANG['cartItemType']['bundle'] = "Paket";
$_LANG['cartItemType']['bundles'] = "Dəstlər";
$_LANG['cartItemType']['domain'] = "Domen";
$_LANG['cartItemType']['domainRegistration'] = "Domen qeydiyyatı";
$_LANG['cartItemType']['domainRenewal'] = "Domenin yenilənməsi";
$_LANG['cartItemType']['domainRenewals'] = "Domen adı yeniləmə";
$_LANG['cartItemType']['domainTransfer'] = "Domen köçürülməsi";
$_LANG['cartItemType']['domainTransfers'] = "Domen köçürmələri";
$_LANG['cartItemType']['domains'] = "Domenlər";
$_LANG['cartItemType']['product'] = "Məhsul";
$_LANG['cartItemType']['products'] = "Məhsullar";
$_LANG['cartItemsSelected'] = ":count seçilmiş və satın almağa hazırsınız.";
...
$_LANG['cartbrowse'] = "Məhsul və Xidmətlərə baxın";
...
$_LANG['choosePackages'] = "Bir sıra paketlərdən seçin";
...
$_LANG['codeApplied'] = "Promo kodu tətbiq olunur";
$_LANG['completeorder'] = "Sifarişi tamamla";
$_LANG['configModalTitle'] = "Konfiqurasiya";
...
$_LANG['confirmItemDeletion'] = "Silinməni təsdiq";
...
$_LANG['cycleRenewal'] = ":cycle Yeniləmə";
$_LANG['daily'] = "Günlük";
...
$_LANG['designedToFitAnyBudget'] = "İstənilən büdcəyə uyğun hazırlanmışdır";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Açar söz, təsvir və ya domen üzrə axtarın.&#10;Məsələn: &quot;Əyləncəli iş tədbirləri &quot;, &quot;Peşəkarlar üçün hərtərəfli maliyyə planlaşdırma xidməti&quot;və ya &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Qısa bir təsvir və ya dəqiq bir domen daxil edin.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "Sistem heç bir təklif tapa bilmədi.";
$_LANG['domainSearch']['exactMatch'] = "Dəqiq uyğunluq";
$_LANG['domainSearch']['maxLength'] = "Maksimum uzunluq";
$_LANG['domainSearch']['notAvailable'] = "Mövcud deyil";
$_LANG['domainSearch']['safeSearch'] = "Təhlükəsiz axtarış";
$_LANG['domainSearch']['tlds'] = "TLD-ləri daxil edin";
$_LANG['domainSearch']['topAiSuggestion'] = "Ən yaxşı AI təklifi";
$_LANG['domainSearch']['topSuggestion'] = "Ən Yaxşı Təklif";
...
$_LANG['dynamicServiceFields']['validation']['accepted'] = ":attribute-ni yoxlayaraq xidmət şərtlərini qəbul etməlisiniz.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute bir sıra olmalıdır.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute etibarlı bir tarix olmalıdır.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute etibarlı e-poçt ünvanı olmalıdır.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "Sistem daxili bir səhv ilə qarşılaşdı. Daha sonra yenidən cəhd edin.";
$_LANG['dynamicServiceFields']['validation']['in'] = ":attribute üçün seçilmiş seçim etibarsızdır.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute tam ədəd olmalıdır.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute -də :max simvoldan çox olmaya bilər.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute aşağıdakı fayl növlərindən birini istifadə etməlidir: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute ən azı :min simvollarını ehtiva etməlidir.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute bir nömrə olmalıdır.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute etibarlı müntəzəm ifadə olmalıdır.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute tələb olunur.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute protokolu ehtiva edən etibarlı bir URL olmalıdır ('http: //' və ya 'https: //').";
...
$_LANG['encryption_failed'] = "Şifrləmə uğursuz oldu %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Daha sonra yenidən cəhd edin.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Ana səhifə";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Çox sorğu göndərdiniz.";
...
$_LANG['estimateTaxes'] = "Vergiləri təxmin edin";
$_LANG['every'] = "Hər biri";
$_LANG['exampledomain'] = "nüm. example.com";
$_LANG['excludeTLDs'] = "Bəzi TLD və yeni domenlər xaric";
...
$_LANG['extendYourDomainBy1Year'] = "Domeninizi 1 il genişləndir*";
...
$_LANG['findDomains'] = "Domenləri tapın";
...
$_LANG['forTheFirstYear'] = "ilk il üçün";
...
$_LANG['freeDomainHostingPromo'] = "Hosting alarkən pulsuz bir domen əldə edin.";
$_LANG['from'] = "dan";
...
$_LANG['hideSearchControls'] = "Axtarış nəzarətlərini gizlət";
...
$_LANG['inStock'] = "Anbarda: :amount";
$_LANG['incApplicableTaxes'] = "tətbiq olunan vergilər daxildir";
$_LANG['includeTLDs'] = "TLD-ləri daxil edin";
$_LANG['included'] = "Daxildir";
...
$_LANG['invalidCode'] = "Yanlış promo kodu";
$_LANG['invalid_input'] = "Yanlış giriş: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "Yanlış bilet identifikatoru və ya cavab identifikatoru.";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Giriş";
...
$_LANG['maxLength'] = "Maksimum uzunluq";
...
$_LANG['navMarketConnectService']['dynamic'] = "Dinamik xidmətlər";
...
$_LANG['noDomainsFound'] = "Heç bir domen tapılmadı";
...
$_LANG['orderForm']['additionalInformation'] = "Əlavə məlumatlar";
...
$_LANG['orderForm']['findNewDomainAi'] = "AI-yə əsaslanan təklifləri olan bir domen axtarın.";
...
$_LANG['ordererrortldsnotconfigured'] = "Hal-hazırda heç bir domen uzantısı satışa çıxarılmır. Kömək üçün bizimlə əlaqə saxlayın.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "İllik";
$_LANG['orderpaymenttermadjectivebiennially'] = "İki illik";
$_LANG['orderpaymenttermadjectivefree'] = "Pulsuz";
$_LANG['orderpaymenttermadjectivemonthly'] = "monthly";
$_LANG['orderpaymenttermadjectiveonetime'] = "bir dəfəlik";
$_LANG['orderpaymenttermadjectivequarterly'] = "Rüblük";
$_LANG['orderpaymenttermadjectivesemiannually'] = "Yarım illik";
$_LANG['orderpaymenttermadjectivetriennially'] = "Üç illik";
...
$_LANG['orderselectterm'] = "Termin seçin";
...
$_LANG['passwordtips'] = "<strong>Təhlükəsiz şifrə üçün göstərişlər</strong><br />Həm böyük, həm də kiçik hərflərdən istifadə edin.<br />Ən azı bir simvolu daxil edin (məsələn, <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>və ya <code>&amp;</code>).<br />Lüğət sözlərindən istifadə etməyin.<br />Parollarda :maximum_length simvolları ola bilər.";
...
$_LANG['previous'] = "Öncəki";
$_LANG['previouspage'] = "Əvvəlki səhifə";
$_LANG['price'] = "qiymət";
$_LANG['priceFor'] = ":termüçün qiymət";
$_LANG['priceForThisTerm'] = "Bu müddət üçün qiymət";
$_LANG['priceStandard'] = "Hər il :renewalPrice-da yenilənir, üstəlik vergi.";
$_LANG['priceWithDiscount'] = "İlk il üçün :registrationPrice , sonra hər il :renewalPrice .";
...
$_LANG['pwlengthmax'] = "Şifrələrdə :max simvoldan çox ola bilməz.";
...
$_LANG['pwstrengthfail'] = "Bu şifrə kifayət qədər güclü deyil. Daha mürəkkəb bir parol daxil edin.";
...
$_LANG['recommendedTLDs'] = "Tövsiyə olunan TLD-lər";
...
$_LANG['renewPrice'] = "Qiyməti yeniləyin";
...
$_LANG['requiredFields'] = "Tələb olunan sahələr* ilə işarələnir";
...
$_LANG['safeSearch'] = "Təhlükəsiz axtarış";
$_LANG['sale'] = "Endirim";
$_LANG['salePrice'] = "satış qiyməti";
$_LANG['salesTaxes'] = "Satış vergiləri";
$_LANG['search'] = "Axtar";
$_LANG['searchOurKnowledgebase'] = "Məlumat bazamızı axtarın";
$_LANG['searchResults'] = "Sorğulama nəticələri";
...
$_LANG['selectCountry'] = "Ölkəni seç";
$_LANG['selectDomain'] = "Domen seçin";
$_LANG['selectDomainForHosting'] = "Bu paylaşılan hosting paketini hansı domena əlavə etmək istərdiniz?";
$_LANG['selectDomainsForSsl'] = "Əsas SSL-ni hansı domen (lər) ə tətbiq etmək istərdiniz? Birdən çox seçə bilərsiniz.";
$_LANG['selectState'] = "Dövlət seçin";
...
$_LANG['service_unavailable'] = "Xidmət mövcud deyil: %s";
$_LANG['servicesRenew'] = "Yenilə";
$_LANG['setupFee'] = ":amount Quraşdırma haqqı";
$_LANG['setupMandate'] = "Ödəniş üçün mandat qurun";
$_LANG['sharedHosting'] = "Paylaşılan Hosting";
$_LANG['shopNow'] = "İndi al";
$_LANG['shortcuts'] = "Qısayollar";
$_LANG['show'] = "Göstər";
$_LANG['showMenu'] = "Menyunu göstər";
$_LANG['showSearchControls'] = "Axtarış nəzarətlərini göstər";
...
$_LANG['store']['dynamic']['title'] = "Dinamik xidmətlər";
...
$_LANG['store']['error']['serviceUnavailable'] = "Hazırda sorğunuzu emal edə bilməz. Bu, vaxt ayırması və ya müvəqqəti xidmət problemi ilə əlaqədar ola bilər. Xahiş edirəm yenidən cəhd edin.";
$_LANG['store']['error']['validationFailed'] = "Zəhmət olmasa aşağıdakı səhvləri yoxlayın və düzəldin.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo sizə mütəxəssis olmağınızı tələb etmədən sübut edilmiş, idarə olunan SEO prosesi təqdim edir. <br> marketgoo əlverişlidir və hamısı intuitiv interfeysdə hərtərəfli SEO hesabatları, planları və tövsiyələri təqdim edir.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Marketgoo-nu digər SEO məhsullarından nə fərqləndirir?";
$_LANG['store']['marketgoo']['faqs']['title'] = "Suallar və dəstək";
$_LANG['store']['marketgoo']['featurematrix']['1'] = "Axtarış Motoru Təqdimat";
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Veb sayt quruculuğu";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "Aylıq tərəqqi hesabatı";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Trafik analitikası";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "SEO hesabatını PDF olaraq yükləyin <a href='https://mktgoo.co/seo-report-score2'>(Nümunəyə baxın)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "Aİ ilə işləyən xüsusiyyətlər: Başlıq və Meta Təsvirinin avtomatik yaradılması";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Səhifələr taranır";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Rəqib izlənməsi";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Açar söz izləmə və optimallaşdır";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Yenilənmiş Hesabat və Plan";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Xüsusi SEO Planı";
$_LANG['store']['marketgoo']['features']['1'] = "SEO Planınızı əldə edin";
$_LANG['store']['marketgoo']['features']['2'] = "Addım-addım təlimatları";
$_LANG['store']['marketgoo']['features']['3'] = "Aylıq hesabat ilə irəliləyişi izləyin";
$_LANG['store']['marketgoo']['features']['4'] = "Rəqibləri izləyin və izlə";
$_LANG['store']['marketgoo']['features']['5'] = "Fərdi Səhifə Optimallaşdır";
$_LANG['store']['marketgoo']['features']['6'] = "Asan açar söz araşdırması və monitorinqi";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Qeydiyyatdan keçin və ani SEO hesabatınızı və planınızı əldə edin. Təkmilləşdirmə üçün harada yer olduğuna baxın və saytınız üçün uyğunlaşdırılmış tövsiyələr alın.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Təlimatlar texnoloji təcrübəli olmayan istifadəçilər üçün yazılıb, nümunələr və izahlarla hər tövsiyədə sizə rəhbərlik edir.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Hər ay saytınızın SEO tərəqqisi ilə bir e-poçt alın və PDF şəklində yükləyin.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Trafik əldə etmək üçün nə etdiklərini və nömrələrinizin onlara qarşı necə yığıldığını görmək üçün rəqibləri izləyin. İzlədiyinizi heç vaxt bilməyəcəklər!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo, seçdiyiniz açar sözlərdən birinə uyğunlaşdıraraq saytınızdakı hər bir fərdi səhifəni optimallaşdırmaqla və tezliyin və yerləşdirmənin düzgün olduğundan əmin olmaqla sizə rəhbərlik edir.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "SEO ilə tanış deyilsinizsə, açar sözlər çox böyük ola bilər. marketgoo açar sözləri tövsiyə edir və eyni zamanda optimallaşdırmaq istədiyinizi axtarmağa və daxil etməyə imkan verir.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Bütün veb sayt qurucuları ilə işləyir";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Müqayisə tarixi: 19 iyun, 20 25:tagBreak*AV-Test tərəfindən aparılan araşdırmalara görə ümumi şəbəkə performansı. :tagOpenhesabatını:tagClose-ni oxuya bilərsiniz.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Sızan etimadnamələr haqqında xəbər";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Yükləmələr üçün zərərli proqram";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Açıqlanmadı";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "İzləyici və reklam blokeri";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN əlaqə sürətini məhdudlaşdırmır. Tam sürətli VPN bağlantımızdan heç bir boğulma olmadan həzz alın.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN, Windows, macOS, Linux, Android və iOS daxil olmaqla bütün məşhur platformalarla uyğundur. Üstəlik, marşrutlaşdırıcınız da daxil olmaqla 10-a qədər cihazı təmin edə bilərsiniz.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "VPN bant genişliyi məhdudiyyəti yoxdur  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Şəxsi və təhlükəsiz bir əlaqə üzərində gözdən keçirin, oynayın və işləyin";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "İctimai Wi-Fi-də belə təhlükəsiz əlaqə saxlayın";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "IP ünvanınızı qoruyaraq onlayn izləməni azaldın";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Xarici səyahət edərkən ev məzmununa baxın";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Qoşulduğunuz zaman və hər yerdə əlavə qorunma təbəqəsi üçün onlayn fəaliyyətinizi şifrələmək üçün NordVPN-dən istifadə edin.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN növbəti nəsil şifrələmə ilə əlaqənizi qoruyur, beləliklə hesablarınıza daxil ola, bank köçürmələri edə və narahat olmadan onlayn alış-veriş edə bilərsiniz. Hətta qorunmayan şəbəkələrdə.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN sizi kiber təhdidlərdən qorumaq üçün geniş xüsusiyyətlərə malikdir. Threat Protection Pro™ -ə əlavə olaraq, VPN bağlantınız azaldıqda internet bağlantınızı bloklayan və məlumatlarınızın təhlükəsiz qalmasını təmin edən avtomatik Kill Switch var. Hökumət senzurası və ciddi internet qaydaları səbəbindən yüksək səviyyədə onlayn təhlükəsizlik tələb olunduqda gizli serverlər kömək edəcəkdir.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "VPN ilə onlayn təhlükəsizliyinizi artırın";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Qabaqcıl təhlükəsizlik";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Bir fayl yüklədiyiniz zaman Threat Protection Pro™ onu zərərli proqram üçün yoxlayır.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ müdaxilə edən reklamları və veb izləyiciləri bloklayır və URL-ləri avtomatik olaraq tarayır və zərərli olanları bloklayır.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Threat Protection Pro™ cihazlarınızı və məxfiliyinizi qoruyur. İzləyiciləri bloklayaraq, onlayn xəbərdarlıqlardan qaçınmağa kömək edir.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "NordVPN-nin :tagOpenThreat Protection Pro™:tagClose xüsusiyyəti bir əlavə kliklə daha çox təhlükəsizlik üstünlükləri və daha yaxşı qorunma təklif edən oyun dəyişdiricisidir.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Yalnız bir VPN-dən daha çox";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Gizlədəcək bir şeyiniz olmasa da, yəqin ki, izlənilmək və izləmək fikrini bəyənmirsiniz. İnternet istifadəçilərinin VPN xidmətlərini seçməsinin əsas səbəbi onlayn məxfilik və ümumi təhlükəsizlikdir.:tagBreakBudur konkret səbəblər NIYƏ?";
$_LANG['store']['nordvpn']['features']['use']['tagline2'] = "Otellərdə, hava limanlarında və qəhvəxanalarda ictimai Wi-Fi şəbəkələri tez-tez təhlükəsizlik tədbirlərinin aşağı olması səbəbindən hakerlər üçün mükəmməl hədəfdir.";
$_LANG['store']['nordvpn']['features']['use']['tagline3'] = "İnternet xidməti təminatçıları kimi üçüncü tərəflərin gündəlik onlayn fəaliyyətinizi görməsinin və izləməsinin qarşısını alın.";
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Facebook, X (Twitter) və WhatsApp kimi platformalarda regional və siyasi məhdudiyyətlərdən çəkinin.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Onlayn reklamlar ümumiyyətlə bezdirici və diqqəti yayındırır. Veb saytların böyük hissələrini qarışdırırlar, əlaqə sürətini yavaşlatır və zərərli ola bilərlər.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Ağıllı ev texnologiyaları, xüsusən etibarsız IoT cihazları ev şəbəkələrində zəifliklər yarada bilər.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Təhlükəsiz ictimai Wi-Fi bağlantısı";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Təhlükəsiz baxış";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Məhdudiyyətsiz sosial mediaya giriş";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Zərərli reklamlardan qorunma";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Ağıllı ev təhlükəsizliyi";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• IP ünvanınızı qoruyun:tagBreak• Zərərli proqramları, izləyiciləri və reklamları bloklayın:tagBreak• 10-a qədər cihazı birləşdirin";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Gündəlik SMART məlumat bazası taramaları";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Gündəlik SMART Fayl Taramaları";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Təzə məzmun dizayn edin, əlaqəni yaxşılaşdırın və SocialBee ilə nəticələrinizi izləyin.";
$_LANG['store']['socialbee']['cartTitle'] = "SocialBee Sosial Media İdarəetməsi";
...
$_LANG['suggestedTLDs'] = "Təklif olunan TLD-lər";
...
$_LANG['tax']['errorVatInvalidFormat'] = ":countryNameüçün etibarsız ƏDV nömrəsi formatı.";
...
$_LANG['update'] = "Yenilə";
$_LANG['updateProductQuantity'] = "Yenilə";
$_LANG['updateTotals'] = "Qiyməti yenilə";
