...
$_LANG['addToCartButton'] = "Dodaj u košaricu";
$_LANG['addToGetFreeDomain'] = "Dodaj da biste dobili besplatnu domenu";
...
$_LANG['applyPromoCode'] = "Prijavite se";
...
$_LANG['basicSsl'] = "Osnovni SSL";
$_LANG['billableitemseach'] = "Svaka";
$_LANG['billableitemshour'] = "Sat";
$_LANG['billableitemshours'] = "Sati";
$_LANG['billableitemsquantity'] = "Kom";
$_LANG['billing']['creditnote'] = "Kreditna bilješka";
$_LANG['billing']['debitnote'] = "Debitna bilješka";
$_LANG['billing']['issuedate'] = "Datum izdavanja";
$_LANG['billing']['issuedby'] = "Izdao";
$_LANG['billing']['issuedto'] = "Izdano";
$_LANG['billing']['ledger']['date'] = "Datum";
$_LANG['billing']['ledger']['reference'] = "Referenca";
$_LANG['billing']['ledger']['title'] = "Knjiga";
$_LANG['billing']['ledger']['type'] = "Vrsta";
$_LANG['billing']['type']['affiliatepayout'] = "Partnerska isplata";
$_LANG['billing']['type']['clientaccountcredit'] = "Kredit za klijentski račun";
$_LANG['billing']['type']['clientaccountdebit'] = "Zaduženje računa klijenta";
$_LANG['billing']['type']['creditnoteadjustment'] = "Prilagodba kreditne bilješke";
$_LANG['billing']['type']['invoiceadjustment'] = "Prilagodba računa";
$_LANG['billing']['type']['payment'] = "Plaćanje";
$_LANG['billing']['type']['refund'] = "Povrat novca";
$_LANG['billing']['type']['refundtocredit'] = "Povrat na račun klijenta";
$_LANG['billingAddress'] = "Adresa za naplatu";
$_LANG['billingOverview'] = "Pregled naplate";
$_LANG['billingdetails'] = "Pojedinosti o naplati";
$_LANG['billingnotes']['creditnote']['items'] = "Stavke kreditne bilješke";
$_LANG['billingnotes']['debitnote']['items'] = "Stavke debitnih bilješki";
...
$_LANG['cartItemType']['addon'] = "Dodatak";
$_LANG['cartItemType']['addons'] = "Dodaci";
$_LANG['cartItemType']['bundle'] = "Paket";
$_LANG['cartItemType']['bundles'] = "Paketi";
$_LANG['cartItemType']['domain'] = "Domena";
$_LANG['cartItemType']['domainRegistration'] = "Registracija domene";
$_LANG['cartItemType']['domainRenewal'] = "Obnova domene";
$_LANG['cartItemType']['domainRenewals'] = "Obnove domena";
$_LANG['cartItemType']['domainTransfer'] = "Prijenos domene";
$_LANG['cartItemType']['domainTransfers'] = "Prijenosi domena";
$_LANG['cartItemType']['domains'] = "Domene";
$_LANG['cartItemType']['product'] = "Proizvod";
$_LANG['cartItemType']['products'] = "Proizvodi";
$_LANG['cartItemsSelected'] = "Imaš :count odabran i spreman za kupnju.";
...
$_LANG['cartbrowse'] = "Pregledajte proizvode i usluge";
...
$_LANG['choosePackages'] = "Odaberite iz niza paketa";
...
$_LANG['codeApplied'] = "Primijenjen promotivni kod";
$_LANG['completeorder'] = "Završi narudžbu";
$_LANG['configModalTitle'] = "Konfiguracija";
...
$_LANG['confirmItemDeletion'] = "Potvrdite brisanje";
...
$_LANG['cycleRenewal'] = ":cycle Obnova";
$_LANG['daily'] = "Dnevno";
...
$_LANG['designedToFitAnyBudget'] = "Dizajniran da odgovara svakom proračunu";
...
$_LANG['domainSearch']['domainOrAiInstruction'] = "Pretraživanje po ključnoj riječi, opisu ili domeni.&#10;Na primjer: &quot;Zabavni poslovni događaji &quot;, &quot;Sveobuhvatna usluga financijskog planiranja za profesionalce&quot;, ili &quot;example.com&quot;.";
$_LANG['domainSearch']['domainOrAiPrompt'] = "Unesite kratak opis ili točnu domenu.";
$_LANG['domainSearch']['errors']['noSuggestions'] = "Sustav nije mogao pronaći nikakve prijedloge.";
$_LANG['domainSearch']['exactMatch'] = "Točno podudaranje";
$_LANG['domainSearch']['maxLength'] = "Maksimalna duljina";
$_LANG['domainSearch']['notAvailable'] = "Nije dostupno";
$_LANG['domainSearch']['safeSearch'] = "Sigurno pretraživanje";
$_LANG['domainSearch']['tlds'] = "Uključite TLD-ove";
$_LANG['domainSearch']['topAiSuggestion'] = "Najbolji prijedlog AI";
$_LANG['domainSearch']['topSuggestion'] = "Vrhunski prijedlog";
...
$_LANG['due'] = "Dugo";
$_LANG['dynamicServiceFields']['validation']['accepted'] = "Morate prihvatiti uvjete pružanja usluge tako što ćete provjeriti :attribute.";
$_LANG['dynamicServiceFields']['validation']['array'] = ":attribute mora biti niz.";
$_LANG['dynamicServiceFields']['validation']['date'] = ":attribute mora biti valjani datum.";
$_LANG['dynamicServiceFields']['validation']['email'] = ":attribute mora biti valjana adresa e-pošte.";
$_LANG['dynamicServiceFields']['validation']['failed'] = "Sustav je naišao na unutarnju pogrešku. Pokušajte ponovo kasnije.";
$_LANG['dynamicServiceFields']['validation']['in'] = "Odabrana opcija za :attribute je nevažeća.";
$_LANG['dynamicServiceFields']['validation']['integer'] = ":attribute mora biti cijeli broj.";
$_LANG['dynamicServiceFields']['validation']['max'] = ":attribute ne smije sadržavati više od :max znakova.";
$_LANG['dynamicServiceFields']['validation']['mimes'] = ":attribute mora koristiti jednu od sljedećih vrsta datoteka: :values.";
$_LANG['dynamicServiceFields']['validation']['min'] = ":attribute mora sadržavati najmanje :min znakove.";
$_LANG['dynamicServiceFields']['validation']['numeric'] = ":attribute mora biti broj.";
$_LANG['dynamicServiceFields']['validation']['regex'] = ":attribute mora biti valjani regularni izraz.";
$_LANG['dynamicServiceFields']['validation']['required'] = ":attribute je obavezan.";
$_LANG['dynamicServiceFields']['validation']['url'] = ":attribute mora biti valjani URL koji uključuje protokol ('http: //' ili 'https: //').";
$_LANG['edit'] = "Uredi";
$_LANG['email'] = "E-mail";
...
$_LANG['encryption_failed'] = "Šifriranje nije uspjelo: %s";
...
$_LANG['errorPage']['rateLimitExceeded']['description'] = "Pokušajte ponovo kasnije.";
$_LANG['errorPage']['rateLimitExceeded']['home'] = "Naslovnica";
$_LANG['errorPage']['rateLimitExceeded']['subtitle'] = "Poslali ste previše zahtjeva.";
...
$_LANG['estimateTaxes'] = "Procijenite poreze";
$_LANG['every'] = "Svako";
$_LANG['exampledomain'] = "npr. example.com";
$_LANG['excludeTLDs'] = "Isključuje određene TLD-ove i nedavno obnovljene domene";
...
$_LANG['extendYourDomainBy1Year'] = "Proširite domenu za 1 godinu*";
...
$_LANG['findDomains'] = "Pronađite domene";
...
$_LANG['forTheFirstYear'] = "za prvu godinu";
...
$_LANG['freeDomainHostingPromo'] = "Nabavite besplatnu domenu prilikom kupovine hostinga.";
$_LANG['from'] = "Od";
...
$_LANG['hideSearchControls'] = "Sakrij kontrole pretraživanja";
...
$_LANG['inStock'] = "Na lageru: :amount";
$_LANG['incApplicableTaxes'] = "uključujući primjenjive poreze";
$_LANG['includeTLDs'] = "Uključite TLD-ove";
$_LANG['included'] = "Uključeno";
...
$_LANG['invalidCode'] = "Nevažeći promotivni kod";
$_LANG['invalid_input'] = "Nevažeći unos: %s";
$_LANG['invalid_ticket_id_or_reply_id'] = "Nevažeći ID karte ili ID odgovora.";
...
$_LANG['lastChance'] = "Posljednja šansa";
...
$_LANG['marketConnect']['dynamic']['manage'] = "Prijavite se";
...
$_LANG['maxLength'] = "Maksimalna duljina";
...
$_LANG['navMarketConnectService']['dynamic'] = "Dinamičke usluge";
...
$_LANG['noDomainsFound'] = "Nema pronađenih domena";
...
$_LANG['orderForm']['additionalInformation'] = "Dodatne informacije";
...
$_LANG['orderForm']['findNewDomainAi'] = "Potražite domenu s prijedlozima na AI.";
...
$_LANG['ordererrortldsnotconfigured'] = "Trenutno nijedna ekstenzija domene nije dostupna za prodaju. Za pomoć, kontaktirajte nas.";
...
$_LANG['orderpaymenttermadjectiveannually'] = "Godišnji";
$_LANG['orderpaymenttermadjectivebiennially'] = "Bijenale";
$_LANG['orderpaymenttermadjectivefree'] = "Besplatno";
$_LANG['orderpaymenttermadjectivemonthly'] = "Mjesečno";
$_LANG['orderpaymenttermadjectiveonetime'] = "Odjednom";
$_LANG['orderpaymenttermadjectivequarterly'] = "Kvartalno";
$_LANG['orderpaymenttermadjectivesemiannually'] = "Polugodišnji";
$_LANG['orderpaymenttermadjectivetriennially'] = "Trijenale";
...
$_LANG['orderselectterm'] = "Odaberite Pojam";
...
$_LANG['page'] = "Stranica";
$_LANG['pageof'] = "od";
$_LANG['passwordtips'] = "<strong>Savjeti za sigurnu lozinku</strong><br />Koristite i velika i mala slova.<br />Uključite barem jedan simbol (na primjer, <code>#</code>, <code>$</code>, <code>!</code>, <code>%</code>, ili <code>&amp;</code>).<br />Nemojte koristiti riječi iz rječnika.<br />Lozinke mogu sadržavati do :maximumznakova _length.";
...
$_LANG['price'] = "cijena";
$_LANG['priceFor'] = "Cijena za :term";
$_LANG['priceForThisTerm'] = "Cijena za ovaj termin";
$_LANG['priceStandard'] = "Obnavlja se svake godine na :renewalPrice, plus porez.";
$_LANG['priceWithDiscount'] = ":registrationPrice prvu godinu, zatim :renewalPrice godišnje.";
...
$_LANG['pwlengthmax'] = "Lozinke ne mogu sadržavati više od :max znakova.";
...
$_LANG['pwstrengthfail'] = "Ova lozinka nije dovoljno jaka. Unesite složeniju lozinku.";
...
$_LANG['recommendedTLDs'] = "Preporučeni TLD-ovi";
...
$_LANG['renewPrice'] = "Obnovite cijenu";
...
$_LANG['requiredFields'] = "Obavezna polja označena su znakom*";
...
$_LANG['safeSearch'] = "Sigurno pretraživanje";
$_LANG['sale'] = "Prodaja";
$_LANG['salePrice'] = "prodajna cijena";
$_LANG['salesTaxes'] = "Porez na promet";
$_LANG['search'] = "Traži";
$_LANG['searchOurKnowledgebase'] = "Pretražite našu bazu znanja";
$_LANG['searchResults'] = "Rezultati pretraživanja";
...
$_LANG['selectCountry'] = "Odaberite državu";
$_LANG['selectDomain'] = "Odaberite domenu";
$_LANG['selectDomainForHosting'] = "Kojoj domeni želite priložiti ovaj zajednički hosting paket?";
$_LANG['selectDomainsForSsl'] = "Na koju domenu želite primijeniti osnovni SSL? Možete odabrati više.";
$_LANG['selectState'] = "Odaberite državu";
...
$_LANG['service_unavailable'] = "Usluga nedostupna: %s";
$_LANG['servicesRenew'] = "Obnavljanje";
$_LANG['setupFee'] = ":amount Naknada za postavljanje";
$_LANG['setupMandate'] = "Postavljanje mandata za plaćanje";
$_LANG['sharedHosting'] = "Dijeljeni hosting";
$_LANG['shopNow'] = "Kupujte sada";
$_LANG['shortcuts'] = "Prečaci";
$_LANG['show'] = "Prikaži";
$_LANG['showMenu'] = "Prikaži izbornik";
$_LANG['showSearchControls'] = "Prikaži kontrole pretraživanja";
...
$_LANG['store']['dynamic']['title'] = "Dinamičke usluge";
...
$_LANG['store']['error']['serviceUnavailable'] = "Trenutno ne mogu obraditi vaš zahtjev. To može biti zbog vremenskog isteka ili privremenog problema s uslugom. Molim pokušajte ponovo.";
$_LANG['store']['error']['validationFailed'] = "Molimo provjerite i ispravite pogreške u nastavku.";
...
$_LANG['store']['marketgoo']['faqs']['a4'] = "marketgoo vam pruža provjereni, vođeni SEO proces bez potrebe da budete stručnjak. <br> marketgoo je pristupačan i pruža sveobuhvatna SEO izvješća, planove i preporuke, sve u intuitivnom sučelju.";
...
$_LANG['store']['marketgoo']['faqs']['q4'] = "Što marketgoo razlikuje od ostalih SEO proizvoda?";
...
$_LANG['store']['marketgoo']['featurematrix']['10'] = "Kompatibilnost graditelja web stranica";
$_LANG['store']['marketgoo']['featurematrix']['11'] = "mjesečni izvještaj o napretku";
$_LANG['store']['marketgoo']['featurematrix']['2'] = "Prometna analitika";
$_LANG['store']['marketgoo']['featurematrix']['3'] = "Preuzmite SEO izvješće kao PDF <a href='https://mktgoo.co/seo-report-score2'>(vidi primjer)</a>";
$_LANG['store']['marketgoo']['featurematrix']['4'] = "Značajke koje pokreću AI: Automatsko generiranje naslova i meta opisa";
$_LANG['store']['marketgoo']['featurematrix']['5'] = "Stranice skenirane";
$_LANG['store']['marketgoo']['featurematrix']['6'] = "Praćenje natjecatelja";
$_LANG['store']['marketgoo']['featurematrix']['7'] = "Praćenje i optimizacija ključnih riječi";
$_LANG['store']['marketgoo']['featurematrix']['8'] = "Ažurirano izvješće i plan";
$_LANG['store']['marketgoo']['featurematrix']['9'] = "Prilagođeni SEO plan";
$_LANG['store']['marketgoo']['features']['1'] = "Nabavite svoj SEO plan";
$_LANG['store']['marketgoo']['features']['2'] = "Slijedite upute korak po korak";
$_LANG['store']['marketgoo']['features']['3'] = "Pratite napredak mjesečnim izvješćem";
$_LANG['store']['marketgoo']['features']['4'] = "Pratite i pratite natjecatelje";
$_LANG['store']['marketgoo']['features']['5'] = "Individualna optimizacija stranice";
$_LANG['store']['marketgoo']['features']['6'] = "Jednostavno istraživanje i praćenje ključnih riječi";
$_LANG['store']['marketgoo']['featuresdetail']['1'] = "Prijavite se i dobijte trenutni SEO izvještaj i plan. Pogledajte gdje ima prostora za poboljšanje i potražite preporuke prilagođene vašoj web lokaciji.";
$_LANG['store']['marketgoo']['featuresdetail']['2'] = "Upute su napisane za korisnike koji nisu pametni u tehnologiji, vodeći vas kroz svaku preporuku, s primjerima i objašnjenjima.";
$_LANG['store']['marketgoo']['featuresdetail']['3'] = "Svakog mjeseca dobijte e-poštu s SEO napretkom vaše web stranice i preuzmite ga kao PDF.";
$_LANG['store']['marketgoo']['featuresdetail']['4'] = "Pratite konkurente kako biste vidjeli što rade kako bi dobili promet i kako se vaši brojevi slažu s njihovim. Nikad neće znati da gledaš!";
$_LANG['store']['marketgoo']['featuresdetail']['5'] = "marketgoo vas vodi kroz optimizaciju svake pojedinačne stranice na vašoj web lokaciji usklađujući je s jednom od odabranih ključnih riječi i osiguravajući da su učestalost i položaj ispravni.";
$_LANG['store']['marketgoo']['featuresdetail']['6'] = "Ključne riječi mogu biti neodoljive ako niste upoznati sa SEO. marketgoo preporučuje ključne riječi, a također vam omogućuje pretraživanje i unos onih za koje želite optimizirati.";
...
$_LANG['store']['marketgoo']['worksWithAllSiteBuilders'] = "Radi sa svim graditeljima web stranica";
...
$_LANG['store']['nordvpn']['features']['comparison']['asterisk'] = " Datum usporedbe: 19. lipnja 20 25:tagBreak*Ukupni učinak mreže prema istraživanju AV-Testa. Možete pročitati :tagOpencijeli izvještaj:tagClose.";
$_LANG['store']['nordvpn']['features']['comparison']['chat'] = "Upozorenja o procurjenim vjerodaj";
$_LANG['store']['nordvpn']['features']['comparison']['log'] = "Preuzimanje zlonamjernog softvera";
...
$_LANG['store']['nordvpn']['features']['comparison']['vpn3'] = "Nije objavljeno";
...
$_LANG['store']['nordvpn']['features']['comparison']['wireguard'] = "Tracker i blokator oglasa";
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Nord VPN ne ograničava brzinu veze. Uživajte u našoj VPN vezi pune brzine bez ikakvog prigušivanja.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "Nord VPN kompatibilan je sa svim popularnim platformama, uključujući Windows, macOS, Linux, Android i iOS. Osim toga, možete osigurati do 10 uređaja, uključujući vaš usmjerivač.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "Nema ograničenja propusnosti VPN-a  ";
...
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Pregledajte, igrajte se i radite na privatnoj i sigurnoj vezi";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Ostanite sigurno povezani čak i na javnom Wi-Fi-u";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Smanjite online praćenje zaštitom vaše IP adrese";
...
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Gledajte kućne sadržaje tijekom putovanja u inozemstvo";
...
$_LANG['store']['nordvpn']['features']['security']['tagline2'] = "Koristite NordVPN za šifriranje aktivnosti na mreži za dodatni sloj zaštite kad god i gdje god ste povezani.";
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN štiti vašu vezu šifriranjem sljedeće generacije, tako da se možete bez brige prijaviti na svoje račune, vršiti bankovne prijenose i kupovati putem interneta. Čak i na nezaštićenim mrežama.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline5'] = "NordVPN se može pohvaliti širokim rasponom značajki koje vas štite od cyber prijetnji. Uz Threat Protection Pro™, postoji i automatski Kill Switch koji blokira vašu internetsku vezu ako vaša VPN veza padne, osiguravajući da vaši podaci ostanu sigurni. Zamagljeni poslužitelji pomoći će kada je potrebna visoka razina internetske sigurnosti zbog vladine cenzure i strogih internetskih propisa.";
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Povećajte svoju internetsku sigurnost pomoću VPN-a";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Napredna sigurnost";
...
$_LANG['store']['nordvpn']['features']['threat']['malware'] = "Kad god preuzmete datoteku, Threat Protection Pro™ pregledava je na zlonamjerni softver.";
$_LANG['store']['nordvpn']['features']['threat']['protection'] = "Threat Protection Pro™ blokira nametljive oglase i web tragače te automatski skenira URL-ove i blokira zlonamjerne.";
$_LANG['store']['nordvpn']['features']['threat']['safe'] = "Threat Protection Pro™ štiti vaše uređaje i vašu privatnost. Blokiranjem tragača pomaže vam da izbjegnete internetske njuškače.";
$_LANG['store']['nordvpn']['features']['threat']['tagline'] = "NordVPN-ova značajka :tagOpenThreat Protection Pro™:tagClose je promjena igre koja nudi još više sigurnosnih pogodnosti i bolju zaštitu jednim dodatnim klikom.";
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Više od VPN-a";
$_LANG['store']['nordvpn']['features']['use']['tagline1'] = "Čak i ako nemate što sakriti, vjerojatno vam se ne sviđa ideja da vas promatraju i prate. Glavni razlog zašto korisnici interneta odabiru VPN usluge je internetska privatnost i opća sigurnost.:tagBreakEvo konkretnih razloga ZAŠTO?";
$_LANG['store']['nordvpn']['features']['use']['tagline2'] = "Javne Wi-Fi mreže u hotelima, zračnim lukama i kafićima savršena su meta hakera zbog često niskih sigurnosnih mjera.";
...
$_LANG['store']['nordvpn']['features']['use']['tagline4'] = "Izbjegavajte regionalna i politička ograničenja na platformama poput Facebooka, X (Twitter) i WhatsAppa.";
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Online oglasi obično su dosadni i ometaju. Oni zatrpavaju velike dijelove web stranica, usporavaju brzinu veze i mogu biti zlonamjerni.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Tehnologije pametnih kuća, posebno nesigurni IoT uređaji, mogu stvoriti ranjivosti u kućnim mrežama.";
...
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Sigurna javna Wi-Fi veza";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Sigurnije pregledavanje";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Neograničen pristup društvenim mrežama";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "zaštita od zlonamjernih oglasa";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Sigurnost pametnog doma";
...
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Dobijte ponudu";
...
$_LANG['store']['nordvpn']['hero']['tagline'] = "• Zaštitite svoju IP adresu:tagBreak• Blokirajte zlonamjerni softver, uređaje za praćenje i oglase:tagBreak• Povežite do 10 uređaja";
...
$_LANG['store']['sitelock']['features']['dailySmartDatabaseScans'] = "Dnevno skeniranje SMART baze podataka";
$_LANG['store']['sitelock']['features']['dailySmartFileScans'] = "Dnevno skeniranje SMART datoteka";
...
$_LANG['store']['socialbee']['cartShortDescription'] = "Dizajnirajte svježi sadržaj, poboljšajte angažman i pratite svoje rezultate uz SocialBee.";
$_LANG['store']['socialbee']['cartTitle'] = "SocialBee Upravljanje društvenim medijima";
...
$_LANG['suggestedTLDs'] = "Predloženi TLD-ovi";
...
$_LANG['tax']['errorVatInvalidFormat'] = "Nevažeći format PDV-a za :countryName.";
...
$_LANG['updateProductQuantity'] = "Osvježi";
$_LANG['updateTotals'] = "Ažurirajte ukupne iznose";
